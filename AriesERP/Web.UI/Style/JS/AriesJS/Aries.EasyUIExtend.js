(function ($Core) {
    ...
    //$Core.Lang.root = parent.AR.Lang.root;
    //$Core.Lang.isChinese = parent.AR.Lang.isChinese;
    //$Core.Lang.isSamePwd = parent.AR.Lang.isSamePwd;
    //$Core.Lang.isMobile = parent.AR.Lang.isMobile;
    //$Core.Lang.isTelePhone = parent.AR.Lang.isTelePhone;
    //$Core.Lang.isUserName = parent.AR.Lang.isUserName;
    //$Core.Lang.isPwd = parent.AR.Lang.isPwd;
    //$Core.Lang.isNumber = parent.AR.Lang.isNumber;
    //$Core.Lang.isID= parent.AR.Lang.isID;
    //$Core.Lang.isMobileOrTelePhone = parent.AR.Lang.isMobileOrTelePhone;
    //$Core.Lang.isDateTime = parent.AR.Lang.isDateTime;
    //$Core.Lang.isYear = parent.AR.Lang.isYear;
    //$Core.Lang.isEmail = parent.AR.Lang.isEmail;
    //$Core.Lang.select = parent.AR.Lang.select;
    //$Core.Lang.selectData = parent.AR.Lang.selectData;
    //$Core.Lang.dataExists = parent.AR.Lang.dataExists;
    //$Core.Lang.requestFail = parent.AR.Lang.requestFail;
    //$Core.Lang.ruleError = parent.AR.Lang.ruleError;
    //$Core.Lang.isLength = parent.AR.Lang.isLength;
    //}
...
_getTreeData = function (nodes, idField, textField, parentField, rootID) {
    return function fn(parentid) {
        var cn = new Array();
        for (var i = 0; i < nodes.length; i++) {
            var n = {};//, attrs = {}
            var xnodes = nodes[i];
            //each: for (var j in xnodes) {
            ...
            //}
            if (!n.attributes) {
                n.attributes = xnodes;//attrs;
            }
            n.id = xnodes[idField], n.text = xnodes[textField];
            if (xnodes[parentField] == parentid) {
                n.children = fn(n.id);//arguments.callee(nodes[i][idField]);
                if (!n.children.length == 0) {
                    n.state = 'closed';
                }
                cn.push(n);
                if (cn[0] && cn[0].attributes[idField]) { cn[0].attributes[idField] = ""; }
                if (cn[0] && cn[0].attributes[textField]) { cn[0].attributes[textField] = ""; }
            }
        }
        return cn;
    }(rootID);
