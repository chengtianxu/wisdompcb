(function ($Core) {
    ...
    //$Core.Lang.operationSuccess = parent.AR.Lang.operationSuccess;
    //$Core.Lang.fillTheBlank = parent.AR.Lang.fillTheBlank;
    //}
        ...
        function Obj() {
            ...
            */
            ...
            this.onInit = function () {
                ...
                this.BtnCommit.$target.click(function () {
                    return that.BtnCommit.onExecute();
                });
                //注册保存跟取消按钮事件
            ...
            */
            this.commit = function ($target, mthodName, tableName, $validator, clearEmptyValue, callBack, url) {
                ...
                if (this.BtnCommit && this.BtnCommit.onBeforeExecute(formData) == false) { return false; }
