...
select '配料单号' as value,'配料单号' as text,'' as parent,25 as sortno union
select '作业单号' as value,'作业单号' as text,'' as parent,30 as sortno union
select '组别代码' as value,'组别代码' as text,'' as parent,40 as sortno union
...
select '销售订单' as value,'销售订单' as text,'' as parent,90 as sortno union
