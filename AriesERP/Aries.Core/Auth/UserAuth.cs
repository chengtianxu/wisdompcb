...
namespace Aries.Core.Auth
{
    ...
    public static partial class UserAuth
    {
        ...
        /// </summary>
        public static bool Login(string company,string userName, string password, out string errMsg)
        {
            ...
            WriteCookie(token, userName,company);
        ...
        public static void WriteCookie(string token, string userName,string company)
        {
            ...
            //HttpCookie companyCookie = new HttpCookie("aries_company", company);
            tokenCookie.Domain = AppConfig.XHtml.Domain;
            userNameCookie.Domain = AppConfig.XHtml.Domain;
            //companyCookie.Domain = AppConfig.XHtml.Domain;
            tokenCookie.Expires = DateTime.Now.AddHours(8);
            userNameCookie.Expires = DateTime.Now.AddDays(30);//记住用户名（30天,最好与页面一致）
            //companyCookie.Expires = DateTime.Now.AddDays(30); //记住公司名
            HttpContext.Current.Response.Cookies.Add(tokenCookie);
            HttpContext.Current.Response.Cookies.Add(userNameCookie);
