inherited frmEdtReqDate_Mod29: TfrmEdtReqDate_Mod29
  Left = 316
  Top = 277
    ...
    object eh72: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          DynProps = <>
          EditButtons = <>
          FieldName = 'Price_Total_C'
          Footers = <>
          ReadOnly = True
          Title.Alignment = taRightJustify
          Title.Caption = #21547#31246#24635#20215
          Width = 81
        end
        item
          Color = clAqua
  ...
  object pm1: TPopupMenu
    ...
    Left = 296
    Top = 105
    object mniDate: TMenuItem
      Caption = #32534#36753#20132#36135#26085#26399
      OnClick = mniDateClick
    end
  end
  object cds72: TClientDataSet
    Aggregates = <>
    Params = <>
    OnCalcFields = cds72CalcFields
    Left = 600
    Top = 65
  end
