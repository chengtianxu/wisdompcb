...
type
  TFrmCheck_705Electron2 = class(TfrmBaseCheck_Mod705)
    lbl14: TLabel;
...
var
  FrmCheck_705Electron2: TFrmCheck_705Electron2;
...
function TFrmCheck_705Electron2.BeforeSaveToDB:Boolean;
begin
  inherited;
  result := false;
...
procedure TFrmCheck_705Electron2.edt_WorkNoButtonClick(Sender: TObject);
begin
  inherited;
edt_AllQty.SetFocus;
end;

procedure TFrmCheck_705Electron2.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
edt_AllQty.SetFocus;
end;
