...
type
  TFrmCheckMrg_705OuterAOI_MZ = class(TfrmBaseCheck_Mod705)
...
var
  FrmCheckMrg_705OuterAOI_MZ: TFrmCheckMrg_705OuterAOI_MZ;
...
function TFrmCheckMrg_705OuterAOI_MZ.BeforeSaveToDB: Boolean;
var
  FQty: Integer;
begin
  inherited;
...
procedure TFrmCheckMrg_705OuterAOI_MZ.btn_SaveClick(Sender: TObject);
var
  LDate: TDate;
...
procedure TFrmCheckMrg_705OuterAOI_MZ.edt_WorkNoButtonClick(Sender: TObject);
var
...
procedure TFrmCheckMrg_705OuterAOI_MZ.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
  edt_PBCount.SetFocus;
end;

procedure TFrmCheckMrg_705OuterAOI_MZ.InitData(AModelID, AEType: Integer;
  AIDKey: string);
begin
  inherited;
 // edt_PPassQty.Text:='0';
