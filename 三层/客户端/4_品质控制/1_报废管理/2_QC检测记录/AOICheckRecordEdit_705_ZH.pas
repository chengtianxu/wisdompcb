unit AOICheckRecordEdit_705_ZH;
...
TAfterAppendEvent = procedure of object;
  TFrmAOICheckRecordEdit_705_ZH = class(TfrmBaseCheck_Mod705)
...
var
  FrmAOICheckRecordEdit_705_ZH: TFrmAOICheckRecordEdit_705_ZH;
...
function TFrmAOICheckRecordEdit_705_ZH.BeforeSaveToDB: Boolean;
var
FQty:integer;
begin
   inherited;
...
procedure TFrmAOICheckRecordEdit_705_ZH.btn_CancelClick(Sender: TObject);
begin
//inherited;
  close;
end;

procedure TFrmAOICheckRecordEdit_705_ZH.btn_SaveClick(Sender: TObject);
var
  FDate: TDate;
begin
  FDate := dtpQC.Date;
...
procedure TFrmAOICheckRecordEdit_705_ZH.edt_WorkNoButtonClick(Sender: TObject);
begin
  inherited;
  edt_PnlQty.SetFocus;
end;

procedure TFrmAOICheckRecordEdit_705_ZH.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
edt_PnlQty.SetFocus;
end;

procedure TFrmAOICheckRecordEdit_705_ZH.InitData(AModelID, AEType: integer;
  AIDKey: string);
begin
  inherited;
