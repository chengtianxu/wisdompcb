...
type
  TFrmCheckMrg_705InnerAOI2 = class(TfrmBaseCheck_Mod705)
...
var
  FrmCheckMrg_705InnerAOI2: TFrmCheckMrg_705InnerAOI2;

implementation
    uses uCommFunc;
{$R *.dfm}
{ TFrmCheckMrg_705InnerAOI2 }

function TFrmCheckMrg_705InnerAOI2.BeforeSaveToDB: Boolean;
var
FQty:Integer;
begin
 inherited;
...
procedure TFrmCheckMrg_705InnerAOI2.btn_SaveClick(Sender: TObject);
var
  LDate: TDate;
...
procedure TFrmCheckMrg_705InnerAOI2.edt_WorkNoButtonClick(Sender: TObject);
begin
  inherited;
  edt_PBCount.SetFocus;
end;

procedure TFrmCheckMrg_705InnerAOI2.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
  edt_PBCount.SetFocus;
end;

procedure TFrmCheckMrg_705InnerAOI2.InitData(AModelID, AEType: Integer;
  AIDKey: string);
begin
  inherited;
