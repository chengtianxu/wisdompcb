...
type
  TFrmCheckMrg_705SecOuterAOI2 = class(TfrmBaseCheck_Mod705)
...
var
  FrmCheckMrg_705SecOuterAOI2: TFrmCheckMrg_705SecOuterAOI2;

implementation
       uses uCommFunc;
{$R *.dfm}

function TFrmCheckMrg_705SecOuterAOI2.BeforeSaveToDB: Boolean;
var
FQty:Integer;
begin
  inherited;
...
procedure TFrmCheckMrg_705SecOuterAOI2.btn_SaveClick(Sender: TObject);
var
  LDate: TDate;
...
procedure TFrmCheckMrg_705SecOuterAOI2.edt_WorkNoButtonClick(Sender: TObject);
begin
  inherited;
edt_PBCount.SetFocus;
end;

procedure TFrmCheckMrg_705SecOuterAOI2.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
edt_PBCount.SetFocus;
end;
