...
type
  TFrmCheckMrg_705OuterAOI1 = class(TfrmBaseCheck_Mod705)
...
var
  FrmCheckMrg_705OuterAOI1: TFrmCheckMrg_705OuterAOI1;

implementation

uses uCommFunc;
{$R *.dfm}
{ TFrmCheckMrg_OutAOI1 }

function TFrmCheckMrg_705OuterAOI1.BeforeSaveToDB: Boolean;
var
FQty:integer;
begin
  inherited;
...
//  if Trim(edt_MachineNo.Text) = '' then
//  begin
//    ShowMessage('机台不能为空！');
//    edt_MachineNo.Focused;
//    exit;
//  end;
...
//  if Trim(edt_BTime.Text) = '' then
//  begin
//    ShowMessage('作业员时间不能为空！');
//    edt_BTime.Focused;
//    exit;
//  end;
//
//  if Trim(edt_ETime.Text) = '' then
//  begin
//    ShowMessage('作业员时间不能为空！');
//    edt_ETime.Focused;
//    exit;
...
procedure TFrmCheckMrg_705OuterAOI1.btn_SaveClick(Sender: TObject);
var
  LDate: TDate;
...
procedure TFrmCheckMrg_705OuterAOI1.edt_WorkNoButtonClick(Sender: TObject);
begin
  inherited;
  edt_PBCount.SetFocus;
end;

procedure TFrmCheckMrg_705OuterAOI1.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
  edt_PBCount.SetFocus;
end;

procedure TFrmCheckMrg_705OuterAOI1.InitData(AModelID, AEType: Integer;
  AIDKey: string);
begin
  inherited;
