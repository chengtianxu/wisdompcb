unit CheckMrg_705SecOuterAOI_MZ;
...
type
  TFrmCheckMrg_705SecOuterAOI_MZ = class(TfrmBaseCheck_Mod705)
...
var
  FrmCheckMrg_705SecOuterAOI_MZ: TFrmCheckMrg_705SecOuterAOI_MZ;

implementation
       uses uCommFunc,uBaseSinglePickListFrm;
{$R *.dfm}

function TFrmCheckMrg_705SecOuterAOI_MZ.BeforeSaveToDB: Boolean;
var
FQty:Integer;
begin
  inherited;
 ...
 if Trim(edt_PnlQty.Text)='' then
  ...
  if Trim(edt_SideQty.Text)='' then
  begin
    ShowMessage('送检面数不能为空！');
    edt_SideQty.Focused;
    exit;
  end;
...
procedure TFrmCheckMrg_705SecOuterAOI_MZ.btn_SaveClick(Sender: TObject);
var
  LDate: TDate;
...
procedure TFrmCheckMrg_705SecOuterAOI_MZ.edt_WorkNoButtonClick(Sender: TObject);
var
...
procedure TFrmCheckMrg_705SecOuterAOI_MZ.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
edt_PBCount.SetFocus;
end;
