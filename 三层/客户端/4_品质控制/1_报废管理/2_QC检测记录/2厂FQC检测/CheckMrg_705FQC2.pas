...
type
  TFrmCheckMrg_705FQC2 = class(TfrmBaseCheck_Mod705)
...
var
  FrmCheckMrg_705FQC2: TFrmCheckMrg_705FQC2;
...
function TFrmCheckMrg_705FQC2.BeforeSaveToDB: Boolean;
//var
//  FQTY: Integer;
begin
  inherited;
...
procedure TFrmCheckMrg_705FQC2.edt_WorkNoButtonClick(Sender: TObject);
begin
  inherited;
  edt_AllQty.SetFocus;
end;

procedure TFrmCheckMrg_705FQC2.edt_WorkNoExit(Sender: TObject);
begin
  inherited;
  edt_AllQty.SetFocus;
end;
