...
uses
  ...
  DBAxisGridsEh, DBGridEh, Vcl.ExtCtrls, Vcl.ComCtrls,uCommFunc;

type
  TFrmMain_Mod40 = class(TfrmBaseMain)
  ...
  private
    function checkPD_Mod40():Boolean;
...
procedure TFrmMain_Mod40.btnQryClick(Sender: TObject);
var
  LGetTime:TDateTime;
begin
...
function TFrmMain_Mod40.checkPD_Mod40: Boolean;
var
  LSql92:string;
...
procedure TFrmMain_Mod40.GetData;
var
  LGetTime:TDateTime;
begin
  LGetTime := gFunc.GetSvrDateTime;
  ...
  FWhere2 := ' and ((d456.ttype=1) or (d456.ttype=5)) and (d70.status in (5,6,7))';
  FOrderby := ' order by d17.INV_PART_NUMBER desc';
  inherited;
end;

procedure TFrmMain_Mod40.N1Click(Sender: TObject);
begin
  inherited;
...
//    ShowMessage('你没有退货权限');
  ...
  if not checkPD_Mod40() then  Exit;
...
procedure TFrmMain_Mod40.OnAfterModPost(Acds: TClientDataSet);
begin
  btnRefreshClick(Self);
end;

procedure TFrmMain_Mod40.pmMainPopup(Sender: TObject);
begin
  inherited;
