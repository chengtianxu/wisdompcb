...
{$M+}
  ...
  TQVTCellNotifyMessage = class(TMessage<TObject>)
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (ADrawColSelection or ((ANode = FFocusNode) and
            (poCellSelection in FPaintOptions))) and AColFocused then
...
begin
  ...
  TMessageManager.DefaultManager.SendMessage(Self,
    TQVTCellNotifyMessage.Create(Self));
end;
