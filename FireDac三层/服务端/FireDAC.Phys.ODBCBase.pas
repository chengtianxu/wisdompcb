...
begin
  ...
  try
    ...
    if Result then begin
      ...
      if Length(FColInfos) = 0 then begin
        CreateDescribeInfos;
    ...
    mkTableTypeFields:
      begin
        ...
        if FStatement.ColumnList.Count >= 17 then begin
          if FStatement.ColumnList[16].GetData(ARowIndex, pData, iSize) then begin
                                                    ...
                                                    
  {
    ...
    mkForeignKeys:
      begin
        ...
        eCascade := ckRestrict;
        iSize := 0;
        if FStatement.ColumnList[10].GetData(ARowIndex, pData, iSize) then
