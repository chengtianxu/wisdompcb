...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['出库单号','采购订单号','材料编码', '供应商代码','供应商简称', '领料人员','仓库', '领料工厂','发料人员']);
  v_Field_List_EN := VarArrayOf(['Gon_number','PO_NUMBER','INV_PART_NUMBER',  'CODE','abbr_name',  'EMPLOYEE_NAME','LOCATION', 'WAREHOUSE_CODE','issue_EMPLOYEENAME']);
