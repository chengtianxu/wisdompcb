...
begin
  ...
  1:
   begin
     Application.CreateForm(TForm2,Form2);
     //Form2.DTPk1.Date:=dm.ADOS1MFG_DATE.Value;
     //Form2.Edit1.Text:=FormatDateTime('yyyy-mm-dd HH:mm:ss',dm.ADOS1MFG_DATE.Value);
     form2.MFG_DATE.DateTime:=dm.ADOS1MFG_DATE.Value;
     Form2.Edit1.Text:=dm.ADOS1number.Value;
     dm.ADOS1.Edit;
  ...
  2:
   begin
     ...
     form2.DBEdit2.Enabled:=False;form2.DBEdit3.Enabled:=False;form2.DBEdit4.Enabled:=False;
     form2.DBEdit5.Enabled:=False;form2.DBEdit6.Enabled:=False;form2.DBEdit7.Enabled:=False;
     form2.DBEdit8.Enabled:=False;form2.DBEdit9.Enabled:=False;
     ...
     form2.DBEdit21.Enabled:=False;Form2.MFG_DATE.Enabled:=False;form2.Edit1.Enabled:=False;
     form2.DBEdit1.Enabled:=False;Form2.DBEdit10.Enabled:=False;Form2.DBEdit12.Enabled:=False;
     //Form2.Edit1.Text:=FormatDateTime('yyyy-mm-dd HH:mm:ss',dm.ADOS1MFG_DATE.Value);
     form2.MFG_DATE.DateTime:=dm.ADOS1MFG_DATE.Value;
     Form2.Edit1.Text:=dm.ADOS1number.Value;
     if form2.ShowModal=mrok then begin end
  ...
  3:
   ...
   if MessageBox(Handle,'确定删除这条记录吗?','提示',MB_YESNO+MB_ICONWARNING+MB_DEFBUTTON2)=IDNO	then exit;
        ...
        try
          DM.tmp.Close;
          DM.tmp.SQL.Text:='delete from product_incept  where rkey='+DM.ADOS1rkey.AsString;
          DM.tmp.ExecSQL;
