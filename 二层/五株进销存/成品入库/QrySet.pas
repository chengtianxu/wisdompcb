...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['入仓单号','本厂编号','客户型号','类别代码','客户代码','客户简称','工厂代码','仓库','客户订单号','接收人员']);
  v_Field_List_EN := VarArrayOf(['product_incept.number','product_incept.MANU_PART_NUMBER','product_incept.MANU_PART_DESC',
  'product_incept.PROD_CODE','product_incept.CUST_CODE','product_incept.ABBR_NAME','product_incept.WAREHOUSE_CODE',
  'product_incept.location','product_incept.PO_NUMBER','product_incept.employee_name']);
...
begin
  ...
  begin
    dm.ADOS1.Close;
    dm.ADOS1.Parameters[0].Value:=dtpk1.DateTime;
    dm.ADOS1.Parameters[1].Value:=dtpk2.DateTime;
    dm.ADOS1.Open;
  end;
end;
