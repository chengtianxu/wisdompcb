...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['材料编码','生产部门代码','产品编码','生产单号','领料单号']);
  v_Field_List_EN := VarArrayOf(['data0017.INV_PART_NUMBER','Data0034.DEPT_CODE','Data0008.PROD_CODE','dbo.data0492.CUT_NO','data0268.number']);
...
begin
 ...
 try
  case ListBox3.ItemIndex of
    ...
    2:
    begin
      InputVar.Fields := 'PROD_CODE/产品编码/200,PRODUCT_NAME/产品名称/200,PRODUCT_DESC/产品规格/200';
      InputVar.Sqlstr :='SELECT RKEY, PROD_CODE, PRODUCT_NAME, PRODUCT_DESC, TTYPE FROM Data0008 order by 2';
  ...
  frmPick_Item_Single.InitForm_New(InputVar);
    ...
    begin
     case ListBox3.ItemIndex of
       ...
       2: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['PROD_CODE'];
     end;
