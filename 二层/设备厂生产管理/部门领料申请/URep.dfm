object Report_Frm: TReport_Frm
  ...
  object ADS268: TADODataSet
    ...
    CommandText = 
      ...
      'EY INNER JOIN '#13#10'                      dbo.Data0015 ON dbo.DATA02' +
      '68.warehouse_ptr = dbo.Data0015.RKEY ON dbo.data0492.CUT_NO = db' +
      'o.DATA0268.CUT_NO'#13#10'where dbo.DATA0268.rkey =:rkey268'#13#10
  ...
  object ADS468: TADODataSet
    ...
    CommandText = 
      ...
      '  '#13#10'FROM         dbo.Data0468 INNER JOIN'#13#10'                      ' +
      'dbo.Data0017 ON dbo.Data0468.INVENT_PTR = dbo.Data0017.RKEY INNE' +
      'R JOIN'#13#10'                      dbo.Data0002 ON dbo.Data0017.STOCK' +
      '_UNIT_PTR = dbo.Data0002.RKEY'#13#10#13#10'WHERE  dbo.Data0468.FLOW_NO=:rk' +
      'ey'
    DataSource = DS1
    MasterFields = 'rkey'
    Parameters = <
