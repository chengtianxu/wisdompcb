...
uses
  ...
  Dialogs, ComCtrls, StdCtrls, DBGridEh, Buttons, ExtCtrls,common,
  DB,ADODB, Menus,DateUtils, Grids;

type
  TUVMIForm = class(TForm)
    Panel1: TPanel;
    Label1: TLabel;
    BtClose: TBitBtn;
    BtBrush: TBitBtn;
...
procedure TUVMIForm.FormShow(Sender: TObject);
var
  i:integer;
  item:TMenuItem;
  QueryTmp:TADOQuery;
...
procedure TUVMIForm.BitBtn4Click(Sender: TObject);
begin
...
procedure TUVMIForm.BtCloseClick(Sender: TObject);
begin
    close;
end;

procedure TUVMIForm.Edit1Change(Sender: TObject);
begin
...
procedure TUVMIForm.Grd1TitleClick(Column: TColumnEh);
begin
...
procedure TUVMIForm.item_click(sender: TObject);
var
  i:byte;
begin
...
procedure TUVMIForm.BitBtn6Click(Sender: TObject);
begin
    popupmenu1.Popup(mouse.CursorPos.x,mouse.CursorPos.y);
end;

procedure TUVMIForm.Grd1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TUVMIForm.DTPK1Click(Sender: TObject);
var
  lDate: TDateTime;
  datetmp:string;
begin
...
procedure TUVMIForm.BtBrushClick(Sender: TObject);
var
  i:integer;
begin
