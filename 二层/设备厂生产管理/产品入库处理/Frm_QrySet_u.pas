...
begin
  ...
  if UpperCase(v_Field_List_EN[ListBox3.ItemIndex])<>'DATA0008.PROD_CODE' then
    ...
    sgrid1.Cells[2,sgrid1.RowCount-1]:=
      ' and exists(select 1 from Data0053 inner join Data0008 on Data0053.CUST_PART_PTR=Data0008.RKEY'+#13+
                 'where Data0053.NPAD_PTR=data0416.rkey and Data0008.PROD_CODE like '+'''%'+edtValue.Text+'%'')';
...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['入库单号','产品编码','制造部门','入库人员代码','备注']);
  v_Field_List_EN := VarArrayOf(['data0416.number','Data0008.PROD_CODE','data0034.dept_code','Data0005.EMPL_CODE','data0416.reference']);
...
begin
 ...
 try
  ...
  frmPick_Item_Single.InitForm_New(InputVar);
    ...
    begin
     case ListBox3.ItemIndex of
       1: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['PROD_CODE'];
       2: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['Dept_code'];
