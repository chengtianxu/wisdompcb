...
type
  TDM = class(TDataModule)
    ...
    ADO70_1rkey: TAutoIncField;
    ADO70_1sales_order: TStringField;
    ADO70_1sales_date: TDateTimeField;
    ADO70_1customer_ptr: TIntegerField;
    ADO70_1type: TWordField;
    ADO70_1status: TWordField;
    ADO70_1ship_method: TStringField;
    ADO70_1location: TStringField;
    ADO70_1SALES_REP_PTR: TIntegerField;
    ADO70_1ent_date: TDateTimeField;
    ADO70_1ent_user_ptr: TIntegerField;
    ADO70_1currency_ptr: TIntegerField;
    ADO70_1exch_rate: TBCDField;
    ADO70_1total_amount: TBCDField;
    ADO70_1entrust_deptptr: TIntegerField;
    ADO70_1produce_deptptr: TIntegerField;
    ADO70_1CONTACT_NAME: TStringField;
    ADO70_1CONT_PHONE: TStringField;
    ADO70_1TAX_cate: TStringField;
    ADO70_1pay_method: TStringField;
    ADO70_1CONF_BY_EMPL_PTR: TIntegerField;
    ADO70_1CONF_DATE: TDateTimeField;
    ADO70_1remark: TStringField;
    wdstrngfldADO70PO_NO: TWideStringField;
    wdstrngfldADO70_1PO_NO: TWideStringField;
    tmp1: TADOQuery;
