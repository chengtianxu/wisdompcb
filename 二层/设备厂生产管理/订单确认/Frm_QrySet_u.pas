...
begin
  ...
  BitBtn7.Visible:=listbox3.ItemIndex in [1,4,5,6,8,9,10] ;
...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['订单编号','客户代码','装运方法','送货地址','业务员代码','货币代码','生产部门代码','票据类型','输入员代码','确认员代码','委托部门代码']);
  v_Field_List_EN := VarArrayOf(['wzcp0070.sales_order','Data0010.CUST_CODE','wzcp0070.ship_method','wzcp0070.location','Data0009.REP_CODE','Data0001.CURR_CODE','Data0034.DEPT_CODE','wzcp0070.tax_cate','Data0005.EMPL_CODE','d5.EMPL_CODE','d34.dept_code']);
  ...
  frmPick_Item_Single.InitForm_New(InputVar);
    ...
    begin
     case ListBox3.ItemIndex of
       ...
       6,10: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['Dept_code'];
       8,9: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['EMPL_CODE'];
     end;
     Button3.Enabled := true ;
    end;
  finally
