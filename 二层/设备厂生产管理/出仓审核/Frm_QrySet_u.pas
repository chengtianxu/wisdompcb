...
begin
  ...
  BitBtn7.Visible:=listbox3.ItemIndex in [2,5,7] ;
...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['出仓单号','订单编号','客户代码','装运方法','送货地址','货币代码','票据类型','输入员代码']);
  v_Field_List_EN := VarArrayOf(['wzcp0060.sales_order','wzcp0070.sales_order','Data0010.CUST_CODE','wzcp0060.ship_method','wzcp0060.location','Data0001.CURR_CODE','wzcp0060.tax_cate','Data0005.EMPL_CODE']);
...
begin
 ...
 try
  case ListBox3.ItemIndex of
    2:
    begin
      InputVar.Fields := 'CUST_CODE/客户编码/100,CUSTOMER_NAME/客户名称/150';
  ...
  frmPick_Item_Single.InitForm_New(InputVar);
    ...
    begin
     case ListBox3.ItemIndex of
       2: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['CUST_CODE'];
       5: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['CURR_CODE'];
       7: edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['EMPL_CODE'];
     end;
     Button3.Enabled := true ;
    end;
  finally
