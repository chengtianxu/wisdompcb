object Form_putoutintreport: TForm_putoutintreport
  ...
  object aq457: TADODataSet
    ...
    CommandText = 
      ...
      ',Data0457.Cut_No as '#22791#27880',dbo.data0492.CUT_NO as '#29983#20135#21333#21495',  dbo.Data000' +
      '8.PROD_CODE as '#24037#31243#32534#30721','#13#10'  dbo.Data0008.PRODUCT_NAME as '#20135#21697#21517#31216',  dbo.' +
      'Data0008.PRODUCT_DESC as '#20135#21697#25551#36848#13#10'FROM dbo.Data0457 INNER JOIN'#13#10'   ' +
      '   dbo.Data0015 ON dbo.Data0457.warehouse_ptr = dbo.Data0015.RKE' +
      'Y INNER JOIN'#13#10'      dbo.Data0034 ON dbo.Data0457.dept_ptr = dbo.' +
      'Data0034.RKEY INNER JOIN'#13#10'      dbo.Data0005 ON dbo.Data0457.REC' +
      'D_BY = dbo.Data0005.RKEY INNER JOIN'#13#10'      dbo.Data0005 Data0005' +
      '_1 ON dbo.Data0457.CREATE_BY = Data0005_1.RKEY  left join '#13#10'DATA' +
      '0268 on  dbo.Data0457.REF_NUMBER=dbo.DATA0268.number left join '#13 +
      #10'data0492 on dbo.DATA0268.CUT_NO=dbo.data0492.CUT_NO  left join'#13 +
      #10'data0008 on dbo.data0492.BOM_PTR=dbo.Data0008.RKEY '#13#10'where data' +
      '0457.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
    ...
    object aq457DSDesigner8: TStringField
