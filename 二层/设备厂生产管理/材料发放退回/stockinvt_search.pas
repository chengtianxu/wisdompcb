...
uses damo, purout_invt,putoutinvt_dept, common, putoutinvt_inspect;
 ...
 if form_putout.ShowModal=mrok then
  begin
   ...
   begin
    ...
    if (aq22EXPIRE_DATE.Value>=common.getsystem_date(dm.ADOQuery1,1)) or (aq22EXPIRE_DATE.Value=0) then
    with form2 do
    begin
