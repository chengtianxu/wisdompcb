object Form_putoutmiscreport: TForm_putoutmiscreport
  Left = 252
  Top = 278
  Width = 338
  Height = 370
  Caption = #26434#39033#29289#21697#20986#20179#21333
  Color = clBtnFace
  ...
  object aq457: TADODataSet
    ...
    CommandText = 
      ...
      ' data0457.status when 0 then '#39#26410#23457#35745#39#13#10'when 1 then '#39#24050#23457#35745#39' end as '#29366#24577',' +
      '       '#13#10' dbo.data0492.CUT_NO as '#29983#20135#21333#21495',  dbo.Data0008.PROD_CODE a' +
      's '#24037#31243#32534#30721','#13#10'  dbo.Data0008.PRODUCT_NAME as '#20135#21697#21517#31216',  dbo.Data0008.PROD' +
      'UCT_DESC as '#20135#21697#25551#36848#13#10'FROM dbo.Data0457 INNER JOIN'#13#10'      dbo.Data00' +
      '15 ON dbo.Data0457.warehouse_ptr = dbo.Data0015.RKEY INNER JOIN'#13 +
      #10'      dbo.Data0034 ON dbo.Data0457.dept_ptr = dbo.Data0034.RKEY' +
      ' INNER JOIN'#13#10'      dbo.Data0005 ON dbo.Data0457.RECD_BY = dbo.Da' +
      'ta0005.RKEY INNER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Dat' +
      'a0457.CREATE_BY = Data0005_1.RKEY left join '#13#10'data0492 on dbo.Da' +
      'ta0457.CUT_NO492=dbo.data0492.CUT_NO  left join'#13#10'data0008 on dbo' +
      '.data0492.BOM_PTR=dbo.Data0008.RKEY '#13#10'where data0457.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
    ...
    object aq457DSDesigner5: TStringField
      FieldName = #24037#31243#32534#30721
      Size = 25
    end
    object aq457DSDesigner6: TStringField
      FieldName = #20135#21697#21517#31216
      Size = 30
    end
    object aq457DSDesigner7: TStringField
