object Form5: TForm5
  ...
  object aq457: TADODataSet
    ...
    CommandText = 
      ...
      'd  CREATE_DATE<=:dtpk2'#13#10'order by  dbo.Data0457.RKEY desc'
  ...
  object ado207: TADODataSet
    ...
    CommandText = 
      ...
      'o.Data0468.QUAN_ISSUED, data0468.STATUS,Data0207.D0468_PTR ,wzcp' +
      '0492.Con_QTY,wzcp0492.QUAN_ASSIGN'#13#10',data0475.d492_ptr as  rkey47' +
      '5_w492'#13#10'FROM dbo.Data0207 INNER JOIN'#13#10'      dbo.Data0017 ON dbo.' +
      'Data0207.INVENTORY_PTR = dbo.Data0017.RKEY INNER JOIN'#13#10'      dbo' +
      '.Data0022 ON dbo.Data0207.D0022_PTR = dbo.Data0022.RKEY INNER JO' +
      'IN'#13#10'      dbo.Data0002 ON '#13#10'      dbo.Data0022.LOCATION_PTR_FROM' +
      ' = dbo.Data0002.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0468 ON dbo.' +
      'Data0207.D0468_PTR = dbo.Data0468.RKEY'#13#10'      left join wzcp0492' +
      ' on   wzcp0492.rkey=Data0468.wzcp0492_ptr'#13#10'   left join data0475' +
      ' on wzcp0492.rkey=data0475.d492_ptr and data0475.rkey22=data0207' +
      '.D0022_PTR'#13#10'where gon_ptr=:rkey'
    DataSource = DataSource1
    MasterFields = 'rkey'
    Parameters = <
      item
    ...
    object ado207rkey475_w492: TIntegerField
      FieldName = 'rkey475_w492'
    end
  end
  object ado208: TADODataSet
    ...
    CommandText = 
      ...
      '235.QUAN_ON_HAND,data0208.rkey,data0208.dept_ptr,data0208.GON_PT' +
      'R'#13#10'FROM dbo.DATA0208 INNER JOIN'#13#10'      dbo.Data0235 ON dbo.DATA0' +
      '208.SOURCE_PTR = dbo.Data0235.RKEY INNER JOIN'#13#10'      dbo.Data000' +
      '2 ON dbo.Data0235.unit_ptr = dbo.Data0002.RKEY'#13#10'where data0208.g' +
      'on_ptr=:rkey'
    DataSource = DataSource1
    MasterFields = 'rkey'
    Parameters = <
