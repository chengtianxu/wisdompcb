...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['申领单号','部门代码','审核状态','申领员工','工厂代码','生产单号','产品编码']);
  v_Field_List_EN := VarArrayOf(['data0268.number','data0034.dept_code','data0268.status','data0005.employee_name','data0015.warehouse_code','data0268.cut_no','data0008.prod_code']);
...
procedure TFrm_QrySet.edtValueKeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
