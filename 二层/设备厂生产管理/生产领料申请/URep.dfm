object Report_Frm: TReport_Frm
  ...
  Width = 362
  Height = 200
  Caption = #39046#26009#21333#25171#21360
  Color = clBtnFace
  ...
  object ppDB268: TppDBPipeline
    ...
    object ppDB268ppField13: TppField
    ...
    object ppDB268ppField14: TppField
      FieldAlias = #20351#29992#20154#22995#21517
      FieldName = #20351#29992#20154#22995#21517
      FieldLength = 0
      DisplayWidth = 0
      Position = 13
    end
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'D:\DGVLG\NIERP\REPORT\Rep268.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
    ...
    object ppTitleBand1: TppTitleBand
      ...
      object ppDBText9: TppDBText
        UserName = 'DBText9'
        DataField = #20351#29992#20154#22995#21517
        DataPipeline = ppDB268
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
      ...
      object ppDBText16: TppDBText
        UserName = 'DBText16'
        DataField = #20135#21697#31867#22411
        DataPipeline = ppDB268
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel13: TppLabel
        UserName = 'Label13'
        AutoSize = False
        Caption = #22791#27880'('#24403#21069#24211#23384#25968')'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
        Font.Size = 10
    ...
    object ppDetailBand1: TppDetailBand
      ...
      object ppDBText7: TppDBText
        UserName = 'DBText7'
        DataField = #24635#24211#23384#21442#32771#25968#37327
        DataPipeline = ppDB468
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
  ...
  object ADS268: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'SELECT     dbo.DATA0268.rkey,dbo.DATA0268.number AS '#30003#39046#21333#21495', dbo.DA' +
      'TA0268.DATE AS '#30003#39046#26085#26399', dbo.Data0005.EMPLOYEE_NAME AS '#30003#35831#20154', '#13#10'      ' +
      '                Data0005_1.EMPLOYEE_NAME AS '#23457#25209#20154', dbo.DATA0268.au' +
      'th_date AS '#23457#25209#26085#26399', dbo.DATA0268.reference AS '#22791#27880', '#13#10'               ' +
      '       dbo.Data0034.DEPT_NAME AS '#37096#38376#21517#31216', dbo.Data0015.ABBR_NAME AS' +
      ' '#24037#21378#21517#31216', dbo.Data0008.PROD_CODE AS '#20135#21697#32534#30721', '#13#10'                      d' +
      'bo.Data0008.PRODUCT_NAME AS '#20135#21697#21517#31216', dbo.Data0008.PRODUCT_DESC AS '#20135 +
      #21697#25551#36848', '#13#10'                      CASE dbo.Data0008.TTYPE WHEN 0 THEN' +
      ' '#39#21322#25104#21697#39' WHEN 1 THEN '#39#25104#21697#39' END AS '#20135#21697#31867#22411', Data0005_2.EMPLOYEE_NAME as' +
      ' '#20351#29992#20154#22995#21517#13#10'FROM         dbo.Data0008 INNER JOIN'#13#10'                  ' +
      ...
      '_emplptr = Data0005_1.RKEY LEFT JOIN'#13#10'                      dbo.' +
      'Data0005 AS Data0005_2 ON dbo.DATA0268.user_name = Data0005_2.RK' +
      'EY INNER JOIN'#13#10'                      dbo.Data0015 ON dbo.DATA026' +
      '8.warehouse_ptr = dbo.Data0015.RKEY ON dbo.data0492.CUT_NO = dbo' +
      '.DATA0268.CUT_NO'#13#10#13#10'where dbo.DATA0268.rkey =:rkey268'#13#10
    ...
    object ADS268DSDesigner11: TStringField
      FieldName = #20135#21697#25551#36848
      Size = 200
    end
    object ADS268DSDesigner12: TStringField
      FieldName = #20135#21697#31867#22411
      ReadOnly = True
      Size = 6
    end
    object ADS268username: TStringField
      FieldName = #20351#29992#20154#22995#21517
      Size = 10
    end
  end
  object ADS468: TADODataSet
    ...
    CommandText = 
      ...
      'S '#21333#20301','#13#10'data0017.quan_on_hand '#24635#24211#23384#21442#32771#25968#37327'                      '#13#10'FROM' +
      '         dbo.Data0468 INNER JOIN'#13#10'                      dbo.Data' +
      '0017 ON dbo.Data0468.INVENT_PTR = dbo.Data0017.RKEY INNER JOIN'#13#10 +
      '                      dbo.Data0002 ON dbo.Data0017.STOCK_UNIT_PT' +
      'R = dbo.Data0002.RKEY'#13#10#13#10'WHERE  dbo.Data0468.FLOW_NO=:rkey'
    DataSource = DS1
    MasterFields = 'rkey'
    Parameters = <
      item
