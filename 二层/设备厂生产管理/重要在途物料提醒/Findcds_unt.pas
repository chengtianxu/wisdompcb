...
uses SelectedDate_unt, Main_unt;
...
procedure TFindcds_frm.MsgError(msg:string);
begin
...
Function TFindcds_frm.IsDateTime(Str:string):Boolean;    //是有效的日期时间
var
  mDateTime: TDateTime;
begin
  Result:=False;
...
Function TFindcds_frm.IsNumeric(Str:string):Boolean;
var
  i: integer;
  f: Double;
begin
