object FrmMain3: TFrmMain3
  Left = 222
  Top = 165
  Width = 739
  Height = 503
  Caption = #21457#26009#21040#36710#38388#24211#23384
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label8: TLabel
      ...
      Alignment = taRightJustify
      AutoSize = False
      Caption = #20986#20179#21442#32771#21495':'
    end
    ...
    object BitBtn6: TBitBtn
      ...
      Width = 25
      Height = 26
      Hint = #24320#22987#26032#30340#20986#20179#21333
      ParentShowHint = False
      ShowHint = True
      TabOrder = 6
  ...
  object MainMenu1: TMainMenu
    ...
    object IQC1: TMenuItem
      ...
      object IQC2: TMenuItem
        Caption = #21015#21360#20986#20179#21333
        OnClick = BitBtn7Click
      end
      object N2: TMenuItem
        Caption = '-'
  ...
  object ADOData0095: TADOStoredProc
    Connection = MainForm.ADOConnection1
    ProcedureName = 'EP017;9'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object ADOData0207: TADOStoredProc
    Connection = MainForm.ADOConnection1
    Filtered = True
    ProcedureName = 'EP017;8'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object Adodata0004: TADOStoredProc
    Connection = MainForm.ADOConnection1
    ProcedureName = 'EP017;5'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object ADOData0457: TADOStoredProc
    Connection = MainForm.ADOConnection1
    ProcedureName = 'EP017;4'
    Parameters = <>
    Left = 190
    Top = 208
  end
  object ADOData0458: TADOStoredProc
    Connection = MainForm.ADOConnection1
    ProcedureName = 'EP017;17'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object tmpADO2: TADOStoredProc
    Connection = MainForm.ADOConnection1
    Filtered = True
    LockType = ltBatchOptimistic
    ProcedureName = 'EP017;3'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object tmpADO3: TADOStoredProc
    Connection = MainForm.ADOConnection1
    Filtered = True
    LockType = ltReadOnly
    ProcedureName = 'EP017;15'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object tmpADO0: TADOStoredProc
    Connection = MainForm.ADOConnection1
    Filtered = True
    LockType = ltReadOnly
    ProcedureName = 'EP017;10'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object tmpADO1: TADOStoredProc
    Connection = MainForm.ADOConnection1
    Filtered = True
    LockType = ltBatchOptimistic
    ProcedureName = 'EP017;12'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
