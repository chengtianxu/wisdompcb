 ...
 strgrid1.Cells[9,0] := '备注';
  ...
  for i:=1 to dm.Aq22.RecordCount do
   begin
    ...
    strgrid1.Cells[3,i] := dm.Aq22PRICE.AsString;
    ...
    if dm.Aq22CONVERSION_FACTOR.Value>0 then
     begin
      ...
      strgrid1.Cells[5,i] :=dm.Aq22TAX_2.AsString;
     ...
     begin
      ...
      strgrid2.Cells[3,i] :=dm.Aq22PRICE.AsString;
     end;
...
if self.aded_flag=1 then //新增
 begin
  ...
  for i:=1 to strgrid1.RowCount-1 do
   if strtoint(strgrid1.Cells[7,i])>0 then
    begin
     dm.ADO22.Append;
