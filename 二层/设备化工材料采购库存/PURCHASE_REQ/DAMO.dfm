object DM: TDM
  ...
  object ADO69: TADOQuery
    ...
    object ADO69QUANTITY: TBCDField
      FieldName = 'QUANTITY'
      DisplayFormat = '0.000'
      Precision = 9
      Size = 3
    end
    object ADO69UNIT_PRICE: TBCDField
      FieldName = 'UNIT_PRICE'
      DisplayFormat = '0.000'
      Precision = 9
      Size = 3
    end
    object ADO69tax_price: TBCDField
      FieldName = 'tax_price'
      DisplayFormat = '0.000'
      Precision = 9
      Size = 3
    ...
    object ADO69CONVERSION_FACTOR: TBCDField
    ...
    object ADO69req_unitname: TStringField
      FieldKind = fkLookup
      FieldName = 'req_unitname'
      LookupDataSet = aq0002
      LookupKeyFields = 'rkey'
      LookupResultField = 'unit_name'
      KeyFields = 'req_unit_ptr'
      Lookup = True
    end
