object Frmreport3: TFrmreport3
  ...
  object aq64: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Data0064.RKEY,Data0064.SHIPMENT_NO,Data0064.QUAN_SHIPPED,' +
        'Data0064.ovsh_qty,'
      
        '      Data0064.QUAN_SHIPPED + Data0064.ovsh_qty AS quantity,data' +
        '0064.remark,'
      
        '      (Data0064.QUAN_SHIPPED + Data0064.ovsh_qty)*data0050.REPOR' +
        'T_UNIT_VALUE1/1000 as weight,'
      '      Data0060.SALES_ORDER, Data0050.CUSTOMER_PART_NUMBER,'
      
        '      Data0050.CP_REV, Data0050.CUSTOMER_PART_DESC,data0064.part' +
        '_price,'
      
        '      data0050.set_x_qty,data0050.set_y_qty,data0050.CATALOG_NUM' +
        'BER,'
      
        '      Data0097.PO_NUMBER, Data0097.PO_DATE,data0050.REPORT_UNIT_' +
        'VALUE1,'
      '      data0060.fob,data0060.reference_number,TOTAL_ADD_L_PRICE,'
    ...
    object aq64CUSTOMER_PART_NUMBER: TStringField
      FieldName = 'CUSTOMER_PART_NUMBER'
    end
    object aq64CP_REV: TStringField
      FieldName = 'CP_REV'
      FixedChar = True
      Size = 5
    end
    object aq64CUSTOMER_PART_DESC: TStringField
    ...
    object aq64quantity: TIntegerField
      FieldName = 'quantity'
      ReadOnly = True
    end
    ...
    object aq64set_x_qty: TIntegerField
      FieldName = 'set_x_qty'
    end
    object aq64set_y_qty: TIntegerField
      FieldName = 'set_y_qty'
    end
    object aq64CATALOG_NUMBER: TStringField
  ...
  object ppDB64: TppDBPipeline
    ...
    object ppDB64ppField3: TppField
      FieldAlias = #26412#20135#32534#21495
      FieldName = 'CUSTOMER_PART_NUMBER'
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
    ...
    object ppDB64ppField19: TppField
      FieldAlias = #25340#29256'X'#26041#21521#25968
      FieldName = 'set_x_qty'
      FieldLength = 10
      DisplayWidth = 10
      Position = 18
    ...
    object ppDB64ppField20: TppField
      FieldAlias = #25340#29256'Y'#26041#21521#25968
      FieldName = 'set_y_qty'
      FieldLength = 10
      DisplayWidth = 10
      Position = 19
  ...
  object ppReport1: TppReport
    ...
    SaveAsTemplate = True
    Template.FileName = 'R:\NIERP\Report\packlist_list_report.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
  ...
  object ppReport3: TppReport
    ...
    SaveAsTemplate = True
    Template.FileName = 'R:\NIERP\Report\packlist_list_report2.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
  ...
  object ppReport4: TppReport
    ...
    PrinterSetup.PaperSize = 256
    SaveAsTemplate = True
    Template.FileName = 'R:\NIERP\Report\packlist_list_report3.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
  ...
  object ppReport5: TppReport
    ...
    PrinterSetup.PaperSize = 9
    SaveAsTemplate = True
    Template.FileName = 'R:\NIERP\Report\packlist_list_report4.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
