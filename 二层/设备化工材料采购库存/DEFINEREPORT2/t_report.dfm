object Form_trp: TForm_trp
  ...
  object AQ415: TADOQuery
    ...
    SQL.Strings = (
      'SELECT data0415.number,data0415.type, '
        ...
        '      dbo.Data0050.CP_REV, dbo.Data0005.EMPLOYEE_NAME, dbo.data0' +
        '415.sys_date, '
      ...
      'FROM dbo.data0415 INNER JOIN'
        ...
        '      dbo.Data0050 ON dbo.data0415.custpart_ptr = dbo.Data0050.R' +
        'KEY INNER JOIN'
      ...
      '      dbo.Data0010 ON '
        ...
        '      dbo.Data0050.CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUTER J' +
        'OIN'
    ...
    object AQ415CUSTOMER_PART_NUMBER: TStringField
      FieldName = 'CUSTOMER_PART_NUMBER'
    end
    object AQ415CUSTOMER_PART_DESC: TStringField
      FieldName = 'CUSTOMER_PART_DESC'
      Size = 40
    end
    object AQ415CP_REV: TStringField
      FieldName = 'CP_REV'
      FixedChar = True
      Size = 5
    end
  ...
  object ppDB415: TppDBPipeline
    ...
    object ppDB415ppField4: TppField
