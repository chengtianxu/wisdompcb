...
uses mater_Report, Report2, DataModule, Report1, report3, report4, report5,
  ...
  desi_o_report, desi_o_reportmic, sales_order, Mreport, waifa_report,
...
begin
  Application.CreateForm(TFrmReport11, FrmReport11);
  FrmReport11.ppDesigner1.ShowModal ;
  FrmReport11.Free;
end;
