object Form_report: TForm_report
  ...
  object ADO22: TADOQuery
    ...
    SQL.Strings = (
      'SELECT dbo.Data0023.CODE, dbo.Data0023.SUPPLIER_NAME, '
        ...
        '      dbo.Data0456.ship_DATE, Data0022.PRICE, dbo.Data0015.WAREH' +
        'OUSE_CODE,'
      
        '      dbo.Data0015.WAREHOUSE_NAME, dbo.Data0022.QUAN_TO_BE_SHIPP' +
        'ED, '
      '      dbo.Data0022.QUAN_RETURNED, dbo.Data0022.BARCODE_ID, '
        ...
        '      dbo.Data0456.GRN_NUMBER, dbo.Data0022.RKEY, Data0022.TAX_2' +
        ','
      
        '      round(Data0022.PRICE*Data0022.TAX_2*0.01/(1+Data0022.TAX_2' +
        '*0.01),2) AS tax_price,'
      '      dbo.Data0456.TTYPE'
  ...
  object ADO95: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      dbo.Data0002.UNIT_NAME, dbo.Data0071.PRICE AS po_price, '
      '      dbo.Data0071.CONVERSION_FACTOR, dbo.Data0070.PO_NUMBER, '
      
        '      dbo.Data0070.PO_DATE, dbo.Data0022.PRICE, dbo.Data0022.TAX' +
        '_2, '
      '      dbo.Data0456.TTYPE'
      ...
      '      dbo.Data0095 INNER JOIN'
        ...
        'ON '
      '      dbo.Data0456.RKEY = dbo.Data0022.GRN_PTR LEFT OUTER JOIN'
      ...
      '      dbo.Data0002 ON '
        ...
        '      dbo.Data0070 ON dbo.Data0071.PO_PTR = dbo.Data0070.RKEY ON' +
        ' '
