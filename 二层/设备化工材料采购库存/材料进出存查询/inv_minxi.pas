...
type
  TForm9 = class(TForm)
    ...
    ado0022ANALYSIS_CODE_1: TStringField;
    ado0022EMPLOYEE_NAME: TStringField;
    ado0022CONFIRMATION_NUMBER: TStringField;
...
procedure TForm9.DBGrid1DrawColumnCell(Sender: TObject; const Rect: TRect;
  DataCol: Integer; Column: TColumn; State: TGridDrawState);
begin
// if (ado0022EXPIRE_DATE.Value < strtodate(form1.ADOserver_datedate1.Value))   then
 if ado0022eff_day.Value < 0 then
  DBGrid1.Canvas.Font.Color := clred
 else
   if ado0022eff_day.Value <= 30 then
