object Form2: TForm2
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'IQC'#26816#26597#26102#38388
        Visible = False
      end
      item
        Expanded = False
        FieldName = 'IQC'#26816#26597#20154#21592
        Visible = False
      end
      item
        Expanded = False
  ...
  object ado0022: TADOQuery
    ...
    SQL.Strings = (
        ...
        'RR_CODE, dbo.Data0022.TAX_2, dbo.Data0022.tax_price, dbo.Data002' +
        '2.PRICE AS '#19981#21547#31246#20215', '
        ...
        'NTITY AS '#25509#25910#24635#37325', data0022.QUAN_RTNED_FM_FACT,'
        ...
        '                      dbo.Data0005.EMPLOYEE_NAME AS IQC'#26816#26597#20154#21592', dbo' +
        '.Data0071.PRINTED_DATE as IQC'#26816#26597#26102#38388',dbo.data0022.GLPTR_STATUS,'
      ...
      '                      dbo.Data0022 INNER JOIN'
        ...
        'bo.Data0496.RKEY ON dbo.Data0019.rkey = dbo.Data0496.group_ptr I' +
        'NNER JOIN'
      
        '                      dbo.Data0005 AS Data0005_1 ON dbo.Data0456' +
        '.CREATE_BY = Data0005_1.RKEY ON dbo.Data0023.RKEY = dbo.Data0456' +
        '.SUPP_PTR ON '
      
        '                      dbo.Data0002.RKEY = dbo.Data0022.LOCATION_' +
        'PTR_FROM INNER JOIN'
        ...
        #9#9' dbo.data0071 ON dbo.Data0022.SOURCE_PTR = dbo.Data0071.RKEY L' +
        'EFT OUTER JOIN'
      
        '                      dbo.Data0005 ON dbo.Data0005.RKEY = dbo.Da' +
        'ta0071.IQCEMPL_PTR  LEFT OUTER JOIN'
      
        '                      dbo.Data0005 AS Data0005_2 RIGHT OUTER JOI' +
        'N'
      
        '                      dbo.Data0070 ON Data0005_2.RKEY = dbo.Data' +
        '0070.EMPLOYEE_POINTER ON dbo.Data0456.PO_PTR = dbo.Data0070.RKEY'
    ...
    object ado0022GLPTR_STATUS: TBooleanField
      DisplayLabel = #26159#21542#24050#24320#31080
      FieldName = 'GLPTR_STATUS'
    end
