object DM: TDM
  ...
  object Ado538: TADOQuery
    ...
    SQL.Strings = (
        ...
        'A0538.STATUS,data0538.IF_CamWf,'
      ...
      'when 5 then '#39'CAM'#24320#22987#39'when 6 then '#39'CAM'#32467#26463#39'when 7 then '#39'QAE'#24320#22987#39
        ...
        'dnew,dbo.Data0538.QAE_XiShu,dbo.Data0538.QAE_JCLX,'
        ...
        '8.QAE_SENDBACK, '
      #9#9'dbo.Data0005.EMPLOYEE_NAME AS E_NAME1, dbo.Data0538.IF_HCL,'
        ...
        'case data0538.IF_CamWf when 0 then '#39#21542#39' when 1 then '#39#26159#39' end as ca' +
        'mwf_status'
    ...
    object Ado538QAE_JCLX: TWideStringField
      FieldName = 'QAE_JCLX'
      Size = 50
    end
