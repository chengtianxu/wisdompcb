...
type
  TDM = class(TDataModule)
    ...
    Ado538iSTATUS: TStringField;
    Ado538YS_EQ_STATUS2: TStringField;
    Ado538CAM_EQ_STATUS2: TStringField;
    Ado538QAE_EDN_DATE: TDateTimeField;
    Ado538QAE_XiShu: TFloatField;
    Ado538QAE_JCLX: TStringField;
    Ado538sales_order: TStringField;
    Ado538SCH_DATE: TDateTimeField;
    Ado538HCL_USER_PTR: TIntegerField;
    Ado538HCL_DATE: TDateTimeField;
    Ado538IF_HCL: TWordField;
    Ado538HCL_STATUS: TWordField;
    Ado538IF_CamWf: TWordField;
    Ado538camwf_status: TStringField;
  private
