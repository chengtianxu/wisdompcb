object DM: TDM
  ...
  object Ado538: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT CAST(0 AS bit) AS Sel,dbo.Data0025.MANU_PART_NUMBER, dbo.' +
        'Data0025.MANU_PART_DESC,'
      
        '       dbo.DATA0538.*, dbo.Data0005.EMPLOYEE_NAME AS E_NAME1,Dat' +
        'a0060.sales_order,data0060.SCH_DATE, '
        ...
        '       case DATA0538.STATUS when 0 then '#39#39044#23457#24453#20998#37197#39' when 1 then '#39#24453#39044#23457 +
        #39' when 2 then '#39#39044#23457#24320#22987#39' when 3 then '#39#39044#23457#32467#26463#39' when 4 then '#39'CAM'#24453#29702#39' when' +
        ' 5 then '#39'CAM'#24320#22987#39
      
        '       when 6 then '#39'CAM'#32467#26463#39' when 7 then '#39'QAE'#24320#22987#39' when 8 then '#39'QAE'#32467 +
        #26463#39' when 9 then '#39'CAM'#36864#22238#39' when 10 then '#39'QAE'#36864#22238#39' end as iSTATUS,'
      
        '       case data0538.YS_EQ_STATUS when 0 then '#39#26080#39' when 1 then '#39#36827 +
        #34892#20013#39' when 2 then '#39#24050#23436#25104#39' end as YS_EQ_STATUS2,'
      
        '       case data0538.CAM_EQ_STATUS when 0 then '#39#26080#39' when 1 then '#39 +
        #36827#34892#20013#39' when 2 then '#39#24050#23436#25104#39' end as CAM_EQ_STATUS2,'
      
        '       case data0538.IF_CamWf when 0 then '#39#21542#39' when 1 then '#39#26159#39' en' +
        'd as camwf_status'
      'FROM  dbo.DATA0538 INNER JOIN'
        ...
        '      dbo.data0015 on data0025.PROD_ROUTE_PTR=data0015.Rkey left' +
        ' join'
      
        '      dbo.data0060 on data0538.CUST_PART_PTR=data0060.CUST_PART_' +
        'PTR and data0538.CONF_DATE=data0060.CONF_DATE')
    Left = 168
    Top = 16
    object Ado538Sel: TBooleanField
      FieldName = 'Sel'
    end
    ...
    object Ado538iSTATUS: TStringField
      FieldName = 'iSTATUS'
      ReadOnly = True
      Size = 10
    end
    ...
    object Ado538QAE_EDN_DATE: TDateTimeField
      FieldName = 'QAE_END_DATE'
    end
    object Ado538QAE_XiShu: TFloatField
      FieldName = 'QAE_XiShu'
    end
    object Ado538QAE_JCLX: TStringField
      DisplayWidth = 10
      FieldName = 'QAE_JCLX'
      Size = 50
    end
    object Ado538sales_order: TStringField
    ...
    object Ado538IF_HCL: TWordField
      FieldName = 'IF_HCL'
    end
    object Ado538HCL_STATUS: TWordField
      FieldName = 'HCL_STATUS'
    end
    object Ado538IF_CamWf: TWordField
      FieldName = 'IF_CamWf'
    end
    object Ado538camwf_status: TStringField
