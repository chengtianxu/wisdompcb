...
begin
 ...
 // Edit6.SelectAll ;
  ...
  begin
    ...
    begin
      Edit13.Text :=adoquery9.Fieldbyname('space_l_min').asString;
      Edit14.Text :=adoquery9.Fieldbyname('space_w_min').asString;
      Edit1.Text :=Fieldbyname('border_l_min').AsString;
      Edit38.Text :=Fieldbyname('border_w_min').AsString;
    end;
  end;
end;
...
begin
 ...
 if not svValid then exit;
  ...
  if dm.ads502.RecordCount>0 then dm.ads502.Edit else  dm.ads502.Append;
  ...
  begin
    ...
    end else if ttype='2' then begin
