    ...
    begin
      ...
      begin
        ...
        begin
          ...
          LPaintData := Calc4RegToPaintData(A_SheetArr[J], 0, 0, 0, 0, False);
...
//      end;
  ...
  begin
    ...
    LPaintData := Calc4RegToPaintData(LABSheetArr[I].SheetA, 0, 0, 0, 0, False);
    ...
    begin
      ...
      if LRet.SheetB.Calc4Reg.Hor_Ver = 0 then
        LPaintData := Calc4RegToPaintData(LABSheetArr[I].SheetB, 0, 0, 0, 0, False,0,LRet.SheetA.H)
      else
        LPaintData := Calc4RegToPaintData(LABSheetArr[I].SheetB, 0, 0, 0, 0, False,LRet.SheetA.W,0);
