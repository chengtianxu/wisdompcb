...
begin
  ...
  begin
    ...
    begin
      ...
      LZoom := g_PaintMapSize / MaxValue([LPnl.W,LPnl.H]);
      LPnl.PaintData := Calc4RegToPaintData(PnlCalc4Reg,StrToFloat(edtSetSpaceX_A.Text),
        StrToFloat(edtSetSpaceY_A.Text),StrToFloat(edtPnlLeftRightW_A.Text), StrToFloat(edtPnlTopBottomW_A.Text), LZoom);
      ...
      LZoom := g_PaintMapSize / MaxValue([LSheet.W, LSheet.H]);
      LSheet.PaintData := Calc4RegToPaintData(SheetCalc4Reg,0,0,0,0,LZoom);
      LSheet.OriginalPaintData := Calc4RegToPaintData(SheetCalc4Reg,0,0,0,0,LZoom);
...
//          LPnlBorderSize.Pnl_ZeroBorderH := A_PnlArr[I].H - ACutParam.PnlABorderTopBottomWidth*2;
      ...
      FRet.PnlA.PBorderSize^.Pnl_ZeroBorderW := FRet.PnlA.W - FRet.CutParam.PnlABorderLeftRightWidth * 2;
      FRet.PnlA.PBorderSize^.Pnl_ZeroBorderH := FRet.PnlA.H - FRet.CutParam.PnlABorderTopBottomWidth * 2;
...
begin
  ...
  if (tmpW > strtofloat(edtPnlW_A.Text) + 0.0000000001) or (tmpH > StrToFloat(edtPnlH_A.Text) + 0.0000000001) then
  begin
  ...
  if (tmpW > StrToFloat(edtSheetW.Text) + 0.0000000001) or (tmpH > StrToFloat(edtSheetH.Text) + 0.0000000001) then
  begin
