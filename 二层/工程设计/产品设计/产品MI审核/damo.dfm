object DM: TDM
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      'ta0025.LAST_MODIFIED_DATE >=:dtpk1 and'#13#10'           data0025.LAST' +
      '_MODIFIED_DATE-1 <=:dtpk2 and'#13#10'           data0025.parent_ptr is' +
      ' null and'#13#10'  data0025.tstatus <> :v6 and'#13#10'  data0025.tstatus <> ' +
      ':v0 and'#13#10'  data0025.tstatus <> :v3 and'#13#10'  data0025.tstatus <> :v' +
      '4 and'#13#10'  data0025.tstatus <> :v1 and'#13#10'  data0025.tstatus <> :v5 ' +
      'and'#13#10'  data0025.tstatus <> :v2'#13#10
    Parameters = <
      item
        Name = 'dtpk1'
  ...
  object AQY0025: TADOQuery
    ...
    SQL.Strings = (
        ...
        'layers_image,flod_number,ZDR_TYPE,ORIG_CUSTOMER,minring,Diffmark' +
        ',ProdGrade,RoHS,Compress,'
      'grade_code'
      'FROM dbo.Data0025'
      'where rkey=:rkey'
      ' ')
  ...
  object ADS38: TADODataSet
    ...
    CommandText = 
      ...
      'REMARK,data0038.grade_note,'#13#10'd34.PPC_CYCLE_TIME,data0038.grade_n' +
      'ote,D34.BARCODE_ENTRY_FLAG,'#13#10'd34.dept_code,d34.dept_name'#13#10'FROM D' +
      'ata0038 INNER JOIN Data0034 D34 ON Data0038.DEPT_PTR = D34.Rkey'#13 +
      #10'where Data0038.source_ptr=:rkey'#13#10'order by Data0038.step_number'#13 +
      #10
    ...
    object ADS38PPC_CYCLE_TIME: TIntegerField
      FieldName = 'PPC_CYCLE_TIME'
    end
    object ADS38grade_note_1: TWideStringField
      FieldName = 'grade_note_1'
      Size = 2048
    end
    ...
    object ADS38dept_code: TStringField
      DisplayLabel = #24037#24207#24037#30721
      FieldName = 'dept_code'
      Size = 10
    end
