...
uses part_search, uDM,Pick_Item_Single,DEPT_Edit,DEPT_Add, DEPT_Main,uNew,uFAEdit,PubFunc,ShellAPI,uMain;
...
begin
 ...
 if not dm.AdoTable1.IsEmpty then
  ...
  if dm.ADOQuery2.Active then
    ...
    dm.ADOQuery2.Parameters.ParamValues['rkey738'] :=dm.ADO0738.fieldbyname('Rkey').value;
    dm.ADOQuery2.Open;
    dm.ADOQuery2.Edit;
   ...
   // FormNew.Hide;
    ...
    Close;
    SQL.Clear;
    SQL.Text:='select * from fa0739 where d738_ptr='+inttostr(dm.ADO0738.fieldbyname('Rkey').value)+
...
//    end;
   ...
   ///////////////////////////////////////////////////////
    ...
    Parameters[2].Value:=dm.ADO0738.fieldbyname('Rkey').Value;
...
function TFormEdit2.GetIDKey: string;
var
  FGUID:TGUID;
begin
  CreateGUID(FGUID);
...
function TFormEdit2.Get_05Ptr(ARkey73: string;
...
function TFormEdit2.CheckFtpDir(AFtp: TIdFTP; ADir: string): Boolean;
begin
  Result:= False;
...
procedure TFormEdit2.CreateDir2(AFtp: TIdFTP; ADir: string);
var
...
procedure TFormEdit2.PopupMenu3Popup(Sender: TObject);
begin
if not dm.ADOFTP.IsEmpty  then
begin
N11.Enabled:=True;
N12.Enabled:=True;
end;
...
procedure TFormEdit2.PopupMenu1Popup(Sender: TObject);
begin
...
procedure TFormEdit2.Grd2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
