object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      ' AS '#21333#21482#38754#31215'PCS, Data0025.unit_sq AS '#21333#21482#38754#31215'SET, '#13#10'Data0025.spell_sq AS' +
      ' '#21333#21482#38754#31215'SPEL, Data0025.layers_info AS '#23618#21387#32467#26500', '#13#10'Data0025.REMARK as '#21152#24037 +
      #25351#31034',Data0025.ENG_NOTE as '#24037#31243#22791#27880', data0025.barcode_flag,'#13#10'Data0025.E' +
      'ST_SCRAP as '#25253#24223#29575' , Data0025.SHELF_LIFE as '#29983#20135#21608#26399', data0025.NOPB_fla' +
      'g,'#13#10'      Data0025.REVIEW_DAYS as '#26377#25928#26399#22825#25968', Data0025.MFG_LEAD_TIME ' +
      'as '#21046#36896#25552#21069#26399', '#13#10'      Data0025.ANALYSIS_CODE_3 as '#22823#26009#35268#26684', Data0025.REP' +
      'ORT_UNIT_VALUE1 AS '#21333#21482#37325#37327'g, '#13#10'      dbo.Data0025.OPT_LOT_SIZE as '#27969 +
      #36716#25209#37327',data0025.QTY_BOM as '#21387#21512#27604#20363','#13#10'case Data0025.ONHOLD_SALES_FLAG w' +
      'hen 0 then '#39#26377#25928#39' when 1 then '#39#36807#26399#39' end as '#38144#21806#29366#24577', '#13#10'case Data0025.TS' +
      'TATUS'#13#10'   when 0 then '#39#24453#21046#20316#39' when 1 then '#39#24050#23457#26680#39' when 2 then '#39#23457#36864#22238#39' ' +
      'when 3 then '#39#24453#26816#26597#39#13#10'   when 4 then '#39#24453#23457#26680#39' when 5 then '#39#26816#36864#22238#39' when 6' +
      ' then '#39#26410#25552#20132#39' end as '#23457#25209#29366#24577','#13#10'case   Data0025.ttype  when 0 then '#39#37327#20135 +
      #39' when 1 then '#39#26679#26495#39'  end as '#37327#20135#26679#26495','#13#10'case Data0025.green_flag when ' +
      #39'Y'#39' then '#39'4G'#26631#35782#39'  else '#39' '#39' end as '#26631#35782'4G,'#13#10'case when data0025.PAREN' +
      'T_PTR is null then '#39#22806#23618#39' ELSE '#39#20869#23618#39' end as  '#20135#21697#24615#36136','#13#10'case when ltrim' +
      '(data0025.CURRENT_REV)='#39'Y'#39' then '#39#26080#21348#32032#39' else '#39#39' end as '#21348#32032#35201#27714','#13#10'case' +
      ' when ltrim(data0025.amp_mb)='#39'Y'#39' then '#39#21151#25918#26495#39' else '#39#39' end as '#21151#25918#26495','#13 +
      #10'case when data0025.REACH=1 then '#39'REACH'#35201#27714#39' else '#39#39' end as REACH,' +
      #13#10'data0025.flod_number as '#38075#23380#21472#26495#25968',data0025.ZDR_TYPE as '#38075#23380#21442#25968',data00' +
      '25.layers_image as '#21387#21512#22270#29255','#13#10'data0025.ORIG_CUSTOMER as '#20851#32852#21407#23458#25143',data00' +
      '25.DiffMark as '#21046#36896#38590#24230',data0025.ProdGrade as '#20135#21697#31561#32423','#13#10'data0025.RoHS,D' +
      'ata0025.Compress as '#21387#21512#31243#24335',Data0025.DrillRemark as '#38075#23380#22791#27880',data0025.g' +
      'rade_code as '#31561#32423#25351#31034',Data0025.MinRing as '#26368#23567'Ring'#29615#13#10'FROM dbo.Data0008' +
      ...
      'N'#13#10'      dbo.Data0005 Data0005_3 ON '#13#10'      dbo.Data0025.CHECK_B' +
      'Y_PTR = Data0005_3.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data' +
      '0005_2 ON '#13#10'      dbo.Data0025.LAST_MODIFIED_BY_PTR = Data0005_2' +
      '.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Data' +
      '0025.AUDITED_BY_PTR = Data0005_1.RKEY'#13#10'where data0025.rkey=:rkey' +
      #13#10
    Parameters = <
      item
        Name = 'rkey'
    ...
    object ADS25DSDesigner39: TWideStringField
    ...
    object ADS25DSDesigner40: TStringField
  ...
  object ads38: TADODataSet
    ...
    CommandText = 
      ...
      '.DEPT_NAME as '#24037#24207#21517#31216', '#13#10'      Data0038.STEP_NUMBER, Data0038.tooli' +
      'ng_rev as '#24037#20855#29256#26412', '#13#10'      Data0034.BARCODE_ENTRY_FLAG as '#36807#25968', Data0' +
      '038.OUTP_SPFC as '#20135#20986', '#13#10'      Data0038.DEF_ROUT_INST as '#22791#27880', data0' +
      '038.SOURCE_PTR'#13#10'FROM Data0038 INNER JOIN'#13#10'      Data0034 ON dbo.' +
      'Data0038.DEPT_PTR = Data0034.RKEY'#13#10'WHERE  (Data0038.SOURCE_PTR =' +
  ...
  object ppReport1: TppReport
    ...
    SaveAsTemplate = True
    Template.FileName = '..\NIERP\Report\Manu_instruction.rtm'
    Units = utMillimeters
    CachePages = True
    DeviceType = 'Screen'
    ...
    object raCodeModule4: TraCodeModule
      ProgramStream = {
        ...
        726F63656475726506536F757263650C5701000070726F636564757265205661
        ...
        
        0000}
    end
  end
  ...
  object ppDB25: TppDBPipeline
    ...
    object ppDB25ppField58: TppField
      FieldAlias = #26368#23567'Ring'#29615
      FieldName = #26368#23567'Ring'#29615
      FieldLength = 10
      DisplayWidth = 10
  ...
  object ads29: TADODataSet
    ...
    CommandText = 
      ...
      'BER AS SE'#23380#25968#13#10'FROM dbo.Data0029'#13#10'where source_ptr=:rkey'#13#10
    DataSource = DataSource1
    MasterFields = 'rkey'
    Parameters = <
      item
  ...
  object ADS30: TADODataSet
    ...
    CommandText = 
      ...
      'om DATA0030'#13#10'where  source_ptr=:rkey'#13#10'order by SEQ_NO'
    DataSource = DataSource1
