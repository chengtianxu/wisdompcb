...
uses
  ...
  Dialogs, StdCtrls, Buttons, ExtCtrls, Menus, Grids, DBGrids, DB, ADODB;
...
if DM.AQY0025.FieldByName('CHECK_BY_PTR').IsNull then  DM.ADOQuery2.SQL.Text := DM.ADOQuery2.SQL.Text + ' ,CHECK_BY_PTR = null '
else DM.ADOQuery2.SQL.Text := DM.ADOQuery2.SQL.Text +
