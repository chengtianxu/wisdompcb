...
begin
 ...
 0:
  sgrid1.Cells[2,sgrid_row]:='and FA0745.F_NUM LIKE ''%'+trim(edit2.Text)+'%''';
 1:
 ...
 3:
  sgrid1.Cells[2,sgrid_row]:='and FA0745.CreateDate >='''+datetostr(dtpk1.date)+
                            ''' and FA0745.CreateDate <='''+datetostr(dtpk2.date+1)+'''';
 4:
...
begin
 for i:=1 to sgrid1.RowCount-2 do
  ...
  case listbox2.ItemIndex of
 0:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and FA0745.F_NUM LIKE ''%'+trim(edit2.Text)+'%''';
 1:
 ...
 3:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and FA0745.CreateDate >='''+datetostr(dtpk1.date)+
                            ''' and FA0745.CreateDate <='''+datetostr(dtpk2.date+1)+'''';
 4:
...
if sgrid1.RowCount=2 then
 ...
 begin
  with dm.ADO0745 do
   begin
    close;
    dm.ADO0745.CommandText:=main.sqltext;
    for i:=1 to sgrid1.RowCount-2 do
    dm.ADO0745.CommandText:=dm.ADO0745.CommandText+#32+sgrid1.Cells[2,i];
    open;
   end;
  self.Close; 
 end;
