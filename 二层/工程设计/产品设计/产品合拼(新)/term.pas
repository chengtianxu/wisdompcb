...
uses  uDM, employee_search, cust_search,Pick_Item_Single,ConstVar;
...
begin
 ...
 3:
  sgrid1.Cells[2,sgrid_row]:='and d10.CUST_CODE = '''+edit3.Text+'''';
 4:
  sgrid1.Cells[2,sgrid_row]:='and d97.PO_NUMBER LIKE ''%'+edit3.Text+'%''';
 5:
  begin
 ...
 6:
  sgrid1.Cells[2,sgrid_row]:='and d05.empl_code LIKE ''%'+edit3.Text+'%''';
 7:
  begin
