object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      's '#21152#24037#25351#31034',Data0025.ENG_NOTE as '#24037#31243#22791#27880', data0025.barcode_flag,data0025' +
      '.CarProd_flag,'#13#10'Data0025.EST_SCRAP as '#25253#24223#29575' , Data0025.SHELF_LIFE ' +
      'as '#29983#20135#21608#26399', data0025.NOPB_flag,'#13#10'      Data0025.REVIEW_DAYS as '#26377#25928#26399#22825 +
      ...
      'Data0025.OPT_LOT_SIZE as '#27969#36716#25209#37327',data0025.QTY_BOM as '#21387#21512#27604#20363','#13#10'case Da' +
      'ta0025.ONHOLD_SALES_FLAG when 0 then '#39#26377#25928#39' when 1 then '#39#36807#26399#39' end a' +
      's '#38144#21806#29366#24577', '#13#10'case Data0025.TSTATUS'#13#10'   when 0 then '#39#24453#21046#20316#39' when 1 the' +
      'n '#39#24050#23457#26680#39' when 2 then '#39#23457#36864#22238#39' when 3 then '#39#24453#26816#26597#39#13#10'   when 4 then '#39#24453#23457#26680 +
      #39' when 5 then '#39#26816#36864#22238#39' when 6 then '#39#26410#25552#20132#39' end as '#23457#25209#29366#24577','#13#10'case   Data0' +
      '025.ttype  when 0 then '#39#37327#20135#39' when 1 then '#39#26679#26495#39'  end as '#37327#20135#26679#26495','#13#10'case' +
      ' Data0025.green_flag when '#39'Y'#39' then '#39'4G'#26631#35782#39'  else '#39' '#39' end as '#26631#35782'4G,' +
      #13#10'case when data0025.PARENT_PTR is null then '#39#22806#23618#39' ELSE '#39#20869#23618#39' end ' +
      'as  '#20135#21697#24615#36136',Data0025.REACH,'#13#10'case when ltrim(data0025.CURRENT_REV)=' +
      #39'Y'#39' then '#39#26080#21348#32032#39' else '#39#39' end as '#21348#32032#35201#27714#13#10'FROM dbo.Data0008 INNER JOIN' +
      #13#10'      dbo.Data0025 ON '#13#10'      dbo.Data0008.RKEY = dbo.Data0025' +
      '.PROD_CODE_PTR INNER JOIN'#13#10'      dbo.Data0010 ON '#13#10'      dbo.Dat' +
      'a0025.CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUTER JOIN'#13#10'      db' +
      'o.Data0005 Data0005_3 ON '#13#10'      dbo.Data0025.CHECK_BY_PTR = Dat' +
      'a0005_3.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_2 ON '#13 +
      #10'      dbo.Data0025.LAST_MODIFIED_BY_PTR = Data0005_2.RKEY LEFT ' +
      'OUTER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Data0025.AUDITE' +
      'D_BY_PTR = Data0005_1.RKEY'#13#10'where data0025.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
    ...
    object ADS25CarProd_flag: TStringField
      FieldName = 'CarProd_flag'
      FixedChar = True
      Size = 1
    end
    object ADS25bz4g: TStringField
  ...
  object ppReport1: TppReport
    ...
    SaveAsTemplate = True
    Template.FileName = 'D:\SJSYS\NIERP\Report\Manu_instruction_FPC.rtm'
    Units = utMillimeters
    CachePages = True
    DeviceType = 'Screen'
    ...
    object raCodeModule4: TraCodeModule
      ProgramStream = {
        ...
        
