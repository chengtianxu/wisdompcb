...
begin                                 //zsp修改于20170607
  ...
  begin
    ...
    sql.Text:=' ;with CTE(rkey,PARENT_PTR,MANU_PART_NUMBER,qty_bom,shelf_life,analysis_code_3,ttype,QTY_PARENTBOM,OPT_LOT_SIZE,lv) as    ' + #13+
              ...
              '  from '+database+ 'dbo.data0025 where rkey='+inttostr(rkey25) + #13+
              '  UNION ALL  '+ #13+
              ...
              '  from '+database+ 'dbo.data0025 d25 INNER JOIN CTE on	d25.parent_ptr=CTE.rkey ' + #13+
              ')  ' + #13+
