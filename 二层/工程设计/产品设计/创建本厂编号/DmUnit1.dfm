object DM: TDM
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        '      case Data0025.green_flag when '#39'Y'#39' then '#39'4G'#26631#35782#39' WHEN '#39'N'#39' the' +
      ...
      '      data0025.SAMPLE_NR,data0025.ANCESTOR_PTR,'
        ...
        '      Data0025.RFQNo, data0025.memo_text as memotext,Data0025.OR' +
        'IG_CUSTOMER,case Data0025.pricing_principle when 1 then '#39#25253#20215#39' whe' +
        'n 0 then '#39#21327#35758#39' end as pricing_principle'
    ...
    object ADOQuery1memotext: TMemoField
      DisplayLabel = #24066#22330#22791#27880
      FieldName = 'memotext'
      OnGetText = ADOQuery1memotextGetText
      BlobType = ftMemo
    end
    ...
    object ADOQuery1pricing_principle: TStringField
      FieldName = 'pricing_principle'
      ReadOnly = True
      Size = 4
    end
  end
  object ADOQuery2: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT RKEY,MANU_PART_NUMBER,MANU_PART_DESC,SAMPLE_NR,LAYERS,pri' +
        'cing_principle'
      ',SO_UNIT,pcs_lngth,pcs_width,set_lngth,set_width,green_flag'
      ',ANALYSIS_CODE_2,memo_text,set_qty,current_rev,CustFileName'
      ...
      ',ENG_ROUTE_PTR,prod_route_ptr,spell_qty,nopb_flag'
        ...
        'H,RFQNo,ORIG_CUSTOMER,RoHS,print2dkey,'
      'grade_code'
      'FROM DATA0025'
      'WHERE RKEY = :RKEY25'
      ' ')
    ...
    object ADOQuery2ORIG_CUSTOMER: TStringField
      FieldName = 'ORIG_CUSTOMER'
      Size = 30
    end
    ...
    object ADOQuery2pricing_principle: TWordField
      FieldName = 'pricing_principle'
    end
    object ADOQuery2CustFileName: TStringField
      FieldName = 'CustFileName'
      Size = 50
    end
    object ADOQuery2RoHS: TBooleanField
      FieldName = 'RoHS'
    end
    object ADOQuery2print2dkey: TIntegerField
      FieldName = 'print2dkey'
    end
    object ADOQuery2grade_code: TStringField
  ...
  object AQY0025: TADOQuery
    ...
    SQL.Strings = (
        ...
        'arcode_flag,quality_status,quality_user,quality_date,REACH,RoHS,'
      '      RFQNo'
      'FROM dbo.Data0025'
      'where rkey=:rkey'
      ' ')
  ...
  object dsADOQuery2: TDataSource
    DataSet = ADOQuery2
    Left = 312
    Top = 16
  end
