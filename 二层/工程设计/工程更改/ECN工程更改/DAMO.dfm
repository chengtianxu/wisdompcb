object DM: TDM
  ...
  object ads273: TADODataSet
    ...
    CommandText = 
      ...
      '     dbo.Data0025.MANU_PART_NUMBER, Data0025.MANU_PART_DESC, Dat' +
      'a0025.ANALYSIS_CODE_2,'#13#10'      Data0025_1.MANU_PART_NUMBER AS cop' +
      'ytonumber, Data0025_1.ANALYSIS_CODE_2 as CODE_2 ,'#13#10'      Data002' +
      '5_1.MANU_PART_DESC AS copytodesc, Data0273.Tooling_close, '#13#10'case' +
      ' Data0273.STATUS when 0 then '#39#26410#25552#20132#39' '#13#10'                           ' +
      '              when 1 then '#39#24453#32467#26696#39#13#10'                               ' +
      '          when 2 then '#39#24050#32467#26696#39' end as tstatus,'#13#10'case data0273.sourc' +
      'e when 1 then '#39#20869#37096#39' when 2 then '#39#22806#37096#39' end as tsource,'#13#10'case data02' +
      '73.tooling_close '#13#10' when 1 then '#39#37327#20135#36716#37327#20135#39' '#13#10' when 2 then '#39#37327#20135#36716#26679#26495#39#13#10 +
      ' when 3 then '#39#26679#26495#36716#26679#26495#39#13#10' when 4 then '#39#26679#26495#36716#37327#20135#39' end as ttype,'#13#10'data02' +
      '73.CUSTOMER_PART_PTR'#13#10'FROM dbo.Data0273 INNER JOIN'#13#10'      dbo.Da' +
      'ta0010 ON dbo.Data0273.CUSTOMER_PTR = dbo.Data0010.RKEY INNER JO' +
      'IN'#13#10'      dbo.Data0005 ON dbo.Data0273.ENTERED_BY = dbo.Data0005' +
      '.RKEY INNER JOIN'#13#10'      dbo.Data0025 ON '#13#10'      dbo.Data0273.COP' +
      'YFROMCUST_PTR = dbo.Data0025.RKEY INNER JOIN'#13#10'      dbo.Data0025' +
      ' Data0025_1 ON '#13#10'      dbo.Data0273.CUSTOMER_PART_PTR = Data0025' +
      '_1.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Da' +
      'ta0273.VERIFIED_BY = Data0005_1.RKEY'#13#10'where Data0273.ENTERED_DAT' +
      'E >=:dtpk1 '#13#10'  and  Data0273.ENTERED_DATE <=:dtpk2 '#13#10'  and data0' +
      '273.status <> :v0'#13#10'  and data0273.status <> :v1'#13#10'  and data0273.' +
      'status <> :v2'#13#10
    ...
    object ads273ANALYSIS_CODE_2: TStringField
      DisplayLabel = #21464#26356#21069#29289#26009#21495
      FieldName = 'ANALYSIS_CODE_2'
      Size = 80
    end
    object ads273CODE_2: TStringField
      DisplayLabel = #21464#26356#21518#29289#26009#21495
      FieldName = 'CODE_2'
      Size = 80
    end
  end
  ...
  object AQY0025: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      ANALYSIS_CODE_4, SO_UNIT, ttype, RKEY,layers_info,'
        ...
        'PB_flag,TUSAGE,'
      'REACH,flod_number,ZDR_TYPE,layers_image,ORIG_CUSTOMER,grade_code'
      'FROM dbo.Data0025'
      'where rkey=:rkey')
    Left = 185
    Top = 104
