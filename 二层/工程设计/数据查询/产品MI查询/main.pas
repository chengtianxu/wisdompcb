   ...
   //ads29.Open;
      ...
      begin
       ...
       begin
        ...
        form_report.ads29.CommandText:=form_report.ads29.CommandText+'and flow_no IN('+ copy(ckstr,0,Length(ckstr)-1)+') ORDER BY SEQ_NO';
       end;
      end;
      ads29.Open;
...
begin
  ...
  MI1.Enabled:=dm.ADS25TSTATUS.Value=1;
