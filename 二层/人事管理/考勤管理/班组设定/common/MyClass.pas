...
var
  ...
  Tmp_str,Expr1,Expr2,Expr3:string;
begin
  Input_str:=' '+Input_str+' ';
...
var
  ...
  StrTmp,strLeft,strRight,TmpExpr,partA,partB:string;
  n : integer;
  Op : TOperator;
...
var
  Prase:string;
  i,j,P1,P2,P3:integer;
  StrTmp,strLeft,strRight,TmpExpr,Div_A,Div_B:string;
  n : integer;
  Op : TOperator;
  DataType,DataType2:byte;//数据类型1:数字，2:字符
  intLen : integer;
...
begin
  ...
  begin
    ...
    try
      str_expr:= Get_If_Expr(str_expr);
      Out_Value := Calc_Expr(str_expr); //MyDataClass.Get_Sql_Value(' select '+str_expr);
    except
      result := false;
