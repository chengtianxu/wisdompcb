   ...
   Self.ComboBox1.Items.Clear;
    ...
    begin
          ...
          SQL.Text:='SELECT   rkey, dictid, item '+
           ' FROM  dbo.datadetail WHERE dictid = 9 '+#13;
          Open;
          first;
          while not Eof do
          begin
...
begin
 ...
 0:    //类型
  begin
        ...
        0:sgrid1.Cells[2,sgrid_row]:='and d9.item = '''+trim(ComboBox2.Text)+'''';
        1:sgrid1.Cells[2,sgrid_row]:='and d9.item like ''%'+trim(ComboBox2.Text)+'%''';
        end;
   end;
 1:   //部门
  begin
        ...
        case radiogroup1.ItemIndex of
        0:sgrid1.Cells[2,sgrid_row]:='and d.rkey = '''+inttostr(edtValue.tag)+'''';
        1:sgrid1.Cells[2,sgrid_row]:='and d.rkey in '+label3.Caption;
        end;
  end;
  ...
  2:  //职务
   begin
        sgrid1.Cells[1,sgrid_row]:=trim(edtValue.Text);
        case radiogroup1.ItemIndex of
        0:sgrid1.Cells[2,sgrid_row]:='and d1.item = '''+edtValue.Text+'''';
        1:sgrid1.Cells[2,sgrid_row]:='and d1.item like ''%'+edtValue.Text+'%''';
        end;
    end;
 3:  //工号姓名
  begin
        sgrid1.Cells[1,sgrid_row]:=trim(edtValue.Text);
        case radiogroup1.ItemIndex of
        0:sgrid1.Cells[2,sgrid_row]:='and e.chinesename = '''+edtValue.Text+'''';
        1:sgrid1.Cells[2,sgrid_row]:='and e.chinesename like ''%'+edtValue.Text+'%''';
        end;
    end;
 4:  //入职日期
 begin
      ...
      0:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_ondutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  = '''+datetostr(DateTimePicker2.Date)+'''';
      1:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_ondutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  > '''+datetostr(DateTimePicker2.Date)+'''';
      2:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_ondutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  < '''+datetostr(DateTimePicker2.Date)+'''';
      3:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_ondutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  between '''+datetostr(dtpk1.Date)+' and '''+datetostr(dtpk2.Date)+'''';
      end;
    end;
 5:  //离职日期
 begin
      ...
      sgrid1.Cells[1,sgrid_row]:=radiogroup3.Items.Strings[radiogroup3.ItemIndex]+DateToStr(DateTimePicker2.Date);
      case radiogroup3.ItemIndex of
      0:sgrid1.Cells[2,sgrid_row]:='and  replace(convert(char(10),employee_1.orginal_outdutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  = '''+datetostr(DateTimePicker2.Date)+'''';
      1:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_outdutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  > '''+datetostr(DateTimePicker2.Date)+'''';
      2:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_outdutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  < '''+datetostr(DateTimePicker2.Date)+'''';
      3:sgrid1.Cells[2,sgrid_row]:='and replace(convert(char(10),employee_1.orginal_outdutytime,111),'+#39+'/'+#39+','+#39+'-'+#39+')  between '''+datetostr(dtpk1.Date)+''''+' and '''+datetostr(dtpk2.Date)+'''';
      end;
    end;
 6: //民族
    begin
        sgrid1.Cells[1,sgrid_row]:=trim(edtValue.Text);
        case radiogroup1.ItemIndex of
        0:sgrid1.Cells[2,sgrid_row]:='and e.nation = '''+edtValue.Text+'''';
        1:sgrid1.Cells[2,sgrid_row]:='and e.nation like ''%'+edtValue.Text+'%''';
        end;
    end;
 {7: //审核锁
    begin
