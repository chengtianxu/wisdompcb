  ...
  case Tmenuitem(Sender).Tag of
    ...
    begin
      ...
      begin
        ...
        begin
          ShowMessage('该员工已有考勤档案，不能删除员工信息, 只能做离职处理或联系管理员！');
          Exit;
        end;
      end;
...
begin
 if DM.employee_msg.FieldByName('emp_contract_flag').asstring = '合同数超限'
