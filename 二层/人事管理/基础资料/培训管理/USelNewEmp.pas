...
var
  frmSelNewEmp: TfrmSelNewEmp;

implementation

{$R *.dfm}

procedure TfrmSelNewEmp.eh1TitleClick(Column: TColumnEh);
begin
...
procedure TfrmSelNewEmp.edt_1Change(Sender: TObject);
begin
...
procedure TfrmSelNewEmp.btn_SelAllClick(Sender: TObject);
begin
...
procedure TfrmSelNewEmp.btnCancelClick(Sender: TObject);
begin
close;
end;

procedure TfrmSelNewEmp.FormShow(Sender: TObject);
begin
