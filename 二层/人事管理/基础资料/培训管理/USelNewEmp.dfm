object frmSelNewEmp: TfrmSelNewEmp
  Left = 610
  Top = 229
  Width = 574
  Height = 469
  ...
  object qry1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'values (0)'
        ...
        'entName, b.item, a.station, a.departmentid,a.onDutyTime'
      'from  employeemsg  a  '
      'inner join datadepartment d   on a.departmentid=d.rkey'
      'inner join datadetail b on a.station =b.rkey '
      'join @TempTable c on 1=1'
      
        'where  a.status<>2 and a.IsPlan=0  and  (a.departmentID is not n' +
        'ull or a.departmentID='#39#39') '
      'and  (a.station is not null or a.station='#39#39')')
    Left = 432
    Top = 16
