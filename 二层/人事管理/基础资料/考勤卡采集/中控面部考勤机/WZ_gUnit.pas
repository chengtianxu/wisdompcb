...
begin
  ...
  outRet.DBConnectString := 'Provider=SQLOLEDB.1;Password=wisdomtopcb1077;Persist Security Info=True;' +
    'User ID=wzsa;Initial Catalog=sj_v20_live;Data Source=172.16.68.8;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=CHENGTX-PC;Use Encryption for Data=False;Tag with column collation when possible=False';
  outRet.DBName := '深圳备份';
end;
