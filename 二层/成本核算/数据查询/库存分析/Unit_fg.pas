...
begin
 try
  ...
  form_report2.QRLabel1.Caption:='五洲电路板有限公司';
...
//  eaapps1.worksheets.Add(null,null,1,null,0);
  ...
  Form_Progress.show;
  Form_Progress.Label1.Caption :='正在汇总数据表';
...
//aSheet:=eaapps1.Worksheets[1];
  //---------//开始导出第一页
  DbgridEh1.DataSource.DataSet.DisableControls; //禁止控制
  ...
  try
    ...
    while not DbgridEh1.DataSource.DataSet.Eof do
      begin
        ...
        if Dbgrideh1.DataSource.DataSet.RecordCount div 100>0 then //进度条
