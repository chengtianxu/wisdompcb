...
begin
 if (trim(dm.ADOData0073PASSWORD.Value) <> MD5Print(MD5String(trim(edit1.Text))))
  and (trim(dm.ADOData0073PASSWORD.Value)<>'')
  and (activecontrol.Name<>'BitBtn2') then
   begin
...
begin
 ...
 DM.Adodata0073.Edit;
 DM.Adodata0073password.value := MD5Print(MD5String(trim(edit3.Text)));
 DM.Adodata0073.Post ;
