 ...
 with ADOQ105 do
  begin
    ...
    case FieldByName('trans_type').asinteger of
      ...
      10:FieldByName('ttype').asstring:='银行转帐'
    end;
  end;
end;
...
begin
  ...
  dm.ADODS106Cgl_Acc.AsString :=dm.ADODS106.FieldByName('pGL_DESCRIPTION').AsString +'-'+dm.ADODS106.FieldByName('GL_DESCRIPTION').AsString
ELSE
  dm.ADODS106Cgl_Acc.AsString :=dm.ADODS106.FieldByName('GL_DESCRIPTION').AsString;
 if dm.ADODS106.FieldByName('tGL_DESCRIPTION').AsVariant <>null then
  dm.ADODS106Cgl_Acc.AsString :=dm.ADODS106.FieldByName('tGL_DESCRIPTION').AsString +'-'+dm.ADODS106Cgl_Acc.AsString;
