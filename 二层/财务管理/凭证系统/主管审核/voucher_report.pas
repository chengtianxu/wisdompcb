...
type
  TForm_voucherreport = class(TForm)
    ...
    AQD106DESCRIPTION_1: TStringField;
    AQD106DESCRIPTION_2: TStringField;
    AQD106Field: TStringField;
    DB105: TppDBPipeline;
    DB106: TppDBPipeline;
    DB493: TppDBPipeline;
    ppReport1: TppReport;
...
procedure TForm_voucherreport.AQD106CalcFields(DataSet: TDataSet);
begin
self.AQD106Field.Value:=self.AQD106GL_DESCRIPTION.Value;
if self.AQD106DESCRIPTION_1.Value<>'' then
begin
 self.AQD106Field.Value:=self.AQD106DESCRIPTION_1.Value+'-'+
                         self.AQD106Field.Value;
 if self.AQD106DESCRIPTION_2.Value<>'' then
  self.AQD106Field.Value:=self.AQD106DESCRIPTION_2.Value+'-'+
                          self.AQD106Field.Value;
end;
end;
...
begin
 ...
 self.AQD106.First;
ppLabel20.Caption :=self.SmallTOBig(d_amount);
end;
