object Form_voucherreport: TForm_voucherreport
  ...
  object AQD106: TADODataSet
    ...
    CommandText = 
      ...
      'NT, '#13#10'         round(1/Data0106.EXCH_RATE,6) as exch_rate, '#13#10'   ' +
      '      Data0001.CURR_CODE as '#36135#24065#20195#30721', '#13#10'         Data0001.CURR_NAME ' +
      'as '#36135#24065#21517#31216', '#13#10'         Data0103.GL_ACC_NUMBER as '#31185#30446#20195#30721', '#13#10'         D' +
      'ata0103.GL_DESCRIPTION, '#13#10'         Data0103_1.GL_DESCRIPTION AS ' +
      'DESCRIPTION_1, '#13#10'         Data0103_2.GL_DESCRIPTION AS DESCRIPTI' +
      'ON_2'#13#10'FROM dbo.Data0103 Data0103_2 RIGHT OUTER JOIN'#13#10'      dbo.D' +
      'ata0103 Data0103_1 ON '#13#10'      Data0103_2.RKEY = Data0103_1.PAREN' +
      'T_PTR RIGHT OUTER JOIN'#13#10'      dbo.Data0106 INNER JOIN'#13#10'      dbo' +
      '.Data0103 ON '#13#10'      dbo.Data0106.GL_ACCT_NO_PTR = dbo.Data0103.' +
      'RKEY INNER JOIN'#13#10'      dbo.Data0001 ON dbo.Data0106.CURR_PTR = d' +
      'bo.Data0001.RKEY ON '#13#10'      Data0103_1.RKEY = dbo.Data0103.PAREN' +
      'T_PTR'#13#10'where GL_HEADER_PTR =:rkey'
  ...
  object ppReport1: TppReport
    ...
    PrinterSetup.PaperName = 'A2 420 x 594 mm'
