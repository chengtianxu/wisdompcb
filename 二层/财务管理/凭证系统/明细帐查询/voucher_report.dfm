object Form_voucherreport: TForm_voucherreport
  ...
  object AQD105: TADODataSet
    ...
    CommandText = 
      ...
      ' '#39#20986#32435#24050#23457#39' when 5 then '#39#34987#20316#24223#39#13#10'     end as '#20973#35777#29366#24577#13#10'FROM dbo.Data0105 I' +
      'NNER JOIN'#13#10'      dbo.Data0005 ON '#13#10'      dbo.Data0105.ENTERED_BY' +
      '_EMPL_PTR = dbo.Data0005.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data000' +
      '5 Data0005_4 ON '#13#10'      dbo.Data0105.POSTED_BY_EMPL_PTR = Data00' +
      '05_4.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_3 ON '#13#10'  ' +
      '    dbo.Data0105.supervisor_ptr = Data0005_3.RKEY LEFT OUTER JOI' +
      'N'#13#10'      dbo.Data0005 Data0005_2 ON '#13#10'      dbo.Data0105.AUDITED' +
      '_BY_EMPL_PTR = Data0005_2.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data00' +
      '05 Data0005_1 ON dbo.Data0105.casher_ptr = Data0005_1.RKEY'#13#10'wher' +
      'e data0105.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
  ...
  object AQD106: TADODataSet
    ...
    CommandText = 
      ...
      ' case when Data0106.EXCH_RATE>0 then'#13#10'         round(1/Data0106.' +
      'EXCH_RATE,8) else 0 end as exch_rate, '#13#10'Isnull(dbo.Data0106.PRIC' +
      'E,0) As '#21407#24065#37329#39069', '#13#10'Data0001.CURR_CODE as '#36135#24065#20195#30721', '#13#10'Data0001.CURR_NAME' +
      ' AS '#36135#24065#21517#31216', '#13#10'dbo.Data0103.GL_ACC_NUMBER AS '#31185#30446#20195#30721', '#13#10'(CASE WHEN dat' +
      'a0103_3.GL_DESCRIPTION IS NOT NULL '#13#10'                      THEN ' +
      'data0103_3.GL_DESCRIPTION + '#39'-'#39' + data0103_2.GL_DESCRIPTION + '#39'-' +
      #39' + data0103_1.GL_DESCRIPTION + '#39'-'#39' + '#39'-'#39' + data0103.GL_DESCRIPT' +
      'ION ELSE CASE WHEN'#13#10'                       data0103_2.GL_DESCRIP' +
      'TION IS NOT NULL '#13#10'                      THEN data0103_2.GL_DESC' +
      'RIPTION + '#39'-'#39' + '#39'-'#39' + data0103_1.GL_DESCRIPTION + '#39'-'#39' + data0103' +
      '.GL_DESCRIPTION ELSE CASE WHEN data0103_1.GL_DESCRIPTION IS NOT'#13 +
      #10'                       NULL THEN data0103_1.GL_DESCRIPTION + '#39'-' +
      #39' + data0103.GL_DESCRIPTION ELSE data0103.GL_DESCRIPTION END END' +
      ' END) AS '#31185#30446#21517#31216#13#10'FROM         dbo.Data0106 INNER JOIN'#13#10'           ' +
      '           dbo.Data0103 ON dbo.Data0106.GL_ACCT_NO_PTR = dbo.Dat' +
      'a0103.RKEY INNER JOIN'#13#10'                      dbo.Data0001 ON dbo' +
      '.Data0106.CURR_PTR = dbo.Data0001.RKEY LEFT OUTER JOIN'#13#10'        ' +
      '              dbo.Data0103 AS Data0103_1 ON dbo.Data0103.PARENT_' +
      'PTR = Data0103_1.RKEY LEFT OUTER JOIN'#13#10'                      dbo' +
      '.Data0103 AS Data0103_2 LEFT OUTER JOIN'#13#10'                      d' +
      'bo.Data0103 AS data0103_3 ON Data0103_2.PARENT_PTR = data0103_3.' +
      'RKEY ON Data0103_1.PARENT_PTR = Data0103_2.RKEY'#13#10'where GL_HEADER' +
      '_PTR =:rkey'
    ...
    object AQD106DSDesigner7: TBCDField
    ...
    object AQD106DSDesigner6: TStringField
  ...
  object DB106: TppDBPipeline
    ...
    object DB106ppField12: TppField
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'R:\NIERP\Report\VOUCHER_REPORT.rtm'
    Units = utMillimeters
