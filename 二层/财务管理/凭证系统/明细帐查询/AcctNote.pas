...
procedure TFrmAcctNote.BitBtn3Click(Sender: TObject);
begin
  FrmAcctNote.close;
end;
...
begin
 dm.ADOQ.close;
 dm.ADOQ.SQL.Clear;
 dm.ADOQ.SQL.Text:='select rkey from data0105 where voucher='+''''+trim(edit6.text)+'''';
 dm.ADOQ.Open;

 if dm.ADOQ.RecordCount<>0 then
   report_print(dm.ADOQ.FieldValues['rkey']);
end;
