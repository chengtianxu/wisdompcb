object DM: TDM
  ...
  object ADOQ105: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      Data0105.ATTACHED, Data0105.VOU_TYPE, Data0105.STATUS,'
        ...
        '      Data0005_2.EMPLOYEE_NAME AS supervisor,data0105.BATCH_NUMB' +
        'ER,'
      ...
      'and Data0105.status<>:vstatus5 and Data0105.status <> :vstatus6'
      ''
    ...
    object ADOQ105BATCH_NUMBER: TStringField
  ...
  object ADODS106: TADODataSet
    ...
    CommandText = 
      'SELECT Data0103_3.GL_ACC_NUMBER, Data0103_3.GL_DESCRIPTION, '#13#10'  ' +
      '    Data0001.CURR_NAME, Data0103_2.GL_DESCRIPTION AS tGL_DESCRIP' +
      'TION, '#13#10'      Data0103_1.GL_DESCRIPTION AS pGL_DESCRIPTION, Data' +
      '0106.GL_HEADER_PTR, '#13#10'      Data0106.RKEY, Data0106.GL_ACCT_NO_P' +
      'TR, Data0106.REF_NUMBER, '#13#10'      Data0106.DESCRIPTION, Data0106.' +
      'SRCE_PTR, Data0106.AMOUNT, Data0106.D_C, '#13#10'      Data0106.FYEAR,' +
      ' Data0106.PERIOD, Data0106.INV_PTR, Data0106.UNIT_PTR, '#13#10'      D' +
      'ata0106.CURR_PTR, Data0106.PRICE, Data0106.EXCH_RATE, '#13#10'      Da' +
      'ta0001.CURR_CODE'#13#10'FROM Data0103 Data0103_1 LEFT OUTER JOIN'#13#10'    ' +
      '  Data0103 Data0103_2 ON '#13#10'      Data0103_1.PARENT_PTR = Data010' +
      '3_2.RKEY RIGHT OUTER JOIN'#13#10'      Data0103 Data0103_3 INNER JOIN'#13 +
      #10'      Data0106 ON Data0103_3.RKEY = Data0106.GL_ACCT_NO_PTR INN' +
      'ER JOIN'#13#10'      Data0001 ON Data0106.CURR_PTR = Data0001.RKEY ON ' +
      #13#10'      Data0103_1.RKEY = Data0103_3.PARENT_PTR'#13#10'WHERE (Data0106' +
      '.GL_HEADER_PTR =:rkey)'#13#10
