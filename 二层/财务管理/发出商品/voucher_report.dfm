object Form_voucherreport: TForm_voucherreport
  ...
  object AQD106: TADODataSet
    ...
    CommandText = 
      ...
      'MBER AS '#38468#21152#21442#32771','#13#10' dbo.Data0106.D_C, dbo.Data0106.AMOUNT, '#13#10'ROUND(1' +
      ' / dbo.Data0106.EXCH_RATE, 8) AS exch_rate, '#13#10'Data0001.CURR_CODE' +
      ' as '#36135#24065#20195#30721', data0106.price as '#21407#24065#37329#39069','#13#10'Data0001.CURR_NAME AS '#36135#24065#21517#31216', '#13 +
      #10'dbo.Data0103.GL_ACC_NUMBER AS '#31185#30446#20195#30721', '#13#10'(CASE WHEN data0103_3.GL_' +
      'DESCRIPTION IS NOT NULL '#13#10'                      THEN data0103_3.' +
      'GL_DESCRIPTION + '#39'-'#39' + data0103_2.GL_DESCRIPTION + '#39'-'#39' + data010' +
      '3_1.GL_DESCRIPTION + '#39'-'#39' + '#39'-'#39' + data0103.GL_DESCRIPTION ELSE CA' +
      'SE WHEN'#13#10'                       data0103_2.GL_DESCRIPTION IS NOT' +
      ' NULL '#13#10'                      THEN data0103_2.GL_DESCRIPTION + '#39 +
      '-'#39' + '#39'-'#39' + data0103_1.GL_DESCRIPTION + '#39'-'#39' + data0103.GL_DESCRIP' +
      'TION ELSE CASE WHEN data0103_1.GL_DESCRIPTION IS NOT'#13#10'          ' +
      '             NULL THEN data0103_1.GL_DESCRIPTION + '#39'-'#39' + data010' +
      '3.GL_DESCRIPTION ELSE data0103.GL_DESCRIPTION END END END) AS '#31185#30446 +
      #21517#31216#13#10'FROM         dbo.Data0106 INNER JOIN'#13#10'                      ' +
      'dbo.Data0103 ON dbo.Data0106.GL_ACCT_NO_PTR = dbo.Data0103.RKEY ' +
      'INNER JOIN'#13#10'                      dbo.Data0001 ON dbo.Data0106.C' +
      'URR_PTR = dbo.Data0001.RKEY LEFT OUTER JOIN'#13#10'                   ' +
      '   dbo.Data0103 AS Data0103_1 ON dbo.Data0103.PARENT_PTR = Data0' +
      '103_1.RKEY LEFT OUTER JOIN'#13#10'                      dbo.Data0103 A' +
      'S Data0103_2 LEFT OUTER JOIN'#13#10'                      dbo.Data0103' +
      ' AS data0103_3 ON Data0103_2.PARENT_PTR = data0103_3.RKEY ON Dat' +
      'a0103_1.PARENT_PTR = Data0103_2.RKEY'#13#10'where GL_HEADER_PTR =:rkey' +
      #13#10
    ...
    object AQD106DSDesigner7: TFloatField
