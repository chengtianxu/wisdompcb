...
procedure TForm_Acct.Enter(PickType: byte);
var
  sqlstr:string;
begin
  if PickType = 1 then  //借方
    sqlstr := ' and Data0103.db_cr='+QuotedStr('D')
  else                        //贷方
    sqlstr := ' and Data0103.db_cr='+QuotedStr('C');
