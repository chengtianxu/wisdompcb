  ...
  object Aq107: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      dbo.Data0107.EX_RATE, '
        ...
        '       * dbo.Data0107.EX_RATE, 2) AS mature_bamt,data0107.GLPTR_' +
        'STATUS'
      'FROM dbo.Data0023 INNER JOIN'
        ...
        'RKEY'
      'WHERE (Data0107.STATUS = 1) AND'
      '      (Data0107.DUE_DATE < GETDATE()) and'
      
        '      (Data0107.INV_TOTAL - Data0107.AMT_PAID - Data0107.CASH_DI' +
        'SC >0)'
