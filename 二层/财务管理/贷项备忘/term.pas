...
begin
 ...
 0:
  sgrid1.Cells[2,sgrid_row]:='and Data0116.MEMO_NUMBER LIKE ''%'+edit3.Text+'%''';
 1:
  begin
    case  combobox1.ItemIndex of
    0:sgrid1.Cells[2,sgrid_row]:='and data0116.memo_tp=1';
    1:sgrid1.Cells[2,sgrid_row]:='and data0116.memo_tp=4';
    2:sgrid1.Cells[2,sgrid_row]:='and data0116.memo_tp=3';
   end;
...
//   sgrid1.Cells[2,sgrid_row]:='and Data0116.memo_status ='+inttostr(combobox2.ItemIndex+1);
//   sgrid1.Cells[1,sgrid_row]:=combobox2.Text;
  end;
 6:
  sgrid1.Cells[2,sgrid_row]:='and Data0116.warehouse_ptr = '+inttostr(Edit3.Tag);
 end;
...
begin
 ...
 case listbox3.ItemIndex of
 0:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0116.MEMO_NUMBER LIKE ''%'+edit3.Text+'%''';
 1:
  begin
    case  combobox1.ItemIndex of
    0:sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0116.memo_tp=1';
    1:sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0116.memo_tp=4';
    2:sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0116.memo_tp=3';
   end;
 ...
 5:
  begin
    ...
    sgrid1.Cells[2,sgrid1.RowCount-1]:=' and Data0116.memo_status in (' + s1 + ')';
//   sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0116.memo_status ='+inttostr(combobox2.ItemIndex+1);
//   sgrid1.Cells[1,sgrid1.RowCount-1]:=combobox2.Text;
  end;
 6:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0116.warehouse_ptr = '+inttostr(Edit3.Tag);
 end;
...
if radiogroup1.ItemIndex=0 then
 label4.Caption:='备忘日期从:'
else
 label4.Caption:='出货日期从:'
end;
