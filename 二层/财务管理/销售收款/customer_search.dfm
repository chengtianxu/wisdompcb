object Form_Customer: TForm_Customer
  ...
  object ADOQuery1: TADODataSet
    ...
    CommandText = 
      ...
      '_NAME, base_to_other,'#13#10'NET_PAY, ACC_REC_PTR,CURRENCY_PTR,data001' +
      '0.FED_TAX_ID_NO,'#13#10'abbr_name'#13#10'from data0010 inner join data0001'#13#10 +
      'on CURRENCY_PTR=data0001.rkey'#13#10
