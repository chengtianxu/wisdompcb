object Form3: TForm3
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object DBGrd: TDBGridEh
        ...
        Width = 685
        Height = 171
        Hint = 'ctrl+del'#21024#38500#35760#24405#13#10'Insert  '#25554#20837#35760#24405
        Align = alBottom
        DataSource = DS152
        ...
        TitleFont.Style = []
        OnColExit = DBGrdColExit
        OnEditButtonClick = DBGrdEditButtonClick
        OnExit = DBGrdExit
        OnKeyDown = DBGrdKeyDown
        OnKeyPress = DBGrdKeyPress
        Columns = <
          item
      ...
      object DBCheckBox1: TDBCheckBox
        ...
        Width = 113
        Height = 17
        Caption = #21516#27493#29983#25104#20973#35777
        DataField = 'IF_VOUCHER'
        DataSource = DM.DataSource2
        TabOrder = 15
        ValueChecked = 'True'
  ...
  object CDS152: TClientDataSet
    Aggregates = <>
    Params = <>
    Left = 156
    Top = 408
    object CDS152srce_ptr: TIntegerField
      FieldName = 'srce_ptr'
    end
    object CDS152po_number: TStringField
      DisplayWidth = 32
      FieldName = 'po_number'
      Size = 25
    end
    object CDS152manu_part_number: TStringField
      FieldName = 'manu_part_number'
    end
    object CDS152amount: TFloatField
      FieldName = 'amount'
    end
    object CDS152all_shipqty: TIntegerField
      FieldName = 'all_shipqty'
    end
  end
  ...
  object ADO152: TADODataSet
    ...
    CursorType = ctStatic
    LockType = ltReadOnly
    AfterOpen = ADO152AfterOpen
    CommandText = 
      'select srce_ptr,po_number,manu_part_number,amount,all_shipqty fr' +
      'om data0152 where srce_ptr=:rkey114'
    Parameters = <
      item
        Name = 'rkey114'
        Attributes = [paSigned]
    ...
    Left = 44
    Top = 408
    object ADO152srce_ptr: TIntegerField
      FieldName = 'srce_ptr'
    end
    ...
    object ADO152amount: TFloatField
      FieldName = 'amount'
    end
