...
begin
 ...
 0:
  sgrid1.Cells[2,sgrid_row]:='and Data0112.invoice_number LIKE ''%'+edit3.Text+'%''';
 1:
  sgrid1.Cells[2,sgrid_row]:='and data0010.cust_code LIKE ''%'+edit3.Text+'%''';
 2:
  begin
  sgrid1.Cells[2,sgrid_row]:='and data0112.invoice_type='+inttostr(combobox1.ItemIndex+1);
  sgrid1.Cells[1,sgrid_row]:=combobox1.Text;
  end;
 3:
  sgrid1.Cells[2,sgrid_row]:='and Data0105.VOUCHER like ''%'+edit3.Text+'%''';
 4:
  sgrid1.Cells[2,sgrid1.Row]:='and Data0112.warehouse_ptr = '+inttostr(Edit3.Tag);
 end;
...
begin
 ...
 case listbox3.ItemIndex of
 0:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0112.invoice_number LIKE ''%'+edit3.Text+'%''';
 1:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0010.cust_code LIKE ''%'+edit3.Text+'%''';
 2:
  begin
   sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0112.invoice_type='+inttostr(combobox1.ItemIndex+1);
   sgrid1.Cells[1,sgrid1.RowCount-1]:=combobox1.Text;
  end;
 3:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0105.VOUCHER like ''%'+edit3.Text+'%''';
 4:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0112.warehouse_ptr = '+inttostr(Edit3.Tag);
 5:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0112.INVOICE_STATUS = '+inttostr(combobox2.ItemIndex+1);
 end;
...
begin
Label4.Caption:=RadioGroup1.Items.Strings[RadioGroup1.ItemIndex];
end;
