object DM: TDM
  ...
  object AqD112: TADODataSet
    ...
    CommandText = 
      ...
      'CODE, '#13#10'      dbo.Data0010.ABBR_NAME, dbo.Data0001.CURR_NAME, da' +
      'ta0010.REG_TAX_FIXED_UNUSED,data0010.FED_TAX_ID_NO,'#13#10'      dbo.D' +
      'ata0112.EXCHANGE_RATE, dbo.Data0105.VOUCHER, '#13#10'      dbo.Data000' +
      '5.EMPLOYEE_NAME,Data0105.STATUS,  data0015.WAREHOUSE_CODE,'#13#10'    ' +
      '  data0112.amount_paid+data0112. CASH_DISC as '#24050#20184#37329#39069','#13#10'      case ' +
      '  data0112.INVOICE_STATUS'#13#10'      when 1 then '#39#26377#25928#30340#39' when 2 then '#39 +
      #24050#20184#27454#39' when 3 then '#39#24050#21462#28040#39#13#10'     end as '#21457#31080#29366#24577',  data0010.ACC_REC_PTR,' +
      'data0112.invoice_type,'#13#10'      round(Data0112.INVOICE_TOTAL*Data0' +
      '112.EXCHANGE_RATE,2) as total_amount,'#13#10'      data0105.rkey as rk' +
      'ey105, data0112.POSTED_DATE,data0112.GLPTR_STATUS'#13#10'FROM dbo.Data' +
      '0112 LEFT OUTER JOIN'#13#10'      dbo.Data0060 ON '#13#10'      dbo.Data0112' +
      '.sales_order_ptr = dbo.Data0060.RKEY LEFT OUTER JOIN'#13#10'      dbo.' +
      'Data0105 ON dbo.Data0105.SOURCE_PTR = dbo.Data0112.RKEY AND '#13#10'  ' +
      '    dbo.Data0105.TRANS_TYPE = 5 INNER JOIN'#13#10'      dbo.Data0010 O' +
      'N dbo.Data0112.CUSTOMER_PTR = dbo.Data0010.RKEY INNER JOIN'#13#10'    ' +
      '  dbo.Data0001 ON dbo.Data0112.CURRENCY_PTR = dbo.Data0001.RKEY ' +
      'INNER JOIN'#13#10'      dbo.Data0005 ON dbo.Data0112.EMPL_PTR = dbo.Da' +
      'ta0005.RKEY left outer join '#13#10'      data0015 on data0112.warehou' +
      'se_ptr = data0015.rkey'#13#10'WHERE '#13#10'               (data0112.POSTED_' +
      'DATE  >= :dtpk1) and'#13#10'               (data0112.POSTED_DATE  <= :' +
      'dtpk2)'
    ...
    object AqD112REG_TAX_FIXED_UNUSED: TStringField
      DisplayLabel = #26376#32467#26041#27861
      FieldName = 'REG_TAX_FIXED_UNUSED'
      FixedChar = True
      Size = 1
    end
    object AqD112FED_TAX_ID_NO: TStringField
  ...
  object ADOD64: TADODataSet
    ...
    CommandText = 
      'SELECT Data0060.SALES_ORDER,'#13#10'     Data0025.MANU_PART_NUMBER, Da' +
      'ta0025.MANU_PART_DESC,  '#13#10'      dbo.Data0064.QUAN_SHIPPED, dbo.D' +
      'ata0064.part_price, dbo.Data0064.TAX_2, '#13#10'      dbo.Data0097.PO_' +
      'NUMBER, dbo.Data0097.PO_DATE, dbo.Data0060.SCH_DATE, '#13#10'      dbo' +
      '.Data0064.ovsh_qty, dbo.Data0064.ovsh_discount, dbo.Data0064.dis' +
      'count, '#13#10'      dbo.Data0060.tax_in_price, dbo.Data0060.ENT_DATE,' +
      ' dbo.Data0064.SO_PTR, '#13#10'      dbo.Data0064.RKEY, dbo.Data0064.pa' +
      'cking_list_ptr'#13#10'FROM dbo.Data0060 INNER JOIN'#13#10'      dbo.Data0064' +
      ' ON dbo.Data0060.RKEY = dbo.Data0064.SO_PTR INNER JOIN'#13#10'      db' +
      'o.Data0025 ON dbo.Data0060.CUST_PART_PTR = dbo.Data0025.RKEY INN' +
      'ER JOIN'#13#10'      dbo.Data0097 ON '#13#10'      dbo.Data0060.PURCHASE_ORD' +
      'ER_PTR = dbo.Data0097.RKEY INNER JOIN'#13#10'      dbo.data0439 ON dbo' +
      '.Data0064.packing_list_ptr = dbo.data0439.rkey'#13#10'where data0439.i' +
      'nvoice_ptr=:rkey112'
    Parameters = <
      item
        Name = 'rkey112'
    ...
    object ADOD64part_price: TFloatField
      DisplayLabel = #20215#26684
      FieldName = 'part_price'
    end
    object ADOD64TAX_2: TBCDField
      DisplayLabel = #31246#29575'%'
      FieldName = 'TAX_2'
      Precision = 4
      Size = 2
    end
    object ADOD64PO_NUMBER: TStringField
      DisplayLabel = #23458#25143#35746#21333#21495
      FieldName = 'PO_NUMBER'
      Size = 25
    end
    object ADOD64PO_DATE: TDateTimeField
      DisplayLabel = #23458#25143#35746#21333#26085#26399
      FieldName = 'PO_DATE'
    end
    object ADOD64SCH_DATE: TDateTimeField
      DisplayLabel = #22238#22797#20132#26399
      FieldName = 'SCH_DATE'
    end
    object ADOD64QUAN_SHIPPED: TIntegerField
      DisplayLabel = #26631#20934#35013#36816#25968#37327' '
      FieldName = 'QUAN_SHIPPED'
    end
    object ADOD64ovsh_qty: TIntegerField
      DisplayLabel = #28322#35013#25968#37327
      FieldName = 'ovsh_qty'
    end
    object ADOD64ovsh_discount: TBCDField
      DisplayLabel = #28322#35013#25240#25187'%'
      FieldName = 'ovsh_discount'
      Precision = 5
      Size = 2
    end
    object ADOD64discount: TBCDField
    ...
    object ADOD64ENT_DATE: TDateTimeField
    ...
    object ADOD64packing_list_ptr: TIntegerField
      FieldName = 'packing_list_ptr'
    end
    object ADOD64MANU_PART_NUMBER: TStringField
      FieldName = 'MANU_PART_NUMBER'
    end
    object ADOD64MANU_PART_DESC: TStringField
