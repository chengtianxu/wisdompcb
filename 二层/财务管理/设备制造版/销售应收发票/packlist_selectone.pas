...
type
  TForm_selectpk = class(TForm)
    ...
    aqd439sales_order: TStringField;
    aqd439sales_date: TDateTimeField;
    aqd439ship_method: TStringField;
    aqd439REG_TAX_FIXED_UNUSED: TStringField;
    aqd439EDI_FLAG_CREDIT_MEMO: TSmallintField;
    aqd439FED_TAX_ID_NO: TStringField;
    aqd64price: TBCDField;
    aqd64tax_rate: TBCDField;
    aqd64quantity: TBCDField;
    aqd64tax_in_price: TStringField;
    aqd64PROD_CODE: TStringField;
    aqd64PRODUCT_NAME: TStringField;
    aqd64PRODUCT_DESC: TStringField;
    aqd64so_ptr: TIntegerField;
