...
type
  TDM = class(TDataModule)
    ...
    ADOD64price: TBCDField;
    ADOD64tax_rate: TBCDField;
    ADOD64sales_date: TDateTimeField;
    ADOD64quantity: TBCDField;
    ADOD64so_ptr: TIntegerField;
    ADOD64PROD_CODE: TStringField;
    ADOD64PRODUCT_NAME: TStringField;
    ADOD64PRODUCT_DESC: TStringField;
