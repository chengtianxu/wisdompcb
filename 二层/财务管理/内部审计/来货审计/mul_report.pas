...
for i:=1 to dm.aqwz456.RecordCount do
 begin
  stg1.Cells[0,i]:=dm.aqwz456GRN_NUMBER.Value;
  stg1.Cells[1,i]:=dm.aqwz456ABBR_NAME.Value;
  stg1.Cells[2,i]:=dm.aqwz456rkey.AsString;
...
begin
rkey456:=dm.Aqwz456rkey.Value;
stg2.RowCount:=dm.Aqwz456.RecordCount+2;
...
for i:=1 to dm.Aqwz456.RecordCount do
 begin
  stg2.Cells[0,i]:=dm.Aqwz456GRN_NUMBER.Value;
  stg2.Cells[1,i]:=dm.Aqwz456ABBR_NAME.Value;
  stg2.Cells[2,i]:=dm.Aqwz456rkey.AsString;
