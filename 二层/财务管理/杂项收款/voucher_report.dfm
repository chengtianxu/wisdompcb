object Form_voucherreport: TForm_voucherreport
  ...
  object AQD105: TADODataSet
    ...
    CommandText = 
      ...
      ' '#39#20986#32435#24050#23457#39' when 5 then '#39#34987#20316#24223#39' '#13#10'     end as '#20973#35777#29366#24577#13#10'FROM dbo.Data0105 ' +
      'INNER JOIN'#13#10'      dbo.Data0005 ON '#13#10'      dbo.Data0105.ENTERED_B' +
      'Y_EMPL_PTR = dbo.Data0005.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data00' +
      '05 Data0005_4 ON '#13#10'      dbo.Data0105.POSTED_BY_EMPL_PTR = Data0' +
      '005_4.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_3 ON '#13#10' ' +
      '     dbo.Data0105.supervisor_ptr = Data0005_3.RKEY LEFT OUTER JO' +
      'IN'#13#10'      dbo.Data0005 Data0005_2 ON '#13#10'      dbo.Data0105.AUDITE' +
      'D_BY_EMPL_PTR = Data0005_2.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0' +
      '005 Data0005_1 ON dbo.Data0105.casher_ptr = Data0005_1.RKEY'#13#10'whe' +
      're data0105.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
