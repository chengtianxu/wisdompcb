...
type
  TDM = class(TDataModule)
    ...
    ADS105REVERSE_TRANS_FLAG: TStringField;
    ADOQuery3: TADOQuery;
    DataSource3: TDataSource;
    ADOQuery3GLPTR_STATUS: TBooleanField;
    ...
    ADOQuery3delivery_no: TStringField;
    ADOQuery3date_sailing: TDateTimeField;
    ADOQuery3QUAN_SHIPPED: TIntegerField;
    ADOQuery3PARTS_ALLOC: TFloatField;
    ADOQuery3cust_decl: TStringField;
    ADOQuery3TAX_2: TBCDField;
    ADOQuery3invoice_number: TStringField;
    ADOQuery3SHIPMENT_NO: TSmallintField;
    ADOQuery3ovsh_qty: TIntegerField;
    ADOQuery3alloc_qty: TIntegerField;
    ADOQuery3ABBR_NAME: TStringField;
    ADOQuery3CUST_CODE: TStringField;
    ADOQuery3Expr1: TStringField;
    ADOQuery3CURR_CODE: TStringField;
    ADOQuery3RKEY: TAutoIncField;
    procedure ADOQuery3GLPTR_STATUSChange(Sender: TField);
  private
...
procedure TDM.ADOQuery3GLPTR_STATUSChange(Sender: TField);
begin
  if self.ADOQuery3GLPTR_STATUS.Value=true then
   self.ADOQuery3ovsh_qty.Value:=self.ADOQuery3QUAN_SHIPPED.Value
  else
   self.ADOQuery3ovsh_qty.Value:=0;
end;
