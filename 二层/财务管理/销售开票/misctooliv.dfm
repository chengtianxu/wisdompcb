object Form_misctooliv: TForm_misctooliv
  ...
  object ads112: TADODataSet
    ...
    CommandText = 
      ...
      #31867#22411','#13#10' INVOICE_TYPE,ship_amount,'#13#10'FED_TAX_AMOUNT,'#39#21457#31080#39' as ttype,RU' +
      'SH_CHARGE_AMOUNT,'#13#10'INVOICE_TOTAL-RUSH_CHARGE_AMOUNT as all_amoun' +
      't, POSTED_DATE,'#13#10'data0015.abbr_name'#13#10'FROM         dbo.Data0112 l' +
      'eft outer join data0015'#13#10'on data0112.warehouse_ptr=data0015.rkey' +
      #13#10'WHERE  (INVOICE_STATUS = 1) AND (GLPTR_STATUS = 0)'#13#10
    ...
    object ads112RUSH_CHARGE_AMOUNT: TBCDField
      DisplayLabel = #24050#24320#31080#37329#39069
      FieldName = 'RUSH_CHARGE_AMOUNT'
      Precision = 19
    end
