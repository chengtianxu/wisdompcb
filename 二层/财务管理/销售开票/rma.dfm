object Form_rma: TForm_rma
  ...
  object ads98: TADODataSet
    ...
    CommandText = 
      ...
      'ER, dbo.Data0025.MANU_PART_DESC, dbo.Data0097.PO_NUMBER, dbo.Dat' +
      'a0098.RMA_NUMBER, '#13#10'dbo.Data0098.RMA_DATE, Data0098.QTY_RECD,Dat' +
      'a0098.QTY_CRED,'#13#10'dbo.Data0098.QTY_RECD - dbo.Data0098.QTY_CRED A' +
      'S alloc_qty, dbo.Data0060.PARTS_ALLOC,'#13#10' dbo.Data0098.tax_2 as R' +
      'USH_CHARGE, data0015.abbr_name, dbo.Data0098.RKEY, dbo.Data0116.' +
      'MEMO_NUMBER'#13#10',Data0025.ORIG_CUSTOMER,Data0025.LAYERS,Data0025.un' +
      'it_sq,Data0008.PRODUCT_NAME'#13#10'FROM         dbo.Data0098 INNER JOI' +
      'N'#13#10'                      dbo.Data0060 ON dbo.Data0098.SO_PTR = d' +
      'bo.Data0060.RKEY INNER JOIN'#13#10'                      dbo.Data0116 ' +
      'ON dbo.Data0098.srce_ptr = dbo.Data0116.RKEY INNER JOIN'#13#10'       ' +
      '               dbo.Data0025 ON dbo.Data0098.CUSTOMER_PART_PTR = ' +
      'dbo.Data0025.RKEY INNER JOIN'#13#10'                      dbo.Data0097' +
      ' ON dbo.Data0060.PURCHASE_ORDER_PTR = dbo.Data0097.RKEY left out' +
      'er join '#13#10'data0015 on data0116.warehouse_ptr=data0015.rkey'#13#10'left' +
      ' join data0008 on data0008.rkey=data0025.PROD_CODE_PTR'#13#10'where (D' +
      'ata0098.QTY_RECD - Data0098.QTY_CRED>0) and (Data0098.GLPTR_STAT' +
      'US = 0)'
    ...
    Left = 104
    Top = 264
    object ads98SALES_ORDER: TStringField
      DisplayLabel = #38144#21806#35746#21333
      FieldName = 'SALES_ORDER'
      FixedChar = True
      Size = 12
    end
    object ads98MANU_PART_NUMBER: TStringField
      DisplayLabel = #26412#21378#32534#21495
      FieldName = 'MANU_PART_NUMBER'
    end
    object ads98MANU_PART_DESC: TStringField
      DisplayLabel = #23458#25143#22411#21495
      FieldName = 'MANU_PART_DESC'
      Size = 80
    end
    object ads98PO_NUMBER: TStringField
      DisplayLabel = #23458#25143#35746#21333#21495
      FieldName = 'PO_NUMBER'
      Size = 25
    end
    object ads98RMA_NUMBER: TStringField
      DisplayLabel = #36864#36135#21333#21495
      FieldName = 'RMA_NUMBER'
      FixedChar = True
      Size = 10
    end
    object ads98RMA_DATE: TDateTimeField
      DisplayLabel = #36864#36135#26085#26399
      FieldName = 'RMA_DATE'
    end
    object ads98alloc_qty: TIntegerField
      DisplayLabel = #21487#24320#31080#25968#37327
      FieldName = 'alloc_qty'
      ReadOnly = True
    end
    object ads98PARTS_ALLOC: TFloatField
      DisplayLabel = #20215#26684
      FieldName = 'PARTS_ALLOC'
    end
    object ads98RUSH_CHARGE: TBCDField
      DisplayLabel = #31246#29575
      FieldName = 'RUSH_CHARGE'
      Precision = 5
      Size = 2
    end
    object ads98RKEY: TIntegerField
      DisplayLabel = #26631#35782#21015
      FieldName = 'RKEY'
      ReadOnly = True
    end
    object ads98MEMO_NUMBER: TStringField
      DisplayLabel = #36151#39033#22791#24536
      FieldName = 'MEMO_NUMBER'
      Size = 10
    end
    object ads98QTY_RECD: TIntegerField
      DisplayLabel = #36864#36135#25968#37327
      FieldName = 'QTY_RECD'
    end
    object ads98QTY_CRED: TIntegerField
      DisplayLabel = #24050#24320#31080#25968#37327
      FieldName = 'QTY_CRED'
    end
    object ads98abbr_name: TStringField
      DisplayLabel = #24037#21378#31616#31216
      FieldName = 'abbr_name'
      Size = 10
    end
    object ads98ORIG_CUSTOMER: TStringField
      FieldName = 'ORIG_CUSTOMER'
      Size = 10
    end
    object ads98LAYERS: TWordField
      FieldName = 'LAYERS'
    end
    object ads98unit_sq: TFloatField
      FieldName = 'unit_sq'
    end
    object ads98PRODUCT_NAME: TStringField
      FieldName = 'PRODUCT_NAME'
      Size = 30
    end
  end
