object DM: TDM
  ...
  object ADS105: TADODataSet
    ...
    CommandText = 
      ...
      '       Data0105.SUPP_PTR, dbo.Data0105.CURRENCY_PTR, '#13#10'dbo.Data0' +
      '105.EXCHANGE_RATE, dbo.Data0023.ABBR_NAME, dbo.Data0023.CODE, '#13#10 +
      '                      dbo.Data0023.SUPPLIER_NAME, '#13#10'            ' +
      '          CASE data0105.STATUS WHEN 0 THEN '#39#26410#23457#26680#39' WHEN 1 THEN '#39#20250#35745 +
      #24050#23457#39' '#13#10'WHEN 2 THEN '#39#20027#31649#24050#23457#39' WHEN 3 THEN '#39#24050#30331#24080#39' WHEN 4 THEN '#39#20986#32435#24050#23457#39' WH' +
      'EN 5 THEN'#13#10'                       '#39#34987#20316#24223#39' END AS v_status, dbo.Dat' +
      'a0001.CURR_CODE, dbo.Data0001.CURR_NAME'#13#10'FROM         dbo.Data01' +
      '05 INNER JOIN'#13#10'                      dbo.Data0005 ON dbo.Data010' +
      '5.ENTERED_BY_EMPL_PTR = dbo.Data0005.RKEY INNER JOIN'#13#10'          ' +
      '            dbo.Data0023 ON dbo.Data0105.SUPP_PTR = dbo.Data0023' +
      '.RKEY LEFT OUTER JOIN'#13#10'                      dbo.Data0001 ON dbo' +
      '.Data0105.CURRENCY_PTR = dbo.Data0001.RKEY'#13#10'WHERE     (dbo.Data0' +
      '105.TRANS_TYPE = 12)'#13#10'and DATA0105.entered_dt>=:vdate1'#13#10'and DATA' +
      '0105.entered_dt<=:vdate2'#13#10'and data0105.STATUS<>:vStaus0'#13#10'and dat' +
      'a0105.STATUS<>:vStaus1'#13#10'and data0105.STATUS<>:vStaus2'#13#10'and data0' +
      '105.STATUS<>:vStaus3'#13#10'and  data0105.STATUS<>:vStaus4'#13#10'and  data0' +
      '105.STATUS<>:vStaus5'#13#10
    EnableBCD = False
    ...
    object ADS105CODE: TStringField
      DisplayLabel = #20379#24212#21830#20195#30721
      FieldName = 'CODE'
      Size = 10
    end
    object ADS105SUPPLIER_NAME: TStringField
      DisplayLabel = #20379#24212#21830#21517#31216
      FieldName = 'SUPPLIER_NAME'
      Size = 100
    end
    object ADS105SUPP_PTR: TIntegerField
      FieldName = 'SUPP_PTR'
    end
  end
  object ads106: TADODataSet
    ...
    CommandText = 
      ...
      '106.price,'#13#10' (CASE WHEN data0103_4.GL_DESCRIPTION IS NOT NULL '#13#10 +
      '                      THEN data0103_4.GL_DESCRIPTION + '#39'-'#39' + dat' +
      'a0103_3.GL_DESCRIPTION + '#39'-'#39' + data0103_2.GL_DESCRIPTION + '#39'-'#39' +' +
      ' data0103_1.GL_DESCRIPTION + '#39'-'#39' + data0103.GL_DESCRIPTION'#13#10'    ' +
      '                   ELSE CASE WHEN data0103_3.GL_DESCRIPTION IS N' +
      'OT NULL '#13#10'                      THEN data0103_3.GL_DESCRIPTION +' +
      ' '#39'-'#39' + data0103_2.GL_DESCRIPTION + '#39'-'#39' + data0103_1.GL_DESCRIPTI' +
      'ON + '#39'-'#39' + data0103.GL_DESCRIPTION ELSE CASE WHEN data0103_2.GL_' +
      'DESCRIPTION'#13#10'                       IS NOT NULL '#13#10'              ' +
      '        THEN data0103_2.GL_DESCRIPTION + '#39'-'#39' + data0103_1.GL_DES' +
      'CRIPTION + '#39'-'#39' + data0103.GL_DESCRIPTION ELSE CASE WHEN data0103' +
      '_1.GL_DESCRIPTION IS NOT'#13#10'                       NULL THEN data0' +
      '103_1.GL_DESCRIPTION + '#39'-'#39' + data0103.GL_DESCRIPTION ELSE data01' +
      '03.GL_DESCRIPTION END END END END) AS description_2'#13#10'FROM       ' +
      '  dbo.Data0103 AS Data0103_4 RIGHT OUTER JOIN'#13#10'                 ' +
      '     dbo.Data0103 AS Data0103_3 ON Data0103_4.RKEY = Data0103_3.' +
      'PARENT_PTR RIGHT OUTER JOIN'#13#10'                      dbo.Data0103 ' +
      'AS Data0103_2 ON Data0103_3.RKEY = Data0103_2.PARENT_PTR RIGHT O' +
      'UTER JOIN'#13#10'                      dbo.Data0103 AS Data0103_1 ON D' +
      'ata0103_2.RKEY = Data0103_1.PARENT_PTR RIGHT OUTER JOIN'#13#10'       ' +
      '               dbo.Data0103 ON Data0103_1.RKEY = dbo.Data0103.PA' +
      'RENT_PTR INNER JOIN'#13#10'                      dbo.Data0106 ON dbo.D' +
      'ata0103.RKEY = dbo.Data0106.GL_ACCT_NO_PTR INNER JOIN'#13#10'         ' +
      '             dbo.Data0001 ON dbo.Data0106.CURR_PTR = dbo.Data000' +
      '1.RKEY'#13#10'WHERE (dbo.Data0106.GL_HEADER_PTR =  :rkey)'#13#10
