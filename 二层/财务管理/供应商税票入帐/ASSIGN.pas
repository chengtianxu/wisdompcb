...
type
  TForm_ASSIGN = class(TForm)
    ...
    ads64INV_PART_NUMBER: TStringField;
    ads64INV_PART_DESCRIPTION: TStringField;
    ads64GRN_NUMBER: TStringField;
    ads64DELIVER_NUMBER: TStringField;
    ads64ship_DATE: TDateTimeField;
    ads64UNIT_NAME: TStringField;
    ads64tax_price: TBCDField;
    ads64TAX_2: TBCDField;
    ads64QUANTITY: TFloatField;
    ads64amount: TFloatField;
    ads64tax_amount: TFloatField;
    ads64cust_decl: TStringField;
    ads64INVOICE_NO: TStringField;
    ads64sType: TStringField;
...
procedure TForm_ASSIGN.DBGrid1DrawColumnCell(Sender: TObject;
  const Rect: TRect; DataCol: Integer; Column: TColumn;
  State: TGridDrawState);
begin
  if ads64sType.Value='1' then
