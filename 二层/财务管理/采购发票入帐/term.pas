...
uses curr_search, supplier_search, employee_search, warehouse_search;
...
begin
 ...
 0:
  sgrid1.Cells[2,sgrid_row]:='and Data0107.INVOICE_NO LIKE ''%'+edit3.Text+'%''';
 1:
 ...
 3:
  BEGIN
   sgrid1.Cells[2,sgrid_row]:='and data0107.INV_TP='''+inttostr(combobox1.ItemIndex)+'''';
...
begin
 ...
 case listbox3.ItemIndex of
 0:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0107.INVOICE_NO LIKE ''%'+edit3.Text+'%''';
 1:
 ...
 3:
  BEGIN
   sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0107.INV_TP='''+inttostr(combobox1.ItemIndex)+'''';
