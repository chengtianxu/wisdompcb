...
uses  damo, employee_search, customer_search, prod_search,
...
{ 5:
 ...
 8:
 begin
    sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0025.ORIG_CUSTOMER = ' + QuotedStr(Edit3.Text);
 end;
 9:
 begin
    sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0025.ANALYSIS_CODE_2 LIKE ''%'+edit3.Text+'%''';
 end;
...
try
 ...
 InputVar.Fields := 'WAREHOUSE_CODE/工厂代码/100,WAREHOUSE_NAME/工厂名称/277,ABBR_NAME/工厂简称/100';
...
7:
 ...
 begin
   frmPick_Item_Single := TfrmPick_Item_Single.Create(application);
   try
    InputVar.Fields:='CUST_CODE/客户代码/156,ABBR_NAME/简称/196';
