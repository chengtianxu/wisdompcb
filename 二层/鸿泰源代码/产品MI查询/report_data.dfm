object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      's '#21152#24037#25351#31034',Data0025.ENG_NOTE as '#24037#31243#22791#27880', data0025.barcode_flag,'#13#10'Data00' +
      '25.EST_SCRAP as '#25253#24223#29575' , Data0025.SHELF_LIFE as '#29983#20135#21608#26399', data0025.NOPB' +
      '_flag,'#13#10'      Data0025.REVIEW_DAYS as '#26377#25928#26399#22825#25968', Data0025.MFG_LEAD_T' +
      'IME as '#21046#36896#25552#21069#26399', '#13#10'      Data0025.ANALYSIS_CODE_3 as '#22823#26009#35268#26684', Data0025' +
      '.REPORT_UNIT_VALUE1 AS '#21333#21482#37325#37327'g, '#13#10'      dbo.Data0025.OPT_LOT_SIZE ' +
      'as '#27969#36716#25209#37327',data0025.QTY_BOM as '#21387#21512#27604#20363','#13#10'case Data0025.ONHOLD_SALES_FL' +
      'AG when 0 then '#39#26377#25928#39' when 1 then '#39#36807#26399#39' end as '#38144#21806#29366#24577', '#13#10'case Data002' +
      '5.TSTATUS'#13#10'   when 0 then '#39#24453#21046#20316#39' when 1 then '#39#24050#23457#26680#39' when 2 then '#39#23457 +
      #36864#22238#39' when 3 then '#39#24453#26816#26597#39#13#10'   when 4 then '#39#24453#23457#26680#39' when 5 then '#39#26816#36864#22238#39' wh' +
      'en 6 then '#39#26410#25552#20132#39' end as '#23457#25209#29366#24577','#13#10'case when ltrim(data0025.CURRENT_R' +
      'EV)='#39'Y'#39' then '#39#26080#21348#32032#39' else '#39#39' end as '#21348#32032#35201#27714','#13#10'case   Data0025.ttype  ' +
      'when 0 then '#39#37327#20135#39' when 1 then '#39#26679#26495#39'  end as '#37327#20135#26679#26495','#13#10'case Data0025.g' +
      'reen_flag when '#39'Y'#39' then '#39'4G'#26631#35782#39'  else '#39' '#39' end as '#26631#35782'4G,'#13#10'case when' +
      ' data0025.PARENT_PTR is null then '#39#22806#23618#39' ELSE '#39#20869#23618#39' end as  '#20135#21697#24615#36136','#13#10 +
      'data0025.flod_number as '#38075#23380#21472#26495#25968',data0025.ZDR_TYPE as '#38075#23380#21442#25968','#13#10'data00' +
      '25.layers_image as '#21387#21512#22270#29255',data0025.ORIG_CUSTOMER as '#20851#32852#21407#23458#25143',vcut_B,v' +
      'cut_T,vcut_X,gf_A,gf_L,gf_T '#13#10'FROM dbo.Data0008 INNER JOIN'#13#10'    ' +
      '  dbo.Data0025 ON '#13#10'      dbo.Data0008.RKEY = dbo.Data0025.PROD_' +
      'CODE_PTR INNER JOIN'#13#10'      dbo.Data0010 ON '#13#10'      dbo.Data0025.' +
      'CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data' +
      '0005 Data0005_3 ON '#13#10'      dbo.Data0025.CHECK_BY_PTR = Data0005_' +
      '3.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_2 ON '#13#10'     ' +
      ' dbo.Data0025.LAST_MODIFIED_BY_PTR = Data0005_2.RKEY LEFT OUTER ' +
      'JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Data0025.AUDITED_BY_P' +
      'TR = Data0005_1.RKEY'#13#10'where data0025.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
  ...
  object ads29: TADODataSet
    ...
    CommandText = 
      ...
      '029'#13#10'where  flow_no=0  and source_ptr=:rkey'#13#10'ORDER BY SEQ_NO'
    DataSource = DataSource1
    MasterFields = 'rkey'
    Parameters = <
      item
  ...
  object ds1: TADODataSet
    ...
    CommandText = 
      ...
      'CS'#23380#25968','#13#10' PANEL_A as A'#26495#23380#25968', PANEL_B AS B'#26495#23380#25968', '#13#10'REMARK as '#22791#27880',SET_UNM' +
      'BER AS SE'#23380#25968','#13#10'mo_number as '#30952#27425',drill_number as '#25968#37327#13#10'FROM dbo.Data0' +
      '029'#13#10'where  flow_no>=1  and source_ptr=:rkey'#13#10'ORDER BY flow_no,S' +
      'EQ_NO'
    DataSource = DataSource1
    MasterFields = 'rkey'
    Parameters = <
