object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      #32032#39' else '#39#21348#32032#39' end as '#21348#32032#35201#27714#13#10'FROM dbo.Data0008 INNER JOIN'#13#10'      db' +
  ...
  object ppReport1: TppReport
    ...
    SaveAsTemplate = True
    Template.FileName = 'R:\NIERP\Report\Manu_workorder_sig.rtm'
    Units = utMillimeters
    CachePages = True
    DeviceType = 'Screen'
    ...
    TextFileName = 'R:\NIERP\Report\Manu_workorder_sig.rtm'
  ...
  object ads06: TADODataSet
    ...
    CommandText = 
      ...
      'ode_3 as '#25237#20135#22823#26009#35268#26684','#13#10'     data0034.dept_code,data0034.dept_name'#13#10'FR' +
      'OM         dbo.Data0015 INNER JOIN'#13#10'       dbo.Data0006 INNER JO' +
      'IN'#13#10'       dbo.data0492 ON dbo.Data0006.CUT_NO = dbo.data0492.CU' +
      'T_NO INNER JOIN'#13#10'       dbo.Data0005 ON dbo.data0492.CREATED_BY_' +
      'PTR = dbo.Data0005.RKEY ON '#13#10'       dbo.Data0015.RKEY = dbo.data' +
      '0492.WHOUSE_PTR LEFT OUTER JOIN'#13#10'       dbo.Data0097 RIGHT OUTER' +
      ' JOIN'#13#10'       dbo.Data0060 ON dbo.Data0097.RKEY = dbo.Data0060.P' +
      'URCHASE_ORDER_PTR '#13#10'       ON dbo.data0492.SO_NO = dbo.Data0060.' +
      'SALES_ORDER '#13#10'       inner join data0056 on data0006.rkey=data00' +
      '56.wo_ptr inner join data0034 on data0056.dept_ptr=data0034.rkey' +
      #13#10'WHERE Data0006.rkey  =:rkey06'
    Parameters = <
      item
        Name = 'rkey06'
        Attributes = [paSigned]
