object DM: TDM
  ...
  object AQY0025: TADOQuery
    ...
    SQL.Strings = (
        ...
        'arcode_flag,'
      '     REACH,layers_image,flod_number,ZDR_TYPE,CustFileName,'
      
        '     quality_status,quality_user,quality_date,grade_code,ORIG_CU' +
        'STOMER,CPJS,'
      'vcut_B, vcut_T,vcut_X,gf_A,gf_T,gf_L'
      'FROM dbo.Data0025'
      'where rkey=:rkey')
    Left = 89
    Top = 136
  ...
  object ads494: TADODataSet
    ...
    CommandText = 
      #13#10'SELECT D494.PARAMETER_PTR,D494.PARAMETER_VALUE,D494.custpart_p' +
      'tr,d278.PARAMETER_Name as Parameter_Readonly,d278.PARAMETER_DESC' +
      ' AS Parameter_DESC_ReadOnly,D494.step_number,D494.seq_no, D494.D' +
      'oc_Flag, D494.after_flag, '#13#10'D494.flow_spfc_flag,D494.outp_spfc_f' +
      'lag, d38.dept_ptr FROM Data0494 D494'#13#10'inner join data0038 D38 on' +
      ' D494.custpart_ptr = d38.SOURCE_PTR and d494.step_number = d38.s' +
      'tep_number'#13#10'inner join data0278 d278 on d278.rkey = d494.PARAMET' +
      'ER_PTR'#13#10'where custpart_ptr = :SOURCE_PTR'
  ...
  object ado607: TADOQuery
    ...
    SQL.Strings = (
        ...
        'select TDATEtime,data0025.MANU_PART_NUMBER,data0607.ttype,data00' +
        '05.EMPLOYEE_NAME,'
      
        'case when data0607.ONHOLD_PLANNING_FLAG=1 then '#39#26159#39' else '#39#21542#39' end ' +
        'as tc,'
      
        'case when data0607.ONHOLD_RELEASE_FLAG=1 then '#39#26159#39' else '#39#21542#39' end a' +
        's gd,'
      
        'case when data0607.EDIT_FLAG=1 then '#39#26159#39' else '#39#21542#39' end as pj,data0' +
        '607.NOTE_INFO'
      ' from Data0607'
      ' inner  join Data0005 on data0005.RKEY =data0607.EMPL_PTR'
      ' inner join Data0025 on data0025.RKEY =data0607.cust_ptr'
      ' where data0607.cust_ptr=:rkey')
    Left = 496
    Top = 160
    object ado607TDATEtime: TDateTimeField
      FieldName = 'TDATEtime'
    end
    object ado607MANU_PART_NUMBER: TStringField
      FieldName = 'MANU_PART_NUMBER'
    end
    object ado607ttype: TStringField
      FieldName = 'ttype'
      Size = 8
    end
    object ado607EMPLOYEE_NAME: TStringField
      FieldName = 'EMPLOYEE_NAME'
      Size = 16
    end
    object ado607tc: TStringField
      FieldName = 'tc'
      ReadOnly = True
      Size = 2
    end
    object ado607gd: TStringField
      FieldName = 'gd'
      ReadOnly = True
      Size = 2
    end
    object ado607pj: TStringField
      FieldName = 'pj'
      ReadOnly = True
      Size = 2
    end
    object ado607NOTE_INFO: TStringField
      FieldName = 'NOTE_INFO'
      Size = 150
    end
  end
