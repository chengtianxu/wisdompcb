...
begin
     ...
     begin
        ...
        Form2.StringGrid1.RowCount:=inputform.StringGrid1.RowCount+1;
        inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount-1;
        for i:=1 to StringGrid1.RowCount-1 do
        begin
          Form2.StringGrid1.Cols[2].Clear;//鸿泰
          Form2.StringGrid1.Rows[i].Clear;
          Form2.StringGrid1.Rows[i].Assign(StringGrid1.Rows[i]);
        end;

        inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount+1;
        Form2.StringGrid1.Cols[2].Text:='字符'; //鸿泰
        inputform.Close;
     end;
...
begin
     if Form2.StringGrid1.RowCount<>inputform.StringGrid1.RowCount then
        MessageDlg('不是同一个料号的钻带',  mtConfirmation, [mbOK], 0)
     else
        begin
          Form2.StringGrid1.Cols[9].Assign(StringGrid1.Cols[9]);
          inputform.Close;
        end;
...
begin
     if Form2.StringGrid1.RowCount<>inputform.StringGrid1.RowCount then
        ...
        begin
          Form2.StringGrid1.Cols[10].Assign(StringGrid1.Cols[10]);
          inputform.Close;
        end;
end;
...
var
  i,j:Integer;
begin
    j:=Form2.StringGrid1.RowCount-2;
    inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount-1;
    //j:=inputform.StringGrid1.RowCount;
    Form2.StringGrid1.RowCount:=Form2.StringGrid1.RowCount+inputform.StringGrid1.RowCount-1;
    for i:=1 to StringGrid1.RowCount-1 do
    begin
      Form2.StringGrid1.Rows[i+j].Assign(StringGrid1.Rows[i]);
    end;
    inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount+1;
...
begin
     ...
     begin
        ...
        Form2.strngrd1.RowCount:=inputform.StringGrid1.RowCount+1;
        inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount-1;
        for i:=1 to StringGrid1.RowCount-1 do
        begin
          Form2.strngrd1.Cols[2].Clear;//鸿泰
          Form2.strngrd1.Rows[i].Clear;
          Form2.strngrd1.Rows[i].Assign(StringGrid1.Rows[i]);
        end;

        inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount+1;
        Form2.strngrd1.Cols[2].Text:='字符'; //鸿泰
        inputform.Close;
     end;

end;

procedure Tinputform.N8Click(Sender: TObject);
var
  i:Integer;
begin
     ...
     begin
        ...
        Form2.strngrd2.RowCount:=inputform.StringGrid1.RowCount+1;
        inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount-1;
        for i:=1 to StringGrid1.RowCount-1 do
        begin
          Form2.strngrd2.Cols[2].Clear;//鸿泰
          Form2.strngrd2.Rows[i].Clear;
          Form2.strngrd2.Rows[i].Assign(StringGrid1.Rows[i]);
        end;

        inputform.StringGrid1.ColCount:=inputform.StringGrid1.ColCount+1;
        Form2.strngrd2.Cols[2].Text:='字符'; //鸿泰
        inputform.Close;
     end;
