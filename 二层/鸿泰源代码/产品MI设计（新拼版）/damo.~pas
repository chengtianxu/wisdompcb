...
type
  TDM = class(TDataModule)
    ...
    qry1: TADOQuery;
    ado607: TADOQuery;
    ado607TDATEtime: TDateTimeField;
    ado607MANU_PART_NUMBER: TStringField;
    ado607ttype: TStringField;
    ado607EMPLOYEE_NAME: TStringField;
    ado607tc: TStringField;
    ado607gd: TStringField;
    ado607pj: TStringField;
    ds1: TDataSource;
    ado607NOTE_INFO: TStringField;
      ...
      begin
        ...
        begin
          ...
          LSql := 'update data0038 set grade_note = ' + QuotedStr(LQryGrade.fieldbyname('dept_note').AsString) +
              ...
              ' and dept_ptr = ' + LQryGrade.fieldbyname('dept_ptr').AsString;
          LQrytmp.SQL.Add(LSql);
          LQrytmp.ExecSQL;
          LQryGrade.Next;
        end;
