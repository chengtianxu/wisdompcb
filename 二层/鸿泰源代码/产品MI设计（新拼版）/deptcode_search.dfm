object Form_deptcode: TForm_deptcode
  ...
  object ADOQuery1: TADODataSet
    ...
    CommandText = 
      ...
      'NST,ppc_status,'#13#10'SEQ_NR'#13#10'FROM dbo.Data0034'#13#10'WHERE (ACTIVE_FLAG =' +
      ' 0) AND (TTYPE = '#39'1'#39')'
    IndexFieldNames = 'SEQ_NR'
    Parameters = <>
    Left = 375
    Top = 475
    ...
    object ADOQuery1ppc_status: TWordField
      FieldName = 'ppc_status'
    end
    object ADOQuery1SEQ_NR: TIntegerField
