exec EP100;122 '0','0','1','2013-05-14','2013-05-18','order by customer_part_number',0 --过期查询
go
exec EP100;122 '0','0','0','2013-05-14','2013-05-18','order by customer_part_number',0  --未期查询
go
...
select @cond = '
SELECT TOP 100 PERCENT data0050.schno,data0050.baseinfo_status,Data0050.RKEY, Data0050.TTYPE,data0050.assign_to_ptr,c.employee_name as assignman,
