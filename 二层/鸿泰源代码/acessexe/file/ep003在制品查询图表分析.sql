--ep003在制品查询图表分析
--exec EP003;2 1,2,'P',1,0,4,2,'7','%','%',0,'%','3',NULL,NULL,0,2,NULL,NULL

create PROCEDURE EP003;2
@vdisp_flag int=0, 
@vtp int,  -- 不显示已经交货但尚有WIP的订单 0:显示，1：不显示
@vtype int,  --显示0：外层1：内部2：全部
@tp char(1), --单位模式U/P
@vindex int,  --汇总模式 0：部门，1：工序，2：产品类别，3：客户，4:组
@vindex2 int, -- 产品范围 0：全部，1：本厂编号，2：客户型号
@vindex5 int,  --返工与否 0：正常，1： 退货返工，2：正常返工，3：全部
...
if @Whse_ptr>0
select @cond=@cond+' and Data0006.whouse_ptr='+convert(varchar(10),@Whse_ptr)
