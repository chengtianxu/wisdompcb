...
update data0909 set price=a.price /a.conversion_factor --原来未考虑转换率
from data0909,
...
update data0022 set tax_price=a.tax_price /a.conversion_factor  --原来未考虑转换率
from data0022,
(select * from data0071) a
where data0022.source_ptr=a.rkey

SELECT tax_price,  price,tax_2,source_ptr,* FROM data0022 WHERE tax_price=0 AND price<>0 --and source_ptr is null


UPDATE data0022 SET TAX_price=price * (1+tax_2*0.01) WHERE tax_price=0 AND price<>0

----------------------------------------------


select * from data0022  
select * from data0071 where discount=0 AND data0071.conversion_factor<>1
...
---------------------------
update data0022 set tax_price=a.tax_price --/data0071.conversion_factor  --未考虑转换率
from data0022,
(select * from data0071) a
where data0022.source_ptr=a.rkey
