object DM: TDM
  ...
  object ADS60: TADODataSet
    ...
    CommandText = 
      ...
      'use_code,'#13#10'(dbo.Data0060.PARTS_ORDERED +dbo.Data0060.PARTS_RETUR' +
      'NED-dbo.Data0060.PARTS_SHIPPED - dbo.data0060.returned_ship) AS ' +
      'parts_margin,data0060.P_CODE,DATA0283.PRIORITY_name,'#13#10' cast(data' +
      '0060.RemarkSO as varchar(400) ) as RemarkSO'#13#10'FROM         dbo.Da' +
      'ta0060 INNER JOIN'#13#10'                   dbo.Data0025 ON dbo.Data00' +
      '60.CUST_PART_PTR = dbo.Data0025.RKEY INNER JOIN'#13#10'               ' +
      '    dbo.Data0010 ON dbo.Data0060.CUSTOMER_PTR = dbo.Data0010.RKE' +
      'Y INNER JOIN'#13#10'                   dbo.Data0097 ON dbo.Data0060.PU' +
      'RCHASE_ORDER_PTR = dbo.Data0097.RKEY INNER JOIN'#13#10'               ' +
      '    dbo.Data0008 ON dbo.Data0025.PROD_CODE_PTR = dbo.Data0008.RK' +
      'EY inner join '#13#10'                   data0015 on data0060.SHIP_REG' +
      '_TAX_ID=data0015.rkey INNER JOIN '#13#10'                   DATA0283 O' +
      'N data0060.P_CODE = DATA0283.PRIORITY_CODE'#13#10'WHERE     (dbo.Data0' +
      '060.PROD_REL <> '#39'3'#39') AND (dbo.Data0060.STATUS = 1)'#13#10'and (data006' +
      '0.ent_date >= :dtpk1) and (data0060.ent_date <= :dtpk2)'#13#10'and (da' +
      'ta0060.so_tp = :sotp)'#13#10
    ...
    object ADS60PRIORITY_name: TStringField
      DisplayLabel = #20248#20808#31561#32423
    ...
    object ADS60RemarkSO: TStringField
      FieldName = 'RemarkSO'
      Size = 400
    end
  end
