object dmcon: Tdmcon
  ...
  object ADOConnection1: TADOConnection
    ...
    ConnectionString = 
      ...
      'lse;Tag with column collation when possible=Fals'
    LoginPrompt = False
    Provider = 'SQLOLEDB.1'
    Left = 48
    Top = 25
  ...
  object adsDept_Sum: TADODataSet
    ...
    CommandText = 
      ...
      'G+D56.TO_BE_STOCKED))as onlineQty'#13#10#9'FROM dbo.Data0006 D06 INNER ' +
      'JOIN'#13#10#9'      dbo.Data0025 D25 ON D06.BOM_PTR = D25.RKEY INNER JO' +
      'IN'#13#10#9'      dbo.data0492 D492 ON D06.CUT_NO = D492.CUT_NO INNER J' +
      'OIN'#13#10#9'      dbo.data0056 D56 ON D06.RKEY = D56.WO_PTR INNER JOIN' +
      #13#10#9'      dbo.Data0034 D34 ON D56.DEPT_PTR = D34.RKEY'#13#10'Where D34.' +
      'Seq_Nr>0 and D34.ttype=1 and barcode_entry_flag='#39'Y'#39' '#13#10#9'GROUP BY ' +
      'D492.CUT_NO, D25.MANU_PART_NUMBER, D06.PANEL_A_B, D34.Seq_Nr,D34' +
      '.DEPT_CODE,D34.DEPT_Name'#13#10'order by D492.CUT_NO, D25.MANU_PART_NU' +
      'MBER, D06.PANEL_A_B, D34.Seq_Nr'#13#10
    Parameters = <>
    Prepared = True
    Left = 128
    Top = 160
