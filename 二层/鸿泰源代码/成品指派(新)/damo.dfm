object dm: Tdm
  ...
  object ADS64: TADODataSet
    ...
    CommandText = 
      ...
      'rea, D64.assign_type, '#13#10'                    CASE D64.assign_type' +
      ' WHEN 0 THEN '#39#27491#24120#25351#27966#39' WHEN 1 THEN '#39#36864#36135#25351#27966#39' END AS v_assign_type, '#13#10' ' +
      '                     CASE D64.packing_slip_flag WHEN 0 THEN '#39#26410#35013#36816 +
      #39' WHEN 1 THEN '#39#24050#35013#36816#39' END AS if_ship, D64.DATE_ASSIGN, D64.REMARK,' +
      ' D64.cust_decl, '#13#10'                      D05.EMPLOYEE_NAME, D97.P' +
      'O_NUMBER, D60.SCH_DATE, D60.PARTS_ORDERED, D60.PARTS_SHIPPED, D6' +
      '0.PARTS_RETURNED, D60.RETURNED_SHIP, '#13#10'                      D60' +
      '.PARTS_SHIPPED - D60.PARTS_RETURNED + D60.RETURNED_SHIP AS total' +
      '_shipped, '#13#10'                      D60.PARTS_ORDERED - D60.PARTS_' +
      'SHIPPED + D60.PARTS_RETURNED - D60.RETURNED_SHIP AS parts_margin' +
      ', '#13#10'                      CASE D60.status WHEN 1 THEN '#39#26377#25928#39' WHEN ' +
      '2 THEN '#39#26242#32531#39' WHEN 3 THEN '#39#20851#38381#39' '#13#10'                     WHEN 4 THEN ' +
      #39#23436#25104#39' WHEN 5 THEN '#39#21462#28040#39' WHEN 6 THEN '#39#26410#25552#20132#39' END AS v_status,'#13#10'      ' +
      '                 CASE D60.so_tp WHEN 0 THEN '#39#33258#21046#39' WHEN 1 THEN '#39#22806#21457 +
      #39' WHEN 2 THEN '#39#21322#21046#31243#39' END AS v_type, d60.REPUT_APPR_BY,'#13#10'         ' +
      '             CASE D60.commision_on_tooling WHEN '#39'Y'#39' THEN '#39#36716#21378#39' WH' +
      'EN '#39'N'#39' THEN '#39#20869#38144#39' END AS v_kind, D60.COMMISION_ON_TOOLING, D60.RE' +
      'FERENCE_NUMBER, '#13#10'                      D60.CUSTOMER_PTR, D10.CU' +
      'ST_CODE, D10.CUSTOMER_NAME, D25.MANU_PART_NUMBER, D25.MANU_PART_' +
      'DESC, D25.ANALYSIS_CODE_1, '#13#10'                      D25.REPORT_UN' +
      'IT_VALUE1, D25.QTY_ON_HAND, D25.set_qty, dbo.Data0023.ABBR_NAME ' +
      'AS abbrname23, D60.ENT_DATE,  '#13#10'                      D97.PO_DAT' +
      'E, D60.SHIPPING_METHOD, D12.LOCATION, D15.ABBR_NAME, d64.cartons' +
      '_no,'#13#10'                      D64.REPORT_UNIT_VALUE1 AS REPORT_UNI' +
      'T_VALUE1_1, dbo.data0439.delivery_no'#13#10'FROM         dbo.Data0064 ' +
      'AS D64 INNER JOIN'#13#10'                      dbo.Data0060 AS D60 ON ' +
      'D64.SO_PTR = D60.RKEY INNER JOIN'#13#10'                      dbo.Data' +
      '0025 AS D25 ON D60.CUST_PART_PTR = D25.RKEY INNER JOIN'#13#10'        ' +
      '              dbo.Data0097 AS D97 ON D60.PURCHASE_ORDER_PTR = D9' +
      '7.RKEY INNER JOIN'#13#10'                      dbo.Data0010 AS D10 ON ' +
      'D60.CUSTOMER_PTR = D10.RKEY INNER JOIN'#13#10'                      db' +
      'o.Data0012 AS D12 ON D60.CUST_SHIP_ADDR_PTR = D12.RKEY INNER JOI' +
      'N'#13#10'                      dbo.Data0005 AS D05 ON D64.ENT_EMPL_PTR' +
      ' = D05.RKEY INNER JOIN'#13#10'                      dbo.Data0015 AS D1' +
      '5 ON D60.SHIP_REG_TAX_ID = D15.RKEY LEFT OUTER JOIN'#13#10'           ' +
      '           dbo.data0439 ON D64.packing_list_ptr = dbo.data0439.r' +
      'key LEFT OUTER JOIN'#13#10'                      dbo.Data0023 ON D60.s' +
      'upplier_ptr = dbo.Data0023.RKEY'#13#10'WHERE d64.date_assign>=:dtpk1 a' +
      'nd d64.date_assign<=:dtpk2'#13#10
