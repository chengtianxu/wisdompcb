object DM: TDM
  ...
  object ADO97: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT dbo.Data0097.PO_NUMBER, dbo.Data0060.PURCHASE_ORDER_PTR A' +
        'S rkey97,'
      
        '      dbo.data0090.auth_date, dbo.data0090.user_ptr, dbo.Data000' +
        '5.EMPLOYEE_NAME, '
      '      dbo.data0090.IF_PUTHDATE, dbo.data0090.PUTH_INFO, '
      
        '      dbo.Data0060.SALES_ORDER, dbo.Data0060.RKEY AS rkey60, dat' +
        'a0025.barcode_flag,'
      '      dbo.Data0060.CUST_PART_PTR, dbo.Data0060.PARTS_ORDERED, '
      
        '      dbo.Data0060.PART_PRICE, dbo.Data0060.QUOTE_PRICE, dbo.Dat' +
        'a0060.RMA_PTR, '
      '      dbo.Data0060.MFG_ORDER_DATE, dbo.Data0097.PO_DATE, '
      '      dbo.Data0060.RUSH_CHARGE_PCT_USED, dbo.Data0060.DUE_DATE, '
      '      dbo.Data0060.SCH_DATE, dbo.Data0010.CUSTOMER_NAME, '
      
        '      dbo.Data0010.CUST_CODE, dbo.Data0010.ABBR_NAME, data0010.C' +
        'ONSUME_FORECASTS,'
      
        '      Data0060.ORIG_REQUEST_DATE, Data0060.ORIG_SCHED_SHIP_DATE,' +
        ' '
      
        '      Data0060.so_oldnew, Data0060.set_ordered,data0060.ent_date' +
        ','
      
        '      Data0025.MANU_PART_NUMBER, Data0025.MANU_PART_DESC,data006' +
        '0.ORIG_CUSTOMER,'
      
        '      Data0025.ALLOW_EDIT_FLAG, Data0025.ONHOLD_SALES_FLAG,data0' +
        '025.SAMPLE_NR,'
      
        '      Data0025.ONHOLD_RELEASE_FLAG,Data0025.ONHOLD_PLANNING_FLAG' +
        ',data0025.CUSTPART_ENT_DATE, '
      
        '      round (data0060.PARTS_ORDERED*data0025.unit_sq,3) as parts' +
        '_mianji,data0060.reference_number,'
      
        '      data0060.ENTERED_BY_EMPL_PTR,data0060.PURCHASE_ORDER_PTR,d' +
        'ata0060.PARTS_ALLOC,data0060.RUSH_CHARGE,'
      
        '      case when data0060.tax_in_price='#39'N'#39' then  data0060.PARTS_O' +
        'RDERED*data0060.PARTS_ALLOC*(1+data0060.RUSH_CHARGE*0.01)+ data0' +
        '060.TOTAL_ADD_L_PRICE'
      
        '      else data0060.PARTS_ORDERED*data0060.PART_PRICE+ data0060.' +
        'TOTAL_ADD_L_PRICE end as sumprice, '
      '      data0001.CURR_CODE,'
      
        '  d5.EMPLOYEE_NAME as poname, data0025.ANALYSIS_CODE_2,data0025.' +
        'layers,data0025.ANALYSIS_CODE_1,data0025.ANALYSIS_CODE_5,'
      
        '  round(case when data0025.unit_sq=0 then 0 else  data0060.PART_' +
        'PRICE/data0025.unit_sq end ,2) sp2,d5_1.employee_name as miname,'
      
        'case when data0025.green_flag='#39'Y'#39' then 1 else 0 end as green_fla' +
        'g  ,data0025.NOPB_flag,case when data0025.CURRENT_REV='#39'Y'#39' then 1' +
        ' else 0 end as CURRENT_REV,data0025.set_qty,'
      'Data0025.LAST_MODIFIED_DATE'
      ...
      '      dbo.Data0025 ON'
        ...
        'JOIN'
      '      dbo.Data0005 ON dbo.data0090.user_ptr = dbo.Data0005.RKEY'
      '   left join Data0001 on data0001.RKEY=data0060.CURRENCY_PTR'
      
        '  LEFT  JOIN Data0005 d5  on data0060.ENTERED_BY_EMPL_PTR=d5.RKE' +
        'Y'
      
        '    LEFT  JOIN Data0005 d5_1  on data0025.LAST_MODIFIED_BY_PTR=d' +
        '5_1.RKEY'
      'WHERE'
    ...
    object ADO97PURCHASE_ORDER_PTR: TIntegerField
      FieldName = 'PURCHASE_ORDER_PTR'
    end
    object ADO97PARTS_ALLOC: TFloatField
      FieldName = 'PARTS_ALLOC'
    end
    object ADO97RUSH_CHARGE: TFloatField
      FieldName = 'RUSH_CHARGE'
    end
    object ADO97sumprice: TFloatField
      FieldName = 'sumprice'
    end
    object ADO97CURR_CODE: TStringField
      FieldName = 'CURR_CODE'
      Size = 6
    end
    object ADO97poname: TStringField
      FieldName = 'poname'
      Size = 10
    end
    object ADO97ANALYSIS_CODE_2: TStringField
      FieldName = 'ANALYSIS_CODE_2'
      Size = 100
    end
    object ADO97layers: TIntegerField
      FieldName = 'layers'
    end
    object strngfldADO97ANALYSIS_CODE_1: TStringField
    ...
    object strngfldADO97ANALYSIS_CODE_5: TStringField
      FieldName = 'ANALYSIS_CODE_5'
      Size = 35
    end
    object ADO97sp2: TFloatField
      FieldName = 'sp2'
    end
    object ADO97green_flag: TSmallintField
      FieldName = 'green_flag'
    end
    object ADO97NOPB_flag: TSmallintField
      FieldName = 'NOPB_flag'
    end
    object ADO97CURRENT_REV: TSmallintField
      FieldName = 'CURRENT_REV'
    end
    object ADO97set_qty: TIntegerField
      FieldName = 'set_qty'
    end
    object ADO97LAST_MODIFIED_DATE: TDateTimeField
      FieldName = 'LAST_MODIFIED_DATE'
    end
    object ADO97miname: TStringField
      FieldName = 'miname'
      Size = 10
    end
  end
  ...
  object ado89: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       Data0002 ON dbo.Data0278.UNIT_PTR = dbo.Data0002.RKEY '
      '       INNER JOIN'
      '       Data0277 ON dbo.Data0278.CATEGORY_PTR = dbo.Data0277.RKEY'
      
        '       inner join Data0025 on data0025.RKEY =data0089.cust_part_' +
        'ptr'
      
        '       inner join  Data0008 on data0008.RKEY =data0025.PROD_CODE' +
        '_PTR'
      
        '       inner join  Data0007 on data0007.RKEY =Data0008.PR_GRP_PO' +
        'INTER'
      
        '       inner join  Data0087 on data0087.group_ptr =Data0007.RKEY' +
        '  and data0089.parameter_ptr=data0087.PARAMETER_PTR'
      'where cust_part_ptr=:cust_part_ptr'
  ...
  object ado60_cancel: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      dbo.Data0060.PURCHASE_ORDER_PTR AS rkey97, '
        ...
        '      dbo.Data0060.PARTS_ORDERED * dbo.Data0025.unit_sq AS parts' +
        '_mianji, '
      ...
      '      dbo.Data0025.ONHOLD_PLANNING_FLAG'
      'FROM dbo.Data0060 INNER JOIN'
      '      dbo.Data0097 ON '
  ...
  object qry1: TADOQuery
    ...
    SQL.Strings = (
        ...
        '  select data0089.cust_part_ptr,  data0089.tvalue as T61,d89.tva' +
        'lue as T17,d89_1.tvalue as T69,d89_2.tvalue  as T68,'#13'd89_3.tvalu' +
        'e as T29,d89_4.tvalue as T26,'
      
        'd89_5.tvalue as T28, d89_6.tvalue  as T56,d89_7.tvalue as T93,d8' +
        '9_8.tvalue as T57,d89_9.tvalue as T27, '#13'd89_10.tvalue as T144,d8' +
        '9_11.tvalue as T143,'
      
        'd89_12.tvalue as T30,d89_13.tvalue as T8  from data0089 '#13'left jo' +
        'in data0089 d89 on d89.cust_part_ptr=data0089.cust_part_ptr and ' +
        'd89.parameter_ptr=17        '
      
        '   '#13'left join data0089 d89_1 on d89_1.cust_part_ptr=data0089.cus' +
        't_part_ptr and d89_1.parameter_ptr=69'
      
        ' '#13'left join data0089 d89_2 on d89_2.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_2.parameter_ptr=68'
      
        ' '#13'left join data0089 d89_3 on d89_3.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_3.parameter_ptr=29'
      
        ' '#13'left join data0089 d89_4 on d89_4.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_4.parameter_ptr=26'
      
        ' '#13'left join data0089 d89_5 on d89_5.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_5.parameter_ptr=28'
      
        ' '#13'left join data0089 d89_6 on d89_6.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_6.parameter_ptr=56'
      
        ' '#13'left join data0089 d89_7 on d89_7.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_7.parameter_ptr=93'
      
        ' '#13'left join data0089 d89_8 on d89_8.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_8.parameter_ptr=57'
      
        ' '#13'left join data0089 d89_9 on d89_9.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_9.parameter_ptr=27 '
      
        ' '#13'left join data0089 d89_10 on d89_10.cust_part_ptr=data0089.cus' +
        't_part_ptr and d89_10.parameter_ptr=144'
      
        ' '#13'left join data0089 d89_11 on d89_11.cust_part_ptr=data0089.cus' +
        't_part_ptr and d89_11.parameter_ptr=143'
      
        ' '#13'left join data0089 d89_12 on d89_12.cust_part_ptr=data0089.cus' +
        't_part_ptr and d89_12.parameter_ptr=30 '
      
        'left join data0089 d89_13 on d89_13.cust_part_ptr=data0089.cust_' +
        'part_ptr and d89_13.parameter_ptr=8        '
      
        ' '#13'where data0089.parameter_ptr=61 and data0089.cust_part_ptr=:cu' +
        'st_part_ptr')
    Left = 128
    Top = 416
    object qry1cust_part_ptr: TIntegerField
      FieldName = 'cust_part_ptr'
    end
    object qry1T61: TStringField
      FieldName = 'T61'
      Size = 50
    end
    object qry1T17: TStringField
      FieldName = 'T17'
      Size = 50
    end
    object qry1T69: TStringField
      FieldName = 'T69'
      Size = 50
    end
    object qry1T68: TStringField
      FieldName = 'T68'
      Size = 50
    end
    object qry1T29: TStringField
      FieldName = 'T29'
      Size = 50
    end
    object qry1T26: TStringField
      FieldName = 'T26'
      Size = 50
    end
    object qry1T28: TStringField
      FieldName = 'T28'
      Size = 50
    end
    object qry1T56: TStringField
      FieldName = 'T56'
      Size = 50
    end
    object qry1T93: TStringField
      FieldName = 'T93'
      Size = 50
    end
    object qry1T57: TStringField
      FieldName = 'T57'
      Size = 50
    end
    object qry1T27: TStringField
      FieldName = 'T27'
      Size = 50
    end
    object qry1T144: TStringField
      FieldName = 'T144'
      Size = 50
    end
    object qry1T143: TStringField
      FieldName = 'T143'
      Size = 50
    end
    object qry1T30: TStringField
      FieldName = 'T30'
      Size = 50
    end
    object qry1T8: TStringField
      FieldName = 'T8'
      Size = 35
    end
  end
  ...
  object qry2: TADOQuery
    ...
    SQL.Strings = (
      '  '
        ...
        '  select data0060.SALES_ORDER, data0060.so_oldnew, data0060.ENT_' +
        'DATE,data0025.MANU_PART_NUMBER,data0060.PARTS_ORDERED,'
      'case when Data0025.ttype=0 then '#39#37327#20135#39' else '#39#26679#26495#39' end as ttype ,'
      
        '  data0060.ORIG_REQUEST_DATE,data0025.MANU_PART_DESC,datA0025.AN' +
        'ALYSIS_CODE_1,DATA0025.set_qty,DATA0025.unit_sq*DATA0060.PARTS_O' +
        'RDERED AS SP1,'
      
        ' dbo.Data0097.PO_NUMBER, DATA0010.CUST_CODE,DATA0025.LAYERS,DATA' +
        '0025.set_lngth,DATA0025.set_width,DATA0008.PRODUCT_NAME,DATA0060' +
        '.RemarkSO'
      
        'from Data0060  inner join Data0025 on dbo.Data0060.CUST_PART_PTR' +
        ' = dbo.Data0025.RKEY  and  isnull(data0025.PARENT_PTR,0)=0'
      
        'INNER JOIN      dbo.Data0097 ON      dbo.Data0060.PURCHASE_ORDER' +
        '_PTR = dbo.Data0097.RKEY '
      
        'INNER JOIN     dbo.Data0010 ON dbo.Data0060.CUSTOMER_PTR = dbo.D' +
        'ata0010.RKEY'
      'LEFT JOIN Data0008 ON Data0008.RKEY =DATA0025.PROD_CODE_PTR'
      'WHERE DATA0060.rkey=:rkey60')
    Left = 304
    Top = 408
    object qry2SALES_ORDER: TStringField
      FieldName = 'SALES_ORDER'
      FixedChar = True
      Size = 12
    end
    object qry2so_oldnew: TStringField
      FieldName = 'so_oldnew'
      Size = 10
    end
    object qry2ENT_DATE: TDateTimeField
      FieldName = 'ENT_DATE'
    end
    object qry2MANU_PART_NUMBER: TStringField
      FieldName = 'MANU_PART_NUMBER'
    end
    object qry2PARTS_ORDERED: TFloatField
      FieldName = 'PARTS_ORDERED'
    end
    object qry2ORIG_REQUEST_DATE: TDateTimeField
      FieldName = 'ORIG_REQUEST_DATE'
    end
    object qry2MANU_PART_DESC: TStringField
      FieldName = 'MANU_PART_DESC'
      Size = 80
    end
    object qry2ANALYSIS_CODE_1: TStringField
      FieldName = 'ANALYSIS_CODE_1'
      Size = 30
    end
    object qry2set_qty: TIntegerField
      FieldName = 'set_qty'
    end
    object qry2SP1: TFloatField
      FieldName = 'SP1'
      ReadOnly = True
    end
    object qry2PO_NUMBER: TStringField
      FieldName = 'PO_NUMBER'
      Size = 32
    end
    object qry2CUST_CODE: TStringField
      FieldName = 'CUST_CODE'
      Size = 50
    end
    object qry2LAYERS: TWordField
      FieldName = 'LAYERS'
    end
    object qry2set_lngth: TBCDField
      FieldName = 'set_lngth'
      Precision = 7
      Size = 3
    end
    object qry2set_width: TBCDField
      FieldName = 'set_width'
      Precision = 7
      Size = 3
    end
    object qry2PRODUCT_NAME: TStringField
      FieldName = 'PRODUCT_NAME'
      Size = 30
    end
    object qry2RemarkSO: TMemoField
      FieldName = 'RemarkSO'
      BlobType = ftMemo
    end
    object qry2ttype: TStringField
      FieldName = 'ttype'
      ReadOnly = True
      Size = 4
    end
