...
edit6.Text:=dm.AQY0025EST_SCRAP.AsString;
...
begin
  ...
  begin
   ...
   if dm.AQY0025ttype.Value=0 then
    edit6.Text:=Form_prodcode.adoquery1EST_SCRAP.AsString
   else
    edit6.Text:=Form_prodcode.adoquery1EST_SCRAP1.AsString;
...
function TForm_append.invo_number_error(number: string): boolean;
begin
result:=false;
with dm.ADOQuery1 do
 begin
