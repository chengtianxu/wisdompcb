object DM: TDM
  ...
  object AQY0025: TADOQuery
    ...
    SQL.Strings = (
        ...
        'flag,REACH,'
      'layers_image,flod_number,ZDR_TYPE,CustFileName,'
      '     quality_status,quality_user,quality_date,grade_code'
      '     ,ORIG_CUSTOMER,vcut_B, vcut_T,vcut_X,gf_A,gf_T,gf_L,TUSAGE '
      'FROM dbo.Data0025'
      'where rkey=:rkey'
      ' '
      ' ')
