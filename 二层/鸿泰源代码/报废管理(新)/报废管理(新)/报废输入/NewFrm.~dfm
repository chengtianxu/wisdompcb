object frmNew: TfrmNew
    ...
    object grp1: TGroupBox
      ...
      object grp4: TGroupBox
        ...
        object lbl17: TLabel
          ...
          Width = 60
          Height = 13
          Caption = #24050#25253#38754#31215#65306
        end
  ...
  object qry1: TADOQuery
    ...
    SQL.Strings = (
      'select unit_sq from Data0025 '
      
        'where RKEY in (select BOM_PTR from Data0006 where WORK_ORDER_NUM' +
        'BER=:@work)')
    Left = 257
    Top = 9
    object fltfldqry1unit_sq: TFloatField
      FieldName = 'unit_sq'
    end
  end
end
