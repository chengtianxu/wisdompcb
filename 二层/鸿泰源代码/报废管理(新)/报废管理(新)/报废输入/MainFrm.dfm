object frmMain: TfrmMain
  ...
  Width = 925
  Height = 601
  Caption = #25253#24223#31649#29702
  Color = clBtnFace
    ...
    object ehFrmMain: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          Footers = <>
          Title.Caption = #25968#37327'|'#30003#35831#25968
          Width = 35
        end
        item
          EditButtons = <>
          FieldName = 'PANELS'
          Footers = <>
          Title.Caption = #25968#37327'|PNL'#25968
          Width = 35
        end
        item
          EditButtons = <>
          ...
          Footers = <>
          Title.Caption = #25968#37327'|'#25209#20934#25968
          Width = 35
        end
        item
          EditButtons = <>
        ...
        item
          ...
          Footers = <>
          Title.Caption = #30003#35831#24037#24207'|'#20195#30721
          Width = 40
        end
        item
          EditButtons = <>
          ...
          Footers = <>
          Title.Caption = #30003#35831#24037#24207'|'#21517#31216
          Width = 40
        end
        item
          EditButtons = <>
          ...
          Footers = <>
          Title.Caption = #36131#20219#24037#24207'|'#20195#30721
          Width = 40
        end
        item
          EditButtons = <>
          ...
          Footers = <>
          Title.Caption = #36131#20219#24037#24207'|'#21517#31216
          Width = 40
        end
        item
          EditButtons = <>
        ...
        item
          ...
          Footers = <>
          Title.Caption = #25209#20934#26085#26399
          Width = 120
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'ABBR_NAME'
          Footers = <>
          Title.Caption = #24037#21378#21517#23383
          Width = 100
        end
        item
          EditButtons = <>
        ...
        item
          ...
          Footers = <>
          Title.Caption = #25237#26009#25968#37327
        end
        item
          EditButtons = <>
        ...
        item
          ...
          FieldName = 'sp1'
          Footers = <>
          Title.Caption = #25253#24223#38754#31215
        end>
    end
  end
  object pnl1: TPanel
  ...
  object pm1: TPopupMenu
    ...
    object N1: TMenuItem
      Tag = 1
      Caption = #20869#23618#39044#25253#24223
      OnClick = mniNewClick
    end
    object mniChangeQXDM: TMenuItem
      Caption = #20462#25913#32570#38519#20195#30721
      OnClick = mniChangeQXDMClick
    end
    object N2: TMenuItem
      Caption = #20462#25913#36131#20219#24037#24207
      OnClick = N2Click
    end
    object mniChangeGCDM: TMenuItem
      Caption = #20462#25913#24037#21378#20195#30721
      Visible = False
      OnClick = mniChangeGCDMClick
    end
    object mniFSH: TMenuItem
