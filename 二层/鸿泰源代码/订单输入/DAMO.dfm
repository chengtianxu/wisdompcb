object dm: Tdm
  ...
  object ADOQuery1: TADODataSet
    ...
    CommandText = 
      ...
      'R, dbo.Data0060.ORIG_REQUEST_DATE, BOMPrice06.maolilv_add ,'#13#10'   ' +
      '   dbo.Data0060.DUE_DATE AS D60DUE_DATE, dbo.Data0060.QUOTE_PRIC' +
      'E, data0060.PART_PRICE ,'#13#10'      dbo.Data0060.SCH_DATE AS D60SCH_' +
      'DATE, dbo.Data0097.PO_DATE, BOMPrice06.BPNO, '#13#10'      dbo.Data006' +
      '0.ENT_DATE, Data0060.issued_qty as QTY_PLANNNED, data0085.TNUMBE' +
      'R,'#13#10'      Data0060.PARTS_SHIPPED+data0060.returned_ship as PARTS' +
      '_SHIPPED, Data0060.PARTS_RETURNED, '#13#10'      Data0005_1.EMPLOYEE_N' +
      'AME, dbo.Data0060.SHIPPING_METHOD, '#13#10'      Data0060.PARTS_ORDERE' +
      'D +Data0060.PARTS_RETURNED- '#13#10'      Data0060.PARTS_SHIPPED - dat' +
      'a0060.returned_ship AS parts_margin, '#13#10'      Data0025.MANU_PART_' +
      'NUMBER, Data0025.MANU_PART_DESC,data0025.ANALYSIS_CODE_2,data002' +
      '5.ONHOLD_SALES_FLAG,'#13#10'     case data0060.so_tp when 0 then '#39#33258#21046#39' ' +
      'when 1 then '#39#22806#21457#39' when 2 then '#39#21322#21046#31243#39' end as sotp,Data0060.ORIG_CUS' +
      'TOMER,Data0025.ttype,'#13#10'     case when data0085.TNUMBER is NULL t' +
      'hen BOMPrice06.BPNO else data0085.TNUMBER end as TNUMBERs,Data00' +
      '25.CPJS, round(Data0060.PARTS_ORDERED*data0025.unit_sq,3) as sp'#13 +
      #10'FROM dbo.Data0005 INNER JOIN'#13#10'      dbo.Data0097 INNER JOIN'#13#10'  ' +
      '    dbo.Data0060 INNER JOIN'#13#10'      dbo.Data0010 ON dbo.Data0060.' +
      'CUSTOMER_PTR = dbo.Data0010.RKEY ON '#13#10'      dbo.Data0097.RKEY = ' +
      'dbo.Data0060.PURCHASE_ORDER_PTR ON '#13#10'      dbo.Data0005.RKEY = d' +
      'bo.Data0060.ENTERED_BY_EMPL_PTR INNER JOIN'#13#10'      dbo.Data0025 O' +
      'N '#13#10'      dbo.Data0060.CUST_PART_PTR = dbo.Data0025.RKEY INNER J' +
      'OIN'#13#10'      dbo.Data0001 ON dbo.Data0060.CURRENCY_PTR = dbo.Data0' +
      '001.RKEY  LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON '#13#10'  ' +
      '    dbo.Data0060.CONF_BY_EMPL_PTR = Data0005_1.RKEY left outer j' +
      'oin'#13#10'     data0023 on Data0060.supplier_ptr = data0023.RKEY left' +
      ' outer join'#13#10'     data0085 on data0060.QTE_PTR = data0085.rkey l' +
      'eft outer join'#13#10'     BOMPrice06 on Data0060.BP06_ptr=BOMPrice06.' +
      'IDKey'#13#10'WHERE Data0060.STATUS <> :v1 AND Data0060.STATUS <> :v2'#13#10 +
      '      AND Data0060.STATUS <> :v3 AND Data0060.STATUS <> :v4'#13#10'   ' +
      '   AND Data0060.STATUS <> :v5 AND Data0060.STATUS <> :v6'#13#10'      ' +
      'AND Data0060.ent_date >=:dtpk1'#13#10'      AND Data0060.ent_date <=:d' +
      'tpk2'#13#10
    ...
    object fltfldADOQuery1sp: TFloatField
      FieldName = 'sp'
    end
  end
  ...
  object AdoSP2: TADOQuery
    ...
    SQL.Strings = (
      ...
      'CONTACT_NAME_6,INTERNAL_ECN_COUNT,EXTERNAL_ECN_COUNT,'
        ...
        'ptr,data0008.LEAD_TIME,data0025.ANALYSIS_CODE_2'
      'from data0001,data0010,data0025,data0097,data0060,data0008'
      ...
      'data0025.PROD_CODE_PTR=data0008.rkey and '
