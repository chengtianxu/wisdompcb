...
begin
  ProcessKey(TagToCharArray[TSpeedButton(Sender).Tag]);
end;
...
procedure TPopupCalculatorEh.WMNCPaint(var Message: TMessage);
begin
  inherited;
  DrawBorder;
end;

procedure TPopupCalculatorEh.WMMouseActivate(var Message: TMessage);
begin
