object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      's '#21152#24037#25351#31034',Data0025.ENG_NOTE as '#24037#31243#22791#27880', data0025.barcode_flag, '#13#10'Data0' +
      '025.EST_SCRAP as '#25253#24223#29575' , Data0025.SHELF_LIFE as '#29983#20135#21608#26399', data0025.NOP' +
      'B_flag,'#13#10'      Data0025.REVIEW_DAYS as '#26377#25928#26399#22825#25968', Data0025.MFG_LEAD_' +
      'TIME as '#21046#36896#25552#21069#26399', '#13#10'      Data0025.ANALYSIS_CODE_3 as '#22823#26009#35268#26684', Data002' +
      '5.REPORT_UNIT_VALUE1 AS '#21333#21482#37325#37327'g, '#13#10'      dbo.Data0025.OPT_LOT_SIZE' +
      ' as '#27969#36716#25209#37327',data0025.QTY_BOM as '#21387#21512#27604#20363','#13#10'case Data0025.ONHOLD_SALES_F' +
      'LAG when 0 then '#39#26377#25928#39' when 1 then '#39#36807#26399#39' end as '#38144#21806#29366#24577', '#13#10#13#10'case Data' +
      '0025.TSTATUS'#13#10'   when 0 then '#39#24453#21046#20316#39' when 1 then '#39#24050#23457#26680#39' when 2 then' +
      ' '#39#23457#36864#22238#39' when 3 then '#39#24453#26816#26597#39#13#10'   when 4 then '#39#24453#23457#26680#39' when 5 then '#39#26816#36864#22238#39 +
      ' when 6 then '#39#26410#25552#20132#39' end as '#23457#25209#29366#24577','#13#10'case when ltrim(data0025.CURREN' +
      'T_REV)='#39'Y'#39' then '#39#26080#21348#32032#39' else '#39#39' end as '#21348#32032#35201#27714','#13#10'case   Data0025.ttyp' +
      'e  when 0 then '#39#37327#20135#39' when 1 then '#39#26679#26495#39'  end as '#37327#20135#26679#26495','#13#10'case Data002' +
      '5.green_flag when '#39'Y'#39' then '#39'4G'#26631#35782#39'  else '#39' '#39' end as '#26631#35782'4G,'#13#10'case w' +
      'hen data0025.PARENT_PTR is null then '#39#22806#23618#39' ELSE '#39#20869#23618#39' end as  '#20135#21697#24615#36136 +
      ','#13#10'data0025.layers_image as '#21387#21512#22270#29255','#13#10'data0025.flod_number as '#38075#23380#21472#26495#25968 +
      ',data0025.ZDR_TYPE as '#38075#23380#21442#25968','#13#10'data0025.ORIG_CUSTOMER as '#20851#32852#21407#23458#25143', vc' +
      'ut_B,vcut_T,vcut_X,gf_A,gf_L,gf_T   '#13#10'FROM dbo.Data0008 INNER JO' +
      'IN'#13#10'      dbo.Data0025 ON '#13#10'      dbo.Data0008.RKEY = dbo.Data00' +
      '25.PROD_CODE_PTR INNER JOIN'#13#10'      dbo.Data0010 ON '#13#10'      dbo.D' +
      'ata0025.CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUTER JOIN'#13#10'      ' +
      'dbo.Data0005 Data0005_3 ON '#13#10'      dbo.Data0025.CHECK_BY_PTR = D' +
      'ata0005_3.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_2 ON' +
      ' '#13#10'      dbo.Data0025.LAST_MODIFIED_BY_PTR = Data0005_2.RKEY LEF' +
      'T OUTER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Data0025.AUDI' +
      'TED_BY_PTR = Data0005_1.RKEY'#13#10'where data0025.rkey=:rkey'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
          ...
          object ppChildReport5: TppChildReport
            ...
            object raCodeModule5: TraCodeModule
              ProgramStream = {
                ...
                726506536F757263650C5A02000070726F636564757265205661726961626C65
                ...
                }
            end
          end
        end
      end
  ...
  object ds1: TADODataSet
    ...
    CommandText = 
      ...
      #24452','#13#10' PTH as PTH'#23380', TOLERANCE as '#20844#24046', '#13#10' DRILL_DIA as '#38075#21632', UNIT as P' +
      'CS'#23380#25968','#13#10' PANEL_A as A'#26495#23380#25968', PANEL_B AS B'#26495#23380#25968', '#13#10'REMARK as '#22791#27880',SET_UNM' +
      'BER AS SE'#23380#25968#13#10'FROM dbo.Data0029'#13#10'where  flow_no>=1 and  source_pt' +
      'r=:rkey'#13#10'ORDER BY flow_no, SEQ_NO'
    DataSource = DataSource1
    MasterFields = 'rkey'
    Parameters = <
      item
  ...
  object ppDB2901: TppDBPipeline
    ...
    object pdbpln1ppField8: TppField
    ...
    object pdbpln1ppField9: TppField
    ...
    object pdbpln1ppField10: TppField
    ...
    object pdbpln1ppField11: TppField
    ...
    object pdbpln1ppField12: TppField
