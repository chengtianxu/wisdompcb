object Form_product: TForm_product
  ...
  object adoquery1: TADODataSet
    ...
    CommandText = 
      ...
      'bo.Data0025.MANU_PART_DESC, data0025.quality_status,'#13#10'  Data0008' +
      '.PRODUCT_NAME, data0008.prod_code,'#13#10'Data0010.CUST_CODE, Data0025' +
      '.ONHOLD_SALES_FLAG,'#13#10'Data0025.LAYERS, Data0025.ttype,data0025.PR' +
      'OD_ROUTE_PTR,'#13#10'case   Data0025.ttype'#13#10'  when 0 then '#39#37327#20135#39' when 1 ' +
      'then '#39#26679#26495#39'  end as batch_or_former,'#13#10'case Data0025.ONHOLD_SALES_F' +
      'LAG'#13#10'when 0 then '#39#26377#25928#39' when 1 then '#39#36807#26399#39' end as overdue,'#13#10'Data0025' +
      '.PROD_CODE_PTR,Data0025.CUSTOMER_PTR,'#13#10'data0008.EST_SCRAP,data00' +
      '08.EST_SCRAP1'#13#10'FROM Data0008 INNER JOIN'#13#10'      Data0025 ON '#13#10'   ' +
      '   Data0008.RKEY = Data0025.PROD_CODE_PTR INNER JOIN'#13#10'      Data' +
      '0010 ON Data0025.CUSTOMER_PTR = Data0010.RKEY'#13#10'where Data0025.MA' +
      'NU_PART_NUMBER like :part_number '#13#10'          and data0025.parent' +
      '_ptr is null'#13#10
