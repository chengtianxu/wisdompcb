 ...
 try
   case Self.ListBox3.ItemIndex of
    ...
    begin
      ...
      InputVar.Fields := 'code/审批代码/120,PURCHASE_APPROV_DESC/说明/250';
      InputVar.Sqlstr :='select rkey,code,PURCHASE_APPROV_DESC from data0094 order by code';
    end;
    2:
    begin
      frmPick_Item_Single := TfrmPick_Item_Single.Create(application) ;
   ...
   case Self.ListBox3.ItemIndex of
    0:edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['code'] ;
    1:edtValue.Text := frmPick_Item_Single.adsPick.FieldValues['PURCHASE_APPROV_DESC'] ;
