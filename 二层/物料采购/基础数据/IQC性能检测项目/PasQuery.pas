...
//   tmp_date:TDateTime;
begin
  field_cn:= VarArrayOf(['供应商代码','供应商名称','材料类别','型号','批号']);
  field_en:=VarArrayOf(['Data0023.CODE','Data0023.ABBR_NAME','DATA0496.GROUP_NAME',
                'data0622.model','Data0391.batch_no']);
  ltbConditon.Clear;
...
begin
  ...
  btn1.Visible:= (ltbConditon.ItemIndex = 2);
