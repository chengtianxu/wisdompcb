...
var
 i,rkey70:integer;
begin
stg1.Cells[0,0]:='采购单号码';
stg1.Cells[1,0]:='供应商';
stg2.Cells[0,0]:='采购单号码';
stg2.Cells[1,0]:='供应商';
...
for i:=1 to dm.AQ0070.RecordCount do
 begin
  if dm.AQ0070CSI_USER_POINTER.Value>0 then
  begin
   stg1.Cells[0,stg1.RowCount-1]:=dm.AQ0070po_number.Value;
   stg1.Cells[1,stg1.RowCount-1]:=dm.AQ0070supp_abbrname.Value;
   stg1.Cells[2,stg1.RowCount-1]:=dm.AQ0070rkey.AsString;
   stg1.Cells[3,stg1.RowCount-1]:=inttostr(stg1.RowCount-1);
...
for i:=1 to dm.AQ0070.RecordCount do
 begin
  if dm.AQ0070CSI_USER_POINTER.Value>0 then
   begin
   stg2.Cells[0,stg2.RowCount-1]:=dm.AQ0070po_number.Value;
   stg2.Cells[1,stg2.RowCount-1]:=dm.AQ0070supp_abbrname.Value;
   stg2.Cells[2,stg2.RowCount-1]:=dm.AQ0070rkey.AsString;
   stg2.Cells[3,stg2.RowCount-1]:=inttostr(stg2.RowCount-1);
   stg2.RowCount:=stg2.RowCount+1;
   end;
  dm.AQ0070.Next;
 end;
