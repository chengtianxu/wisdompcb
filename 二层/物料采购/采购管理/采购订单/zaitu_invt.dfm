object Form_zaitu: TForm_zaitu
  ...
  object ADODataSet1: TADODataSet
    ...
    CommandText = 
      ...
      '70.ANALYSIS_CODE_1)  AS ANALYSIS_CODE_1'#13#10'FROM         dbo.Data00' +
      '68 LEFT OUTER JOIN'#13#10'                      dbo.Data0005 ON dbo.Da' +
      'ta0068.REQ_BY = dbo.Data0005.RKEY LEFT OUTER JOIN'#13#10'             ' +
      '         dbo.Data0069 ON dbo.Data0068.RKEY = dbo.Data0069.PURCH_' +
      'REQ_PTR RIGHT OUTER JOIN'#13#10'                      dbo.Data0071 INN' +
      'ER JOIN'#13#10'                      dbo.Data0070 ON dbo.Data0071.PO_P' +
      'TR = dbo.Data0070.RKEY INNER JOIN'#13#10'                      dbo.Dat' +
      'a0023 ON dbo.Data0070.SUPPLIER_POINTER = dbo.Data0023.RKEY INNER' +
      ' JOIN'#13#10'                      dbo.Data0002 ON dbo.Data0071.PURCHA' +
      'SE_UNIT_PTR = dbo.Data0002.RKEY ON dbo.Data0069.RKEY = dbo.Data0' +
      '071.rkey69'#13#10'WHERE     (dbo.Data0070.STATUS = 5) AND (dbo.Data007' +
      '1.QUAN_ORD - dbo.Data0071.QUAN_RECD + dbo.Data0071.QUAN_RETN > 0' +
      ')and '#13#10'     (dbo.Data0071.INVT_PTR = :rkey)'
    Parameters = <
      item
        Name = 'rkey'
        Attributes = [paSigned]
