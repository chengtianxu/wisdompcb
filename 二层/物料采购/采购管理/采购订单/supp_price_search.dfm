  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       data0028.avl_flag,data0028.AMT_QUAN_FLAG,data0028.tax_2,'
        ...
        '       data0028.MIN_ORDER_QTY,data0028.MIN_ORDER_AMT,data0023.ED' +
        'I_OUT_NEW_PO,'
      
        '       data0028.currency_ptr,data0028.purchase_unit_ptr,data0028' +
        '.prot_report_ptr,'
      ...
      '       data0002.unit_code,data0002.unit_name,data0028.tax_flag,'
        ...
        '       PRICE_1,PRICE_2,PRICE_3,PRICE_4,PRICE_5,PRICE_6,data0023.' +
        'EDI_FLAG_FOR_PO,'
      '       QUAN_VOL_1,QUAN_VOL_2,QUAN_VOL_3,QUAN_VOL_4,QUAN_VOL_5,'
      
        '       data0028.DISC_1,data0028.DISC_2,data0028.DISC_3,DATA0028.' +
        'IF_CAF,'
      
        '       data0028.DISC_4,data0028.DISC_5,DISC_6,data0028.rohs,data' +
        '0028.orig_abbrname'
    ...
    object ADOQuery1v_flag: TStringField
      DisplayLabel = #35748#21487#26631#35782
    ...
    object ADOQuery1v_meoth: TStringField
      DisplayLabel = #35746#36141#26041#27861
      DisplayWidth = 6
      FieldKind = fkCalculated
      FieldName = 'v_meoth'
      Size = 6
    ...
    object ADOQuery1v_min_order: TFloatField
      Alignment = taLeftJustify
      DisplayLabel = #26368#23569#35746#36141#25968#37327
      FieldKind = fkCalculated
    ...
    object ADOQuery1EDI_OUT_NEW_PO: TWordField
      DisplayLabel = 'VMI'#20379#24212#21830
    ...
    object ADOQuery1prot_report_ptr: TIntegerField
      FieldName = 'prot_report_ptr'
    end
    object ADOQuery1EDI_FLAG_FOR_PO: TSmallintField
      DisplayLabel = 'VMI'#20215#26684#21462#21521
      FieldName = 'EDI_FLAG_FOR_PO'
    end
    object ADOQuery1orig_abbrname: TStringField
