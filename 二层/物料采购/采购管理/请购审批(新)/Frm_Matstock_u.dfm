  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       Data0071 ON Data0022.SOURCE_PTR = dbo.Data0071.RKEY'
        ...
        'WHERE  (Data0022.QUAN_ON_HAND <> 0)  and  (data0017.rkey= :INVT_' +
        'PTR)'
      ...
      '       Data0071 ON DATA0134.SOURCE_PTR = Data0071.RKEY'
        ...
        'WHERE  (data0134.quan_on_hand>0)  and  (DATA0134.INVENTORY_ptr =' +
        ' :INVT_PTR)'
    ...
    object ADOQuery1avl_price: TFloatField
      DisplayLabel = #24179#22343#21547#31246#20215#26684'('#26412#20301#24065')'
      FieldName = 'avl_price'
      ReadOnly = True
    end
