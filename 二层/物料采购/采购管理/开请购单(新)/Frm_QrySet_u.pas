...
begin
  ...
  end else if listbox3.itemindex=0 then
  begin
...
begin
  ...
  v_Field_List_CN := VarArrayOf(['请购编号','请购类型','工厂','请购员代码']);
  v_Field_List_EN := VarArrayOf(['data0068.po_req_number','data0068.flag','data0015.warehouse_code','data0005.empl_code']);
