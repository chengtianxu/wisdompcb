...
implementation
uses damo, supplier_search, Unit_search, michistory_price, curr_search,common;
{$R *.dfm}
...
try
 ...
 with form_supp.ADOQuery1 do
  begin
   ...
   sql.Add('where data0023.status=0');
  ...
  begin
   ...
   with dm.ADOQuery1 do
      begin
       ...
       sql.Add('Data0024.SUPPLIER_PTR ='+inttostr(dm.ADO204SUPPLIER_PTR.Value));
       sql.Add('order by data0024.rkey');
       active:=true;
       dm.ADO204tax.Value := dm.ADOQuery1.FieldValues['state_tax'];  //..7增值税率
      end;
  end
 else
  edit1.SetFocus;
