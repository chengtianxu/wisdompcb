object DM: TDM
  ...
  object ADOConnection1: TADOConnection
    ConnectionString = 
      ...
      '=True;User ID=sa;Initial Catalog=sj_v20_live_3;Data Source=172.1' +
      '7.0.188'
    LoginPrompt = False
    Provider = 'SQLOLEDB.1'
    Left = 202
  ...
  object AQ0068: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       Data0068.DEPARTMENT_NAME,Data0068.REQ_DATE,'
      ...
      '       Data0073 ON data0276.user_ptr = dbo.Data0073.RKEY'
        ...
        'WHERE  (Data0068.STATUS = 2) AND (dbo.data0276.auth_date IS NULL' +
        ') AND'
      ''
      
        '       (data0276.user_ptr IN (SELECT rkey FROM data0073 WHERE rp' +
        'l_pr_ptr = :RKEY731))'
      
        'AND (Data0068.APPD_BY IN (SELECT rkey FROM data0073 WHERE rpl_pr' +
        '_ptr = :RKEY732))')
    Left = 95
    Top = 71
  ...
  object aq69: TADOQuery
    ...
    SQL.Strings = (
      'SELECT'
      '        data0017.inv_part_number as inv_number,'
      '        Data0017.inv_name as INV_PART_NUMBER,'
      '        Data0017.INV_PART_DESCRIPTION,Data0069.extra_req,'
      '        Data0069.QUANTITY,Data0069.UNIT_PRICE,data0069.o_i_flag,'
      
        '        Data0069.reply_DATE,Data0023.ABBR_NAME,Data0069.INVT_PTR' +
        ','
      '        Data0001.CURR_NAME,Data0002.UNIT_NAME,data0069.REQ_DATE,'
      '        Data0496.GROUP_DESC,Data0019.inv_group_desc,'
      '        data0069.reason,data0069.tax,data0069.tax_price'
      'FROM    Data0069 INNER JOIN'
      '        Data0017 ON Data0069.INVT_PTR = Data0017.RKEY INNER JOIN'
      '        Data0023 ON Data0069.SUPP_PTR = Data0023.RKEY INNER JOIN'
      '        Data0002 ON Data0069.UNIT_PTR = Data0002.RKEY INNER JOIN'
      
        '        Data0001 ON Data0069.PO_LINK_PTR = Data0001.RKEY INNER J' +
        'OIN'
      
        '        Data0496 ON Data0017.GROUP_PTR = Data0496.RKEY INNER JOI' +
        'N'
      '        Data0019 ON Data0496.group_ptr = Data0019.rkey'
    ...
    object aq69unit_price: TFloatField
      DisplayLabel = #19981#21547#31246#21333#20215
    ...
    object aq69curr_name: TStringField
      DisplayLabel = #36135#24065#31867#22411
      FieldName = 'curr_name'
    end
    ...
    object aq69in_out: TStringField
  ...
  object aq204: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       Data0204.QUANTITY_REQUIRED,Data0204.UNIT_PRICE,'
      '       Data0204.REQ_DATE,Data0001.CURR_NAME,Data0204.reason,'
      
        '       Data0204.reply_date,Data0002.UNIT_NAME,data0204.tax,data0' +
        '204.tax_price'
    ...
    object aq204curr_name: TStringField
      DisplayLabel = #36135#24065#31867#21035
      FieldName = 'curr_name'
    end
