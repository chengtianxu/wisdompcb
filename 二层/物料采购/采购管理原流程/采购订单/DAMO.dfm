object DM: TDM
  ...
  object AQ0070: TADOQuery
    ...
    object AQ0070PO_REV_NO: TStringField
      DisplayLabel = #37319#36141#37096#38376
      FieldName = 'PO_REV_NO'
      FixedChar = True
      Size = 10
    end
  ...
  object ADO72: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from  data0072 where rkey is null')
    Left = 237
    Top = 71
  ...
  object ADO0069: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       data0017.inv_name,data0017.inv_description,'
      '       data0023.abbr_name,data0002.unit_name,data0001.curr_name'
      'from'
      ' data0069,data0023,data0001,data0017,data0002'
      'where'
      ' data0069.supp_ptr=data0023.rkey and'
      ' data0069.po_link_ptr=data0001.rkey and'
      ' data0069.invt_ptr = data0017.rkey and'
      ' data0069.unit_ptr = data0002.rkey and'
      ' purch_req_ptr=:rkey')
    Left = 40
    Top = 260
  ...
  object ADO0204: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       data0023.abbr_name,data0001.curr_name,'
      '       data0002.unit_name'
      'from'
      ' data0204,data0023,data0001,data0002'
      'where'
      ' data0204.supplier_ptr=data0023.rkey and'
      ' data0204.po_link_ptr=data0001.rkey and'
      ' data0204.g_l_ptr = data0002.rkey and'
  ...
  object ADO28: TADOQuery
    ...
    SQL.Strings = (
      'select PRICE_1,tax_flag from data0028'
  ...
  object ADO04: TADOQuery
    ...
    SQL.Strings = (
      'select '
      'SEED_VALUE,SEED_FLAG from data0004'
      'where rkey=46')
    Left = 253
    Top = 194
