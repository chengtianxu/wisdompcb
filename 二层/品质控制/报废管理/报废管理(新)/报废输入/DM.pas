...
type
  Tdm1 = class(TDataModule)
    ...
    cdsINQTY_REJECT: TFloatField;
    cdsINPANELS: TIntegerField;
    cdsINREJ_CODE: TStringField;
    cdsINREJECT_DESCRIPTION: TStringField;
    cdsINWORK_ORDER_NUMBER: TStringField;
    cdsINDEPT_NAME: TStringField;
    adsINused_qty: TIntegerField;
    cdsINused_qty: TIntegerField;
    adsINrkey: TAutoIncField;
    cdsINrkey: TAutoIncField;
    adsINqty: TIntegerField;
    cdsINqty: TIntegerField;
  private
