object dm1: Tdm1
  ...
  object adsIN: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'if exists(select * from sysobjects where name='#39'#tmp999'#39')'#13#10#13#10'drop' +
      ' table #tmp999'#13#10#13#10'CREATE TABLE #tmp999 (qty INT DEFAULT 0)'#13#10#13#10'IN' +
      'SERT INTO #tmp999 VALUES(0)'#13#10';WITH CTE as'#13#10'('#13#10#9'SELECT D489.SOURC' +
      'E_PTR FROM Data0489 D489 WHERE D489.WO_PTR = :OUT06'#13#10#9'UNION ALL'#9 +
      #13#10#9'SELECT D489.SOURCE_PTR FROM Data0489 D489 '#13#10#9#9#9'INNER JOIN CTE' +
      #9'ON CTE.SOURCE_PTR = D489.WO_PTR'#13#10') '#13#10'SELECT D25.MANU_PART_NUMBE' +
      'R,D58.QTY_REJECT,D34.DEPT_NAME'#13#10#9',D58.PANELS,D39.REJ_CODE,D39.RE' +
      'JECT_DESCRIPTION,D06.WORK_ORDER_NUMBER '#13#10'                ,isnull' +
      '(D58.used_qty,0) used_qty,D58.rkey,b.qty'#13#10'FROM Data0058IN D58 IN' +
      'NER JOIN '#13#10#9#9#9'CTE ON D58.WO_PTR = CTE.SOURCE_PTR INNER JOIN '#13#10#9#9 +
      #9'Data0034 D34 ON D34.RKEY=D58.RESP_DEPT_PTR INNER JOIN '#13#10#9#9#9'Data' +
      '0006 D06 ON D58.WO_PTR = D06.RKEY INNER JOIN '#13#10#9#9#9'Data0025 D25 O' +
      'N D06.BOM_PTR = D25.RKEY INNER JOIN  '#13#10#9#9#9'Data0039 D39 ON D39.RK' +
      'EY = D58.REJECT_PTR cross join #tmp999 b'#13#10'where D58.QTY_REJECT -' +
      '  isnull(D58.used_qty,0) > 0'
    Parameters = <
      item
        Name = 'OUT06'
        DataType = ftString
    ...
    object adsINused_qty: TIntegerField
      FieldName = 'used_qty'
    end
    object adsINrkey: TAutoIncField
      FieldName = 'rkey'
      ReadOnly = True
    end
    object adsINqty: TIntegerField
      FieldName = 'qty'
    end
  end
  ...
  object cdsIN: TClientDataSet
    ...
    object cdsINQTY_REJECT: TFloatField
      DisplayLabel = #25253#24223'PCS'
      FieldName = 'QTY_REJECT'
      ReadOnly = True
    end
    object cdsINPANELS: TIntegerField
      DisplayLabel = #25253#24223'PNL'
      FieldName = 'PANELS'
      ReadOnly = True
    end
    object cdsINREJ_CODE: TStringField
      DisplayLabel = #32570#38519#20195#30721
      FieldName = 'REJ_CODE'
      ReadOnly = True
      Size = 5
    end
    object cdsINREJECT_DESCRIPTION: TStringField
      DisplayLabel = #32570#38519#21517#31216
      FieldName = 'REJECT_DESCRIPTION'
      ReadOnly = True
      Size = 30
    ...
    object cdsINDEPT_NAME: TStringField
      DisplayLabel = #36131#20219#24037#24207
      FieldName = 'DEPT_NAME'
      ReadOnly = True
      Size = 30
    end
    object cdsINused_qty: TIntegerField
      DisplayLabel = #24050#29992#25968#37327
      FieldName = 'used_qty'
    end
