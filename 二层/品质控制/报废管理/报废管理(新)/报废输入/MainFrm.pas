...
begin
  ...
  FillZD;
  FWhere := ' WHERE D58.if_stock = 0 and D58.TDATETIME >=getdate() AND D58.TDATETIME <= dateadd(day,1,getdate()) ';
...
begin
  ...
  try
    ...
    begin
      FWhere := 'WHERE D58.if_stock = 0 and D58.TDATETIME BETWEEN ' + QuotedStr(gDateTimeToStr(DateOf(LFrm.dtp1.Date) + TimeOf(LFrm.dtp2.Time)))
