...
var
  ...
  user_ptr,user_ptr_dept,rkey73, vprev,db_ptr: string;
   ...
   try
    ...
    try
      ...
      Lqry.Close;
          //showmessage('4');
      Lqry.SQL.Clear;
      Lqry.SQL.Add('select EMPLOYEE_ID from data0005 where rkey = ' + user_ptr);
      Lqry.Open;
      user_ptr_dept := Lqry.FieldByName('EMPLOYEE_ID').AsString;
      Lqry.Close;
           //  showmessage('5');
    finally
      Lqry.Free;
