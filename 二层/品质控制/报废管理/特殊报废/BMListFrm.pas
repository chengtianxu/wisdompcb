...
begin
  ...
  case rg1.ItemIndex of
    ...
    1:
    begin
      adsBMList.CommandText := 'SELECT RKey AS Rkey34, DEPT_CODE,null as step_no, DEPT_NAME  ' +
              ', CASE TTYPE WHEN 1 THEN ''工序'' WHEN 4 THEN ''部门'' WHEN 5 THEN ''班组'' END AS steptype '  +
              ' FROM Data0034 WHERE TTYPE in (1,4) ORDER BY TTYPE';
    end;
  end;
  adsBMList.Open;
