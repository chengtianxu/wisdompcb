...
//    dm1.adsIN.Close;         //打开内层预报废
//    dm1.adsIN.Parameters[0].Value:= dm1.qrytmp.fieldbyname('RKey06').AsString;
//    dm1.adsIN.Open;
  ...
  //取得当前工序
    ...
    begin
      dm1.qrytmp.Close;
      dm1.qrytmp.SQL.Clear;
      dm1.qrytmp.SQL.Add(' SELECT d25.rkey as rkey25,D56.STEP,D56.WTYPE, D06.QUAN_REJ,D25.MANU_PART_NUMBER,D25.MANU_PART_DESC,D06.PARTS_PER_PANEL, D34.DEPT_CODE, D34.RKey,D34.DEPT_NAME, D56.QTY_BACKLOG,D56.PANELS FROM Data0056 D56 ');
      ...
      edtPCS.Text:= Trim(lblZXPCS.Caption);
      edtPNL.Text:= Trim(lblZXPNL.Caption);
