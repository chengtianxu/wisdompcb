...
procedure TForm_customer.DBGrid2DblClick(Sender: TObject);
begin
if not ADs10.IsEmpty then ModalResult:=mrok;
end;

procedure TForm_customer.DBGrid2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if (key=13) and (not ADs10.IsEmpty) then ModalResult:=mrok;
end;

procedure TForm_customer.DBGrid2TitleClick(Column: TColumn);
begin
