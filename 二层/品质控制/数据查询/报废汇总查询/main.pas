...
uses Pick_Item_Single,ConstVar,common,detail, demo, UTogather;
...
begin
    where:='WHERE D58.if_stock = 0 and D58.TTYPE <> 2 '; //sql条件变量  2017-8-10 改成除成品报废外的报废
  for i:=1 to sgrid1.RowCount-2 do
...
//      end;
 ...
 begin
  ...
  select:='SUM(D58.QTY_REJECT) AS 报废PCS数,'+
    'ROUND(SUM(D58.QTY_REJECT*data0006.panel_ln*data0006.panel_wd*0.000001/data0006.PARTS_PER_PANEL),2) AS 含板边报废面积,'+
    'ROUND(SUM(D58.QTY_REJECT*Data0025.unit_sq),2) AS 报废面积 ,' +
    'ROUND(SUM(D58.QTY_REJECT*data0006.panel_ln*data0006.panel_wd*0.000001/data0006.PARTS_PER_PANEL/dbo.GetParentNum(data0025.rkey)),2) as 含板边顶层报废面积,'+
    'ROUND(SUM(D58.QTY_REJECT * dbo.Data0025.unit_sq/dbo.GetParentNum(data0025.rkey)),2) as 顶层报废面积 '+
    'FROM ' + tablename + ' D58 INNER JOIN Data0039 ON D58.REJECT_PTR=Data0039.RKEY '+
    'INNER JOIN Data0034 ON D58.RESP_DEPT_PTR=Data0034.RKEY '+
    'INNER JOIN Data0006 ON D58.WO_PTR=Data0006.RKEY '+
    'INNER JOIN Data0492 ON Data0006.cut_no=Data0492.cut_no '+
    'INNER JOIN Data0025 ON Data0006.BOM_PTR=Data0025.RKEY '+
  ...
  case cbb1.itemindex  of
    0:
    begin
     Lstr1:='convert(char(10),D58.TDATETIME,120) as 日期';
     Lstr11:='convert(char(10),D58.TDATETIME,120)' ;
    end ;
    1:
    begin
     Lstr1:='convert(char(7),D58.TDATETIME,120) as 月份';
     Lstr11:='convert(char(7),D58.TDATETIME,120)';
    end;
    2:
    begin
     Lstr1:='data0034.dept_name as 责任工序' ;
     Lstr11:='data0034.dept_name';
    end ;
    3:
    begin
     Lstr1:='Data0039.REJECT_DESCRIPTION as 按缺陷' ;
     Lstr11:='Data0039.REJECT_DESCRIPTION';
    end;
    4:
    begin
   ...
   case  cbb2.itemindex of
    0:
    begin
     Lstr2:='convert(char(10),D58.TDATETIME,120) as 日期';
     Lstr22:='convert(char(10),D58.TDATETIME,120)' ;
    end ;
    1:
    begin
     Lstr2:='convert(char(7),D58.TDATETIME,120) as 月份';
     Lstr22:='convert(char(7),D58.TDATETIME,120)';
    end;
    2:
    begin
     Lstr2:='data0034.dept_name as 责任工序' ;
     Lstr22:='data0034.dept_name';
    end ;
    3:
    begin
     Lstr2:='Data0039.REJECT_DESCRIPTION as 按缺陷' ;
     Lstr22:='Data0039.REJECT_DESCRIPTION';
    end;
    4:
    begin
    ...
    s:= 'select '+Lstr1+','+Lstr2+',' +select+where+' group by '+Lstr11+','+Lstr22+ ' order by '+Lstr11;
 ...
 // ShowMessage(s); Exit;
    ...
    s:=  'select '+Lstr1+',' +select+where+' group by '+Lstr11+ ' order by '+Lstr11;
   // showmessage(s);
    ...
    s:= 'select '+Lstr2+','+select+where+' group by '+Lstr22+ ' order by '+Lstr22;
    //showmessage(s);
...
procedure Tmain_form.rg1Click(Sender: TObject);
begin
begin
