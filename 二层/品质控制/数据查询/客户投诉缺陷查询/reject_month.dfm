object Form3: TForm3
  ...
  Width = 696
  Height = 480
  Caption = #25353#26376#20221#32479#35745#25253#24223#36235#21183
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      'SELECT TOP 100 PERCENT'
        ...
        'DATEPART(yy,Data0101.LOG_DATE)*100+DATEPART(mm,Data0101.LOG_DATE' +
        ') as reject_date,'
      '       SUM(Data0118.Qty) AS qty_total,'
      'ROUND(SUM(Data0118.Qty * dbo.Data0025.unit_sq), 2) AS sqft_total'
      ...
      ''
        ...
        'GROUP BY DATEPART(yy,Data0101.LOG_DATE) * 100 + DATEPART(mm,Data' +
        '0101.LOG_DATE)'
      
        'ORDER BY DATEPART(yy,Data0101.LOG_DATE) * 100 + DATEPART(mm,Data' +
        '0101.LOG_DATE)')
    Left = 196
    Top = 119
