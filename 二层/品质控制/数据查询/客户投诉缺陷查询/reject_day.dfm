object Form2: TForm2
  ...
  Width = 696
  Height = 480
  Caption = #25353#26085#32479#35745#25253#24223#36235#21183
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      'SELECT TOP 100 PERCENT'
        ...
        'CONVERT(datetime, CONVERT(varchar, Data0101.LOG_DATE, 101), 101)' +
        ' as reject_date,'
      '       SUM(Data0118.Qty) AS qty_total,'
      'ROUND(SUM(Data0118.Qty * Data0025.unit_sq), 2) AS sqft_total'
      ...
      '      (Data0101.LOG_DATE <= :dtpk2)'
        ...
        'GROUP BY CONVERT(datetime, CONVERT(varchar, Data0101.LOG_DATE, 1' +
        '01), 101)'
      
        'ORDER BY CONVERT(datetime, CONVERT(varchar, Data0101.LOG_DATE, 1' +
        '01), 101)')
    Left = 196
    Top = 119
    object ADOQuery1reject_date: TDateTimeField
