...
DATEPART(yy,Data0058.TDATETIME)*100+DATEPART(mm,Data0058.TDATETIME) as reject_date,
...
GROUP BY DATEPART(yy,Data0058.TDATETIME) * 100 + DATEPART(mm,Data0058.TDATETIME)
ORDER BY DATEPART(yy,Data0058.TDATETIME) * 100 + DATEPART(mm,Data0058.TDATETIME)
}
