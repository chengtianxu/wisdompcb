...
GROUP BY Data0025.MANU_PART_NUMBER,Data0025.MANU_PART_DESC
ORDER BY ROUND(SUM(dbo.Data0058.QTY_REJECT * dbo.Data0025.unit_sq), 2) DESC
}
unit reject_product;
...
while not self.adoquery1.Eof do
 begin
  Series1.Add(self.ADOQuery1sqft_total.Value,self.ADOQuery1MANU_PART_NUMBER.AsString);
  adoquery1.Next;
 end;
  adoquery1.first;
...
while not self.adoquery1.Eof do
 begin
  Series1.Add(self.ADOQuery1qty_total.Value,self.ADOQuery1MANU_PART_NUMBER.AsString);
  adoquery1.Next;
 end;
   adoquery1.first;
...
procedure TForm8.DBGridEh1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
