...
while not self.adoquery1.Eof do
 begin
  Series1.Add(self.ADOQuery1sqft_total.Value,self.ADOQuery1PROD_CODE.AsString);
  adoquery1.Next;
 end;
  adoquery1.first;
...
while not self.adoquery1.Eof do
 begin
  Series1.Add(self.ADOQuery1qty_total.Value,self.ADOQuery1PROD_CODE.AsString);
  adoquery1.Next;
 end;
   adoquery1.first;
