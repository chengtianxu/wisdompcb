...
begin
 ...
 10:sgrid1.Cells[2,sgrid_row]:='and D58.MRB_NO like ''%'+edit3.Text+'%''';
 11:sgrid1.Cells[2,sgrid_row]:='and data0006.WORK_ORDER_NUMBER like ''%'+edit3.Text+'%''';
 12:
  begin
   sgrid1.Cells[2,sgrid_row]:='and D58.ttype = '+inttostr(combobox1.ItemIndex);
   sgrid1.Cells[1,sgrid_row]:=combobox1.Text;
  end;
  13:sgrid1.Cells[2,sgrid_row]:='and D58.warehouse_ptr = '+inttostr(wh_ptr);
  ...
  16:sgrid1.Cells[2,sgrid_row]:=' and data0060.ORIG_CUSTOMER like ''%'+edit3.Text+'%''';
  17:
   begin
