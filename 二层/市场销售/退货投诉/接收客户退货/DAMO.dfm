object dm: Tdm
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        '                     case data0060.so_tp when 0 then '#39#33258#21046#39' when 1' +
        ' then '#39#22806#21457#39' when 2 then '#39#21322#21046#31243#39' end as sotp,'
      
        'dbo.Data0098.CUSTOMER_PART_PTR, dbo.Data0025.MANU_PART_NUMBER,db' +
        'o.Data0025.unit_sq, '
        ...
        'br_name END AS warehouse_name,dbo.Data0097.PO_NUMBER,'
      'data0098.remark'
  ...
  object ADO64: TADOQuery
    ...
    SQL.Strings = (
      ...
      '       quan_shipped,quan_credited,data0064.tax_2,'
