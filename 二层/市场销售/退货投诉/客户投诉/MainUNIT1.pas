...
begin
  ...
  try
      EditForm1.DBGridEh1.ReadOnly := False ;
      EditForm1.N1.Visible := true;
      EditForm1.N2.Visible := True;
      EditForm1.EditMode := 0 ;
      EditForm1.qty_org_rej := 0;
      ...
      begin
          ...
          if dm.adoq0101.fieldbyname('status').AsInteger = 0 then
              begin
                  ...
                  dm.TemADOQuery1.SQL.Add('select rkey from data0098 where shipment_ptr = '+ dm.ADOQALL2rkey.AsString );
