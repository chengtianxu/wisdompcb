...
begin
  try
    ...
    tmpAdo.Close;
    tmpAdo.SQL.Clear;
    tmpAdo.SQL.Text:='select * from data0592 order by iSort';
    tmpAdo.Open;
...
begin
  ...
  begin
    ...
    try
      ...
      IFSingKey2(FIsInsert,'data0592','d278Rkey',IntToStr(Edit1.Tag),'',dm.ADOConnection1);
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='select * from data0592 where iSort='+Trim(Edit4.Text)+'';
      tmpAdo.Open;
      ...
      begin
        ...
        tmpAdo.Close;
        tmpAdo.SQL.Clear;
        tmpAdo.SQL.Text:='select * from data0592 where iSort>='+Trim(Edit4.Text)+' order by iSort desc';
        tmpAdo.Open;
        if (not tmpAdo.IsEmpty) then
        begin
          tmpAdo.First;
          ...
          begin
            tmpAdo2.Close;
            tmpAdo2.SQL.Clear;
            tmpAdo2.SQL.Text:='Update data0592 set iSort='+IntToStr(tmpAdo.FieldBYName('iSort').AsInteger+1)+' where iSort='+tmpAdo.FieldBYName('iSort').AsString+'';
            tmpAdo2.ExecSQL;
            tmpAdo.Next;
          end;
        end;
      ...
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='Insert into data0592 (iSort,d278Rkey,ColName) Values (:iSort,:d278Rkey,:ColName)';
    ...
    try
      ...
      begin
        ...
        begin
          ...
          tmpAdo.Close;
          tmpAdo.SQL.Clear;
          tmpAdo.SQL.Text:='select * from data0592 where iSort>'+Trim(Edit4.Text)+' order by iSort';
          tmpAdo.Open;
          if (not tmpAdo.IsEmpty) then
          begin
            tmpAdo.First;
            ...
            begin
              tmpAdo2.Close;
              tmpAdo2.SQL.Clear;
              tmpAdo2.SQL.Text:='Update data0592 set iSort='+IntToStr(iOrder+1)+' where iSort='+tmpAdo.FieldBYName('iSort').AsString+'';
              tmpAdo2.ExecSQL;
              iOrder:=iOrder+1;
              tmpAdo.Next;
            end;
...
begin
  ...
  begin
    try
      ...
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='delete data0592 where iSort='+ads80iSort.AsString;
      tmpAdo.ExecSQL;
      tmpAdo.close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='select * from data0592 where isort>'+IntToStr(iNo)+' order by iSort';
      tmpAdo.Open;
      if (not tmpAdo.IsEmpty) then
      begin
        tmpAdo.First;
        ...
        begin
          tmpAdo2.Close;
          tmpAdo2.SQL.Clear;
          tmpAdo2.SQL.Text:='update data0592 set iSort='+IntToStr(iNo)+' where iSort='+tmpAdo.FieldBYName('iSort').AsString;
          iNo:=iNo+1;
          tmpAdo2.ExecSQL;
          tmpAdo.Next;
        end;
