...
type
  Tfind_CUSTOMER_PART_DESC_Form2 = class(TfindForm1)
...
begin //此事件每次都要改动
  inherited;
  self.EditDataChange(sender,ADOStoredProc1,'MANU_PART_DESC');

end;

procedure Tfind_CUSTOMER_PART_DESC_Form2.Temp_DBGridEh1TitleBtnClick(
...
procedure Tfind_CUSTOMER_PART_DESC_Form2.Temp_DBGridEh1DblClick(
  Sender: TObject);
begin
  inherited;
  if ADOStoredProc1.RecordCount >0 then
