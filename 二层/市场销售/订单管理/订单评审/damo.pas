...
type
  TDM = class(TDataModule)
    ...
    ado60_cancelCUST_CODE: TStringField;
    ADO97date_area: TBCDField;
    ADO97date_quantity: TIntegerField;
    Adoarea: TADOQuery;
    Adoquantity: TADOQuery;
    ADO97SHIP_REG_TAX_ID: TIntegerField;
    ADO97jinglilv_add: TBCDField;
