...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['物料替代单号','客户代码','送审人','状态']);
  v_Field_List_EN := VarArrayOf(['MATERIAL_REPLACE_NO','CUST_CODE','d05_ptr','check_status']);
...
begin
 ...
 try
  case ListBox3.ItemIndex of
    1:
    begin
      InputVar.Fields := 'CUST_CODE/客户编号/100,CUSTOMER_NAME/客户名称/150,';
