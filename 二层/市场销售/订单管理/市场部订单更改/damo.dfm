  ...
  object ADO60: TADOQuery
    ...
    SQL.Strings = (
      ...
      'Data0060.PROD_REL,data0060.ANALYSIS_CODE_1,'
        ...
        'Data0025.ONHOLD_SALES_FLAG,data0060.parts_alloc1,data0060.ORIG_C' +
        'USTOMER'
      ...
      '                      dbo.Data0060 INNER JOIN'
        ...
        'WHERE (Data0060.STATUS not in(3,4)) and (data0060.ENT_DATE >=:dt' +
        'pk1) and (data0060.ENT_DATE <=:dtpk2) '
      ' ')
    Left = 93
    Top = 64
    ...
    object ADO60sotp: TStringField
      DisplayLabel = #21152#24037#24418#24335
      FieldName = 'sotp'
      ReadOnly = True
      Size = 6
    end
    object strngfldADO60ANALYSIS_CODE_1: TStringField
      FieldName = 'ANALYSIS_CODE_1'
    end
    object ADO60bp06_ptr: TStringField
      FieldName = 'bp06_ptr'
      Size = 38
    end
    object ADO60rkey213: TIntegerField
      FieldName = 'rkey213'
    end
    object ADO60quote_flag: TBooleanField
      FieldName = 'quote_flag'
    end
    object ADO60ONHOLD_SALES_FLAG: TWordField
      FieldName = 'ONHOLD_SALES_FLAG'
    end
    object ADO60parts_alloc1: TFloatField
      FieldName = 'parts_alloc1'
    end
    object strngfldADO60ORIG_CUSTOMER: TStringField
