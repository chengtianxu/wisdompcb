object dm: Tdm
  ...
  object ADOQuery1: TADODataSet
    ...
    CommandText = 
      ...
      'HED_SHIP_DATE,data0001.CURR_NAME as '#36135#24065', '#13#10'      dbo.Data0060.CON' +
      'F_DATE, dbo.Data0060.PROD_REL AS D60PROD_REL, '#13#10'      dbo.Data00' +
      '60.MFG_ORDER_DATE, Data0060.so_style, Data0060.CUST_SHIP_ADDR_PT' +
      'R, '#13#10'      dbo.Data0005.EMPLOYEE_NAME AS D5EMPLOYEE_NAME, data00' +
      '23.code,data0023.ABBR_NAME, '#13#10'      dbo.Data0060.REFERENCE_NUMBE' +
      'R, dbo.Data0060.ORIG_REQUEST_DATE ,'#13#10'      dbo.Data0060.DUE_DATE' +
      ' AS D60DUE_DATE, dbo.Data0060.QUOTE_PRICE, data0060.PART_PRICE ,' +
      #13#10'      dbo.Data0060.SCH_DATE AS D60SCH_DATE, dbo.Data0097.PO_DA' +
      'TE, BOMPrice06.BPNO, '#13#10'      dbo.Data0060.ENT_DATE, Data0060.iss' +
      ...
      'RT_DESC,data0025.ANALYSIS_CODE_2,data0025.ONHOLD_SALES_FLAG,'#13#10'  ' +
      '   case data0060.so_tp when 0 then '#39#33258#21046#39' when 1 then '#39#22806#21457#39' when 2 ' +
      'then '#39#21322#21046#31243#39' end as sotp,Data0060.ORIG_CUSTOMER,Data0025.ttype,'#13#10' ' +
      '    case when data0085.TNUMBER is NULL then BOMPrice06.BPNO else' +
      ' data0085.TNUMBER end as TNUMBERs,'#13#10'     CASE WHEN data0085.TNUM' +
      'BER IS NULL THEN BOMPrice06.maolilv_add ELSE data0085.rate_margi' +
      'n END as maolilv_add,'#13#10'     BOMPrice06.jinglilv_add,'#13#10'     Data0' +
      '025.CPJS'#13#10'     ,round(Data0060.PARTS_ORDERED * Data0025.unit_sq,' +
      '4) as order_sq,data0008.PROD_CODE,data0008.PRODUCT_NAME'#13#10'     ,d' +
      'ata0007.PRODUCT_GROUP_NAME,data0619.category_name,data0008.diffi' +
      'culty_grade_value,data0008.PROD_INCREMENTBY'#13#10'FROM dbo.Data0005 I' +
      'NNER JOIN'#13#10'      dbo.Data0097 INNER JOIN'#13#10'      dbo.Data0060 INN' +
      'ER JOIN'#13#10'      dbo.Data0010 ON dbo.Data0060.CUSTOMER_PTR = dbo.D' +
      'ata0010.RKEY ON '#13#10'      dbo.Data0097.RKEY = dbo.Data0060.PURCHAS' +
      'E_ORDER_PTR ON '#13#10'      dbo.Data0005.RKEY = dbo.Data0060.ENTERED_' +
      'BY_EMPL_PTR INNER JOIN'#13#10'      dbo.Data0025 ON '#13#10'      dbo.Data00' +
      '60.CUST_PART_PTR = dbo.Data0025.RKEY INNER JOIN'#13#10'      dbo.Data0' +
      '001 ON dbo.Data0060.CURRENCY_PTR = dbo.Data0001.RKEY  LEFT OUTER' +
      ' JOIN'#13#10'      dbo.Data0005 Data0005_1 ON '#13#10'      dbo.Data0060.CON' +
      'F_BY_EMPL_PTR = Data0005_1.RKEY left outer join'#13#10'     data0023 o' +
      'n Data0060.supplier_ptr = data0023.RKEY left outer join'#13#10'     da' +
      'ta0085 on data0060.QTE_PTR = data0085.rkey left outer join'#13#10'    ' +
      ' BOMPrice06 on Data0060.BP06_ptr=BOMPrice06.IDKey inner join '#13#10' ' +
      '    Data0008 on data0008.RKEY=data0025.PROD_CODE_PTR inner join'#13 +
      #10'     Data0007 on data0007.RKEY=data0008.PR_GRP_POINTER left joi' +
      'n'#13#10'     DATA0619 on data0619.category=data0008.category'#13#10'WHERE D' +
      'ata0060.STATUS <> :v1 AND Data0060.STATUS <> :v2'#13#10'      AND Data' +
      '0060.STATUS <> :v3 AND Data0060.STATUS <> :v4'#13#10'      AND Data006' +
      '0.STATUS <> :v5 AND Data0060.STATUS <> :v6'#13#10'      AND Data0060.e' +
      'nt_date >=:dtpk1'#13#10'      AND Data0060.ent_date <=:dtpk2'
    ...
    object ADOQuery1rkey213: TIntegerField
      FieldName = 'rkey213'
      ReadOnly = True
      OnGetText = ADOQuery1rkey213GetText
    end
    ...
    object ADOQuery1BPNO: TStringField
      FieldName = 'BPNO'
      Size = 50
    end
    object ADOQuery1TNUMBERs: TStringField
      FieldName = 'TNUMBERs'
      ReadOnly = True
      Size = 50
    end
    ...
    object ADOQuery1maolilv_add: TBCDField
    ...
    object ADOQuery1order_sq: TFloatField
    ...
    object ADOQuery1category_name: TWideStringField
      DisplayLabel = #20135#21697#31867#21035#21517#31216
      FieldName = 'category_name'
      Size = 50
    end
    object ADOQuery1difficulty_grade_value: TFloatField
      DisplayLabel = #38454#25968
      FieldName = 'difficulty_grade_value'
    end
    object ADOQuery1PROD_INCREMENTBY: TSmallintField
      DisplayLabel = #23618#25968
      FieldName = 'PROD_INCREMENTBY'
    end
    object ADOQuery1jinglilv_add: TBCDField
  ...
  object ADOQuery4: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      RUSH_CHARGE_PCT_USED, CONSUME_FORECASTS, BACKWARD_DAYS, '
        ...
        'kSO,RemarkAudit,bp06_ptr,ORIG_CUSTOMER,PARTS_ALLOC1,Print2DKey'
      'FROM dbo.Data0060'
      'where rkey= :p1')
    Left = 352
    Top = 120
    ...
    object ADOQuery4PARTS_ALLOC1: TFloatField
      FieldName = 'PARTS_ALLOC1'
    end
    object ADOQuery4so_oldnew: TStringField
      FieldName = 'so_oldnew'
      Size = 10
    end
    object ADOQuery4Print2DKey: TIntegerField
  ...
  object Ado60_53: TADOQuery
    ...
    SQL.Strings = (
        ...
        'data0010.ABBR_NAME,Data0008.PRODUCT_NAME, Data0008.PROD_CODE, '
        ...
        '2 THEN '#39#36820#20462#37325#26816#20837#20179#39' WHEN 3 THEN '#39#30452#25509#20837#20179#39' WHEN 4 THEN '#39#22996#22806#21152#24037#20837#20179#39
      
        'WHEN 5 THEN '#39#22996#22806#21152#24037#36864#36135#20837#20179#39' WHEN 6 THEN '#39#38144#21806#36864#36135#20837#20179#39' WHEN 7 THEN '#39#36716#25442#20837#20179#39' W' +
        'HEN 8 THEN '#39#29305#27530#20837#20179#39' END AS c_type,'
      
        'CASE t25.TTYPE WHEN 0 THEN '#39#37327#20135#39' WHEN 1 THEN '#39#26679#26495#39' ELSE '#39#26410#23450#20041#39' END ' +
        'AS TTYPE,t53.QTY_ON_HAND,'
      
        'ROUND(t53.QTY_ON_HAND * t25.unit_sq, 4)AS so_mianji,t53.MFG_DATE' +
        ',Data0016.LOCATION,t60.SCH_DATE,'
      
        'CASE t60.COMMISION_ON_TOOLING WHEN '#39'Y'#39' THEN '#39#36716#21378#39' WHEN '#39'N'#39' THEN '#39 +
        #20869#38144#39' END AS COMMISION_ON_TOOLING60'
      'from data0053 t53'
      'left join data0060 t60 on t53.barcode_ptr = t60.RKEY'
      'inner join data0025 t25 on t53.CUST_PART_PTR = t25.RKEY'
      'inner join Data0010 on t60.CUSTOMER_PTR=Data0010.RKEY'
      'inner join Data0016 on t53.LOC_PTR=Data0016.RKEY'
      'inner join Data0008 on t25.PROD_CODE_PTR=Data0008.RKEY'
      'where t60.SCH_DATE<=getdate()'
      'and t53.QTY_ON_HAND>0 '
      'and t53.barcode_ptr<>'#39#39
      'and t25.MANU_PART_NUMBER=:MANU_PART_NUMBER')
    Left = 384
    Top = 328
    object Ado60_53MANU_PART_NUMBER: TStringField
      FieldName = 'MANU_PART_NUMBER'
    end
    object Ado60_53MANU_PART_DESC: TStringField
      FieldName = 'MANU_PART_DESC'
      Size = 80
    end
    object Ado60_53SALES_ORDER: TStringField
      FieldName = 'SALES_ORDER'
      FixedChar = True
      Size = 12
    end
    object Ado60_53ABBR_NAME: TStringField
      FieldName = 'ABBR_NAME'
      Size = 10
    end
    object Ado60_53PRODUCT_NAME: TStringField
      FieldName = 'PRODUCT_NAME'
      Size = 30
    end
    object Ado60_53PROD_CODE: TStringField
      FieldName = 'PROD_CODE'
      Size = 10
    end
    object Ado60_53c_type: TStringField
      FieldName = 'c_type'
      ReadOnly = True
      Size = 16
    end
    object Ado60_53TTYPE: TStringField
      FieldName = 'TTYPE'
      ReadOnly = True
      Size = 6
    end
    object Ado60_53QTY_ON_HAND: TFloatField
      FieldName = 'QTY_ON_HAND'
    end
    object Ado60_53so_mianji: TFloatField
      FieldName = 'so_mianji'
      ReadOnly = True
    end
    object Ado60_53MFG_DATE: TDateTimeField
      FieldName = 'MFG_DATE'
    end
    object Ado60_53LOCATION: TStringField
      FieldName = 'LOCATION'
    end
    object Ado60_53SCH_DATE: TDateTimeField
      FieldName = 'SCH_DATE'
    end
    object Ado60_53COMMISION_ON_TOOLING60: TStringField
  ...
  object AdoSP2: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     dbo.Data0010.CUST_CODE, dbo.Data0010.CUSTOMER_NAME, d' +
        'bo.Data0010.CONTACT_NAME_1, dbo.Data0025.ttype, '
      
        '                      dbo.Data0010.CONTACT_NAME_2, dbo.Data0010.' +
        'CONTACT_NAME_3, dbo.Data0010.CONTACT_NAME_4, dbo.Data0010.CONTAC' +
        'T_NAME_5, '
      
        '                      dbo.Data0010.CONTACT_NAME_6, dbo.Data0010.' +
        'INTERNAL_ECN_COUNT, dbo.Data0010.EXTERNAL_ECN_COUNT, '
      
        '                      dbo.Data0025.MANU_PART_NUMBER, dbo.Data002' +
        '5.MANU_PART_DESC, dbo.Data0010.FED_TAX_ID_NO, dbo.Data0060.ORIG_' +
        'CUSTOMER, '
      
        '                      dbo.Data0025.QTY_ON_HAND, dbo.Data0025.QTY' +
        '_ALLOC, dbo.Data0097.RKEY, dbo.Data0097.PO_NUMBER, dbo.Data0097.' +
        'PO_DATE, '
      
        '                      dbo.Data0025.set_qty, dbo.Data0001.CURR_CO' +
        'DE, dbo.Data0001.CURR_NAME, dbo.Data0025.SHELF_LIFE, dbo.Data002' +
        '5.unit_sq, '
      
        '                      dbo.Data0010.quote_flag, dbo.Data0010.CRED' +
        'IT_RATING, dbo.Data0010.CREDIT_LIMIT, dbo.Data0060.CUSTOMER_PTR,' +
        ' dbo.Data0008.LEAD_TIME, '
      
        '                      dbo.Data0025.ANALYSIS_CODE_2,data0060.Rema' +
        'rkSO,data0060.RemarkAudit,D05_1.RKEY as D05_1Rkey,D05_1.EMPLOYEE' +
        '_NAME as D05_1EMPLOYEE_NAME,'
      
        '                      Data0025.RKEY as rkey25,Data0025.remark as' +
        ' Remark25,Data0025.eng_note as eng_note25,data0008.PRODUCT_NAME,'
      
        '                      Data0085.RKEY as rkey85,Data0085.TNUMBER a' +
        's TNUMBER85,Data0023.code as code23,Data0023.supplier_name as su' +
        'pplier_name23,'
      
        '                      D05_2.EMPLOYEE_NAME AS '#36755#20837#20154#21592',D05_3.EMPLOYEE' +
        '_NAME AS '#30830#35748#20154#21592',Data0015.WAREHOUSE_CODE, dbo.Data0015.WAREHOUSE_NA' +
        'ME,'
      
        '                      Data0012.location,Data0012.SHIP_CTAX_PTR,D' +
        'ata0012.ship_lead_time,data0189.state_id,data0189.state_tax,Data' +
        '0060.qte_ptr,data0060.Print2DKey,data0010.rkey as rkey10'
      'FROM         dbo.Data0060 INNER JOIN'
        ...
        '                      Data0012 on data0060.CUST_SHIP_ADDR_PTR=Da' +
        'ta0012.RKEY inner join'
      
        '                      data0189 on data0012.SHIP_CTAX_PTR=data018' +
        '9.rkey inner join'
      
        '                      Data0005 as D05_2 on data0060.ENTERED_BY_E' +
        'MPL_PTR=D05_2.RKEY left join'
      
        '                      Data0005 as D05_3 on data0060.CONF_BY_EMPL' +
        '_PTR=D05_3.RKEY left join'
      
        '                      Data0005 as D05_1 on data0060.COMM_ASSIGNE' +
        'D_BY_E_P=D05_1.RKEY left join'
      
        '                      Data0085 on data0060.qte_ptr=Data0085.RKEY' +
        ' left join'
      
        '                      Data0023 on Data0060.supplier_ptr=Data0023' +
        '.RKEY left join'
      
        '                      Data0015 on data0060.SHIP_REG_TAX_ID=Data0' +
        '015.RKEY'
    ...
    object AdoSP2LEAD_TIME: TSmallintField
      FieldName = 'LEAD_TIME'
    end
    object AdoSP2ANALYSIS_CODE_2: TStringField
      FieldName = 'ANALYSIS_CODE_2'
      Size = 80
    end
    object AdoSP2RemarkSO: TMemoField
      FieldName = 'RemarkSO'
      BlobType = ftMemo
    end
    object AdoSP2RemarkAudit: TMemoField
      FieldName = 'RemarkAudit'
      BlobType = ftMemo
    end
    object AdoSP2D05_1Rkey: TIntegerField
      FieldName = 'D05_1Rkey'
      ReadOnly = True
    end
    object AdoSP2D05_1EMPLOYEE_NAME: TStringField
      FieldName = 'D05_1EMPLOYEE_NAME'
      Size = 16
    end
    object AdoSP2rkey25: TIntegerField
      FieldName = 'rkey25'
      ReadOnly = True
    end
    object AdoSP2Remark25: TMemoField
      FieldName = 'Remark25'
      BlobType = ftMemo
    end
    object AdoSP2eng_note25: TStringField
      FieldName = 'eng_note25'
      Size = 200
    end
    object AdoSP2rkey85: TIntegerField
      FieldName = 'rkey85'
      ReadOnly = True
    end
    object AdoSP2TNUMBER85: TStringField
      FieldName = 'TNUMBER85'
      Size = 10
    end
    object AdoSP2code23: TStringField
      FieldName = 'code23'
      Size = 10
    end
    object AdoSP2supplier_name23: TStringField
      FieldName = 'supplier_name23'
      Size = 100
    end
    object AdoSP2DSDesigner: TStringField
      FieldName = #36755#20837#20154#21592
      Size = 16
    end
    object AdoSP2DSDesigner2: TStringField
      FieldName = #30830#35748#20154#21592
      Size = 16
    end
    object AdoSP2WAREHOUSE_CODE: TStringField
      FieldName = 'WAREHOUSE_CODE'
      Size = 5
    end
    object AdoSP2WAREHOUSE_NAME: TStringField
      FieldName = 'WAREHOUSE_NAME'
      Size = 70
    end
    object AdoSP2location: TStringField
      FieldName = 'location'
      Size = 80
    end
    object AdoSP2SHIP_CTAX_PTR: TIntegerField
      FieldName = 'SHIP_CTAX_PTR'
    end
    object AdoSP2ship_lead_time: TSmallintField
      FieldName = 'ship_lead_time'
    end
    object AdoSP2state_id: TStringField
      FieldName = 'state_id'
      Size = 10
    end
    object AdoSP2state_tax: TBCDField
      FieldName = 'state_tax'
      Precision = 4
      Size = 2
    end
    object AdoSP2qte_ptr: TIntegerField
      FieldName = 'qte_ptr'
    end
    object AdoSP2Print2DKey: TIntegerField
      FieldName = 'Print2DKey'
    end
    object AdoSP2rkey10: TIntegerField
      FieldName = 'rkey10'
      ReadOnly = True
    end
    object AdoSP2PRODUCT_NAME: TStringField
      FieldName = 'PRODUCT_NAME'
      Size = 30
    end
  end
  object Ado04: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select *  from data0004 where table_name='#39'data0060'#39)
    Left = 536
    Top = 24
    ...
    object Ado04FieldName: TStringField
      FieldName = 'FieldName'
      Size = 100
    end
  end
