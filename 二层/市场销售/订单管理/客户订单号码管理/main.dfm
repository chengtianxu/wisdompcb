object frmMain: TfrmMain
  ...
  object Panel1: TPanel
    ...
    object lblFilter: TLabel
      ...
      Caption = #23458#25143#35746#21333#21495#30721
    end
  ...
  object aq97: TADOQuery
    ...
    Left = 816
    Top = 192
    object aq97RKEY: TAutoIncField
      FieldName = 'RKEY'
      ReadOnly = True
    end
    object aq97PO_NUMBER: TStringField
      FieldName = 'PO_NUMBER'
      Size = 32
    end
    object aq97CUSTOMER_PTR: TIntegerField
      FieldName = 'CUSTOMER_PTR'
    end
    object aq97PO_DATE: TDateTimeField
      FieldName = 'PO_DATE'
    end
    object aq97OPEN_SOS: TSmallintField
      FieldName = 'OPEN_SOS'
    end
    object aq97flag: TStringField
      FieldName = 'flag'
      FixedChar = True
      Size = 1
    end
    object aq97dept_ptr: TIntegerField
      FieldName = 'dept_ptr'
    end
    object aq97file_content: TBlobField
      FieldName = 'file_content'
    end
    object aq97remark: TStringField
      FieldName = 'remark'
      Size = 100
    end
    object aq97filename: TStringField
      FieldName = 'filename'
      Size = 50
    end
  end
  ...
  object adsBrowse: TADODataSet
    ...
    CommandText = 
      ...
      't5 ON t97.dept_ptr = t5.RKEY'#13#10'WHERE (1=1)'#13#10'and t97.PO_DATE Betwe' +
      'en :dtpk1 And :dtpk2'
    Parameters = <
      item
        Name = 'dtpk1'
    ...
    object adsBrowsePO_NUMBER: TStringField
      DisplayLabel = #23458#25143#35746#21333#21495#30721
      DisplayWidth = 20
      FieldName = 'PO_NUMBER'
      Size = 32
    end
    object adsBrowsePO_DATE: TDateTimeField
      DisplayLabel = #35746#21333#26085#26399
      FieldName = 'PO_DATE'
    end
    object adsBrowseOPEN_SOS: TSmallintField
      DisplayLabel = #35746#21333#26126#32454#25968#30446
      DisplayWidth = 15
      FieldName = 'OPEN_SOS'
    end
