...
begin
  ...
  2:                          //订单类型
    begin
      ...
      combobox1.Items.Add('复投单');
      combobox1.Items.Add('复投变更单');
...
begin
  ...
  case listbox3.ItemIndex of
   0:  //RFQ 编号
    sgrid1.Cells[2,sgrid_row]:=' and RFQNo like ''%' + edit3.Text + '%''';
   1:  //客户代码
    sgrid1.Cells[2,sgrid_row]:=' and Cust_Id = ''' + edit3.Text + '''';
   2:  //订单类型
    begin
      sgrid1.Cells[2,sgrid_row]:=' and POType = ' + inttostr(combobox1.ItemIndex);
...
procedure TForm_condition.SGrid1DrawCell(Sender: TObject; ACol,
