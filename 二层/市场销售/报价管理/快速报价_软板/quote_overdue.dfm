object Form_overdue: TForm_overdue
  ...
  object ADS85: TADODataSet
    ...
    CommandText = 
      ...
      ', Data0085.EXPIRATION_DATE, '#13#10'      Data0005.EMPLOYEE_NAME, data' +
      '0009.REP_CODE,'#13#10'     data0009.SALES_REP_NAME,data0008.prod_code,' +
      #13#10'     data0008.product_name,data0264.code,data0264.QTE_APPROV_D' +
      'ESC,'#13#10'    data0346.ROW_NAME,data0085.QBY_EMPL_PTR,'#13#10'case Data008' +
      '5.ttype2 when 0 then '#39#26032#21333#39' when 1 then '#39#26356#25913#24037#33402#39' '#13#10'when 2 then '#39#26448#26009#35843#20215 +
      #39' when 3 then '#39#20854#23427#39' end as '#31867#22411','#13#10'case Data0085.AUDITED_STATUS when' +
      ' 0 then '#39#26410#25552#20132#39#13#10'when 1 then '#39#24453#23457#25209#39' when 2 then '#39#24050#36807#26399#39' '#13#10'when 3 then' +
      ' '#39#24050#23457#25209#39' when 4 then '#39#34987#36864#22238#39' end as '#29366#24577#13#10#13#10'FROM dbo.Data0085 INNER JO' +
      'IN'#13#10'      Data0005 ON dbo.Data0085.QBY_EMPL_PTR = dbo.Data0005.R' +
      'KEY INNER JOIN'#13#10'      Data0001 ON dbo.Data0085.CURR_PTR = dbo.Da' +
      'ta0001.RKEY inner join'#13#10'      data0009 on data0085.srep_ptr = da' +
      'ta0009.rkey inner join '#13#10'      data0008 on data0085.PROD_CODE_PT' +
      'R=data0008.rkey inner join '#13#10'      data0264 on data0085.PROD_ROU' +
      'TE_PTR=data0264.rkey inner join '#13#10'      data0346 on data0085.ENG' +
      'R_ROUTE_PTR=data0346.rkey'#13#10'where data0085.ttype=0 and'#13#10'         ' +
      ' data0085.AUDITED_STATUS=3 and'#13#10'          data0085.expiration_da' +
      'te < :taday_date'
