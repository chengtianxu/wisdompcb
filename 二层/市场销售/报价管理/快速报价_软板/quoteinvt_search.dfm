object Form_quoteinvt: TForm_quoteinvt
  ...
  object ads28: TADODataSet
    ...
    CommandText = 
      ...
      'S d0017_rkey, '#13#10'dbo.Data0496.rkey as rkey496,'#13#10'      dbo.Data000' +
      '2.UNIT_NAME, dbo.Data0001.CURR_NAME, '#13#10'      dbo.Data0001.BASE_T' +
      'O_OTHER'#13#10'FROM dbo.Data0002 INNER JOIN'#13#10'      dbo.Data0028 INNER ' +
      'JOIN'#13#10'      dbo.Data0023 ON dbo.Data0028.SUPPLIER_PTR = dbo.Data' +
      '0023.RKEY INNER JOIN'#13#10'      dbo.Data0017 ON dbo.Data0028.INVENTO' +
      'RY_PTR = dbo.Data0017.RKEY INNER JOIN'#13#10'      dbo.Data0001 ON dbo' +
      '.Data0028.CURRENCY_PTR = dbo.Data0001.RKEY INNER JOIN'#13#10'      dbo' +
      '.Data0496 ON dbo.Data0017.GROUP_PTR = dbo.Data0496.RKEY ON '#13#10'   ' +
      '   dbo.Data0002.RKEY = dbo.Data0028.PURCHASE_UNIT_PTR'#13#10'WHERE (Da' +
      'ta0028.QTE_PRICE > 0) AND '#13#10'              (Data0496.quote_flag =' +
      ' 1) and'#13#10'              (data0028.AVL_FLAG <> '#39'N'#39') and'#13#10'         ' +
      '     (data0023.status = 0)  and'#13#10'              (data0028.quote_t' +
      'ype = :quotetype) and'#13#10'              (Data0017.INV_PART_NUMBER l' +
      'ike :invnumber)'
    ...
    object ads28rkey496: TIntegerField
      FieldName = 'rkey496'
      ReadOnly = True
    end
  end
