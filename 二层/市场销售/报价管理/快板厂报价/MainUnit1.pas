...
begin
  ...
  try
    ...
    begin
       //showmessage('k');
       if dm.ADODataSet2.Active then dm.ADODataSet2.Close;
       if dm.wzcx56_1.Active then dm.wzcx56_1.Close;
       if dm.ADODataSet2.Active then dm.ADODataSet2.Close;

       dm.wzcx56_1.Parameters.ParamValues['@if1']:=1;
       dm.wzcx56_1.Parameters.ParamValues['@wher1']:=If_Form1.parametersvalue1;
       dm.wzcx56_1.Parameters.ParamValues['@wher2']:=If_Form1.parametersvalue1;
       dm.wzcx56_1.Parameters.ParamValues['@wher3']:=If_Form1.parametersvalue2;
       dm.wzcx56_1.Parameters.ParamValues['@wher4']:=If_Form1.parametersvalue3;
       dm.wzcx56_1.Parameters.ParamValues['@wher5']:=If_Form1.parametersvalue4;
       dm.wzcx56_1.Parameters.ParamValues['@wher6']:=If_Form1.parametersvalue5;
       dm.wzcx56_1.Parameters.ParamValues['@wher7']:=If_Form1.parametersvalue7;
       dm.wzcx56_1.Parameters.ParamValues['@ISSUE_DATE1']:=//datetostr(If_Form1.DateTimePicker1.Date);
                                                            FormatDateTime('yyyy-MM-dd',If_Form1.DateTimePicker1.Date)
                                                              +' '+FormatDateTime('HH:MM:SS',If_Form1.DateTimePicker3.Time);

       dm.wzcx56_1.Parameters.ParamValues['@ISSUE_DATE2']:=//datetostr(If_Form1.DateTimePicker2.Date);
                                                            FormatDateTime('yyyy-MM-dd',If_Form1.DateTimePicker2.Date)
                                                              +' '+FormatDateTime('HH:MM:SS',If_Form1.DateTimePicker4.Time);

       dm.wzcx56_1.Prepared;
       dm.wzcx56_1.Open;
       //dm.ADODataSet2.Open;
       DBGridEh1.SetFocus;
    end;
