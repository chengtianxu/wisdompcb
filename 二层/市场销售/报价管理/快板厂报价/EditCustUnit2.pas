...
uses
  ...
  Dialogs, BaseUnit1, Buttons, StdCtrls, Mask, DB, ADODB;

type
  TEditCustForm2 = class(TBaseForm1)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    Label4: TLabel;
...
procedure TEditCustForm2.BitBtn1Click(Sender: TObject);
begin
  inherited;
  //新客户
...
function TEditCustForm2.Get_RkeyData01: integer;
begin
   result := vRkeyData01 ;
end;

function TEditCustForm2.Get_RkeyData08: integer;
begin
   result := vRkeyData08 ;
end;

function TEditCustForm2.Get_RkeyData09: integer;
begin
   result := vRkeyData09 ;
end;

function TEditCustForm2.Get_RkeyData10: integer;
begin
   result := vRkeyData10 ;
end;

procedure TEditCustForm2.Set_RkeyData01(const Value: integer);
begin
   vRkeyData01 := value ;
end;

procedure TEditCustForm2.Set_RkeyData08(const Value: integer);
begin
  vRkeyData08 := value ;
end;

procedure TEditCustForm2.Set_RkeyData09(const Value: integer);
begin
  vRkeyData09 := value ;
end;

procedure TEditCustForm2.Set_RkeyData10(const Value: integer);
begin
  vRkeyData10 := value ;
end;

procedure TEditCustForm2.BitBtn3Click(Sender: TObject);
begin
  inherited;
...
procedure TEditCustForm2.BitBtn4Click(Sender: TObject);
begin
  inherited;
...
procedure TEditCustForm2.BitBtn5Click(Sender: TObject);
begin
  inherited;
...
procedure TEditCustForm2.BitBtn2Click(Sender: TObject);
begin
  inherited;
  modalresult:=mrCancel	;
end;

function TEditCustForm2.DisplayData: boolean;
begin
    result := false ;
...
procedure TEditCustForm2.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TEditCustForm2.CheckBox1Click(Sender: TObject);
begin
  inherited;
