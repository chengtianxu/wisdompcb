SELECT * FROM DATA0419 WHERE PROGRAME = 'qwzpr85.exe'
...
BEGIN TRANSACTION compile_all --开始事务
  ...
  set @description2 = '智能报价' --二组菜单名

  set @description ='快速报价　系统（快板）' --标识  '快速报价　审核（快板）'
  set @PROGRAME ='qwzpr85.exe' --程序名字 --'qwzpr85274.exe' 
