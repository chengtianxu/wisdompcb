object DM: TDM
  ...
  object ADS85: TADODataSet
    ...
    CommandText = 
      ...
      'orig_customer'#13#10'FROM   Data0085 INNER JOIN'#13#10'       Data0005 ON Da' +
      ...
      '85.TType2=dbo.data0086.ttype2'#13#10'WHERE  Data0085.AUDITED_STATUS = ' +
      '1 and'#13#10'       data0274.user_ptr=:rkey73'#13#10'       '
