object dm: Tdm
  ...
  object ADS85: TADODataSet
    ...
    CommandText = 
      ...
      '85.UNIT_WTH*0.001) end AS '#26412#24065#24179#31859#23454#25253#20215#13#10',case when data0085.QTE_UNIT_' +
      'PTR = 1 then  data0085.QTE_UNITS * data0085.USHEET'#13#10'when data008' +
      '5.QTE_UNIT_PTR = 2 THEN  data0085.QTE_UNITS*data0085.USHEET/data' +
      '0085.TUNITS END AS '#26412#24065#24179#31859#23454#25253#20215'FPC'#13#10',data0085.rate_margin, data0085.S' +
      'ALES_ORDERS_ENTERED,'#13#10'data0085.apprv_date, data0085.cust_add2,da' +
      'ta0085.quote_type,'#13#10'case when TUNITS >0 then'#13#10'round(data0085.SAL' +
      'ES_ORDERS_ENTERED*data0085.UNIT_LEN*data0085.UNIT_WTH*0.000001'#13#10 +
      '/data0085.TUNITS,4) else 0 end as mian_ji,data0242.PaperNO,IsNul' +
      'l(data0010.CUST_CODE,'#39#39') as CUST_CODE,'#13#10'data0085.UNIT_LEN,data00' +
      '85.UNIT_WTH,data0085.TUNITS,data0085.QTE_USHEET,DATA0085.MATL_CO' +
      'ST,'#13#10'DATA0085.base_pcscost,DATA0085.CUST_QTE_FACTOR,DATA0085.com' +
      'm_cost,DATA0085.QTE_CONTROL5'#13#10'FROM dbo.Data0085 INNER JOIN'#13#10'    ' +
      '  Data0005 ON dbo.Data0085.QBY_EMPL_PTR = dbo.Data0005.RKEY INNE' +
      'R JOIN'#13#10'      Data0001 ON dbo.Data0085.CURR_PTR = dbo.Data0001.R' +
      'KEY inner join'#13#10'      data0005 as d05 on data0085.srep_ptr = d05' +
      '.rkey inner join '#13#10'      data0008 on data0085.PROD_CODE_PTR=data' +
      '0008.rkey inner join '#13#10'      data0264 on data0085.PROD_ROUTE_PTR' +
      '=data0264.rkey LEFT OUTER JOIN'#13#10'      data0346 on data0085.ENGR_' +
      'ROUTE_PTR=data0346.rkey LEFT OUTER JOIN'#13#10'      data0242 on data0' +
      '085.ptr_242=data0242.RKEY LEFT OUTER JOIN'#13#10'      data0010 on dat' +
      'a0085.CUST_PTR=data0010.RKEY inner join'#13#10'      data0086 on dbo.d' +
      'ata0085.TType2=dbo.data0086.ttype2'#13#10'where data0085.ttype=0 and'#13#10 +
      '           Data0085.QTE_DATE >= :dtpk1 and '#13#10'           Data0085' +
      '.QTE_DATE <= :dtpk2'
    ...
    object ADS85MARKUP: TFloatField
      DisplayLabel = #25104#26412#27611#21033#29575'%'
      DisplayWidth = 10
      FieldName = 'MARKUP'
    end
    ...
    object ADS85DSDesigner4: TFloatField
      DisplayLabel = #26412#24065#24179#31859#23454#25253#20215'(HDI)'
    ...
    object ADS85CUST_QTE_FACTOR: TFloatField
      FieldName = 'CUST_QTE_FACTOR'
    end
    object ADS85QTE_CONTROL5: TStringField
    ...
    object ADS85FPC: TFloatField
      DisplayLabel = #26412#24065#24179#31859#23454#25253#20215'(FPC)'
      FieldName = #26412#24065#24179#31859#23454#25253#20215'FPC'
      ReadOnly = True
      DisplayFormat = '#,##0.##'
    end
  end
