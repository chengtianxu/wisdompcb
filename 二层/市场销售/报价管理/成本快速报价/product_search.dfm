object Form_product: TForm_product
  ...
  object ads50: TADODataSet
    ...
    CommandText = 
      ...
      'dth, '#13#10'      dbo.Data0025.spell_qty,data0025.EST_SCRAP,data0025.' +
      'ORIG_CUSTOMER'#13#10'FROM dbo.Data0025 INNER JOIN'#13#10'      dbo.Data0008 ' +
      'ON '#13#10'      dbo.Data0025.PROD_CODE_PTR = dbo.Data0008.RKEY INNER ' +
      'JOIN'#13#10'      dbo.Data0010 ON dbo.Data0025.CUSTOMER_PTR = dbo.Data' +
      '0010.RKEY'#13#10'WHERE (dbo.Data0025.PARENT_PTR IS NULL)'#13#10'         and' +
      ' data0010.cust_code like :custcode'#13#10'         and Data0025.MANU_P' +
      'ART_NUMBER like :partnumber'
    ...
    object ads50ORIG_CUSTOMER: TStringField
