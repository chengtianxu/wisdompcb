...
type
  TForm_product = class(TForm)
    ...
    ads50spell_lngth: TBCDField;
    ads50spell_width: TBCDField;
    ads50spell_qty: TIntegerField;
    ads50EST_SCRAP: TFloatField;
    ads50ORIG_CUSTOMER: TStringField;
