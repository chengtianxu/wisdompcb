object Form_quoteinvt: TForm_quoteinvt
  ...
  object ads28: TADODataSet
    ...
    CommandText = 
      ...
      'NAME, '#13#10'      dbo.Data0001.BASE_TO_OTHER'#13#10'FROM dbo.Data0002 INNE' +
      'R JOIN'#13#10'      dbo.Data0028 INNER JOIN'#13#10'      dbo.Data0023 ON dbo' +
      '.Data0028.SUPPLIER_PTR = dbo.Data0023.RKEY INNER JOIN'#13#10'      dbo' +
      '.Data0017 ON dbo.Data0028.INVENTORY_PTR = dbo.Data0017.RKEY INNE' +
      'R JOIN'#13#10'      dbo.Data0001 ON dbo.Data0028.CURRENCY_PTR = dbo.Da' +
      'ta0001.RKEY INNER JOIN'#13#10'      dbo.Data0496 ON dbo.Data0017.GROUP' +
      '_PTR = dbo.Data0496.RKEY ON '#13#10'      dbo.Data0002.RKEY = dbo.Data' +
      '0028.PURCHASE_UNIT_PTR'#13#10'WHERE (Data0028.QTE_PRICE > 0) AND '#13#10'   ' +
      '           (Data0496.quote_flag = 1) and'#13#10'              (data002' +
      '8.AVL_FLAG <> '#39'N'#39') and'#13#10'              (data0023.status = 0) and'#13 +
      #10'              (Data0017.INV_PART_NUMBER like :invnumber)'#13#10
