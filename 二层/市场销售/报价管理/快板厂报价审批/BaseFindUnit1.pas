...
var
  BaseFindForm1: TBaseFindForm1;

implementation

{$R *.dfm}

procedure TBaseFindForm1.Temp_DBGridEh1DrawColumnCell(Sender: TObject;
...
procedure TBaseFindForm1.DrawDBGridEHColorCol(DBGridEHName: TDBGridEH;
...
procedure TBaseFindForm1.TitleBtnSort1(Sender: TObject; ACol: Integer;
...
procedure TBaseFindForm1.Button2Click(Sender: TObject);
begin
  modalresult:=mrCancel	;
end;

procedure TBaseFindForm1.Button1Click(Sender: TObject);
begin
  modalresult:=mrok;
end;

procedure TBaseFindForm1.EditDataChange(Sender: TObject; value: TADOTable;vFieldName:string);
begin
  value.Filter:='';
...
procedure TBaseFindForm1.EditDataChange(Sender: TObject; value: TADODataSet;vFieldName:string);
begin
  value.Filter:='';
  if trim(tedit(sender as tedit).Text)<>'' then
  begin
...
procedure TBaseFindForm1.EditDataChange(Sender: TObject; value: TADOQuery;vFieldName:string);
begin
  value.Filter:='';
  if trim(tedit(sender as tedit).Text)<>'' then
  begin
...
procedure TBaseFindForm1.EditDataChange(Sender: TObject;
...
procedure TBaseFindForm1.FormCreate(Sender: TObject);
begin
