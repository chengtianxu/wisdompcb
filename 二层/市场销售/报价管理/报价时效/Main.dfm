object frmMain: TfrmMain
  ...
  Width = 1002
  Height = 676
  Caption = #25253#20215#26102#25928#31649#29702
  Color = clBtnFace
  ...
  object pnlAllClient: TPanel
    ...
    object pnlTop: TPanel
      ...
      object btnSet: TBitBtn
        ...
        Width = 57
        Height = 30
        Hint = #25253#20215#31867#22411#23450#20041
        Caption = #35774#32622
        ParentShowHint = False
        ShowHint = True
        TabOrder = 8
    ...
    object pnlBottom1: TPanel
      ...
      BevelOuter = bvNone
      TabOrder = 2
      object chkQuote_Status0: TCheckBox
        Left = 18
        Top = 6
        Width = 97
        Height = 17
        Hint = 'Quote_Status'
        Caption = #24453#25253#20215
        Checked = True
        State = cbChecked
        TabOrder = 0
        OnClick = chkStatus0Click
      end
      object chkQuote_Status1: TCheckBox
        Tag = 1
        Left = 171
        Top = 6
        Width = 97
        Height = 17
        Hint = 'Quote_Status'
        Caption = #25253#20215#20013
        Checked = True
        State = cbChecked
        TabOrder = 1
        OnClick = chkStatus0Click
      end
      object chkQuote_Status3: TCheckBox
        Tag = 3
        Left = 324
        Top = 6
        Width = 97
        Height = 17
        Hint = 'Quote_Status'
        Caption = #35810#38382#20013
        Checked = True
        State = cbChecked
        TabOrder = 2
        OnClick = chkStatus0Click
      end
      object chkQuote_Status4: TCheckBox
        Tag = 4
        Left = 477
        Top = 6
        Width = 97
      ...
      object chkQuote_Status2: TCheckBox
        Tag = 2
        Left = 630
        Top = 6
        Width = 97
      ...
      object chkQuote_Status255: TCheckBox
        Tag = 255
        Left = 784
        Top = 6
        Width = 97
  ...
  object dmDesignRpt: TPopupMenu
    ...
    object MI1: TMenuItem
      Caption = #35774#35745#25253#20215#36861#36394#34920
      OnClick = MI1Click
    end
    object MI2: TMenuItem
      Caption = #25171#21360#25253#20215#36861#36394#34920
      OnClick = MI2Click
    end
  end
  object pmOp: TPopupMenu
    ...
    object N7: TMenuItem
      Caption = #32534#36753#25253#20215#31867#22411
      OnClick = N7Click
    end
    object N9: TMenuItem
      Caption = '-'
