  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      '  * 0.000001 / dbo.Data0006.PARTS_PER_PANEL, 6) AS total_sq,'
        ...
        '  CASE dbo.data0048.WTYPE WHEN 0 THEN ''正常过数'' WHEN 2 THEN ''返工过数'' ' +
        'WHEN 3 THEN ''外发生产'' END AS C_WTYPE,'
      ...
      'WHERE (dbo.Data0048.OUTTIME >= :dtpk1) AND'
        ...
        '4'
      'ORDER BY 停留小时 desc,data0048.STEP_NO '
      '')
    Left = 329
    Top = 121
