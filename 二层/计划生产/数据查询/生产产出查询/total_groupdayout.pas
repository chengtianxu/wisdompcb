unit total_groupdayout;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, DB, ADODB, MXDB, Grids, MXGRID, Mxstore, ExtCtrls, MXPIVSRC,
  DBGrids, DBGridEh, StdCtrls, Buttons, ComCtrls,Excel2000,OleServer,ComObj;

type
  TForm_groupdayout = class(TForm)
    ADOQuery1: TADOQuery;
    ...
    BitBtn2: TBitBtn;
    aqdate48: TADOQuery;
    aqdate48out_date: TDateTimeField;
  ...
  private
   ...
   function return_row(date:tdatetime):integer;
...
var
  Form_groupdayout: TForm_groupdayout;
...
{$R *.dfm}
function TForm_groupdayout.return_row(date: tdatetime): integer;
begin
...
function TForm_groupdayout.return_col(dept_code: string): integer;
begin
...
procedure TForm_groupdayout.BitBtn2Click(Sender: TObject);
var
...
procedure TForm_groupdayout.DBGridEh1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TForm_groupdayout.FormActivate(Sender: TObject);
var
 i:integer;
begin
...
procedure TForm_groupdayout.ComboBox1Change(Sender: TObject);
var
 i:integer;
begin
aqdate48.First;
...
procedure TForm_groupdayout.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.ActivePageIndex=0 then
