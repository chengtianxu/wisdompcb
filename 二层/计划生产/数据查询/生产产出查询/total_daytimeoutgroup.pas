...
type
  TForm_daytimegroup = class(TForm)
    ADOQuery1: TADOQuery;
...
var
  Form_daytimegroup: TForm_daytimegroup;
...
{$R *.dfm}
function TForm_daytimegroup.return_row(date: string): integer;
begin
...
function TForm_daytimegroup.return_col(dept_code: string): integer;
begin
...
procedure TForm_daytimegroup.DBGridEh1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TForm_daytimegroup.BitBtn2Click(Sender: TObject);
var
...
procedure TForm_daytimegroup.PageControl1Change(Sender: TObject);
begin
if pagecontrol1.ActivePageIndex=0 then
...
procedure TForm_daytimegroup.FormActivate(Sender: TObject);
var
 i:integer;
begin
...
procedure TForm_daytimegroup.ComboBox1Change(Sender: TObject);
var
 i:integer;
begin
aqdate48.First;
