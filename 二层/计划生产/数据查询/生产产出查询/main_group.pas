...
procedure TForm_group.DBGridEh2KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TForm_group.Edit2Change(Sender: TObject);
begin
self.Chart1.MaxPointsPerPage:=updown1.Position;
end;

procedure TForm_group.SpeedButton2Click(Sender: TObject);
begin
chart1.NextPage;
end;

procedure TForm_group.SpeedButton1Click(Sender: TObject);
begin
chart1.PreviousPage;
end;

procedure TForm_group.SpeedButton6Click(Sender: TObject);
begin
  IF Chart1.view3doptions.Zoom>1 THEN
    Chart1.view3doptions.Zoom := Chart1.view3doptions.Zoom-2;
end;

procedure TForm_group.SpeedButton5Click(Sender: TObject);
begin
  IF Chart1.view3doptions.Zoom<300 THEN
    Chart1.view3doptions.Zoom := Chart1.view3doptions.Zoom+2;
end;

procedure TForm_group.SpeedButton3Click(Sender: TObject);
begin
if self.SavePictureDialog1.Execute then
chart1.SaveToBitmapFile(self.SavePictureDialog1.FileName+'.bmp');
end;

procedure TForm_group.SpeedButton4Click(Sender: TObject);
begin
if self.PrintDialog1.Execute then
self.Chart1.Print;
end;

procedure TForm_group.CheckBox1Click(Sender: TObject);
begin
...
procedure TForm_group.PageControl1Change(Sender: TObject);
begin
...
procedure TForm_group.ComboBox2Change(Sender: TObject);
begin
