object Form_group: TForm_group
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      Caption = #29677#32452#27719#24635
    ...
    object TabSheet2: TTabSheet
      Caption = #29677#32452#20135#21697#31867#22411#27719#24635
      ImageIndex = 1
    ...
    object TabSheet3: TTabSheet
      ...
      object Chart1: TChart
        ...
        Title.Font.Style = []
        Title.Text.Strings = (
          #29677#32452#20135#20986#23545#27604#22270)
        BackColor = clSilver
  ...
  object aq48: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT TOP 100 PERCENT Data0034_1.DEPT_CODE, Data0034_1.DEPT_NAM' +
        'E,'
      '      Data0008.PROD_CODE, Data0008.PRODUCT_NAME,'
      '      SUM(Data0048.QTY_PROD) AS total_pcs,'
      '      SUM(Data0048.PANELS) AS total_pan,'
      
        '      round(SUM(Data0048.QTY_PROD * Data0025.unit_sq),2) AS tota' +
        'l_sqft,'
      ...
      'ORDER BY Data0034_1.SEQ_NR, dbo.Data0008.PROD_CODE'
      ' ')
    Left = 120
    Top = 456
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT TOP 100 PERCENT Data0034_1.DEPT_CODE, Data0034_1.DEPT_NAM' +
        'E,'
      '      SUM(dbo.Data0048.QTY_PROD) AS total_pcs,'
      '      SUM(dbo.Data0048.PANELS) AS total_pan,'
      
        'ROUND(SUM(dbo.Data0048.QTY_PROD * dbo.Data0025.unit_sq), 2) AS t' +
        'otal_sqft,'
      
        '      ROUND(SUM(Data0048.QTY_PROD * Data0006.panel_ln * Data0006' +
        '.panel_wd'
      '       * 0.000001 / Data0006.PARTS_PER_PANEL), 2) AS total_sq'
      'FROM  dbo.Data0048 INNER JOIN'
        ...
        '          INNER JOIN Data0007 ON Data0008.pr_grp_Pointer=Data000' +
        '7.RKEY INNER JOIN'
      
        '                      dbo.data0492 ON dbo.Data0006.CUT_NO = dbo.' +
        'data0492.CUT_NO LEFT OUTER JOIN'
      '   dbo.Data0060 ON dbo.data0492.SO_NO = dbo.Data0060.SALES_ORDER'
      'WHERE (Data0048.OUTTIME >= :dtpk1) AND'
      '      (Data0048.OUTTIME <= :dtpk2)'
      
        'GROUP BY Data0034_1.DEPT_CODE, Data0034_1.DEPT_NAME,Data0034_1.S' +
        'EQ_NR'
