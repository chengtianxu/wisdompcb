object FrmSetParameter: TFrmSetParameter
  Left = 509
  Top = 180
  BorderStyle = bsDialog
  Caption = #35746#21333#21442#25968#35774#32622
  ClientHeight = 493
  ClientWidth = 408
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Label1: TLabel
      ...
      Width = 52
      Height = 13
      Caption = #21046#25104#21442#25968
    end
  ...
  object ads57: TADODataSet
    Connection = FrmOrderParameter.ADOConnection1
    CursorType = ctStatic
    Filtered = True
    CommandText = 
      'select data0057.*,data0034.DEPT_CODE,data0034.DEPT_NAME,data0278' +
      '.PARAMETER_NAME,data0278.PARAMETER_DESC'#13#10'from data0057 inner joi' +
      'n data0034'#13#10'on data0057.d34Rkey=data0034.Rkey inner join'#13#10'dbo.da' +
      'ta0278 on dbo.data0057.d278Rkey=dbo.data0278.Rkey'#13#10
    Parameters = <>
    Left = 40
    Top = 240
    object ads57iSort: TIntegerField
      FieldName = 'iSort'
    end
    object ads57d34Rkey: TIntegerField
      FieldName = 'd34Rkey'
    end
    object ads57d278Rkey: TIntegerField
      FieldName = 'd278Rkey'
    end
    object ads57ColName: TStringField
      FieldName = 'ColName'
      Size = 30
    end
    object ads57DEPT_CODE: TStringField
      FieldName = 'DEPT_CODE'
      Size = 10
    end
    object ads57DEPT_NAME: TStringField
      FieldName = 'DEPT_NAME'
      Size = 30
    end
    object ads57PARAMETER_NAME: TStringField
      FieldName = 'PARAMETER_NAME'
      Size = 10
    end
    object ads57PARAMETER_DESC: TStringField
