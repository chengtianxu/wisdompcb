...
begin
  ...
  begin
    ...
    try
      ...
      IFSingKey2(FIsInsert,'dbo.data0057','d34Rkey',IntToStr(Edit2.Tag),'d278Rkey='+IntTOStr(Edit1.Tag)+'',FrmOrderParameter.ADOConnection1);
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='select * from dbo.data0057 where iSort='+Trim(Edit4.Text)+'';
      tmpAdo.Open;
      ...
      begin
        ...
        tmpAdo.Close;
        tmpAdo.SQL.Clear;
        tmpAdo.SQL.Text:='select * from dbo.data0057 where iSort>='+Trim(Edit4.Text)+' order by iSort desc';
        tmpAdo.Open;
        ...
        begin
          ...
          begin
            tmpAdo2.Close;
            tmpAdo2.SQL.Clear;
            tmpAdo2.SQL.Text:='Update dbo.Data0057 set iSort='+IntToStr(tmpAdo.FieldBYName('iSort').AsInteger+1)+' where iSort='+tmpAdo.FieldBYName('iSort').AsString+'';
            tmpAdo2.ExecSQL;
            tmpAdo.Next;
          end;
        end;
      ...
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='Insert into dbo.data0057 (iSort,d34Rkey,d278Rkey,ColName) Values (:iSort,:d34Rkey,:d278Rkey,:ColName)';
    ...
    try
      ...
      begin
        ...
        begin
          ...
          tmpAdo.Close;
          tmpAdo.SQL.Clear;
          tmpAdo.SQL.Text:='select * from dbo.data0057 where iSort>='+Trim(Edit4.Text)+' order by iSort';
          tmpAdo.Open;
          if (not tmpAdo.Eof) then
          begin
            tmpAdo.First;
            ...
            begin
              ...
              tmpAdo2.Close;
              tmpAdo2.SQL.Clear;
              tmpAdo2.SQL.Text:='Update dbo.Data0057 set iSort='+IntToStr(iOrder+i)+' where iSort='+tmpAdo.FieldBYName('iSort').AsString+'';
              tmpAdo2.ExecSQL;
              i:=i+1;
              tmpAdo.Next;
            end;
      ...
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='Update dbo.data0057 set iSort=:iSort,d34Rkey=:d34Rkey,d278Rkey=:d278Rkey,ColName=:ColName where iSort=:iSort2';
      tmpAdo.Parameters.ParamByName('iSort').Value:=Edit4.Text;
      tmpAdo.Parameters.ParamByName('d34Rkey').Value:=Edit2.Tag;
      tmpAdo.Parameters.ParamByName('d278Rkey').Value:=Edit1.Tag;
      tmpAdo.Parameters.ParamByName('ColName').Value:=Edit3.Text;
...
begin
  try
    ...
    tmpAdo.Close;
    tmpAdo.SQL.Clear;
    tmpAdo.SQL.Text:='select * from dbo.data0057 order by iSort';
    tmpAdo.Open;
...
begin
  ...
  begin
    try
      ...
      tmpAdo2:=TADOQuery.Create(Application);
      tmpAdo2.Connection:=FrmOrderParameter.ADOConnection1;
      iNo:=ads57iSort.AsInteger;
      tmpAdo.Close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='delete data0057 where iSort='+ads57iSort.AsString;
      tmpAdo.ExecSQL;
      tmpAdo.close;
      tmpAdo.SQL.Clear;
      tmpAdo.SQL.Text:='select * from dbo.data0057 where isort>'+IntToStr(iNo)+' order by iSort';
      tmpAdo.Open;
      if (not tmpAdo.IsEmpty) then
      begin
        tmpAdo.First;
        ...
        begin
          tmpAdo2.Close;
          tmpAdo2.SQL.Clear;
          tmpAdo2.SQL.Text:='update data0057 set iSort='+IntToStr(iNo)+' where iSort='+tmpAdo.FieldBYName('iSort').AsString;
          iNo:=iNo+1;
          tmpAdo2.ExecSQL;
          tmpAdo.Next;
        end;
