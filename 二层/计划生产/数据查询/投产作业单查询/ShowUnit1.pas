...
var
  ShowForm1: TShowForm1;

implementation

{$R *.dfm}

procedure TShowForm1.Temp_DBGridEh1DrawColumnCell(Sender: TObject;
...
procedure TShowForm1.DrawDBGridEHColorCol(DBGridEHName: TDBGridEH;
...
procedure TShowForm1.TitleBtnSort1(Sender: TObject; ACol: Integer;
...
procedure TShowForm1.EditDataChange(Sender: TObject; value: TADOTable;vFieldName:string);
begin
  value.Filter:='';
...
procedure TShowForm1.EditDataChange(Sender: TObject; value: TADODataSet;vFieldName:string);
begin
  value.Filter:='';
  if trim(tedit(sender as tedit).Text)<>'' then
  begin
...
procedure TShowForm1.EditDataChange(Sender: TObject; value: TADOQuery;vFieldName:string);
begin
  value.Filter:='';
  if trim(tedit(sender as tedit).Text)<>'' then
  begin
...
procedure TShowForm1.EditDataChange(Sender: TObject;
...
procedure TShowForm1.FormCreate(Sender: TObject);
begin
