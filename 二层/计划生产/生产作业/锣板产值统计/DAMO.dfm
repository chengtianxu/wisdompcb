object DM: TDM
  ...
  object adoMain: TADODataSet
    ...
    CommandText = 
      ...
      'KEY'#13#10'where  data0034.dept_code like '#39'%RG%'#39' and dbo.DATA0570.star' +
  ...
  object cds571: TClientDataSet
    ...
    object cds571PARA_VALUE_0: TStringField
      DisplayLabel = #26495#36793#21402#24230
      FieldName = 'PARA_VALUE_0'
      OnChange = cds571pan_qtyChange
      Size = 30
    end
    ...
    object cds571PARA_VALUE_1: TStringField
      DisplayLabel = #38179#31243#38271#24230
      FieldName = 'PARA_VALUE_1'
      OnChange = cds571pan_qtyChange
      Size = 30
    end
