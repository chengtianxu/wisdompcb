...
const
  SJ68_8 = 'Provider=SQLOLEDB.1;Password=wisdomtopcb1077;Persist Security Info=True;' +
    'User ID=sa;Initial Catalog=sj_v20_live;Data Source=172.16.8.112;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=CHENGTX-PC;Use Encryption for Data=False;Tag with column collation when possible=False';
