...
implementation
uses
   DMUnit1,Pick_Item_Single,ConstVar;
...
begin
 case listbox2.ItemIndex of
     ...
     5:begin
          ...
          sgrid1.Cells[2,sgrid_row]:='and data0015.abbr_name='''+ComboBox1.Text+'''';
       end;
     end;
...
begin
  ...
  DM.TemADOQuery1.SQL.Text:='select abbr_name from data0015 ';
  DM.TemADOQuery1.Open;
  while not DM.TemADOQuery1.Eof do
  begin
    ComboBox1.Items.Append(DM.TemADOQuery1.Fields[0].asstring);
