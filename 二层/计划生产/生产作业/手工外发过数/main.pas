...
function TfrmMain.Pick_Work_Order(value: variant; AdoConn: TAdoconnection; PickType: byte): variant; //选择作业单
var
  FDlgInput: PDlgInput;
  Tmp_rslt: variant;
begin
  ...
  FDlgInput.Sqlstr :=
    ...
    'and d492.tstatus<>1 and d492.tstatus<>3 and d56.WTYPE=0';
