object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      'G_CUSTOMER as '#20851#32852#21407#23458#25143',Data0010_1.CUST_CODE as '#20851#32852#21407#23458#25143#20195#30721#13#10'FROM dbo.Da' +
      'ta0008 INNER JOIN'#13#10'      dbo.Data0025 ON '#13#10'      dbo.Data0008.RK' +
      'EY = dbo.Data0025.PROD_CODE_PTR INNER JOIN'#13#10'      dbo.Data0010 O' +
      'N '#13#10'      dbo.Data0025.CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUT' +
      'ER JOIN'#13#10'      dbo.Data0010 Data0010_1 ON '#13#10'      dbo.Data0025.O' +
      'RIG_CUSTOMER=Data0010_1.ABBR_NAME LEFT OUTER JOIN'#13#10'      dbo.Dat' +
      'a0005 Data0005_3 ON '#13#10'      dbo.Data0025.CHECK_BY_PTR = Data0005' +
      '_3.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_2 ON '#13#10'    ' +
      '  dbo.Data0025.LAST_MODIFIED_BY_PTR = Data0005_2.RKEY LEFT OUTER' +
      ' JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo.Data0025.AUDITED_BY_' +
      'PTR = Data0005_1.RKEY'#13#10'where data0025.rkey=:BOM_PTR'
  ...
  object ppReport1: TppReport
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel84: TppLabel
        UserName = 'Label84'
        Caption = #21407#23458#25143#20195#30721':'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = #23435#20307
        Font.Size = 10
  ...
  object ads06: TADODataSet
    ...
    CommandText = 
      ...
      'a0006.QUAN_SCH AS '#20316#19994#21333#25968#37327', data0492.UPANEL2 as B'#26495'PCS'#25968','#13#10'       CAS' +
      'E data0492.TTYPE WHEN 0 THEN '#39#27491#24120#25237#20135#39' WHEN 1 THEN '#39#34917#26009#25237#20135#39' '#13#10'       ' +
      'WHEN 2 THEN '#39#25353'MRB'#37325#25237#39' WHEN 3 THEN '#39#25353'MRB'#36820#20462#39' WHEN 4 THEN '#39#25353#26495#21495#25237#20135#39#13#10' ' +
      '       END AS '#25237#20135#31867#22411', dbo.Data0006.PRIORITY_CODE AS '#20248#20808#32423#21035', '#13#10'      ' +
      ' dbo.Data0060.so_oldnew AS '#35746#21333#26032#26087', dbo.Data0060.FOB AS '#21512#21516#21495', '#13#10'    ' +
      '   Data0097.PO_NUMBER AS '#23458#25143#35746#21333#21495', data0492.PANEL_1_QTY AS PnlA'#25237#20135#25968#37327 +
      ', '#13#10'       data0492.PANEL_2_QTY AS PnlB'#25237#20135#25968#37327', PPC_FLAG,'#13#10'       D' +
      'ata0015.WAREHOUSE_CODE AS '#24037#21378#20195#30721', Data0015.ABBR_NAME AS '#24037#21378#31616#31216','#13#10'   ' +
      '    data0492.remark as '#25237#20135#22791#27880',data0492.analysis_code_3 as '#25237#20135#22823#26009#35268#26684','#13 +
      #10'       t10.CUST_CODE AS '#35746#21333#23458#25143#20195#30721',t10.ABBR_NAME as '#35746#21333#23458#25143#21517#31216#13#10'FROM   ' +
      'dbo.Data0015 INNER JOIN'#13#10'       dbo.Data0006 INNER JOIN'#13#10'       ' +
      'dbo.data0492 ON dbo.Data0006.CUT_NO = dbo.data0492.CUT_NO INNER ' +
      'JOIN'#13#10'       dbo.Data0010 t10 ON dbo.data0492.COMPLETED = t10.RK' +
      'EY INNER JOIN'#13#10'       dbo.Data0005 ON dbo.data0492.CREATED_BY_PT' +
      'R = dbo.Data0005.RKEY ON '#13#10'       dbo.Data0015.RKEY = dbo.data04' +
      '92.WHOUSE_PTR LEFT OUTER JOIN'#13#10'       dbo.Data0097 RIGHT OUTER J' +
      'OIN'#13#10'       dbo.Data0060 ON dbo.Data0097.RKEY = dbo.Data0060.PUR' +
      'CHASE_ORDER_PTR '#13#10'       ON dbo.data0492.SO_NO = dbo.Data0060.SA' +
      'LES_ORDER LEFT JOIN'#13#10'       dbo.Data0056 ON dbo.Data0006.RKEY = ' +
      'dbo.Data0056.WO_PTR'#13#10'WHERE Data0006.rkey = :rkey06'
    Parameters = <
      item
        Name = 'rkey06'
        Attributes = [paSigned]
