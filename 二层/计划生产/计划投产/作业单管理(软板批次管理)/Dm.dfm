object Dmcon: TDmcon
  ...
  object adsSubProds: TADODataSet
    ...
    CommandText = 
      ...
      ' as Qty_Total_Req,data0006.rKey as WONO,'#13#10'case when Data0056.QTY' +
      '_BACKLOG > data0006.PARTS_PER_PANEL * Data0056.PANELS then '#13#10#9'ce' +
      'iling(Data0025.Qty_bom * ceiling(Data0056.QTY_BACKLOG * 1.0 / da' +
      'ta0006.PARTS_PER_PANEL) * data0006.PARTS_PER_PANEL/QTY_PARENTBOM' +
      ') - IsNULL(data0488.quan_issued,0)'#13#10'else ceiling(Data0025.Qty_bo' +
      'm *data0006.PARTS_PER_PANEL * Data0056.PANELS/QTY_PARENTBOM) - I' +
      'sNULL(data0488.quan_issued,0) end as Qty_Needed'#13#10'from data0006 i' +
      'nner join data0025 on '#13#10'data0006.bom_ptr=data0025.parent_ptr '#13#10'L' +
      'EFT JOIN Data0056 ON Data0056.WO_PTR = Data0006.RKey'#13#10'left outer' +
      ' join data0488 on data0488.WO_Ptr=data0006.rKey and data0488.bom' +
      '_ptr=data0025.rkey'#13#10'where data0006.rkey=:F01  AND Data0025.BOM_S' +
      'TEP = 1  AND ISNULL(data0056.STEP,-1) = -1'#13#10'ORDER by data0025.bo' +
      'm_step,data0025.manu_part_number'
    Parameters = <
      item
        Name = 'F01'
        Attributes = [paSigned]
  ...
  object adsWOCtrlList: TADODataSet
    ...
    CommandText = 
      ...
      '005.EMPLOYEE_NAME'#13#10'FROM         dbo.Data0025 AS d25 INNER JOIN'#13#10 +
      '                      dbo.Data0006 AS D06 ON D06.BOM_PTR = d25.R' +
      'KEY LEFT OUTER JOIN'#13#10'                      dbo.Data0056 AS D56 O' +
      'N D56.WO_PTR = D06.RKEY LEFT OUTER JOIN'#13#10'                      d' +
      'bo.Data0034 AS a ON D56.DEPT_PTR = a.RKEY INNER JOIN'#13#10'          ' +
      '            dbo.data0492 AS D492 ON D492.CUT_NO = D06.CUT_NO INN' +
      'ER JOIN'#13#10'                      dbo.Data0008 AS D08 ON D08.RKEY =' +
      ' d25.PROD_CODE_PTR INNER JOIN'#13#10'                      dbo.Data001' +
      '0 AS D10 ON D10.RKEY = d25.CUSTOMER_PTR LEFT OUTER JOIN'#13#10'       ' +
      '               dbo.Data0005 ON D06.TRAV_PRINTED_BY_PTR = dbo.Dat' +
      'a0005.RKEY'#13#10'WHERE     (D06.ENT_DATETIME >= '#39'2006-1-1'#39') AND (D06.' +
      'ENT_DATETIME <= '#39'2006-1-30'#39')'
    Parameters = <>
    Prepared = True
    Left = 32
    Top = 376
