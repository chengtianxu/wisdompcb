...
begin
  ...
  case FType of
    0:
      begin
        ...
        s := 'select data0006.work_order_number,cast((data0025.qty_bom+0.0)/data0025.QTY_PARENTBOM as decimal(18,4)) as qty_bom,data0025.manu_part_number,IsNULL(data0488.quan_issued,0) as quan_issued ,'+
              'data0025.rkey,data0025.bom_step,Data0025.Qty_bom*Data0006.quan_sch/data0025.QTY_PARENTBOM as Qty_Total_Req,data0006.rKey as WONO, ' +
              ' Data0025.Qty_bom*Data0006.quan_sch/data0025.QTY_PARENTBOM as Qty_Needed ' +
    ...
    1:
      begin
        s := 'select data0006.work_order_number,cast((data0025.qty_bom+0.0)/data0025.QTY_PARENTBOM as decimal(18,4)) as qty_bom,data0025.manu_part_number,IsNULL(data0488.quan_issued,0) as quan_issued ,'+
              'data0025.rkey,data0025.bom_step,case when isnull(Data0056.QTY_BACKLOG,0) = 0 then Data0025.Qty_bom*data0006.quan_sch/QTY_PARENTBOM else case when Data0056.QTY_BACKLOG > data0006.PARTS_PER_PANEL * Data0056.PANELS then  '+
              ...
              '  else ceiling(Data0025.Qty_bom *data0006.PARTS_PER_PANEL * Data0056.PANELS/QTY_PARENTBOM) end end as Qty_Total_Req,data0006.rKey as WONO, ' +
              'case when isnull(Data0056.QTY_BACKLOG,0) = 0 then Data0025.Qty_bom*data0006.quan_sch/QTY_PARENTBOM else case when Data0056.QTY_BACKLOG > data0006.PARTS_PER_PANEL * Data0056.PANELS then  ' +
              '    ceiling(Data0025.Qty_bom * ceiling(Data0056.QTY_BACKLOG * 1.0 / data0006.PARTS_PER_PANEL) * data0006.PARTS_PER_PANEL/QTY_PARENTBOM) - IsNULL(data0488.quan_issued,0) ' +
              ' else ceiling(Data0025.Qty_bom *data0006.PARTS_PER_PANEL * Data0056.PANELS/QTY_PARENTBOM) - IsNULL(data0488.quan_issued,0) end end as Qty_Needed ' +
              ' from data0006 inner join data0025 on ' +
              ' data0006.bom_ptr=data0025.parent_ptr ' +
              ' LEFT JOIN Data0056 ON Data0056.WO_PTR = Data0006.RKey ' +
              ' left outer join data0488 on data0488.WO_Ptr=data0006.rKey and data0488.bom_ptr=data0025.rkey ' +
