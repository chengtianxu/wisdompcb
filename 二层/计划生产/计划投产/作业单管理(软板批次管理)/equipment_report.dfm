object Form_equipmentreport: TForm_equipmentreport
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      'g when '#39'Y'#39' then '#39'4G'#39'  else '#39#39' end as '#26631#35782'4G,'#13#10'case when data0025.P' +
      'ARENT_PTR is null then '#39#22806#23618#39' ELSE '#39#20869#23618#39' end as  '#20135#21697#24615#36136#13#10'FROM dbo.Dat' +
      'a0008 INNER JOIN'#13#10'      dbo.Data0025 ON '#13#10'      dbo.Data0008.RKE' +
      'Y = dbo.Data0025.PROD_CODE_PTR INNER JOIN'#13#10'      dbo.Data0010 ON' +
      ' '#13#10'      dbo.Data0025.CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUTE' +
      'R JOIN'#13#10'      dbo.Data0005 Data0005_3 ON '#13#10'      dbo.Data0025.CH' +
      'ECK_BY_PTR = Data0005_3.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005' +
      ' Data0005_2 ON '#13#10'      dbo.Data0025.LAST_MODIFIED_BY_PTR = Data0' +
      '005_2.RKEY LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005_1 ON dbo' +
      '.Data0025.AUDITED_BY_PTR = Data0005_1.RKEY'#13#10'where data0025.rkey=' +
      ':BOM_PTR'
