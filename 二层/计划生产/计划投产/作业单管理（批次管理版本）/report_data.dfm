object Form_report: TForm_report
  ...
  object ADS25: TADODataSet
    ...
    CommandText = 
      ...
      'end as '#37327#20135#26679#26495','#13#10'case Data0025.green_flag when '#39'Y'#39' then '#39'4G'#26631#35782#39'  els' +
      'e '#39' '#39' end as '#26631#35782'4G,'#13#10'case when data0025.PARENT_PTR is null then '#39 +
      #22806#23618#39' ELSE '#39#20869#23618#39' end as  '#20135#21697#24615#36136','#13#10'case when ltrim(data0025.CURRENT_RE' +
      'V)='#39'Y'#39' then '#39#26080#21348#32032#39' else '#39#39' end as '#21348#32032#35201#27714','#13#10'cast(data0025.qty_bom as' +
      ' varchar) +'#39':'#39'+cast(qty_parentbom as varchar) as '#25237#20135#27604#20363','#13#10'data0025' +
      '.qty_bom as '#25237#20135#27604#20363#20998#23376',data0025.qty_parentbom as '#25237#20135#27604#20363#20998#27597',data0025.ORI' +
      'G_CUSTOMER as '#20851#32852#21407#23458#25143','#13#10'Data0010_1.CUST_CODE as '#20851#32852#21407#23458#25143#20195#30721','#13#10'data0025' +
      '.MinRing as '#26368#23567'Ring'#29615',data0025.DiffMark as '#21046#36896#38590#24230',data0025.compress ' +
      'as '#21387#21512#31243#24335'2, Data0025.grade_code as '#31561#32423#25351#31034#13#10'FROM dbo.Data0008 INNER J' +
      'OIN'#13#10'      dbo.Data0025 ON '#13#10'      dbo.Data0008.RKEY = dbo.Data0' +
      '025.PROD_CODE_PTR INNER JOIN'#13#10'      dbo.Data0010 ON '#13#10'      dbo.' +
      'Data0025.CUSTOMER_PTR = dbo.Data0010.RKEY LEFT OUTER JOIN'#13#10'     ' +
      ' dbo.Data0010 Data0010_1 ON '#13#10'      dbo.Data0025.ORIG_CUSTOMER=D' +
      'ata0010_1.ABBR_NAME LEFT OUTER JOIN'#13#10'      dbo.Data0005 Data0005' +
      '_3 ON '#13#10'      dbo.Data0025.CHECK_BY_PTR = Data0005_3.RKEY LEFT O' +
      'UTER JOIN'#13#10'      dbo.Data0005 Data0005_2 ON '#13#10'      dbo.Data0025' +
      '.LAST_MODIFIED_BY_PTR = Data0005_2.RKEY LEFT OUTER JOIN'#13#10'      d' +
      'bo.Data0005 Data0005_1 ON dbo.Data0025.AUDITED_BY_PTR = Data0005' +
      '_1.RKEY'#13#10'where data0025.rkey=:BOM_PTR'
    ...
    object ADS25DSDesigner38: TWideStringField
      FieldName = #21046#36896#38590#24230
    end
    object ADS25Field: TStringField
      FieldKind = fkCalculated
      FieldName = #21387#21512#31243#24335
      Size = 50
      Calculated = True
    end
    object ADS25DSDesigner210: TStringField
      FieldName = #21387#21512#31243#24335'2'
    end
    object ADS25DSDesigner39: TStringField
  ...
  object ads38: TADODataSet
    ...
    CommandText = 
      ...
      #10'      Data0038.STEP_NUMBER, Data0038.tooling_rev as '#24037#20855#29256#26412', Data0' +
      '034.Work_Para as '#39318#20214#29983#20135#21442#25968','#13#10'      Data0034.BARCODE_ENTRY_FLAG as '#36807 +
      #25968', Data0038.OUTP_SPFC as '#20135#20986', '#13#10'      Data0038.DEF_ROUT_INST as '#22791 +
      #27880', data0038.SOURCE_PTR,data0038.grade_note as  '#31561#32423#25351#31034#13#10'FROM Data00' +
      '38 INNER JOIN'#13#10'      Data0034 ON dbo.Data0038.DEPT_PTR = Data003' +
      '4.RKEY'#13#10'WHERE  (Data0038.SOURCE_PTR = :BOM_PTR) '#13#10'order by Data0' +
      '038.STEP_NUMBER'
    DataSource = DataSource3
    MasterFields = 'BOM_PTR'
    Parameters = <
    ...
    object ads38DSDesigner8: TStringField
      FieldName = #39318#20214#29983#20135#21442#25968
      Size = 500
    end
    object ads38DSDesigner7: TWideStringField
      FieldName = #31561#32423#25351#31034
      Size = 2048
    end
  end
  ...
  object ads494: TADODataSet
    ...
    LockType = ltReadOnly
    CommandText = 
      'SELECT Data0278.PARAMETER_NAME'#13#10#9' , Data0278.PARAMETER_DESC'#13#10#9' ,' +
      ' Data0494.PARAMETER_VALUE'#13#10#9' , Data0002.UNIT_CODE'#13#10#9' , data0494.' +
      'seq_no'#13#10#9' , data0494.step_number'#13#10#9' , data0494.TaskTopLimt'#13#10#9' , ' +
      'data0494.TaskLowLimt'#13#10#9' , data0494.InnerTopLimt'#13#10#9' , data0494.In' +
      'nerLowLimt'#13#10#9' , data0494.SpecialNote'#9' '#9' '#13#10'FROM'#13#10#9'dbo.Data0494'#13#10#9 +
      'INNER JOIN dbo.Data0278'#13#10#9#9'ON dbo.Data0494.PARAMETER_PTR = dbo.D' +
      'ata0278.RKEY'#13#10#9'INNER JOIN dbo.Data0002'#13#10#9#9'ON dbo.Data0278.UNIT_P' +
      'TR = dbo.Data0002.RKEY'#13#10'WHERE'#13#10#9'data0494.custpart_ptr = :source_' +
      'ptr'#13#10#9'AND Data0494.PARAMETER_VALUE <> :value'#13#10#9'AND data0494.doc_' +
      'flag = '#39'Y'#39#13#10'ORDER BY'#13#10#9'data0494.step_number'#13#10'  , data0494.seq_no' +
      #13#10'  '
    Parameters = <
      item
        Name = 'source_ptr'
    ...
    object ads494TaskTopLimt: TFloatField
      FieldName = 'TaskTopLimt'
    end
    object ads494TaskLowLimt: TFloatField
      FieldName = 'TaskLowLimt'
    end
    object ads494InnerTopLimt: TFloatField
      FieldName = 'InnerTopLimt'
    end
    object ads494InnerLowLimt: TFloatField
  ...
  object ppReport1: TppReport
    ...
    PrinterSetup.mmMarginBottom = 3175
    PrinterSetup.mmMarginLeft = 6350
    PrinterSetup.mmMarginRight = 6350
    PrinterSetup.mmMarginTop = 3175
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppDBText12: TppDBText
        UserName = 'DBText12'
        AutoSize = True
        DataField = #35746#21333#23458#25143#20195#30721
        DataPipeline = ppDB06
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = #23435#20307
      ...
      object ppDBText69: TppDBText
        UserName = 'DBText69'
        AutoSize = True
        DataField = #20851#32852#21407#23458#25143#20195#30721
        DataPipeline = ppDB25
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = #23435#20307
      ...
      object ppDBBarCode4: TppDBBarCode
        ...
        BarColor = clWindowText
        CalcCheckDigit = False
        DataField = #21387#21512#31243#24335'2'
        DataPipeline = ppDB25
        PrintHumanReadable = False
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
    ...
    object ppFooterBand1: TppFooterBand
      ...
      object ppLabel27: TppLabel
        UserName = 'Label55'
        Caption = #21463#25511':DG-WI-PPC-001-01/00'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = #23435#20307
        Font.Size = 10
      ...
      object ppLabel31: TppLabel
        UserName = 'Label56'
        Caption = #20445#23384#26399#38480':'#36710#36733#26495'16'#24180#65292#38750#36710#36733#26495'3'#24180
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = #23435#20307
        Font.Size = 10
    ...
    object ppGroup2: TppGroup
      ...
      object ppGroupHeaderBand2: TppGroupHeaderBand
        ...
        object ppLabel39: TppLabel
          UserName = 'Label54'
          Caption = #25910#26495#25968#37327
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clBlack
          Font.Name = #23435#20307
          Font.Size = 9
    ...
    object raCodeModule1: TraCodeModule
      ProgramStream = {
        ...
        
  ...
  object ads06: TADODataSet
    ...
    CommandText = 
      ...
      'eration_rate AS '#39044#25237#29575#13#10'FROM   dbo.Data0015 INNER JOIN'#13#10'       dbo.' +
      'Data0006 INNER JOIN'#13#10'       dbo.data0492 ON dbo.Data0006.CUT_NO ' +
      '= dbo.data0492.CUT_NO INNER JOIN'#13#10'       dbo.Data0010 t10 ON dbo' +
      '.data0492.COMPLETED = t10.RKEY INNER JOIN'#13#10'       dbo.Data0005 O' +
      'N dbo.data0492.CREATED_BY_PTR = dbo.Data0005.RKEY ON '#13#10'       db' +
      'o.Data0015.RKEY = dbo.data0492.WHOUSE_PTR LEFT OUTER JOIN'#13#10'     ' +
      '  dbo.Data0097 RIGHT OUTER JOIN'#13#10'       dbo.Data0060 ON dbo.Data' +
      '0097.RKEY = dbo.Data0060.PURCHASE_ORDER_PTR '#13#10'       ON dbo.data' +
      '0492.SO_NO = dbo.Data0060.SALES_ORDER LEFT JOIN'#13#10'       dbo.Data' +
      '0056 ON dbo.Data0006.RKEY = dbo.Data0056.WO_PTR'#13#10'WHERE Data0006.' +
      'rkey = :rkey06'
    Parameters = <
      item
        Name = 'rkey06'
    ...
    object ads06Field36: TStringField
      FieldKind = fkCalculated
      FieldName = #24037#21333'36'#30721
      Calculated = True
    end
  end
  ...
  object ppDB06: TppDBPipeline
    ...
    object ppDB06ppField40: TppField
      FieldAlias = #24037#21333'36'#30721
      FieldName = #24037#21333'36'#30721
      FieldLength = 20
      DisplayWidth = 20
      Position = 39
  ...
  object ADS30: TADODataSet
    ...
    CommandText = 
      ...
      'ource_ptr,'#13#10'impedance_first as '#39#25104#21697#38459#25239#39318#20214#25511#21046#39',product_control as '#39#25104#21697 +
      #38459#25239#25511#21046#39',adjust_first as '#39#32511#27833#21069#39318#20214#25511#21046#39',adjust_control as '#39#32511#27833#21069#38459#25239#25511#21046#39#13#10' fr' +
      'om DATA0030'#13#10'where  source_ptr=:BOM_PTR'#13#10'order by SEQ_NO'
    DataSource = DataSource3
  ...
  object ads29: TADODataSet
    ...
    CommandText = 
      ...
      '029'#13#10'where source_ptr= :BOM_PTR'#13#10
    DataSource = DataSource3
    MasterFields = 'BOM_PTR'
    Parameters = <
      item
