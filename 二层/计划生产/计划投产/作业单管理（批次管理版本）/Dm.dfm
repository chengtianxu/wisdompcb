object Dmcon: TDmcon
  ...
  object adsWOCtrlList: TADODataSet
    ...
    CommandText = 
      ...
      '                   case d25.barcode_flag when 0 then '#39#21542#39' else '#39#26159 +
      #39' end  as barcode_flag,'#13#10'                      CASE D06.Trav_Pri' +
      'nted_By_Ptr WHEN 0 THEN '#39#26410#25171#21360#39' ELSE '#39#24050#25171#21360#39' END AS Print_Status, D0' +
      '6.CANCEL_HOLD_DATE, dbo.Data0005.EMPLOYEE_NAME,'#13#10'               ' +
      '       d25.unit_sq, (D06.panel_ln*D06.panel_wd*0.000001) / D06.P' +
      'ARTS_PER_PANEL  AS  unit_sq_includingBoader,d10.rkey as rkey10,d' +
      '25.rkey as rkey25,d60.ENT_DATE'#13#10'FROM         dbo.Data0025 AS d25' +
      ' INNER JOIN'#13#10'                      dbo.Data0006 AS D06 ON D06.BO' +
      'M_PTR = d25.RKEY LEFT OUTER JOIN'#13#10'                      dbo.Data' +
      '0056 AS D56 ON D56.WO_PTR = D06.RKEY LEFT OUTER JOIN'#13#10'          ' +
      '            dbo.Data0034 AS a ON D56.DEPT_PTR = a.RKEY INNER JOI' +
      'N'#13#10'                      dbo.data0492 AS D492 ON D492.CUT_NO = D' +
      '06.CUT_NO INNER JOIN'#13#10'                      dbo.Data0008 AS D08 ' +
      'ON D08.RKEY = d25.PROD_CODE_PTR INNER JOIN'#13#10'                    ' +
      '  dbo.Data0010 AS D10 ON D10.RKEY = d25.CUSTOMER_PTR LEFT OUTER ' +
      'JOIN'#13#10'                      dbo.Data0005 ON D06.TRAV_PRINTED_BY_' +
      'PTR = dbo.Data0005.RKEY LEFT JOIN Data0060 d60 ON d60.SALES_ORDE' +
      'R = d492.SO_NO '#13#10'WHERE     (D06.ENT_DATETIME >= '#39'2006-1-1'#39') AND ' +
      '(D06.ENT_DATETIME <= '#39'2006-1-30'#39')'
    Parameters = <>
    Prepared = True
    Left = 32
    Top = 376
