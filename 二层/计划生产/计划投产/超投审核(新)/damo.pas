...
type
  Tdm = class(TDataModule)
    ...
    strngfldads491USER_FULL_NAME: TStringField;
    intgrfldads491csi_ptr: TIntegerField;
    wrdfldads491ranking: TWordField;
    strngfldads491DSDesigner: TStringField;
    qrytemp: TADOQuery;
    ads491auth_flag: TBooleanField;
    atncfldads491rkey491: TAutoIncField;
    atncfldads491rkey492: TAutoIncField;
  private
