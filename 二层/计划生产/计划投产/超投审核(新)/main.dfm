object Form1: TForm1
  ...
  Width = 1074
  Height = 544
  Caption = #36229#25237#23457#26680
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object btnW: TBitBtn
      ...
      Width = 62
      Height = 29
      Caption = #24494#20449#23457#26680
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clRed
      Font.Height = -13
      Font.Name = #23435#20307
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        DisplayFormat = '0.0000000000000'
        EditButtons = <>
        FieldName = 'area1'
        Footers = <>
        Title.Caption = #25237#20135#38754#31215
        Width = 125
      end
      item
        EditButtons = <>
      ...
      item
        ...
        FieldName = 'area2'
        Footers = <>
        Title.Caption = #36229#25237#38754#31215
        Width = 152
      end
      item
        EditButtons = <>
      ...
      item
        ...
        FieldName = 'unit_sq'
        Footers = <>
        Title.Caption = #27599'PCS'#38754#31215
        Width = 183
      end
      item
        EditButtons = <>
      ...
      item
        ...
        FieldName = 'remark492'
        Footers = <>
        Title.Caption = #36229#25237#21407#22240
        Width = 104
      end
      item
        EditButtons = <>
      ...
      item
        ...
        Footers = <>
        Title.Caption = #24403#21069#23457#26680#20154
        Width = 76
      end
      item
        EditButtons = <>
  ...
  object PopupMenu2: TPopupMenu
    ...
    object N3: TMenuItem
      Caption = #23457#26680#20154#20449#24687
      OnClick = N3Click
    end
  end
  object qry14: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select   *   from data0014'
      'where 1=2')
    Left = 608
    Top = 288
  end
  object qry314: TADOQuery
    Connection = dm.ADOConnection1
    Parameters = <>
    SQL.Strings = (
      'select   *   from data0314'
      'where 1=2')
    Left = 688
    Top = 296
  end
