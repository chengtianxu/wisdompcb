object Dmcon: TDmcon
  ...
  object adsProdList: TADODataSet
    ...
    CommandText = 
      ...
      #13#10'ORDER BY D06.WORK_ORDER_NUMBER'#13#10
    Parameters = <>
    Left = 24
    Top = 72
  end
  ...
  object adsWOReleaseList: TADODataSet
    ...
    CommandText = 
      ...
      'USTOMER_PTR, D25.MANU_PART_NUMBER,D25.MANU_PART_DESC,D492.TType ' +
      ',D08.PROD_CODE,dateadd(day,(0-D25.SHELF_LIFE),D06.SCH_COMPL_DATE' +
      ') AS AdvicePordDate,D06.wtype,D06.put_type,D492.WHOUSE_PTR'#13#10'FROM' +
      ' dbo.Data0025 D25 INNER JOIN'#13#10'      dbo.Data0010 D10 ON D25.CUST' +
      'OMER_PTR = D10.RKEY '#13#10'INNER JOIN Data0006 D06 on D06.BOM_PTR=D25' +
      '.RKEY'#13#10'INNER JOIN DATA0492 D492 ON D492.CUT_NO=D06.CUT_NO'#13#10'INNER' +
      ' JOIN DATA0008 D08 ON D08.RKEY=D25.PROD_CODE_PTR'#13#10'Where  (D06.WI' +
      'PMAT_STATUS = 1) and (D06.PROD_STATUS=2) and (D492.TSTATUS <>1)'#13 +
      #10'ORDER BY D06.WORK_ORDER_NUMBER'#13#10
    Parameters = <>
    Prepared = True
    Left = 48
    Top = 280
  ...
  object adsWOCtrlList: TADODataSet
    ...
    CommandText = 
      ...
      'DEPT_CODE, D06.PROD_STATUS, D06.wtype AS wtype06, D06.QUAN_SCH, ' +
      'D56.FLOW_NO, '#13#10'                      D06.QUAN_REJ, D06.QUAN_PROD' +
      ', D06.QUAN_ALLREJ, D06.REFERENCE_PTR, d25.PARENT_PTR, a.DEPT_PTR' +
      ' AS deptptr, a.TTYPE, D06.PANELS, '#13#10'                      D56.PA' +
      'NELS AS PNL_ONLine, D06.BOM_PTR, d25.MANU_PART_NUMBER, d25.MANU_' +
      'PART_DESC, D56.STEP, D56.RKEY AS d56_rkey, D56.WTYPE, '#13#10'        ' +
      '              D06.FLOW_NO AS Flow_NO_06, a.DEPT_NAME, D06.SCH_CO' +
      'MPL_DATE, D06.PRIORITY_CODE, D06.PARTS_PER_PANEL, D56.QTY_BACKLO' +
      'G, '#13#10'                      D56.TO_BE_STOCKED, D56.DEPT_PTR, D492' +
      '.SO_NO, D492.CUT_NO, D08.PRODUCT_NAME, D10.CUST_CODE, D10.CUSTOM' +
      'ER_NAME, D06.ENT_DATETIME, '#13#10'                      CASE D06.Prod' +
      '_Status WHEN 2 THEN '#39#24453#21457#25918#39' WHEN 3 THEN '#39#29983#20135#20013#39' WHEN 4 THEN '#39#22806#21457#29983#20135#39' W' +
      'HEN 5 THEN '#39#24453#20837#20179#39' WHEN 6 THEN '#39#24453#20998#37197#39' WHEN 9 THEN '#39#29983#20135#32467#26463#39#13#10'         ' +
      '              WHEN 102 THEN '#39#29983#20135#21069#26242#32531#39' WHEN 103 THEN '#39#29983#20135#20013#26242#32531#39' WHEN 2' +
      '02 THEN '#39#21462#28040#39' ELSE '#39#39' END AS prod_Status_CN, '#13#10'                  ' +
      '    CASE D06.Trav_Printed_By_Ptr WHEN 0 THEN '#39#26410#25171#21360#39' ELSE '#39#24050#25171#21360#39' EN' +
      'D AS Print_Status, D06.CANCEL_HOLD_DATE, dbo.Data0005.EMPLOYEE_N' +
      'AME'#13#10'FROM         dbo.Data0025 AS d25 INNER JOIN'#13#10'              ' +
      '        dbo.Data0006 AS D06 ON D06.BOM_PTR = d25.RKEY LEFT OUTER' +
      ' JOIN'#13#10'                      dbo.Data0056 AS D56 ON D56.WO_PTR =' +
      ' D06.RKEY LEFT OUTER JOIN'#13#10'                      dbo.Data0034 AS' +
      ' a ON D56.DEPT_PTR = a.RKEY INNER JOIN'#13#10'                      db' +
      'o.data0492 AS D492 ON D492.CUT_NO = D06.CUT_NO INNER JOIN'#13#10'     ' +
      '                 dbo.Data0008 AS D08 ON D08.RKEY = d25.PROD_CODE' +
      '_PTR INNER JOIN'#13#10'                      dbo.Data0010 AS D10 ON D1' +
      '0.RKEY = d25.CUSTOMER_PTR LEFT OUTER JOIN'#13#10'                     ' +
      ' dbo.Data0005 ON D06.TRAV_PRINTED_BY_PTR = dbo.Data0005.RKEY'#13#10'WH' +
      'ERE     (D06.ENT_DATETIME >= '#39'2006-1-1'#39') AND (D06.ENT_DATETIME <' +
      '= '#39'2006-1-30'#39')'
    Parameters = <>
    Prepared = True
    Left = 32
