object DM: TDM
  ...
  object ADS60: TADODataSet
    ...
    CommandText = 
      ...
      'a0060.PURCHASE_ORDER_PTR,Data0060.CUST_PART_PTR,'#13#10'data0025.rkey ' +
      'as rkey25,case data0060.SpellTogether when 0 then '#39#26410#21512#25340#39' when 1 t' +
      'hen '#39#24050#21512#25340#39' when -1 then '#39#21333#21482#19979#32447#39' when 2 then '#39#21512#24182#20013#39' end as '#21512#25340#29366#24577','#13#10'da' +
      'ta0060.REFERENCE_NUMBER, data0060.SHIP_REG_TAX_ID ,round(Data006' +
      '0.PARTS_ORDERED*data0025.unit_sq,6) as order_sq,'#13#10'data0025.OPT_L' +
      'OT_SIZE, data0025.EST_SCRAP,data0025.spell_sq,data0015.warehouse' +
      '_code,(dbo.Data0060.PARTS_ORDERED +dbo.Data0060.PARTS_RETURNED-d' +
      'bo.Data0060.PARTS_SHIPPED - dbo.data0060.returned_ship) AS parts' +
      '_margin'#13#10'FROM         dbo.Data0060 INNER JOIN'#13#10'                 ' +
      '  dbo.Data0025 ON dbo.Data0060.CUST_PART_PTR = dbo.Data0025.RKEY' +
      ' INNER JOIN'#13#10'                   dbo.Data0010 ON dbo.Data0060.CUS' +
      'TOMER_PTR = dbo.Data0010.RKEY INNER JOIN'#13#10'                   dbo' +
      '.Data0097 ON dbo.Data0060.PURCHASE_ORDER_PTR = dbo.Data0097.RKEY' +
      ' INNER JOIN'#13#10'                   dbo.Data0008 ON dbo.Data0025.PRO' +
      'D_CODE_PTR = dbo.Data0008.RKEY inner join '#13#10'                   d' +
      'ata0015 on data0060.SHIP_REG_TAX_ID=data0015.rkey'#13#10'WHERE     (db' +
      'o.Data0060.PROD_REL <> '#39'3'#39') AND (dbo.Data0060.STATUS = 1)'#13#10'and (' +
      'data0060.ent_date >= :dtpk1) and (data0060.ent_date <= :dtpk2)'#13#10 +
      'and (data0060.so_tp = :sotp)'#13#10
  ...
  object ads494: TADODataSet
    ...
    CommandText = 
      ...
      '.Data0494'#13#10'where custpart_ptr = :SOURCE_PTR and data0494.step_nu' +
      'mber=:step_number'
  ...
  object ADOQuery5: TADOQuery
    ...
    Left = 616
    Top = 224
    object ADOQuery5RKEY: TAutoIncField
      FieldName = 'RKEY'
      ReadOnly = True
    end
    object ADOQuery5INV_PART_NUMBER: TStringField
      FieldName = 'INV_PART_NUMBER'
      Size = 25
    end
    object ADOQuery5INV_NAME: TStringField
      FieldName = 'INV_NAME'
      Size = 30
    end
    object ADOQuery5INV_DESCRIPTION: TStringField
      FieldName = 'INV_DESCRIPTION'
      Size = 70
    end
    object ADOQuery5GROUP_PTR: TIntegerField
      FieldName = 'GROUP_PTR'
    end
    object ADOQuery5code: TStringField
      FieldName = 'code'
      Size = 10
    end
    object ADOQuery5rkey23: TAutoIncField
      FieldName = 'rkey23'
      ReadOnly = True
    end
    object ADOQuery5QUAN_ON_HAND2: TIntegerField
      FieldName = 'QUAN_ON_HAND2'
    end
    object ADOQuery5UNIT_NAME: TStringField
      FieldName = 'UNIT_NAME'
    end
    object ADOQuery5ABBR_NAME: TStringField
      FieldName = 'ABBR_NAME'
      Size = 16
    end
    ...
    object ADOQuery5REMARK: TStringField
      FieldName = 'REMARK'
      Size = 50
    end
    object ADOQuery5remark_1: TStringField
      FieldName = 'remark_1'
      Size = 10
    end
    object ADOQuery5XY_1: TStringField
      FieldName = 'XY_1'
      ReadOnly = True
      Size = 8
    end
    object ADOQuery5QUAN_ON_HAND2_1: TIntegerField
      FieldName = 'QUAN_ON_HAND2_1'
    end
    object ADOQuery5LEN_SIZE: TBCDField
      FieldName = 'LEN_SIZE'
      Precision = 6
      Size = 2
    end
    object ADOQuery5WEI_SIZE: TBCDField
      FieldName = 'WEI_SIZE'
      Precision = 6
      Size = 2
    end
  ...
  object ADOQuery7: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     dbo.Data0025.MANU_PART_NUMBER,Data0278.spec_rkey,PARA' +
        'METER_VALUE=ISNULL(dbo.Data0279.PARAMETER_VALUE,0)'
