object Form_MRBREWORKED: TForm_MRBREWORKED
  ...
  object ads414: TADODataSet
    ...
    CommandText = 
      ...
      'custpart_ptr, dbo.data0414.number, '#13#10'       data0414.sys_date, D' +
      'ata0010.CUST_CODE, data0414.qty_rece,'#13#10'       Data0025.MANU_PART' +
      '_NUMBER, Data0025.MANU_PART_DESC,        '#13#10'       data0414.qty_t' +
      'o_be_reworked, Data0010.ABBR_NAME,'#13#10'data0025.OPT_LOT_SIZE,data00' +
      '25.EST_SCRAP,Data0025.CUSTOMER_PTR'#13#10'FROM         dbo.data0415 IN' +
      'NER JOIN'#13#10'    dbo.data0414 ON dbo.data0415.rkey = dbo.data0414.d' +
      '415_ptr INNER JOIN'#13#10'   dbo.Data0025 ON dbo.data0415.custpart_ptr' +
      ' = dbo.Data0025.RKEY INNER JOIN'#13#10'    dbo.Data0010 ON dbo.Data002' +
      '5.CUSTOMER_PTR = dbo.Data0010.RKEY'#13#10'WHERE     (dbo.data0414.stat' +
      'us = 2) AND '#13#10'                  (dbo.data0414.qty_reworked = 0) '
