...
case listbox3.ItemIndex of
 0:RadioGroup2.Visible:=False;
 1:
 begin
  bitbtn6.Visible:=true;
  RadioGroup2.Visible:=False;
 end;
 2:RadioGroup2.Visible:=False;
 3:
 begin
 bitbtn6.Visible:=true;
 RadioGroup2.Visible:=False;
 end;
 4:RadioGroup2.Visible:=False;
 5:
 begin
  edit3.Visible:=false;
 ...
 9:
  begin
   if RadioGroup2.ItemIndex=0 then
     sgrid1.Cells[2,sgrid1.RowCount-1]:=' and round(Data0060.PARTS_ORDERED*data0025.unit_sq,6)='+edit3.Text
   else if RadioGroup2.ItemIndex=1 then
     sgrid1.Cells[2,sgrid1.RowCount-1]:='and round(Data0060.PARTS_ORDERED*data0025.unit_sq,6)>'+edit3.Text
   else
     sgrid1.Cells[2,sgrid1.RowCount-1]:='and round(Data0060.PARTS_ORDERED*data0025.unit_sq,6)<'+edit3.Text;
   sgrid1.Cells[1,sgrid1.RowCount-1]:=RadioGroup2.Items[RadioGroup2.ItemIndex]+edit3.Text;
 end;
