object DM: TDM
  ...
  object ADS60: TADODataSet
    ...
    CommandText = 
      ...
      '.CUST_PART_PTR,Data0060.CONF_DATE,'#13#10'data0025.rkey as rkey25,data' +
      '0025.ANCESTOR_PTR,'#13#10'data0060.REFERENCE_NUMBER, data0060.SHIP_REG' +
      '_TAX_ID ,round(Data0060.PARTS_ORDERED*data0025.unit_sq,6) as ord' +
      'er_sq,'#13#10'data0025.OPT_LOT_SIZE, data0025.EST_SCRAP,data0025.spell' +
      '_sq,data0015.warehouse_code,(dbo.Data0060.PARTS_ORDERED +dbo.Dat' +
      'a0060.PARTS_RETURNED-dbo.Data0060.PARTS_SHIPPED - dbo.data0060.r' +
      'eturned_ship) AS parts_margin,data0060.P_CODE,DATA0283.PRIORITY_' +
      'name,Data0060.PARTS_RETURNED,data0060.REPUT_APPR_BY,data0025.AUD' +
      'ITED_DATE'#13#10',round(Data0060.TO_BE_PLANNED * data0025.unit_sq,6) a' +
      's tobeplanned_sq'#13#10',CASE Data0025.ttype WHEN  1 THEN '#39#26679#26495#39' WHEN 0 ' +
      'THEN '#39#37327#20135#39' END as strtype'#13#10'FROM         dbo.Data0060 INNER JOIN'#13#10 +
      '                   dbo.Data0025 ON dbo.Data0060.CUST_PART_PTR = ' +
      'dbo.Data0025.RKEY INNER JOIN'#13#10'                   dbo.Data0010 ON' +
      ' dbo.Data0060.CUSTOMER_PTR = dbo.Data0010.RKEY INNER JOIN'#13#10'     ' +
      '              dbo.Data0097 ON dbo.Data0060.PURCHASE_ORDER_PTR = ' +
      'dbo.Data0097.RKEY INNER JOIN'#13#10'                   dbo.Data0008 ON' +
      ' dbo.Data0025.PROD_CODE_PTR = dbo.Data0008.RKEY inner join '#13#10'   ' +
      '                data0015 on data0060.SHIP_REG_TAX_ID=data0015.rk' +
      'ey INNER JOIN '#13#10'                   DATA0283 ON data0060.P_CODE =' +
      ' DATA0283.PRIORITY_CODE'#13#10'WHERE     (dbo.Data0060.PROD_REL <> '#39'3'#39 +
      ') AND (dbo.Data0060.STATUS = 1)'#13#10'and (data0060.ent_date >= :dtpk' +
      '1) and (data0060.ent_date <= :dtpk2)'#13#10'and (data0060.so_tp = :sot' +
      'p)'#13#10
    ...
    object ADS60PRIORITY_name: TStringField
      DisplayLabel = #32039#32423#31243#24230
    ...
    object ADS60CONF_DATE: TDateTimeField
      FieldName = 'CONF_DATE'
    end
  end
