object frmMultiSelectedItem: TfrmMultiSelectedItem
  ...
  object Dt: TADODataSet
    ...
    CommandText = 
      ...
      '17.DeviType=d12.DeviType and active_flag in(3,4) and d17.EquiTyp' +
      'e=0/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684'*/ '#13#10'join data0034 d34 on d34.rkey=d17.DEPT_PTR ' +
      'join data0015 d15 on d17.warehouse_ptr=d15.rkey '#13#10'join data0816 ' +
      'd16 on d12.MainCycl=d16.MainCycl  '#13#10'where not exists(select * fr' +
      'om data0831 d31  where d31.DeviNumb=d17.Fasset_Code and d31.Main' +
      'Cycl=d12.MainCycl) '#13#10'UNION '#13#10'select * from '#13#10'('#13#10'select Cast(0 as' +
      ' Bit) selected ,'#13#10'case when d31.PlanMainDate+d16.cycl_duration<g' +
      'etDate() then CONVERT(VARCHAR(10),getDate(),120)'#13#10'     else CONV' +
      'ERT(VARCHAR(10),d31.PlanMainDate+d16.cycl_duration,120) end Plan' +
      'MainDate,d15.ABBR_NAME,d17.Fasset_Code ,'#13#10'FASSET_NAME ,DEPT_Name' +
      ' ,d17.DeviType ,d12.MainCycl,d16.rkey as d16rkey, d17.equipment_' +
      'grade,d17.LOCATION,'#13#10'[StdTimeCons]=(select [StdTimeCons] from [d' +
      'ata0847] where  [D417_ptr]=d17.rkey and d12.MainCycl  =[data0847' +
      '].MainCycl) '#13#10'from data0417 d17 '#13#10'join data0812 d12 on d17.DeviT' +
      'ype=d12.DeviType and active_flag in(3,4) and d17.EquiType=0/*3'#23433#35013 +
      #23436#25104',4'#39564#25910#21512#26684'*/'#13#10'join data0034 d34 on d34.rkey=d17.DEPT_PTR    '#13#10'join' +
      ' data0015 d15 on d17.warehouse_ptr=d15.rkey                    '#13 +
      #10'join data0831 d31 on d31.DeviNumb=d17.Fasset_Code and d31.MainC' +
      'ycl=d12.MainCycl '#13#10'join data0816 d16 on d31.MainCycl=d16.MainCyc' +
      'l   '#13#10'where exists ('#13#10'    select * from '#13#10'        (select max(Pl' +
      'anMainDate)PlanMainDate,DeviNumb,MainCycl from data0831 '#13#10'      ' +
      '  where RKEY832 in (2,4)'#13#10'        and not exists(select * from d' +
      'ata0831 d31 where data0831.DeviNumb=d31.DeviNumb    '#13#10'          ' +
      '     and data0831.MainCycl=d31.MainCycl and d31.RKEY832 in(1,3,5' +
      ',6) )         '#13#10'        group by DeviNumb,MainCycl  )as t1  '#13#10'  ' +
      '  where d31.PlanMainDate=t1.PlanMainDate'#13#10'    and d31.DeviNumb=t' +
      '1.DeviNumb and d31.MainCycl=t1.MainCycl '#13#10'              )      '#13 +
      #10#13#10') as temptemp'#13#10'order by FASSET_NAME,PlanMainDate,d16rkey'
    Parameters = <>
    Left = 168
    Top = 72
  ...
  object dt1: TClientDataSet
    ...
    CommandText = 
      ...
      ' from [data0847] where  [D417_ptr]=d17.rkey and d12.MainCycl  =[' +
      'data0847].MainCycl) '#13#10'from data0417 d17 '#13#10'join data0812 d12 on d' +
      '17.DeviType=d12.DeviType and active_flag in(3,4,7) and d17.EquiT' +
      'ype=0/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684',7'#38386#32622'*/ '#13#10'join data0034 d34 on d34.rkey=d17.DEP' +
      'T_PTR join data0015 d15 on d17.warehouse_ptr=d15.rkey '#13#10'join dat' +
      'a0816 d16 on d12.MainCycl=d16.MainCycl  '#13#10'where not exists(selec' +
      't * from data0831 d31  where d31.DeviNumb=d17.Fasset_Code and d3' +
      '1.MainCycl=d12.MainCycl) '#13#10'UNION '#13#10'select * from '#13#10'('#13#10'select Cas' +
      't(0 as Bit) selected ,'#13#10'case when d31.PlanMainDate+d16.cycl_dura' +
      'tion<getDate() then CONVERT(VARCHAR(10),getDate(),120)'#13#10'     els' +
      'e CONVERT(VARCHAR(10),d31.PlanMainDate+d16.cycl_duration,120) en' +
      'd PlanMainDate,d15.ABBR_NAME,d17.Fasset_Code ,'#13#10'FASSET_NAME ,DEP' +
      'T_Name ,d17.DeviType ,d12.MainCycl,d16.rkey as d16rkey, d17.equi' +
      'pment_grade,d17.LOCATION,'#13#10'[StdTimeCons]=(select [StdTimeCons] f' +
      'rom [data0847] where  [D417_ptr]=d17.rkey and d12.MainCycl  =[da' +
      'ta0847].MainCycl) '#13#10'from data0417 d17 '#13#10'join data0812 d12 on d17' +
      '.DeviType=d12.DeviType and active_flag in(3,4,7) and d17.EquiTyp' +
      'e=0/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684',7'#38386#32622'*/'#13#10'join data0034 d34 on d34.rkey=d17.DEPT_P' +
      'TR    '#13#10'join data0015 d15 on d17.warehouse_ptr=d15.rkey         ' +
      '           '#13#10'join data0831 d31 on d31.DeviNumb=d17.Fasset_Code a' +
      'nd d31.MainCycl=d12.MainCycl '#13#10'join data0816 d16 on d31.MainCycl' +
      '=d16.MainCycl   '#13#10'where exists ('#13#10'    select * from '#13#10'        (s' +
      'elect max(PlanMainDate)PlanMainDate,DeviNumb,MainCycl from data0' +
      '831 '#13#10'        where RKEY832 in (2,4)'#13#10'        and not exists(sel' +
      'ect * from data0831 d31 where data0831.DeviNumb=d31.DeviNumb    ' +
      #13#10'               and data0831.MainCycl=d31.MainCycl and d31.RKEY' +
      '832 in(1,3,5,6) )         '#13#10'        group by DeviNumb,MainCycl  ' +
      ')as t1  '#13#10'    where d31.PlanMainDate=t1.PlanMainDate'#13#10'    and d3' +
      '1.DeviNumb=t1.DeviNumb and d31.MainCycl=t1.MainCycl '#13#10'          ' +
      '    )      '#13#10#13#10') as temptemp'#13#10'order by FASSET_NAME,PlanMainDate,' +
      'd16rkey'
    Params = <>
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from data0417 d17 '
        ...
        'n(3,4,7) and d17.EquiType=0/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684',7'#38386#32622'*/ '
