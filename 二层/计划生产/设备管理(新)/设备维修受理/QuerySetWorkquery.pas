...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['申请单号','设备代码','部门代码','雇员','工厂','提交日期','受理日期','完工日期','雇员开始时间','雇员结束时间']);
  v_Field_List_EN := VarArrayOf(['data0567.number','data0417.FASSET_CODE','data0034.dept_code','d5.EMPLOYEE_NAME',
                     'data0015.abbr_name','DATA0567.referring_date','DATA0567.disposal_date','DATA0567.complete_date','Data0842.BeginTime','Data0842.EndTime']);
...
var i:byte;
begin
  if (listbox3.itemindex<>4) and (listbox3.itemindex<>5) and (listbox3.itemindex<>6) and (listbox3.itemindex<>7)
...
begin
  ...
  edtValue.Visible:= (ListBox3.ItemIndex <> 4) and (ListBox3.ItemIndex <> 5) and(listbox3.itemindex<>9)
  and (ListBox3.ItemIndex <> 6) and (ListBox3.ItemIndex <> 7)and (ListBox3.ItemIndex <> 8);
  cbbconfirm.Visible:= (ListBox3.ItemIndex = 4);
  rg1.Visible := (ListBox3.ItemIndex <> 2) and (ListBox3.ItemIndex <> 4) and (ListBox3.ItemIndex <> 5)
    and (ListBox3.ItemIndex <> 6)and (ListBox3.ItemIndex <> 7) and (ListBox3.ItemIndex <> 8) and(listbox3.itemindex<>9) ;
  rg1.ItemIndex :=0;
  ...
  DateTimePicker3.Visible := (ListBox3.ItemIndex=5) or (ListBox3.ItemIndex=6) or (ListBox3.ItemIndex=7)
                             or (ListBox3.ItemIndex=8) or (ListBox3.ItemIndex=9);
  DateTimePicker4.Visible := (ListBox3.ItemIndex=5) or (ListBox3.ItemIndex=6) or (ListBox3.ItemIndex=7)
                             or (ListBox3.ItemIndex=8) or (ListBox3.ItemIndex=9);
  DateTimePicker5.Visible := (ListBox3.ItemIndex=5) or (ListBox3.ItemIndex=6) or (ListBox3.ItemIndex=7)
                             or (ListBox3.ItemIndex=8) or (ListBox3.ItemIndex=9);
  DateTimePicker6.Visible := (ListBox3.ItemIndex=5) or (ListBox3.ItemIndex=6) or (ListBox3.ItemIndex=7)
                             or (ListBox3.ItemIndex=8) or (ListBox3.ItemIndex=9);
  if (ListBox3.ItemIndex=5) or (ListBox3.ItemIndex=6) or (ListBox3.ItemIndex=7) or
     (ListBox3.ItemIndex=8) or (ListBox3.ItemIndex=9) then
    Label8.Caption :='从'
  else
    Label8.Caption := listbox3.Items[listbox3.ItemIndex]+':';
  Label3.Caption := '到';
  Label3.Visible :=(ListBox3.ItemIndex=5) or (ListBox3.ItemIndex=6) or (ListBox3.ItemIndex=7)
  or (ListBox3.ItemIndex=8) or (ListBox3.ItemIndex=9);
