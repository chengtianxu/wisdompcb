object frmMultiSelectedItem: TfrmMultiSelectedItem
  ...
  object Dt: TADODataSet
    ...
    CommandText = 
      ...
      '17.DeviType=d12.DeviType and active_flag in(3,4)/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684'*/a' +
      'nd d17.EquiType=1'#13#10'join data0034 d34 on d34.rkey=d17.DEPT_PTR jo' +
      'in data0015 d15 on d17.warehouse_ptr=d15.rkey '#13#10'join data0816 d1' +
      '6 on d12.MainCycl=d16.MainCycl  '#13#10'where not exists(select * from' +
      ' data0831 d31  where d31.DeviNumb=d17.Fasset_Code and d31.MainCy' +
      'cl=d12.MainCycl) '#13#10'UNION '#13#10'select * from '#13#10'('#13#10'select Cast(0 as B' +
      'it) selected ,'#13#10'case when d31.PlanMainDate+d16.cycl_duration<get' +
      'Date() then CONVERT(VARCHAR(10),getDate(),120)'#13#10'     else CONVER' +
      'T(VARCHAR(10),d31.PlanMainDate+d16.cycl_duration,120) end PlanMa' +
      'inDate,d15.ABBR_NAME,d17.Fasset_Code ,'#13#10'FASSET_NAME ,DEPT_Name ,' +
      'd17.DeviType ,d12.MainCycl,d16.rkey as d16rkey, d17.equipment_gr' +
      'ade,d17.LOCATION,'#13#10'[StdTimeCons]=(select [StdTimeCons] from [dat' +
      'a0847] where  [D417_ptr]=d17.rkey and d12.MainCycl  =[data0847].' +
      'MainCycl) '#13#10'from data0417 d17 '#13#10'join data0812 d12 on d17.DeviTyp' +
      'e=d12.DeviType and active_flag in(3,4)/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684'*/and d17.Equ' +
      'iType=1'#13#10'join data0034 d34 on d34.rkey=d17.DEPT_PTR    '#13#10'join da' +
      'ta0015 d15 on d17.warehouse_ptr=d15.rkey                    '#13#10'jo' +
      'in data0831 d31 on d31.DeviNumb=d17.Fasset_Code and d31.MainCycl' +
      '=d12.MainCycl '#13#10'join data0816 d16 on d31.MainCycl=d16.MainCycl  ' +
      ' '#13#10'where exists ('#13#10'    select * from '#13#10'        (select max(PlanM' +
      'ainDate)PlanMainDate,DeviNumb,MainCycl from data0831 '#13#10'        w' +
      'here RKEY832 in (2,4)'#13#10'        and not exists(select * from data' +
      '0831 d31 where data0831.DeviNumb=d31.DeviNumb    '#13#10'             ' +
      '  and data0831.MainCycl=d31.MainCycl and d31.RKEY832 in(1,3,5,6)' +
      ' )         '#13#10'        group by DeviNumb,MainCycl  )as t1  '#13#10'    w' +
      'here d31.PlanMainDate=t1.PlanMainDate'#13#10'    and d31.DeviNumb=t1.D' +
      'eviNumb and d31.MainCycl=t1.MainCycl '#13#10'              )      '#13#10#13#10 +
      ') as temptemp'#13#10'order by FASSET_NAME,PlanMainDate,d16rkey'
    Parameters = <>
    Left = 168
    Top = 72
  ...
  object dt1: TClientDataSet
    ...
    CommandText = 
      ...
      '7'#38386#32622'*/  and d17.EquiType=1'#13#10'join data0034 d34 on d34.rkey=d17.DEP' +
      ...
      '.DeviType=d12.DeviType and active_flag in(3,4,7)/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684',7'#38386 +
      #32622'*/ and d17.EquiType=1'#13#10'join data0034 d34 on d34.rkey=d17.DEPT_P' +
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      ...
      'from data0417 d17 '
        ...
        'n(3,4,7)/*3'#23433#35013#23436#25104',4'#39564#25910#21512#26684',7'#38386#32622'*/ and d17.EquiType=1'
