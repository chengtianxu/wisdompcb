...
begin
  ...
  begin
    messagedlg('物料发放不成功领料单状态发生变化!请重新选择库存发放',mterror,[mbcancel],0);
    self.update_grid1;
    exit;
  end;
...
begin
  try
    ...
    'case data0268.TTYPE when 0 then ''部门领料'' when 1 then ''BOM领料'' end as vttype'+#13+
