object DM: TDM
  ...
  object ado208: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select SOURCE_PTR,DEPT_PTR,GON_PTR,TDATE,QUANTITY'
      'from data0208'
      'where rkey is null')
    Left = 88
    Top = 128
  ...
  object ads468: TADODataSet
    ...
    CommandText = 
      ...
      'a0002.UNIT_NAME, data0002.UNIT_CODE, data0492.ISSUE_DATE,'#13#10'data0' +
      '017.quan_on_hand-data0017.QUAN_ASSIGN as quan_on_hand,data0468.q' +
      'uan_alloc,'#13#10'data0468.quan_alloc as alloc,case data0468.PRINTIT w' +
      'hen '#39'N'#39' then '#39'VMI'#24211#23384#39' else '#39#26222#36890#24211#23384#39' end as sotck_type'#13#10'FROM data049' +
      '2 INNER JOIN'#13#10'      Data0468 ON data0492.CUT_NO = Data0468.CUT_N' +
      'O INNER JOIN'#13#10'      Data0002 INNER JOIN'#13#10'      Data0017 ON Data0' +
      '002.RKEY = Data0017.STOCK_UNIT_PTR ON '#13#10'      Data0468.INVENT_PT' +
      'R = Data0017.RKEY'#13#10'WHERE (Data0468.DEPT_PTR = :rkey34) AND '#13#10'   ' +
      '            (data0492.WHOUSE_PTR = :wh_ptr) And'#13#10'              (' +
      'Data0468.STATUS = 0) AND '#13#10'              (data0492.Con_Flag = 2)' +
      ' and'#13#10'              (data0468.invent_or=0) and (Data0468.CUT_NO ' +
      '= :cut_no492)'#13#10'order by Data0468.CUT_NO'
    Parameters = <
      item
        Name = 'rkey34'
        Attributes = [paSigned]
  ...
  object aq22: TADODataSet
    ...
    CommandText = 
      ...
      'data0456.warehouse_ptr,'#13#10'      Data0022.EXPIRE_DATE, Data0022.ro' +
      'hs, Data0023.ABBR_NAME, '#13#10'      Data0022.SUPPLIER2, Data0017.STD' +
      '_COST, data0002.unit_code,'#13#10'      dbo.Data0022.INVENTORY_PTR, db' +
      'o.Data0022.RKEY,data0022.barcode_id'#13#10'FROM dbo.Data0022 INNER JOI' +
      'N'#13#10'      dbo.Data0016 ON dbo.Data0022.LOCATION_PTR = dbo.Data001' +
      '6.RKEY INNER JOIN'#13#10'      dbo.Data0017 ON dbo.Data0022.INVENTORY_' +
      'PTR = dbo.Data0017.RKEY INNER JOIN'#13#10'      dbo.Data0002 ON '#13#10'    ' +
      '  dbo.Data0022.LOCATION_PTR_FROM = dbo.Data0002.RKEY INNER JOIN'#13 +
      #10'      dbo.Data0456 ON dbo.Data0022.GRN_PTR = dbo.Data0456.RKEY ' +
      'INNER JOIN'#13#10'      dbo.Data0023 ON dbo.Data0456.SUPP_PTR = dbo.Da' +
      'ta0023.RKEY'#13#10'WHERE (dbo.Data0022.QUAN_ON_HAND > 0) '
  ...
  object ads468_268: TADODataSet
    ...
    CommandText = 
      ...
      '0017.QUAN_ASSIGN as quan_on_hand,data0468.quan_alloc,'#13#10'data0468.' +
      'quan_alloc as alloc,case data0468.PRINTIT when '#39'N'#39' then '#39'VMI'#24211#23384#39' ' +
      'else '#39#26222#36890#24211#23384#39' end as sotck_type'#13#10'FROM data0268 INNER JOIN'#13#10'      D' +
      'ata0468 ON data0268.rkey = Data0468.flow_no INNER JOIN'#13#10'      Da' +
      'ta0002 INNER JOIN'#13#10'      Data0017 ON Data0002.RKEY = Data0017.ST' +
      'OCK_UNIT_PTR ON '#13#10'      Data0468.INVENT_PTR = Data0017.RKEY'#13#10'WHE' +
      'RE (Data0468.flow_no = :rkey268) AND'#13#10'              (Data0468.ST' +
      'ATUS = 0) AND'#13#10'              (data0268.status = 2) and'#13#10'        ' +
