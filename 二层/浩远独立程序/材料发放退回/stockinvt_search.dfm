object Form_stocksearch: TForm_stocksearch
  ...
  object aq22: TADODataSet
    ...
    CommandText = 
      ...
      'code_id'#13#10'FROM dbo.Data0022 INNER JOIN'#13#10'      dbo.Data0016 ON dbo' +
      '.Data0022.LOCATION_PTR = dbo.Data0016.RKEY INNER JOIN'#13#10'      dbo' +
      '.Data0017 ON dbo.Data0022.INVENTORY_PTR = dbo.Data0017.RKEY INNE' +
      'R JOIN'#13#10'      dbo.Data0002 ON '#13#10'      dbo.Data0022.LOCATION_PTR_' +
      'FROM = dbo.Data0002.RKEY INNER JOIN'#13#10'      dbo.Data0456 ON dbo.D' +
      'ata0022.GRN_PTR = dbo.Data0456.RKEY INNER JOIN'#13#10'      dbo.Data00' +
      '23 ON dbo.Data0456.SUPP_PTR = dbo.Data0023.RKEY'#13#10'WHERE (Data0022' +
      '.QUAN_ON_HAND-data0022.QUAN_TO_BE_STOCKED > 0) '
