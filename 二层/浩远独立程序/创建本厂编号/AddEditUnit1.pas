...
uses
   DMUnit1 ,common   ,Pick_Item_Single   ,ConstVar, FindRFQ;
...
begin
        ...
        with dm.TemADOQuery1 do        //更新第二层
         begin
          ...
          sql.Text:='update data0025'+#13+
                   'set DATA0025.MANU_PART_DESC=Data0025_1.MANU_PART_DESC,'+#13+
  ...
  begin
   ...
   IF (VMyEditMode = 1) or (VMyEditMode = 3) THEN //编辑
      BEGIN
         ...
         TRY
             ...
             if  CheckBox3.Checked then
              ...
              close;
              sql.Text:='update data0025'+#13+
                   'set DATA0025.reach=Data0025_1.reach'+#13+
                   'FROM Data0025 INNER JOIN'+#13+
              'Data0025 Data0025_1 ON Data0025.PARENT_PTR = Data0025_1.RKEY'+#13+
              'where Data0025_1.RKEY='+dm.ADOQuery2RKEY.AsString;
              ExecSQL;
              ...
              close;
              sql.Text:='update data0025'+#13+
                   'set DATA0025.reach=Data0025_2.reach'+#13+
                   'FROM data0025 INNER JOIN  '+#13+
                   'Data0025 Data0025_1 ON'+#13+
                   'Data0025.PARENT_PTR = Data0025_1.RKEY INNER JOIN'+#13+
                   'Data0025 Data0025_2 ON '+#13+
              ...
              close;
              sql.Text:='update data0025'+#13+
                   'set DATA0025.reach=Data0025_3.reach'+#13+
                   'FROM data0025 INNER JOIN  '+#13+
                   'Data0025 Data0025_1 ON'+#13+
                   'Data0025.PARENT_PTR = Data0025_1.RKEY INNER JOIN'+#13+
                   'Data0025 Data0025_2 ON '+#13+
          ...
          with dm.TemADOQuery1 do      //更新第三层
           begin
            ...
            sql.Text:='update data0025'+#13+
                     'set DATA0025.MANU_PART_DESC=Data0025_2.MANU_PART_DESC,'+#13+
                     'DATA0025.customer_ptr=Data0025_2.customer_ptr,'+#13+
          ...
          with dm.TemADOQuery1 do      //更新第四层
           begin
            ...
            sql.Text:='update data0025'+#13+
                     'set DATA0025.MANU_PART_DESC=Data0025_3.MANU_PART_DESC,'+#13+
                         'DATA0025.customer_ptr=Data0025_3.customer_ptr,'+#13+
...
begin
   ...
   if dm.ADOQuery2.Active then
       begin
        ...
        edit10.Text := dm.ADOQuery2set_qty.AsString ; //交货单元数
        ...
        if VMyEditMode = 0 then //新增
         begin
           RadioGroup2.ItemIndex := 2;  //浩远独立程序新增时需要赋值
           edit15.Text :='1';
           edit16.Text :='1';
         end;
...
begin
  ...
  dm.TemADOQuery1.Close;
  dm.TemADOQuery1.SQL.Text := 'select CUSTSTATOOL from data0192';
...
procedure TAddEditForm1.DBComboBox1KeyPress(Sender: TObject;
  var Key: Char);
begin
 if self.ADOQ0089MyDATATYPE.Value='数字' then
 if not (key in ['0'..'9','.',#8,#13]) then  //判断是否输入数字
...
procedure TAddEditForm1.DBComboBox1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
