object ColsDisplaySet_frm: TColsDisplaySet_frm
  ...
  object cds_ColsOriginal: TClientDataSet
    Aggregates = <>
    CommandText = 
      '--select Data0862.FormName,Data0862.GridName,Data0863.* '#13#10'--from' +
      ' Data0863 join Data0862 on Data0863.ColsSet_ptr=Data0862.rkey'#13#10'-' +
      '-where 1=2 '#13#10'--order by ColsSet_ptr,DisplayOrder'
    Params = <>
    Left = 160
    Top = 365
  end
  object cds_Grid: TClientDataSet
    Aggregates = <>
    CommandText = 
      '--select FormName,GridName,FrozenField '#13#10'--from Data0862 where 1' +
      '=2'#13#10'--Declare @tb1 table(FormName varchar(50),GridName varchar(5' +
      '0))'#13#10'--select * from @tb1'
    Params = <>
    Left = 160
    Top = 303
  end
