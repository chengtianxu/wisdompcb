...
type
  TDM = class(TDataModule)
    ...
    procedure ADO60AfterOpen(DataSet: TDataSet);
  private
...
begin
 case ado60.FieldValues['status'] of
  1: ado60.FieldValues['v_status']:='有效的';
  2: ado60.FieldValues['v_status']:='暂缓';
  5: ado60.FieldValues['v_status']:='已取消';
  6: ado60.FieldValues['v_status']:='未提交';
 end;
end;
...
procedure TDM.ADO60AfterOpen(DataSet: TDataSet);
begin
