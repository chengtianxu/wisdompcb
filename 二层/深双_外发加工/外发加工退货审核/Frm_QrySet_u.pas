...
begin
  ...
  BitBtn7.Visible:=listbox3.ItemIndex in [2,3,4] ;
  edtValue.Text:='';
end;
...
var i:integer;
begin
  v_Field_List_CN := VarArrayOf(['退货单号','入库单号','工序代码','退货员工代码','供应商代码']);
  v_Field_List_EN := VarArrayOf(['WZDATA306.rejected_number','wzdata303.deliver_number','data0034.dept_code','data0005.empl_code','Data0023.CODE']);
