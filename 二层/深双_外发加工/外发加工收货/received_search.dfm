object Form3: TForm3
  ...
  object Memo1: TMemo
    ...
    Lines.Strings = (
        ...
        'SELECT  distinct wzdata301.rkey,WZDATA300.rkey,WZDATA300.epiboly' +
        '_number,wzdata301.set_qty,'
      ...
      '      DATA0015.ABBR_NAME as whouse_name,'
        ...
        '      case wzdata301.UNIT_NAME when '#39'SET'#39' then data0279.PARAMETE' +
        'R_VALUE*WZDATA301.RECEVIED_QTY'
      
        '                               when '#39'PNL'#39' then data0279.PARAMETE' +
        'R_VALUE*WZDATA301.RECEVIED_QTY*data0502.UPANEL '
      
        '                               when '#39'PCS'#39' then WZDATA301.RECEVIE' +
        'D_QTY end PCS ,'
      
        '      data0279.PARAMETER_VALUE,data0502.UPANEL,Allunit_sq= ROUND' +
        '(data0025.unit_sq,6)  '
      '      '
      '        '
      'FROM WZDATA301 INNER JOIN  Data0025 ON'
      '      WZDATA301.CUSTPART_PTR = dbo.Data0025.RKEY INNER JOIN'
      '      data0279 on data0279.SOURCE_PTR=Data0025.rkey INNER JOIN'
      '      WZDATA300 ON'
      '      WZDATA301.EPIBOLY_PTR = dbo.WZDATA300.rkey left JOIN'
      
        '      WZDATA304 ON WZDATA304.EPILIST_PTR=WZDATA301.rkey left JOI' +
        'N'
      
        '      dbo.WZDATA303  ON dbo.WZDATA303.RKEY = dbo.WZDATA304.DELIV' +
        'ER_PTR INNER JOIN'
        ...
        '      Data0015 ON WZDATA300.WAREHOUSE_PTR=DATA0015.RKEY left JOI' +
        'N'
      
        '      dbo.data0502  ON dbo.Data0025.rkey = dbo.data0502.source_p' +
        'tr  '
      'where WZDATA301.rkey>0  '
      'and data0279.PARAMETER_PTR=445   '
  ...
  object wzaq301: TADOQuery
    ...
    object wzaq301PCS: TIntegerField
      FieldName = 'PCS'
      ReadOnly = True
    end
    object wzaq301Allunit_sq: TFloatField
      FieldName = 'Allunit_sq'
      ReadOnly = True
    end
  end
