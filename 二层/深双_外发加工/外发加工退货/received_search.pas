...
begin
  ...
  stringgrid1.Cells[11,0]:='报废数量';
  stringgrid1.Cells[12,0]:='欠货数量';
  stringgrid1.Cells[13,0]:='备注';
  stringgrid1.Cells[14,0]:='工厂名称';
end;

procedure TForm3.Button3Click(Sender: TObject);
var i:integer;
    eip_qty,sou_qty,ret_qty,reject_qty,short_qty:integer;
begin
 ...
 begin
  ...
  begin
   self.StringGrid1.ColCount:=20;
   stringgrid1.Cells[15,0]:='送货单号';
   stringgrid1.Cells[16,0]:='送货日期';
   stringgrid1.Cells[17,0]:='送货数量';
   stringgrid1.Cells[18,0]:='退货数量';
   stringgrid1.Cells[19,0]:='报废数量';
  ...
  begin
   ...
   stringgrid1.Cells[11,stringgrid1.RowCount-1]:=self.wzaq301reject_qty.AsString; //'报废数量';
   stringgrid1.Cells[12,stringgrid1.RowCount-1]:=self.wzaq301short_qty.AsString; //'欠货数量';
   stringgrid1.Cells[13,stringgrid1.RowCount-1]:=self.wzaq301REMARTK.Value;//备注;
   stringgrid1.Cells[14,stringgrid1.RowCount-1]:=self.wzaq301whouse_name.Value;//工厂;
   ...
   begin
    ...
    begin
     ...
     stringgrid1.Cells[15,stringgrid1.RowCount-1]:=wzdata304DELIVER_NUMBER.Value;   //'送货单号';
     stringgrid1.Cells[16,stringgrid1.RowCount-1]:=wzdata304SHIP_DATE.AsString;     //'送货日期';
     stringgrid1.Cells[17,stringgrid1.RowCount-1]:=wzdata304rece_quantity.AsString; //'送货数量';
     stringgrid1.Cells[18,stringgrid1.RowCount-1]:=wzdata304RETURN_QTY.AsString;    //'退货数量';
     stringgrid1.Cells[19,stringgrid1.RowCount-1]:=wzdata304reject_qty.AsString;    //'报废数量';
  ...
  stringgrid1.Cells[11,stringgrid1.RowCount-1]:=inttostr(reject_qty);//'报废数量';
  stringgrid1.Cells[12,stringgrid1.RowCount-1]:=inttostr(short_qty);//'欠货数量';
 end;
 self.wzaq301.Close;
 form4.Free;
end;
