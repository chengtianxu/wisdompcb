...
begin
 ...
 0:
  ...
  0:sgrid1.Cells[2,sgrid_row]:='and Data0219.GRN_NUMBER = '''+edit3.Text+'''';
  1:sgrid1.Cells[2,sgrid_row]:='and Data0219.GRN_NUMBER > '''+edit3.Text+'''';
  2:sgrid1.Cells[2,sgrid_row]:='and Data0219.GRN_NUMBER <> '''+edit3.Text+'''';
  3:sgrid1.Cells[2,sgrid_row]:='and Data0219.GRN_NUMBER like ''%'+edit3.Text+'%''';
  end;
