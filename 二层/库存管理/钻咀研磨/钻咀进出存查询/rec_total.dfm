  ...
  object adotota22: TADOQuery
    ...
    SQL.Strings = (
      ...
      '          (1+data0022.tax_2*0.01)), 3) AS std_notaxprice,'
        ...
        '      data0019.inv_group_name, Data0017.STOCK_BASE,Data0017.STOC' +
        'K_SELL,'
      
        '      SUM(dbo.Data0022.QUANTITY * dbo.Data0017.STOCK_BASE) AS to' +
        'tal_weight,'
      
        'ROUND(SUM(Data0022.QUANTITY * Data0017.STOCK_SELL / 144), 4) AS ' +
        'total_area'
