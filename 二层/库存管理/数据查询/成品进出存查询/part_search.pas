...
begin
  if trim(Edit1.text)<>'' then
   Adoquery1.Filter:=fieldbyname+' like '''+trim(edit1.Text)+'%'''
  else
   Adoquery1.Filter:='';
end;
...
begin
if self.fieldbyname<>column.FieldName then
 begin
  self.fieldbyname:=column.FieldName;
