...
var
  find_Form2: Tfind_Form2;

implementation

{$R *.dfm}

procedure Tfind_Form2.Edit1Change(Sender: TObject);
begin
  inherited;
...
procedure Tfind_Form2.DBGrid1DblClick(Sender: TObject);
begin
  inherited;
  Button1Click(sender);
end;

procedure Tfind_Form2.DBGrid1KeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if key=#13 then
    Button1Click(sender);
...
procedure Tfind_Form2.DBGrid1TitleClick(Column: TColumn);
begin
  inherited;
  edit1.Text :='';
...
procedure Tfind_Form2.Button1Click(Sender: TObject);
begin
  inherited;
  modalresult:=mrok;
end;

procedure Tfind_Form2.FormShow(Sender: TObject);
begin
  inherited;
  vColumn1:=DBGrid1.Columns[0]; 
end;

procedure Tfind_Form2.Button2Click(Sender: TObject);
begin
  //inherited;
