...
uses
   ...
   ,find_CUSTOMER_PART_NUMBER_Unit2, Unit2,Unit3
   ,Unit4, findUnit1;
...
begin
 ...
 0:begin //订单号
    ...
    sgrid1.Cells[2,sgrid_row]:='and INV_PART_NUMBER LIKE '''+trim(edit2.Text)+'%''';
   end;                             //Data0017.
 1:begin
    sgrid1.Cells[1,sgrid_row]:=edit2.Text;
    sgrid1.Cells[2,sgrid_row]:='and INV_PART_DESCRIPTION LIKE '''+trim(edit2.Text)+'%''';
   end;                            //Data0017.
 2:begin
    sgrid1.Cells[1,sgrid_row]:=edit2.Text;
...
begin
  ...
  0:
    begin
      find_Form2:= Tfind_Form2.Create(application) ;
      try
       find_Form2.Caption :='查找材料';
       find_Form2.ADOStoredProc1.Open;
       if find_Form2.ShowModal=mrok then
       begin
         edit2.Text :=find_Form2.ADOStoredProc1INV_PART_NUMBER.Value;
         if edit2.Text <>'' then
           BitBtn8.Enabled := true ;
         //showmessage(find_SALES_ORDER_Form2.ADOStoredProc1sales_order.Value  );
       end;
       find_Form2.ADOStoredProc1.Close;
      finally
       find_Form2.Free;
      end;
    end;
  1:
    begin
      ...
      try
       ...
       if find_Form2.ShowModal=mrok then
       begin
         edit2.Text :=find_Form2.ADOStoredProc1INV_PART_DESCRIPTION.Value;
         if edit2.Text <>'' then
           BitBtn8.Enabled := true ;
         //showmessage(find_SALES_ORDER_Form2.ADOStoredProc1sales_order.Value  );
       end;
  ...
  2:
    begin
      find_Form3:= Tfind_Form3.Create(application) ;
      try
       find_Form3.Caption :='查找材料';
       find_Form3.ADOStoredProc1.Open;
       if find_Form3.ShowModal=mrok then
       begin
         edit2.Text :=find_Form3.ADOStoredProc1REJECT_DESCRIPTION.Value  ;
         if edit2.Text <>'' then
           BitBtn8.Enabled := true ;
         //showmessage(find_SALES_ORDER_Form2.ADOStoredProc1sales_order.Value  );
       end;
       find_Form3.ADOStoredProc1.Close;
      finally
       find_Form3.Free;
      end;
    end;
