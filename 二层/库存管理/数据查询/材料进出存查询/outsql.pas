...
type
  TForm3 = class(TForm)
    ...
    ado207MANU_PART_NUMBER: TStringField;
    ado207MANU_PART_DESC: TStringField;
    ...
    strngfldado207D496_type: TStringField;
    ...
    Label4: TLabel;
    Edit4: TEdit;
    ado207extra_req: TStringField;
    ado207caigouRen: TStringField;
...
begin
  ...
  begin
    ...
    item.Enabled:=not ((strtoint(vprev)<=2) and (i in [20,16,17,18,19]));
