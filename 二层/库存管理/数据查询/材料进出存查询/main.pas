...
15:
 ...
 begin
   ...
   try
      ...
      if frmPick_Item_Single.ShowModal=mrok then
      begin
        edit2.Text:=trim(frmPick_Item_Single.adsPick.FieldValues['EMPLOYEE_NAME']);
    ...
    18:
     ...
     begin
      ...
      if ComboBox4.ItemIndex=0 then
        ...
        sgrid1.Cells[2,j]:='and data0496.ttype =''M''';
     end;
     20:
    case radiogroup2.ItemIndex of
      0:sgrid1.Cells[2,j] := 'and D5_2.EMPLOYEE_NAME = '''+trim(edit2.Text)+'''';
      1:sgrid1.Cells[2,j] := 'and D5_2.EMPLOYEE_NAME LIKE ''%'+trim(edit2.Text)+'%''';
    end;
  end;
...
begin
  ...
  case listbox6.ItemIndex of
    ...
    4:;
    5,9:edit6.Enabled:=false;
    6:edit6.Enabled:=false;
    8:bitbtn9.Visible:=false;
    7:
    begin
      edit6.Enabled:=false;
      bitbtn9.Visible:=false;
...
//    7:sgrid1.Cells[2,j] := 'and Data0268.CUT_NO like ''%'+trim(edit6.Text)+'%''';
    7:
     ...
     8:sgrid1.Cells[2,j] := 'and Data0457.REF_NUMBER like ''%'+trim(edit6.Text)+'%''';
     9:sgrid1.Cells[2,j] := 'and data0022.LOCATION_PTR='+inttostr(Edit6.Tag);
  end;
...
7:
 begin
   ...
   ComboBox1.Items.Add('有效料');
   ComboBox1.Items.Add('过期料');
   ComboBox1.Items.Add('将过期');
//   ComboBox1.Items.Add('呆滞料');
//   ComboBox1.Items.Add('将呆滞料');
...
10:
 ...
 begin
  ...
  if form_dept.ShowModal=mrok then
   begin
    edit7.Text:=trim(form_dept.ADOQuery1dept_code.Value);
    button7.SetFocus;
   end
  else
   edit7.SetFocus;
...
begin
 ...
 7:
  case combobox1.ItemIndex of
   0: sgrid1.Cells[2,j] := ' and  dbo.Data0022.EXPIRE_DATE is not null and DATEDIFF(day, GETDATE(), dbo.Data0022.EXPIRE_DATE)>= 0 ';  //有效
   1: sgrid1.Cells[2,j] := ' and  dbo.Data0022.EXPIRE_DATE is not null and DATEDIFF(day, GETDATE(), dbo.Data0022.EXPIRE_DATE)< 0';        //过期
   2: sgrid1.Cells[2,j] := ' and (dbo.Data0022.EXPIRE_DATE is not null and DATEDIFF(day, GETDATE(), dbo.Data0022.EXPIRE_DATE)>0 and  DATEDIFF(day, GETDATE(), dbo.Data0022.EXPIRE_DATE)<=30 )';  //快过期
   3: sgrid1.Cells[2,j] := ' and  DATEDIFF(day,dbo.Data0456.ship_date, GETDATE())>=365 ';        //呆滞
   4: sgrid1.Cells[2,j] :=' and (DATEDIFF(day,dbo.Data0456.ship_date, GETDATE())>=335 and  DATEDIFF(day,dbo.Data0456.ship_date, GETDATE())<365)';    //快呆滞
  end;
 8:
  begin
 ...
 11:
   case radiogroup4.ItemIndex of
    0:sgrid1.Cells[2,j]:='and dbo.Data0070.PO_REV_NO = '''+trim(edit7.Text)+'''';
    1:sgrid1.Cells[2,j]:='and dbo.Data0070.PO_REV_NO LIKE ''%'+trim(edit7.Text)+'%''';
   end;
 end;
