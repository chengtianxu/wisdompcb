object Form3: TForm3
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 's_type'
        Title.Caption = #39046#26009#24037#24207#31867#22411
        Visible = False
      end
      item
        Expanded = False
      ...
      item
        ...
        ReadOnly = True
        Title.Caption = #22791#27880'('#20379#24212#21830#22411#21495')'
        Width = 98
        Visible = True
      end>
  end
  ...
  object ado207: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     dbo.Data0457.REF_NUMBER AS REF457_NUMBER, dbo.Data045' +
        '7.GON_NUMBER, dbo.Data0017.INV_PART_NUMBER, dbo.Data0017.INV_NAM' +
        'E, '
      
        '                      dbo.Data0017.INV_DESCRIPTION, dbo.Data0496' +
        '.GROUP_DESC, dbo.Data0034.DEPT_CODE, dbo.Data0034.DEPT_NAME, dbo' +
        '.Data0207.QUANTITY, '
      
        '                      dbo.Data0207.RTN_QUANTITY, dbo.Data0001.CU' +
        'RR_CODE, ROUND(dbo.Data0022.PRICE, 4) AS STANDARD_COST, '
      
        '                      dbo.Data0468.CUT_NO AS CUT_NO, dbo.Data046' +
        '8.SO_NO AS SO_NO, dbo.Data0010.CUST_CODE AS CUST_CODE, '
      
        '                      dbo.Data0010.ABBR_NAME AS ABBR_NAME10, dbo' +
        '.Data0022.BARCODE_ID, dbo.Data0019.inv_group_name, dbo.Data0022.' +
        'TAX_2, '
        ...
        '5.MANU_PART_DESC, Data0015_1.WAREHOUSE_CODE AS '#24211#23384#24037#21378', dbo.Data007' +
        '1.reason,dbo.Data0071.extra_req, '
      '                      dbo.Data0022.EXPIRE_DATE, '
      
        '                      CASE WHEN dbo.Data0496.ttype = '#39'p'#39' THEN '#39#30452 +
        #25509#26448#26009#39' WHEN dbo.Data0496.ttype = '#39'M'#39' THEN '#39#38388#25509#26448#26009#39' END AS D496_type'
      '                      ,D5_2.EMPLOYEE_NAME as caigouRen '
      'FROM         dbo.Data0025 RIGHT OUTER JOIN'
      '                      dbo.Data0071 RIGHT OUTER JOIN'
      ...
      '                      dbo.Data0207 INNER JOIN'
        ...
        '                      dbo.Data0071.RKEY = dbo.Data0022.SOURCE_PT' +
        'R LEFT OUTER JOIN'
      
        '                      dbo.Data0070 ON dbo.Data0456.PO_PTR = dbo.' +
        'Data0070.RKEY LEFT OUTER JOIN'
      
        '                      dbo.data0492 AS data0492_1 ON dbo.Data0468' +
        '.CUT_NO = data0492_1.CUT_NO ON dbo.Data0025.RKEY = data0492_1.BO' +
        'M_PTR LEFT OUTER JOIN'
      
        '                      dbo.Data0010 ON data0492_1.COMPLETED = dbo' +
        '.Data0010.RKEY left join '
      
        '                      data0005 as D5_2 on data0070.EMPLOYEE_POIN' +
        'TER=D5_2.rkey '
    ...
    object ado207MANU_PART_NUMBER: TStringField
      FieldName = 'MANU_PART_NUMBER'
    end
    object ado207MANU_PART_DESC: TStringField
      FieldName = 'MANU_PART_DESC'
      Size = 80
    end
    ...
    object strngfldado207D496_type: TStringField
      FieldName = 'D496_type'
      ReadOnly = True
      Size = 8
    end
    object ado207extra_req: TStringField
      FieldName = 'extra_req'
      Size = 50
    end
    object ado207caigouRen: TStringField
      FieldName = 'caigouRen'
      Size = 16
    end
  end
