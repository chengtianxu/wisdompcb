object Form1: TForm1
  ...
  object ado60: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT Data0060.SALES_ORDER,data0060.SCH_DATE,'
      '      Data0025.MANU_PART_NUMBER,data0025.MANU_PART_DESC,'
      '      Data0060.PARTS_ORDERED, Data0060.PART_PRICE,data0060.fob,'
      '      Data0060.TOTAL_ADD_L_PRICE, Data0060.ORIG_SCHED_SHIP_DATE,'
      
        '      Data0060.EXCH_RATE, Data0001.CURR_NAME, Data0001.CURR_CODE' +
        ','
      
        '      Data0060.ENT_DATE, Data0060.SHIPPING_METHOD, Data0025.unit' +
        '_sq,'
      '      Data0025.ANALYSIS_CODE_2, Data0025.ANALYSIS_CODE_1,'
      '      Data0060.PARTS_ORDERED * Data0025.unit_sq AS mianji'
  ...
  object ADO25: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT Data0025.REMARK, dbo.Data0025.ENG_NOTE, dbo.Data0273.text' +
        ', '
      '        Data0273.remark AS Data0273remark, dbo.Data0025.set_qty'
      'FROM Data0025 LEFT OUTER JOIN'
      '     Data0273 ON '
      '     Data0025.rkey = dbo.Data0273.CUSTOMER_PART_PTR'
      'WHERE (Data0025.PARENT_PTR is null)')
    Left = 80
    Top = 200
    object ADO25REMARK: TMemoField
      FieldName = 'REMARK'
      BlobType = ftMemo
    end
    ...
    object ADO25set_qty: TIntegerField
      FieldName = 'set_qty'
    end
  end
