object Form_Mreport: TForm_Mreport
  ...
  object ADO89: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      Data0025.MANU_PART_DESC,'
      '      Data0278.PARAMETER_DESC, dbo.data0089.tvalue'
      'FROM dbo.Data0025 INNER JOIN'
      
        '      dbo.Data0060 ON dbo.Data0025.RKEY = dbo.Data0060.CUST_PART' +
        '_PTR INNER JOIN'
      
        '      dbo.data0089 ON dbo.Data0025.RKEY = dbo.data0089.cust_part' +
        '_ptr INNER JOIN'
      ...
      '      Data0278.PARAMETER_DESC, data0089.tvalue, data0089.rkey'
      'ORDER BY Data0025.MANU_PART_DESC,data0089.rkey'
      '')
    Left = 79
    Top = 188
    ...
    object ADO89MANU_PART_NUMBER: TStringField
      FieldName = 'MANU_PART_NUMBER'
    end
    object ADO89MANU_PART_DESC: TStringField
      FieldName = 'MANU_PART_DESC'
      Size = 40
    end
