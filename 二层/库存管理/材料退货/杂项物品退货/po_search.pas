...
type
  TForm2 = class(TForm)
    ...
    ADO0072DESCRIPTION: TStringField;
    ADO0072GUI_GE: TStringField;
    ADO0072QUAN_ORD: TFloatField;
    ADO0072UNIT_PRICE: TFloatField;
    ADO0072recd_date: TDateTimeField;
    ADO0072UNIT_NAME: TStringField;
    ADO0072QUANTITY_RECEIVED: TFloatField;
    ADO0072reason: TStringField;
    ADO0072DESCRIPTION2: TStringField;
