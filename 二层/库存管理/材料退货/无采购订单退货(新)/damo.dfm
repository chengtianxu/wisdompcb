object dm: Tdm
  ...
  object ADS22: TADODataSet
    ...
    Filtered = True
    CommandText = 
      'select d17.inv_part_number,d17.INV_part_description,'#13#10' d22.quant' +
      'ity,d22.quan_on_hand,d22.quan_to_be_shipped,d22.QUAN_RETURNED,d0' +
      '2.unit_code,'#13#10' d22.tdate,d22.BARCODE_ID,'#13#10' d23.CODE,d23.SUPPLIER' +
      '_NAME,'#13#10' d15.warehouse_code,d15.abbr_name,d16.location,'#13#10' d22.rk' +
      'ey,d22.inventory_ptr'#13#10' '#13#10'from data0022 d22 inner join data0017 d' +
      '17 on d22.INVENTORY_PTR=d17.rkey'#13#10'inner join data0456 d456 on d2' +
      '2.grn_ptr=d456.rkey'#13#10'inner join data0002 d02 on d22.location_ptr' +
      '_from=d02.rkey'#13#10'inner join data0016 d16 on d22.location_ptr=d16.' +
      'rkey'#13#10'inner join data0015 d15 on d456.warehouse_ptr=d15.rkey'#13#10'in' +
      'ner join data0023 d23 on d456.SUPP_PTR=d23.rkey'#13#10'where  (d456.tt' +
      'ype in('#39'3'#39','#39'4'#39','#39'5'#39'))  and (d456.PO_PTR IS NULL) and d22.tdate>=:' +
      'dtpk1 and d22.tdate<=:dtpk2'
