...
begin
 ...
 case listbox1.ItemIndex of
  ...
  2:sgrid1.Cells[2,sgrid_row]:=' and d23.code='''+trim(edit1.Text)+'''';
  3:sgrid1.Cells[2,sgrid_row]:=' and d15.warehouse_code='''+trim(edit1.Text)+'''';
  4:sgrid1.Cells[2,sgrid_row]:=' and d16.code='''+trim(edit1.Text)+'''';
 end;
end;
