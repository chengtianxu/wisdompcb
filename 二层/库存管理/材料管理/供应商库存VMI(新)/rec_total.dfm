object Form6: TForm6
  ...
  Width = 1021
  Height = 593
  Caption = #26448#26009#20837#24211#27719#24635
  Color = clBtnFace
  ...
  object adotota22: TADOQuery
    ...
    SQL.Strings = (
      ...
      '      SUM(dbo.Data0134.QUANTITY ) AS total_received, '
      
        'ROUND(SUM(Data0134.QUANTITY * Data0134.tax_PRICE * Data0133.EXCH' +
        '_RATE), 3)'
      '                                       AS std_price,'
      
        'ROUND(SUM(Data0134.QUANTITY * Data0134.tax_PRICE * Data0133.EXCH' +
        '_RATE/'
      '          (1+Data0134.tax_2*0.01)), 3) AS std_notaxprice,'
      
        '      data0019.inv_group_name, Data0017.STOCK_SELL,dbo.Data0016.' +
        'code,'
      
        'ROUND(SUM(Data0134.QUANTITY * Data0017.STOCK_SELL), 4) AS total_' +
        'area'
      ...
      '      dbo.Data0017 INNER JOIN'
        ...
        ' ON'
      '      dbo.Data0134.INVENTORY_PTR = dbo.Data0017.RKEY ON'
      '      dbo.data0019.rkey = dbo.Data0496.GROUP_PTR ON'
      '      dbo.Data0133.RKEY = dbo.Data0134.GRN_PTR INNER JOIN'
      
        '      dbo.Data0023 ON dbo.Data0133.SUPP_PTR = dbo.Data0023.RKEY ' +
        'INNER JOIN'
      
        '      dbo.Data0002 ON dbo.Data0134.UNIT_PTR = dbo.Data0002.RKEY ' +
        'inner join'
      
        '     dbo.Data0016 ON dbo.Data0134.LOCATION_PTR = dbo.Data0016.RK' +
        'EY '
