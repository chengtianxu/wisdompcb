...
type
  TForm_Audit = class(TForm)
    ...
    N6: TMenuItem;
    Button2: TButton;
    ADO149INV_DESCRIPTION: TStringField;
    Splitter1: TSplitter;
...
begin
 if not self.cheak_datetime(self.ADS148create_date.Value) then
 begin
 exit;
 end;
...
function TForm_Audit.cheak_datetime(create_date:TDateTime):boolean;
begin
result:=true;
with dm.ADOQuery1 do
 begin
