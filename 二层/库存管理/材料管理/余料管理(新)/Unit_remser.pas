...
begin
 ...
 1:
  sgrid1.Cells[2,sgrid_row]:='and data0017.inv_description LIKE ''%'+trim(edit2.Text)+'%''';
 2:
  sgrid1.Cells[2,sgrid_row]:='and data0556.len_size='+trim(edit2.Text);
 3:
  sgrid1.Cells[2,sgrid_row]:='and data0556.wei_size='+trim(edit2.Text);
 4:
 sgrid1.Cells[2,sgrid_row]:='and data0002.unit_name='''+trim(edit2.Text)+'''';
 5:
  sgrid1.Cells[2,sgrid_row]:='and Data0556.tdate >='''+datetostr(dtpk1.date)+
                            ''' and Data0556.tdate <='''+datetostr(dtpk2.date+1)+'''';
 6:
...
begin
 ...
 1:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0017.inv_description LIKE ''%'+trim(edit2.Text)+'%''';
 2:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0556.len_size='+trim(edit2.Text);
 3:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0556.wei_size='+trim(edit2.Text);
 4:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0002.unit_name='''+trim(edit2.Text)+'''';

 5:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and Data0556.tdate >='''+datetostr(dtpk1.date)+
                            ''' and Data0556.tdate <='''+datetostr(dtpk2.date+1)+'''';
 6:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0005.EMPLOYEE_NAME LIKE ''%'+trim(edit2.Text)+'%''';
 7:
  sgrid1.Cells[2,sgrid1.RowCount-1]:='and data0556.remark LIKE ''%'+trim(edit2.Text)+'%''';
...
if sgrid1.RowCount=2 then
 ...
 begin
  with dm.ADOD556 do
   begin
    close;
    dm.ADOD556.CommandText:=form1.sqltext;
    for i:=1 to sgrid1.RowCount-2 do
    dm.ADOD556.CommandText:=dm.ADOD556.CommandText+#32+sgrid1.Cells[2,i];
    open;
   end;
  self.Close; 
 end;
...
begin
if listbox2.ItemIndex in [2,3] then
