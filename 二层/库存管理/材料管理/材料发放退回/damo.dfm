object DM: TDM
  ...
  object ads468: TADODataSet
    ...
    CommandText = 
      ...
      '468.PRINTIT when '#39'N'#39' then '#39'VMI'#24211#23384#39' else '#39#26222#36890#24211#23384#39' end as sotck_type,' +
      'data0468.supplier_ptr'#13#10',case when data0492.PRINTED_BY_PTR>0 then' +
      ' '#39#24050#25171#21360#39' else '#39#26410#25171#21360#39'  end as printed'#13#10'FROM data0492 INNER JOIN'#13#10'   ' +
      '   Data0468 ON data0492.CUT_NO = Data0468.CUT_NO INNER JOIN'#13#10'   ' +
      '   Data0002 INNER JOIN'#13#10'      Data0017 ON Data0002.RKEY = Data00' +
      '17.STOCK_UNIT_PTR ON '#13#10'      Data0468.INVENT_PTR = Data0017.RKEY' +
      ' left join data0023'#13#10'on data0468.supplier_ptr=data0023.rkey inne' +
      'r join'#13#10'dbo.Data0025 ON dbo.data0492.BOM_PTR = dbo.Data0025.RKEY' +
      #13#10'WHERE (Data0468.DEPT_PTR = :rkey34) AND '#13#10'               (data' +
      '0492.WHOUSE_PTR = :wh_ptr) And'#13#10'              (Data0468.STATUS =' +
      ' 0) AND '#13#10'              (data0492.Con_Flag = 2) and'#13#10'           ' +
      '   (data0468.invent_or=0)'#13#10'order by Data0468.CUT_NO'#13#10
    ...
    object ads468supplier_ptr: TIntegerField
      FieldName = 'supplier_ptr'
    end
    object strngfldads468printed: TStringField
      FieldName = 'printed'
      ReadOnly = True
      Size = 6
    end
  ...
  object aq22: TADODataSet
    ...
    CommandText = 
      ...
      '56.GRN_NUMBER,data0456.DELIVER_NUMBER'#13#10'       , (case when (d391' +
      '.status=2) or (d391.status is null )  then '#39#26159#39'  else '#39#21542#39'  end ) ' +
      ' as  '#39#26159#21542#21487#21457#26009#39#13#10',data0456.SUPP_PTR'#13#10'FROM dbo.Data0022 INNER JOIN'#13#10 +
      '      dbo.Data0016 ON dbo.Data0022.LOCATION_PTR = dbo.Data0016.R' +
      'KEY INNER JOIN'#13#10'      dbo.Data0017 ON dbo.Data0022.INVENTORY_PTR' +
      ' = dbo.Data0017.RKEY INNER JOIN'#13#10'      dbo.Data0002 ON '#13#10'      d' +
      'bo.Data0022.LOCATION_PTR_FROM = dbo.Data0002.RKEY INNER JOIN'#13#10'  ' +
      '    dbo.Data0456 ON dbo.Data0022.GRN_PTR = dbo.Data0456.RKEY INN' +
      'ER JOIN'#13#10'      dbo.Data0023 ON dbo.Data0456.SUPP_PTR = dbo.Data0' +
      '023.RKEY'#13#10'      left join data0391 d391 on data0022.rkey391=d391' +
      '.rkey '#13#10'      WHERE (dbo.Data0022.QUAN_ON_HAND > 0) '#13#10'  order by' +
      '  Data0022.EXPIRE_DATE,dbo.Data0456.ship_DATE'
  ...
  object ads468_268: TADODataSet
    ...
    CommandText = 
      ...
      '.quan_on_hand-data0017.QUAN_ASSIGN as quan_on_hand,cp492.QUAN_AS' +
      'SIGN as quan_alloc,'#13#10'cp492.QUAN_ASSIGN as alloc,case data0468.PR' +
      'INTIT when '#39'N'#39' then '#39'VMI'#24211#23384#39' else '#39#26222#36890#24211#23384#39' end as sotck_type,d492.C' +
      'UT_NO,'#13#10'd492.Rkey as rkey492,cp492.rkey as rkeycp492'#13#10'FROM data0' +
      '268 '#13#10#9'INNER JOIN Data0468 ON data0268.rkey = Data0468.flow_no '#13 +
      #10#9'INNER JOIN  Data0002'#13#10#9'INNER JOIN  Data0017 ON Data0002.RKEY =' +
      ' Data0017.STOCK_UNIT_PTR ON '#13#10#9'            Data0468.INVENT_PTR =' +
      ' Data0017.RKEY'#13#10'left join WZCP0492 cp492 on Data0468.wzcp0492_pt' +
      'r=cp492.Rkey '#13#10'left join data0492 d492 on cp492.D492_ptr=d492.rk' +
      'ey'#9'            '#13#10'WHERE (Data0468.flow_no = :rkey268) AND'#13#10'      ' +
      '        (Data0468.STATUS = 0) AND'#13#10'              (data0268.statu' +
      's = 2) and'#13#10'              (data0468.invent_or=0)'#13#10'order by Data0' +
      '268.number'
    Parameters = <
      item
        Name = 'rkey268'
    ...
    object strngfldads468_268CUT_NO: TStringField
      FieldName = 'CUT_NO'
      FixedChar = True
      Size = 12
    end
    object atncfldads468_268rkey492: TAutoIncField
      FieldName = 'rkey492'
      ReadOnly = True
    end
    object atncfldads468_268rkeycp492: TAutoIncField
      FieldName = 'rkeycp492'
      ReadOnly = True
    end
  end
