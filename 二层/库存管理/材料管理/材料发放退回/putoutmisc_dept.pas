...
uses damo, main, warehouse_search, Prod_Resource, customer_search,
  stockmisc_search, putoutmiscreport,common;
...
begin
sgrid1.Cells[0,0]:='材料名称';
sgrid1.Cells[1,0]:='材料规格';
sgrid1.Cells[2,0]:='材料类型';
  ...
  try
    ...
    begin
      ...
      begin
        ...
        'set data0235.QUAN_ON_HAND=data0235.QUAN_ON_HAND-Data0208.QUANTITY'+#13+
