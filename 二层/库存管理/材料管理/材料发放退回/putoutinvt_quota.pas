...
begin
  ...
  begin
    ...
    Lsql:='warehouse_ptr='+inttostr(self.warehouse_ptr)+
...
with dm.ADOQuery1 do
 begin
  ...
  'FROM         dbo.DATA0475 INNER JOIN'+#13+
    ...
    'where  DATA0475.rkey468='+dm.ads468RKEY.AsString +    //过期也可以发20170912 (data0022.EXPIRE_DATE>getdate() or  data0022.EXPIRE_DATE is null ) and
