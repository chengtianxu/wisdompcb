...
uses damo, warehouse_search, Prod_Resource, customer_search,
  stockinvt_search,  putourinvt_report,common;
...
//                            strtocurr(sgrid2.Cells[2,i])]); //标准成本
  begin
  Lsql:='insert into data0207(TTYPE,INVENTORY_PTR,DEPT_PTR,GON_PTR,D0022_PTR,TDATE,QUANTITY,STANDARD_COST)'+
        'values(2,'+sgrid2.Cells[0,i]+','+dm.ado457dept_ptr.asstring+','+dm.ado457rkey.asstring+','+sgrid2.Cells[1,i]+','+
        ''''+formatdatetime('yyyy-MM-dd hh:mm:ss',dm.ado457CREATE_DATE.asdatetime)+''','+sgrid1.Cells[5,i]+','+sgrid2.Cells[2,i]+' )';
       //ShowMessage(Lsql);
  dm.qrytemp.close;
