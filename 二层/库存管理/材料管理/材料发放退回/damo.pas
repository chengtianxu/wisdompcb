...
type
  TDM = class(TDataModule)
    ...
    ads468supplier_ptr: TIntegerField;
    strngfldads468printed: TStringField;
    qrytemp: TADOQuery;
    strngfldads468_268CUT_NO: TStringField;
    atncfldads468_268rkey492: TAutoIncField;
    atncfldads468_268rkeycp492: TAutoIncField;
...
begin
  ...
  begin
    ...
    begin
      ...
      if (send_msg.text<>'') and (not ADOQuery1.isempty) then
      begin
