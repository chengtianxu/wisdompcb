...
procedure TForm_putout.Edit3KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if trim(edit3.Text)='' then edit3.Text:='0.0000';
...
var
  ...
  n2,n3:Currency;
begin
  n:=ceil(strtocurr(edit4.text)-strtocurr(edit5.Text));//最大可发数
  //showmessage(IntToStr(N)) ;
  n2:=strtocurr(edit4.text)-strtocurr(edit5.Text); //可发数
  n3:= strtocurr(edit3.text); //当前发放数
...
begin
edit3.Text:=formatfloat('0.0000',strtocurr(edit3.Text));
end;
