object Form_putoutmiscreport: TForm_putoutmiscreport
  ...
  object ppDB457: TppDBPipeline
    ...
    object pfldDB457ppField11: TppField
  ...
  object ppDB208: TppDBPipeline
    ...
    object ppDB208ppField10: TppField
  ...
  object ado208: TADODataSet
    ...
    CommandText = 
      ...
      '235.QUAN_ON_HAND,data0208.rkey,data0235.cust_decl'#13#10'FROM dbo.DATA' +
      '0208 INNER JOIN'#13#10'      dbo.Data0235 ON dbo.DATA0208.SOURCE_PTR =' +
      ' dbo.Data0235.RKEY INNER JOIN'#13#10'      dbo.Data0002 ON dbo.Data023' +
      '5.unit_ptr = dbo.Data0002.RKEY'#13#10'where data0208.gon_ptr=:rkey'
    DataSource = DataSource2
    MasterFields = 'rkey'
    Parameters = <
      item
    ...
    object ado208cust_decl: TStringField
      FieldName = 'cust_decl'
      Size = 50
    end
  end
