object Form_putoutintreport: TForm_putoutintreport
  ...
  object ado207: TADODataSet
    ...
    CommandText = 
      ...
      '_NAME,data0022.cust_decl'#13#10'FROM   Data0207 INNER JOIN'#13#10'       Dat' +
      'a0017 ON Data0207.INVENTORY_PTR = Data0017.RKEY INNER JOIN'#13#10'    ' +
      '   Data0022 ON Data0207.D0022_PTR = Data0022.RKEY INNER JOIN'#13#10'  ' +
      '     Data0002 ON Data0022.LOCATION_PTR_FROM = Data0002.RKEY INNE' +
      'R JOIN'#13#10'       Data0456 ON Data0022.GRN_PTR = Data0456.RKEY INNE' +
      'R JOIN'#13#10'       Data0023 ON Data0456.SUPP_PTR = Data0023.RKEY'#13#10'wh' +
      'ere gon_ptr=:rkey'
    ...
    object ado207cust_decl: TStringField
      FieldName = 'cust_decl'
      Size = 50
    end
  end
