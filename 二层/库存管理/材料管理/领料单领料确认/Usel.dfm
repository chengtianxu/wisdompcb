object Form_sel: TForm_sel
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'DEPT_NAME'
        Footers = <>
        Title.Caption = #30003#35831#20154#21592#37096#38376
        Width = 135
      end
      item
        EditButtons = <>
        ...
        Footers = <>
        Title.Caption = #30003#35831#20154#21592#22995#21517
      end
      item
        EditButtons = <>
        FieldName = 'employeecode'
        Footers = <>
        Title.Caption = #39046#26009#20154#21592#24037#21495
        Width = 118
      end
      item
        EditButtons = <>
        ...
        Footers = <>
        Title.Caption = #39046#26009#20154#21592#22995#21517
        Width = 102
      end>
  end
  ...
  object ADODataSet1: TADODataSet
    ...
    LockType = ltReadOnly
    CommandText = 
      'SELECT   dbo.DATA0268.rkey, dbo.DATA0268.number, dbo.DATA0268.DA' +
      'TE,  employeemsg.chinesename, employeemsg.employeecode, dbo.Data' +
      '0034.DEPT_NAME, dbo.DATA0268.EMPL_PTR,dbo.data0005.EMPLOYEE_NAME' +
      ', '#13#10'                      dbo.DATA0268.ConfMan'#13#10'FROM         dbo' +
      '.DATA0268 INNER JOIN'#13#10'                      dbo.Data0034 ON dbo.' +
      'DATA0268.dept_ptr = dbo.Data0034.RKEY LEFT OUTER JOIN'#13#10'         ' +
      '             '#13#10'                      employeemsg ON dbo.DATA0268' +
      '.ConfMan = employeemsg.employeecode'#13#10'inner join dbo.data0005 on ' +
      'dbo.DATA0268.EMPL_PTR = data0005.rkey'#13#10#13#10'WHERE  dbo.DATA0268.DAT' +
      'E>=:vdate1'#13#10'           and  dbo.DATA0268.DATE<=:vdate2  '
    Parameters = <
      item
        Name = 'vdate1'
        DataType = ftDateTime
    ...
    object ADODataSet1number: TStringField
      FieldName = 'number'
      Size = 10
    end
