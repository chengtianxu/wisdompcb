object Form_BzReport: TForm_BzReport
  ...
  object ADO22: TADOQuery
    ...
    SQL.Strings = (
      ...
      'data0023.CODE as '#20379#24212#21830#20195#30721',data0023.SUPPLIER_NAME as '#20379#24212#21830#21517#31216','
        ...
        #30721','
      'data0022.quantity as '#25910#20837','
    ...
    object ADO22DSDesigner9: TStringField
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      'select sum(data0022.quan_on_hand) as qty from data0022'
      'inner join data0456 on data0022.grn_ptr=data0456.rkey'
      'inner join data0023 on data0456.supp_ptr=data0023.rkey'
      'inner join data0017 on data0022.INVENTORY_PTR=data0017.rkey'
  ...
  object ppDB22: TppDBPipeline
    ...
    object ppDB22ppField6: TppField
      FieldAlias = #35268#26684#22411#21495
      FieldName = #35268#26684#22411#21495
      FieldLength = 0
      DataType = dtNotKnown
      DisplayWidth = 0
