object Form_SelectOut: TForm_SelectOut
  Left = 90
  Top = 75
  Width = 1000
  Height = 560
  Caption = #26448#26009'VMI'#20986#24211#28165#21333
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT    dbo.Data0724.GON_NUMBER,'
      '                  case when dbo.data0724.ttype=0 then '#39#36864#36135#20986#20179#39
      
        '                           when dbo.data0724.ttype=1 then '#39#39046#26009#20986#20179#39 +
        '  end  '#20986#24211#31867#22411','
      '                  case when dbo.data0724.status=0 then '#39#26410#23457#26680#39'  '
      
        '                          when dbo.data0724.status=1 then '#39#24050#23457#26680#39' ' +
        '   end '#29366#24577','
      'dbo.Data0017.INV_PART_NUMBER, dbo.Data0017.INV_NAME,'
      'dbo.Data0017.INV_DESCRIPTION, dbo.Data0496.GROUP_NAME, '
      
        'dbo.Data0149.QUANTITY,dbo.data0149.rtn_quantity,dbo.data0724.ref' +
        '_number,'
      'dbo.Data0001.CURR_CODE,'
      
        'dbo.Data0134.BARCODE_ID, dbo.Data0019.inv_group_name, dbo.Data01' +
        '49.TAX_2,'
      'dbo.Data0149.tax_price, dbo.Data0134.SUPPLIER2,'
      
        'dbo.Data0023.ABBR_NAME, dbo.Data0002.UNIT_NAME, dbo.Data0724.cre' +
        'ate_date,'
      'dbo.Data0134.rohs, dbo.Data0133.GRN_NUMBER,'
      'd05.employee_name as '#25805#20316#20154#21592',dbo.data0005.employee_name as '#39046#26009#20154#21592','
      'dbo.Data0016.LOCATION, dbo.Data0015.WAREHOUSE_NAME'
      'FROM         dbo.Data0149 INNER JOIN'
      
        'dbo.Data0724 ON dbo.Data0149.GON_PTR = dbo.Data0724.RKEY INNER J' +
        'OIN'
      
        'dbo.Data0017 ON dbo.Data0149.INVENTORY_PTR = dbo.Data0017.RKEY I' +
        'NNER JOIN'
      
        'dbo.Data0496 ON dbo.Data0017.GROUP_PTR = dbo.Data0496.RKEY INNER' +
        ' JOIN'
      
        'dbo.Data0134 ON dbo.Data0149.D0134_PTR = dbo.Data0134.RKEY INNER' +
        ' JOIN'
        ...
        'dbo.Data0023 ON dbo.Data0724.supplier_ptr = dbo.Data0023.RKEY IN' +
        'NER JOIN'
      
        'dbo.Data0001 ON dbo.Data0133.currency_ptr = dbo.Data0001.RKEY IN' +
        'NER JOIN'
      
        'dbo.Data0005 ON dbo.Data0724.RECD_BY = dbo.Data0005.RKEY INNER J' +
        'OIN'
      'dbo.data0005 d05 ON dbo.data0724.create_by=d05.rkey inner join'
      
        'dbo.Data0016 ON dbo.Data0134.LOCATION_PTR = dbo.Data0016.RKEY IN' +
        'NER JOIN'
      'dbo.Data0015 ON dbo.Data0724.warehouse_ptr = dbo.Data0015.RKEY'
      
        'WHERE    ( (dbo.Data0149.QUANTITY > 0)  or (dbo.data0149.rtn_qua' +
        'ntity>0))')
    Left = 368
    Top = 160
    object ADOQuery1GON_NUMBER: TStringField
      FieldName = 'GON_NUMBER'
      Size = 10
    end
    ...
    object ADOQuery1rtn_quantity: TBCDField
      FieldName = 'rtn_quantity'
      Precision = 14
    end
    object ADOQuery1ref_number: TStringField
      FieldName = 'ref_number'
      Size = 50
    end
    ...
    object ADOQuery1tax_price: TBCDField
      FieldName = 'tax_price'
      Precision = 12
      Size = 3
    end
