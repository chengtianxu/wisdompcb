object Form_SelectAll: TForm_SelectAll
  Left = 51
  Top = 60
  Width = 1000
  Height = 560
  Caption = #26448#26009'VMI'#24211#23384#28165#21333
  Color = clBtnFace
  ...
  object ADOQuery1: TADOQuery
    ...
    SQL.Strings = (
      'SELECT Data0017.INV_PART_NUMBER, Data0017.INV_NAME,'
        ...
        'v_group_name,'
      '      Data0023.ABBR_NAME AS code23, Data0134.QUAN_ON_HAND, '
        ...
        '_ID, '
      '     Data0134.TAX_2, Data0133.GRN_NUMBER, '
      
        '      Data0015.WAREHOUSE_CODE, Data0133.ship_DATE, Data0134.rohs' +
        ', '
      '      Data0134.SUPPLIER2, Data0133.exch_rate'
      'FROM Data0015 INNER JOIN'
      '      Data0023 INNER JOIN'
      '      Data0133 INNER JOIN'
      '      Data0134 INNER JOIN'
      
        '      Data0017 ON Data0134.INVENTORY_PTR = Data0017.RKEY INNER J' +
        'OIN'
      '      Data0496 ON Data0017.GROUP_PTR = Data0496.RKEY ON '
      '      Data0133.RKEY = Data0134.GRN_PTR INNER JOIN'
      '      Data0002 ON Data0134.UNIT_PTR = Data0002.RKEY ON '
      '      Data0023.RKEY = Data0133.SUPP_PTR INNER JOIN'
      '      Data0016 ON Data0134.LOCATION_PTR = Data0016.RKEY ON '
      '      Data0015.RKEY = Data0133.warehouse_ptr INNER JOIN'
      '      Data0001 ON Data0133.currency_ptr = Data0001.RKEY'
      '      inner join data0019 on data0496.group_ptr=data0019.rkey '
