object Form_SelectIn: TForm_SelectIn
  Left = 69
  Top = 30
  Width = 1000
  Height = 560
  Caption = #26448#26009'VMI'#20837#24211#28165#21333
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = #26448#26009#31867#21035
        Visible = True
      end
      item
        Expanded = False
        FieldName = #26448#26009#32452#21035
        Width = 60
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = #29616#25345#26377#25968#37327
        Width = 67
        Visible = True
      end
      item
      ...
      item
        Expanded = False
        FieldName = #36865#36135#26085#26399
        Visible = True
      end
      item
        Expanded = False
      ...
      item
        Expanded = False
        FieldName = #22791#27880#25209#27425
        Width = 113
        Visible = True
      end
      item
        Expanded = False
        FieldName = #29615#20445
        Visible = True
      end
      item
        Expanded = False
  ...
  object ADOQuery1: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT Data0133.GRN_NUMBER as '#20837#24211#21333#21495', '
      '      case when data0133.ttype=1 then '#39#25353'PO'#20837#24211#39
      '               when data0133.ttype=3  then '#39#30452#25509#20837#24211#39' end '#20837#24211#31867#22411','
      
        '      Data0017.INV_PART_NUMBER as '#26448#26009#32534#30721', Data0017.INV_NAME as '#26448#26009#21517 +
        #31216','
      
        '      Data0017.INV_DESCRIPTION as '#26448#26009#35268#26684' , Data0496.GROUP_NAME as ' +
        #26448#26009#31867#21035',data0019.inv_group_name as '#26448#26009#32452#21035','
      
        '      Data0015.WAREHOUSE_CODE as '#24037#21378', Data0070.PO_NUMBER as '#37319#36141#35746#21333#21495 +
        ',Data0023.CODE as '#20379#24212#21830#20195#30721','
      '      Data0023.ABBR_NAME AS '#20379#24212#21830#21517#31216', Data0134.QUANTITY as '#25509#25910#25968#37327','
      '      Data0134.QUAN_ON_HAND as '#29616#25345#26377#25968#37327', '
      '      Data0001.CURR_CODE as '#36135#24065#20195#30721',Data0134.TAX_2 as '#31246#29575','
      '      Data0134.tax_PRICE as '#21547#31246#20215',Data0134.PRICE as '#19981#21547#31246#20215','
      '      Data0002.UNIT_NAME as '#21333#20301','
      
        '     Data0005.EMPLOYEE_NAME as '#21019#24314#20154',data0133.deliver_number as '#36865#36135 +
        #21333#21495','
      
        '      Data0016.LOCATION as '#20179#24211', Data0133.ship_DATE as '#36865#36135#26085#26399', Data0' +
        '134.SUPPLIER2 as '#22791#27880#25209#27425','
      
        '      Data0134.rohs as '#29615#20445', Data0134.BARCODE_ID as '#22791#27880#20449#24687',Data0134.' +
        'EXPIRE_DATE as '#26377#25928#26399
      ...
      '      dbo.Data0134 INNER JOIN'
        ...
        ' ON '
      '      dbo.Data0019.rkey = dbo.Data0496.group_ptr INNER JOIN'
      
        '      dbo.Data0005 ON dbo.Data0133.CREATE_BY = dbo.Data0005.RKEY' +
        ' ON '
      '      dbo.Data0023.RKEY = dbo.Data0133.SUPP_PTR ON '
      '      dbo.Data0002.RKEY = dbo.Data0134.UNIT_PTR INNER JOIN'
      ...
      '      dbo.Data0001 ON '
        ...
        '      dbo.Data0133.currency_ptr = dbo.Data0001.RKEY LEFT OUTER J' +
        'OIN'
      '      dbo.Data0070 ON dbo.Data0133.PO_PTR = dbo.Data0070.RKEY'
    ...
    object ADOQuery1DSDesigner11: TBCDField
      FieldName = #25509#25910#25968#37327
      Precision = 19
    end
    object ADOQuery1DSDesigner12: TBCDField
      FieldName = #29616#25345#26377#25968#37327
      Precision = 19
    end
    ...
    object ADOQuery1DSDesigner14: TBCDField
      FieldName = #31246#29575
      Precision = 4
      Size = 2
    end
    object ADOQuery1DSDesigner15: TBCDField
      FieldName = #21547#31246#20215
      Precision = 12
      Size = 3
    end
    object ADOQuery1DSDesigner16: TBCDField
      FieldName = #19981#21547#31246#20215
      Precision = 15
      Size = 6
    end
    ...
    object ADOQuery1DSDesigner23: TDateTimeField
      FieldName = #36865#36135#26085#26399
    end
    object ADOQuery1DSDesigner24: TStringField
      FieldName = #22791#27880#25209#27425
      Size = 30
    end
    ...
    object ADOQuery1DSDesigner26: TStringField
      FieldName = #22791#27880#20449#24687
      Size = 50
    end
    object ADOQuery1DSDesigner27: TDateTimeField
      FieldName = #26377#25928#26399
    end
  ...
  object PopupMenu1: TPopupMenu
    ...
    object N21: TMenuItem
      Caption = #22791#27880#25209#27425
      Checked = True
      OnClick = N1Click
    end
