object Form_mainin: TForm_mainin
  Left = 192
  Top = 77
    ...
    object Grd2: TDBGridEh
      ...
      Columns = <
        ...
        item
          ...
          Footers = <>
          Title.Caption = #22791#27880#21046#36896#26085#26399
          Width = 119
        end
        item
          EditButtons = <>
          FieldName = 'SUPPLIER2'
          Footers = <>
          Title.Caption = #22791#27880#25209#27425
          Width = 72
        end>
    end
  end
  ...
  object ADO133_1: TADOQuery
    ...
    SQL.Strings = (
      'select * from data0133 where rkey=:rkey133')
    Left = 360
    Top = 80
    object ADO133_1RKEY: TAutoIncField
      FieldName = 'RKEY'
      ReadOnly = True
    end
    object ADO133_1GRN_NUMBER: TStringField
      FieldName = 'GRN_NUMBER'
      Size = 10
    end
    object ADO133_1DELIVER_NUMBER: TStringField
      FieldName = 'DELIVER_NUMBER'
      Size = 15
    end
    object ADO133_1warehouse_ptr: TIntegerField
      FieldName = 'warehouse_ptr'
    end
    object ADO133_1SUPP_PTR: TIntegerField
      FieldName = 'SUPP_PTR'
    end
    object ADO133_1currency_ptr: TIntegerField
      FieldName = 'currency_ptr'
    end
    object ADO133_1exch_rate: TBCDField
      FieldName = 'exch_rate'
      Precision = 12
      Size = 8
    end
    object ADO133_1PO_PTR: TIntegerField
      FieldName = 'PO_PTR'
    end
    object ADO133_1TTYPE: TSmallintField
      FieldName = 'TTYPE'
    end
    object ADO133_1CREATE_DATE: TDateTimeField
      FieldName = 'CREATE_DATE'
    end
    object ADO133_1CREATE_BY: TIntegerField
      FieldName = 'CREATE_BY'
    end
    object ADO133_1ship_DATE: TDateTimeField
      FieldName = 'ship_DATE'
    end
    object ADO133_1ship_BY: TStringField
      FieldName = 'ship_BY'
    end
    object ADO133_1REF_NUMBER: TStringField
      FieldName = 'REF_NUMBER'
      Size = 100
    end
  end
