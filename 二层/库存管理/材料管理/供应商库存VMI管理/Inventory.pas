...
procedure TForm_Inventory.Edit1Change(Sender: TObject);
begin
...
procedure TForm_Inventory.DBGrid1DblClick(Sender: TObject);
begin
if not adoquery1.IsEmpty then
 ModalResult:=mrok;
end;

procedure TForm_Inventory.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
 if (key=13) and (not adoquery1.IsEmpty) then ModalResult:=mrok;
end;

procedure TForm_Inventory.RadioGroup1Click(Sender: TObject);
begin
if radiogroup1.ItemIndex=0 then
