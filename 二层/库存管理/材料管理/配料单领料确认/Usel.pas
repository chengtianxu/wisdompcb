...
begin
  ...
  FCondition:=' ORDER BY dbo.data0492.rkey DESC';
  sSql:=ADODataSet1.CommandText;
  DateTimePicker1.Visible:=False;
  DateTimePicker2.Visible:=False;
  ADODataSet1.Close;
  ADODataSet1.CommandText:=ADODataSet1.CommandText+FCondition;
  ADODataSet1.Open;
 ...
 begin
   try
     ...
     begin
       ...
       ADODataSet1.CommandText:=sSql+sqlstr+' ORDER BY dbo.data0492.rkey DESC';
       ADODataSet1.Open;
