...
begin
  ...
  outRet.DBConnectString := 'Provider=SQLOLEDB.1;Password=wisdompcb1077;Persist Security Info=True;' +
    'User ID=sa;Initial Catalog=sj_v20_live;Data Source=172.16.68.8;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=CHENGTX-PC;Use Encryption for Data=False;Tag with column collation when possible=False';
  outRet.DBName := '开发备份';
end;
