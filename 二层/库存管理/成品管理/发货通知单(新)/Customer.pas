...
begin
 ...
 begin
  ADOQuery1.SQL.Text:=ADOQuery1.SQL.Text+' where data0010.rkey in (select customer_ptr from data0100 where csi_ptr='+rkey73+')'+'order by cust_code';
  ADOQuery1.Open;
 end
 else
 begin
  ADOQuery1.SQL.Text:=ADOQuery1.SQL.Text+'order by cust_code';
  ADOQuery1.Open;
 end;
end;
