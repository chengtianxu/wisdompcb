object frmCmpHis: TfrmCmpHis
    ...
    Columns = <
      ...
      item
        ...
        PickList.Strings = (
          #22833#36133
          #25104#21151)
        Title.Caption = #23545#27604#32467#26524
        Width = 80
      end
      item
        EditButtons = <>
      ...
      item
        ...
        FieldName = 'ourBarID'
        Footers = <>
        Title.Caption = #26412#21378'|'#26631#31614'ID'
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'OurManuPartDesc'
        Footers = <>
        Title.Caption = #26412#21378'|'#22411#21495
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'OurVer'
        Footers = <>
        Title.Caption = #26412#21378'|'#29256#26412
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'OurNumber'
        Footers = <>
        Title.Caption = #26412#21378'|'#25968#37327
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'OurZQ'
        Footers = <>
        Title.Caption = #26412#21378'|'#21608#26399
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'HWBarCode'
        Footers = <>
        Title.Caption = #21326#20026'|PKGID'
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'HWCode'
        Footers = <>
        Title.Caption = #21326#20026'|'#22411#21495
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'HWVer'
        Footers = <>
        Title.Caption = #21326#20026'|'#29256#26412
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'HWNumber'
        Footers = <>
        Title.Caption = #21326#20026'|'#25968#37327
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'HWZQ'
        Footers = <>
        Title.Caption = #21326#20026'|'#21608#26399
        Width = 80
      end
      item
        EditButtons = <>
      ...
      item
        EditButtons = <>
        FieldName = 'OurBarIDDB'
        Footers = <>
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'OurCustomerPONumber'
        Footers = <>
        Width = 80
      end
      item
        EditButtons = <>
        FieldName = 'HWBarCodeDB'
        Footers = <>
        Width = 80
      end>
  end
  ...
  object ads737: TADODataSet
    Connection = dm1.con1
    CursorType = ctStatic
    AfterScroll = ads737AfterScroll
    CommandText = 
      'select d737.*,d736.*,d05.EMPLOYEE_NAME FROM data0737 d737'#13#10'inner' +
      ' JOIN data0005 d05 ON d737.cmpUser = d05.RKEY'#13#10'inner join Data07' +
      '36 d736 ON d736.Barcode = HWBarCode'
    Parameters = <>
    Left = 160
    Top = 208
  end
  object ds737: TDataSource
    DataSet = ads737
    Left = 216
    Top = 208
  end
