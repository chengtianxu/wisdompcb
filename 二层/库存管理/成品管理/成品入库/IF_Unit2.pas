...
procedure TIf_Form2.BitBtn5Click(Sender: TObject);
var
 i:byte;
begin
...
procedure TIf_Form2.BitBtn4Click(Sender: TObject);
var
 i:byte;
begin
...
procedure TIf_Form2.BitBtn6Click(Sender: TObject);
begin
  modalresult:=mrCancel	;
end;

procedure TIf_Form2.BitBtn3Click(Sender: TObject);
var
 i:integer;
...
procedure TIf_Form2.sgrid1DrawCell(Sender: TObject; ACol, ARow: Integer;
  Rect: TRect; State: TGridDrawState);
begin
...
procedure TIf_Form2.sgrid1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Integer);
var
 column,row:longint;
begin
...
procedure TIf_Form2.update2_sgrid(sgrid_row: integer);
begin
 case listbox2.ItemIndex of
     0:begin
          sgrid1.Cells[1,sgrid_row] := edit2.Text;
          sgrid1.Cells[2,sgrid_row] := 'and data0416.number LIKE ''' + trim(edit2.Text) + '%''' ;
...
procedure TIf_Form2.BitBtn8Click(Sender: TObject);
begin
  update_sgrid; //新增内容
end;

procedure TIf_Form2.update_sgrid;
var
  i:integer;
begin
...
procedure TIf_Form2.ListBox2Click(Sender: TObject);
begin
...
procedure TIf_Form2.Edit2KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TIf_Form2.FormShow(Sender: TObject);
begin
...
function TIf_Form2.Get_parametersvalue1: string;
begin
  result:=vparametersvalue1;
end;

function TIf_Form2.Get_parametersvalue2: string;
begin
  result:=vparametersvalue2;
end;

function TIf_Form2.Get_parametersvalue3: string;
begin
  result:=vparametersvalue3;
end;

function TIf_Form2.Get_parametersvalue4: string;
begin
  result:=vparametersvalue4;
end;

function TIf_Form2.Get_parametersvalue5: string;
begin
  result:=vparametersvalue5;
end;

function TIf_Form2.Get_parametersvalue6: string;
begin
  result:=vparametersvalue6;
end;

function TIf_Form2.Get_parametersvalue7: string;
begin
  result:=vparametersvalue7;
end;

procedure TIf_Form2.BitBtn7Click(Sender: TObject);
var
  InputVar: PDlgInput ;
begin
  case listbox2.ItemIndex of
...
procedure TIf_Form2.FormCreate(Sender: TObject);
begin
