...
begin
 ...
 0:
  ...
  0:sgrid1.Cells[2,sgrid_row]:='and Data0698.pack_number = '''+edit3.Text+'''';
  1:sgrid1.Cells[2,sgrid_row]:='and Data0698.pack_number > '''+edit3.Text+'''';
  2:sgrid1.Cells[2,sgrid_row]:='and Data0698.pack_number <> '''+edit3.Text+'''';
  3:sgrid1.Cells[2,sgrid_row]:='and Data0698.pack_number like ''%'+edit3.Text+'%''';
  end;
 ...
 4:
  case radiogroup3.ItemIndex of
  0:sgrid1.Cells[2,sgrid_row]:='and data0097.PO_NUMBER = '''+edit3.Text+'''';
  1:sgrid1.Cells[2,sgrid_row]:='and data0097.PO_NUMBER > '''+edit3.Text+'''';
  2:sgrid1.Cells[2,sgrid_row]:='and data0097.PO_NUMBER <> '''+edit3.Text+'''';
  3:sgrid1.Cells[2,sgrid_row]:='and data0097.PO_NUMBER like ''%'+edit3.Text+'%''';
  end;
 ...
 7:
  case radiogroup3.ItemIndex of
  0:sgrid1.Cells[2,sgrid_row]:='and data0698.lotno = '''+edit3.Text+'''';
  1:sgrid1.Cells[2,sgrid_row]:='and data0698.lotno > '''+edit3.Text+'''';
  2:sgrid1.Cells[2,sgrid_row]:='and data0698.lotno <> '''+edit3.Text+'''';
  3:sgrid1.Cells[2,sgrid_row]:='and data0698.lotno like ''%'+edit3.Text+'%''';
  end;
...
begin
 ...
 try
  ...
  begin
    case self.ListBox3.ItemIndex of
     5:edit3.Text:=trim(frmPick_Item_Single.adsPick.FieldValues['CUST_CODE']);
