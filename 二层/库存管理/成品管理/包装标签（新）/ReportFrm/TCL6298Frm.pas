...
procedure TfrmTCL6298.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmTCL6298.btnBCBHClick(Sender: TObject);
var
...
procedure TfrmTCL6298.btnXSDDClick(Sender: TObject);
var
  LFrm: Tsearchso_Form;
  LSql: string;
...
function TfrmTCL6298.GetBCBHInfo(AManu_Part_Number: string): Boolean;
var
  lsql: string;
begin
...
procedure TfrmTCL6298.edtBCBHExit(Sender: TObject);
begin
  if edtBCBH.Text <> '' then
  begin
...
function TfrmTCL6298.GetXSDDInfo(ASOno: string;b: Boolean = False): Boolean;
begin
  Result := False;
//  if b then
//  begin
...
procedure TfrmTCL6298.edtXSDDExit(Sender: TObject);
begin
  if edtXSDD.Text <> '' then
    GetXSDDInfo(edtXSDD.Text, True);
end;

function TfrmTCL6298.GetPCSNumber: Boolean;
begin
  Result := True;
  try
...
procedure TfrmTCL6298.edtSLSetExit(Sender: TObject);
begin
  GetPCSNumber;
end;

procedure TfrmTCL6298.btnSCClick(Sender: TObject);
var
  I: Integer;
  LBarID: string;
  tmpQSXH: string;
...
function TfrmTCL6298.CommonCheck: Boolean;
begin
  Result := False;
...
procedure TfrmTCL6298.btnResetClick(Sender: TObject);
var
  I: Integer;
begin
...
function TfrmTCL6298.ExtractBarID(PackNo: Integer;
...
procedure TfrmTCL6298.intgrfldads699qtyChange(Sender: TField);
begin
...
function TfrmTCL6298.CheckSCZQ: Boolean;
begin
  Result := False;
...
procedure TfrmTCL6298.btnOKClick(Sender: TObject);
var
  LSql: string;
  LPcsCount: Integer;
begin
...
procedure TfrmTCL6298.ViewShow(Rkey698: Integer);
var
  I: Integer;
begin
  btnResetClick(nil);
...
procedure TfrmTCL6298.btnCloseClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

function TfrmTCL6298.IncBQDM(AOldDM: string): string;
var
  I: Integer;
  nIndex: Integer;
  tmps: string;
...
procedure TfrmTCL6298.eh699Columns2UpdateData(Sender: TObject;
