...
type
  TfrmHQ6095 = class(TForm)
    ...
    procedure edtCPMSKeyPress(Sender: TObject; var Key: Char);
  private
...
procedure TfrmHQ6095.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmHQ6095.btnBCBHClick(Sender: TObject);
var
...
procedure TfrmHQ6095.btnXSDDClick(Sender: TObject);
var
  LFrm: Tsearchso_Form;
  LSql: string;
...
function TfrmHQ6095.GetBCBHInfo(AManu_Part_Number: string): Boolean;
var
  lsql: string;
begin
...
procedure TfrmHQ6095.edtBCBHExit(Sender: TObject);
begin
  if edtBCBH.Text <> '' then
  begin
...
function TfrmHQ6095.GetXSDDInfo(ASOno: string;b: Boolean = False): Boolean;
begin
  Result := False;
//  if b then
//  begin
...
procedure TfrmHQ6095.edtXSDDExit(Sender: TObject);
begin
  if edtXSDD.Text <> '' then
    GetXSDDInfo(edtXSDD.Text, True);
end;

function TfrmHQ6095.GetPCSNumber: Boolean;
begin
  Result := True;
  try
...
procedure TfrmHQ6095.edtSLSetExit(Sender: TObject);
begin
  GetPCSNumber;
end;

procedure TfrmHQ6095.btnSCClick(Sender: TObject);
var
  I: Integer;
  LBarID: string;
  tmpQSXH: string;
begin
  ...
  if StrToIntDef(edtCPMS.Text,-1) <= 0 then
  begin
    ShowMessage('请填写最小包数');
    Exit;
  end;
...
function TfrmHQ6095.CommonCheck: Boolean;
begin
  Result := False;
...
procedure TfrmHQ6095.btnResetClick(Sender: TObject);
var
  I: Integer;
begin
...
function TfrmHQ6095.ExtractBarID(PackNo: Integer;
...
procedure TfrmHQ6095.intgrfldads699qtyChange(Sender: TField);
begin
...
function TfrmHQ6095.CheckSCZQ: Boolean;
begin
  Result := False;
...
procedure TfrmHQ6095.btnOKClick(Sender: TObject);
var
  LSql: string;
  LPcsCount: Integer;
begin
...
procedure TfrmHQ6095.ViewShow(Rkey698: Integer);
var
  I: Integer;
begin
  btnResetClick(nil);
...
procedure TfrmHQ6095.btnCloseClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

function TfrmHQ6095.IncBQDM(AOldDM: string): string;
var
  I: Integer;
  nIndex: Integer;
  tmps: string;
...
procedure TfrmHQ6095.eh699Columns2UpdateData(Sender: TObject;
...
procedure TfrmHQ6095.edtCPMSKeyPress(Sender: TObject; var Key: Char);
begin
