...
procedure TfrmWT6259.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmWT6259.btnBCBHClick(Sender: TObject);
var
...
procedure TfrmWT6259.btnXSDDClick(Sender: TObject);
var
  LFrm: Tsearchso_Form;
  LSql: string;
...
function TfrmWT6259.GetBCBHInfo(AManu_Part_Number: string): Boolean;
var
  lsql: string;
begin
...
procedure TfrmWT6259.edtBCBHExit(Sender: TObject);
begin
  if edtBCBH.Text <> '' then
  begin
...
function TfrmWT6259.GetXSDDInfo(ASOno: string;b: Boolean = False): Boolean;
begin
  Result := False;
//  if b then
//  begin
...
procedure TfrmWT6259.edtXSDDExit(Sender: TObject);
begin
  if edtXSDD.Text <> '' then
    GetXSDDInfo(edtXSDD.Text, True);
end;

function TfrmWT6259.GetPCSNumber: Boolean;
begin
  Result := True;
  try
...
procedure TfrmWT6259.edtSLSetExit(Sender: TObject);
begin
  GetPCSNumber;
end;

procedure TfrmWT6259.btnSCClick(Sender: TObject);
var
  I: Integer;
  LBarID: string;
  tmpQSXH: string;
...
function TfrmWT6259.CommonCheck: Boolean;
begin
  Result := False;
...
procedure TfrmWT6259.btnResetClick(Sender: TObject);
var
  I: Integer;
begin
...
function TfrmWT6259.ExtractBarID(PackNo: Integer;
...
procedure TfrmWT6259.intgrfldads699qtyChange(Sender: TField);
begin
...
function TfrmWT6259.CheckSCZQ: Boolean;
begin
  Result := False;
...
procedure TfrmWT6259.btnOKClick(Sender: TObject);
var
  LSql: string;
  LPcsCount: Integer;
begin
...
procedure TfrmWT6259.ViewShow(Rkey698: Integer);
var
  I: Integer;
begin
  btnResetClick(nil);
...
procedure TfrmWT6259.btnCloseClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

function TfrmWT6259.IncBQDM(AOldDM: string): string;
var
  I: Integer;
  nIndex: Integer;
  tmps: string;
...
procedure TfrmWT6259.eh699Columns2UpdateData(Sender: TObject;
