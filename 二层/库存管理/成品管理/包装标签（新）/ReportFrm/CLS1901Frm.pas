...
procedure TfrmCLS1901.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if Key = #13 then
  begin
    Key := #0;
...
procedure TfrmCLS1901.btnBCBHClick(Sender: TObject);
var
...
procedure TfrmCLS1901.btnXSDDClick(Sender: TObject);
var
  LFrm: Tsearchso_Form;
  LSql: string;
...
function TfrmCLS1901.GetBCBHInfo(AManu_Part_Number: string): Boolean;
var
  LSql: string;
begin
...
procedure TfrmCLS1901.edtBCBHExit(Sender: TObject);
begin
  if edtBCBH.Text <> '' then
  begin
...
function TfrmCLS1901.GetXSDDInfo(ASOno: string;b: Boolean = False): Boolean;
begin
  Result := False;
//  if b then
//  begin
...
procedure TfrmCLS1901.edtXSDDExit(Sender: TObject);
begin
  if edtXSDD.Text <> '' then
    GetXSDDInfo(edtXSDD.Text, True);
end;

function TfrmCLS1901.GetPCSNumber: Boolean;
begin
  Result := True;
  try
...
procedure TfrmCLS1901.edtSLSetExit(Sender: TObject);
begin
  GetPCSNumber;
end;

procedure TfrmCLS1901.btnSCClick(Sender: TObject);
var
  I: Integer;
  LBarID: string;
  tmpQSXH: string;
...
function TfrmCLS1901.CommonCheck: Boolean;
begin
  Result := False;
...
procedure TfrmCLS1901.btnResetClick(Sender: TObject);
var
  I: Integer;
begin
...
function TfrmCLS1901.ExtractBarID(PackNo: Integer;
...
procedure TfrmCLS1901.intgrfldads699qtyChange(Sender: TField);
begin
...
function TfrmCLS1901.CheckSCZQ: Boolean;
begin
  Result := False;
...
procedure TfrmCLS1901.btnOKClick(Sender: TObject);
var
  LSql: string;
  LPcsCount: Integer;
begin
...
procedure TfrmCLS1901.ViewShow(Rkey698: Integer);
var
  I: Integer;
begin
  btnResetClick(nil);
...
procedure TfrmCLS1901.btnCloseClick(Sender: TObject);
begin
  ModalResult := mrCancel;
end;

function TfrmCLS1901.IncBQDM(AOldDM: string): string;
var
  I: Integer;
  nIndex: Integer;
  tmps: string;
...
procedure TfrmCLS1901.eh699Columns2UpdateData(Sender: TObject;
