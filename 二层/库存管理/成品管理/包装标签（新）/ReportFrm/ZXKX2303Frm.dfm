object frmZXKX2303: TfrmZXKX2303
  Left = 746
  Top = 159
  ...
  object pnl2: TPanel
    ...
    object grp4: TGroupBox
      ...
      object Label1: TLabel
        ...
        Width = 48
        Height = 13
        Caption = #25171#21449#25968#65306
      end
      object dtpHKRQ: TDateTimePicker
        Left = 143
        Top = 28
        Width = 95
        Height = 20
        Date = 41381.423180057870000000
        Time = 41381.423180057870000000
        ImeName = #20013#25991'('#31616#20307') - '#24517#24212' Bing '#36755#20837#27861
        TabOrder = 0
      end
      object cbxHKRQ: TCheckBox
        Left = 144
        Top = 8
        Width = 73
        Height = 17
        Caption = #28888#28900#26085#26399
        TabOrder = 1
      end
      object cbbDCB: TComboBox
        Left = 10
        Top = 28
        Width = 89
        Height = 21
  ...
  object pnl3: TPanel
    ...
    object mmo1: TMemo
      ...
      Height = 89
      Lines.Strings = (
        'SELECT top 1 d698.v_date,'
        'CASE when'
        #9'datepart'
        '(dayofyear,getDate()) = datepart'
        '(dayofyear,d698.v_date)'#9' AND '
        'datepart(year,getdate())=datepart'
        '(year,d698.v_date)'
        'THEN'
        #9'0'
        'ELSE'
        ...
        'END'
        'as newIncNo'
        ',isnull(d699.incNo,0) as incNo  ,'
        'CONVERT(varchar(100), GETDATE'
        '(), 112) as d'
        'from '
        'data0699 d699'
        'inner JOIN DATA0698 d698 ON '
        'd699.pack_ptr = d698.rkey'
        'WHERE d699.printfilename = '#39'2303'#39
        'ORDER BY d699.pack_ptr '
        'desc,d699.order_no desc')
      TabOrder = 1
      Visible = False
    end
  end
  object ads699: TADODataSet
    ...
    object ads699param1: TStringField
      FieldName = 'param1'
      Size = 100
    end
    object ads699param2: TStringField
      FieldName = 'param2'
      Size = 100
    end
    object ads699printfilename: TStringField
      FieldName = 'printfilename'
      Size = 100
    end
    object ads699incno: TIntegerField
      FieldName = 'incno'
    end
  end
