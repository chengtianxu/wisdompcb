...
begin
  ...
  outRet.DBConnectString := 'Provider=SQLOLEDB.1;Password=wisdompcb1077;Persist Security Info=True;' +
    'User ID=sa;Initial Catalog=demo2;Data Source=192.168.8.37;Use Procedure for Prepare=1;Auto Translate=True;Packet Size=4096;Workstation ID=CHENGTX-PC;Use Encryption for Data=False;Tag with column collation when possible=False';
  outRet.DBName := '开发备份';
end;
